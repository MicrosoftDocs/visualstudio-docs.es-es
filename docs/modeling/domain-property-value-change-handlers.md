...
ms.locfileid: "99935097"
---
# <a name="domain-property-value-change-handlers"></a>Controladores de cambios de valor de propiedad de dominio

En un lenguaje específico de dominio de Visual Studio, cuando cambia el valor de una propiedad de dominio, los `OnValueChanging()` `OnValueChanged()` métodos y se invocan en el controlador de propiedades de dominio. Para responder al cambio, puede invalidar estos métodos.
