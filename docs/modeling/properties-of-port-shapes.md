...
description: Obtenga información sobre las formas de puerto y cómo puede usar las formas de puerto para representar las clases de dominio en el diseñador generado.
...
|Inheritance (modificador)|Describe el tipo de herencia de la clase de código fuente que se genera a partir del puerto ( `none` , `abstract` o `sealed` ).|ninguno|
