...
## <a name="in-this-section"></a>En esta sección
 [Tiempo de ejecución de generación de texto con plantillas de texto T4](../modeling/run-time-text-generation-with-t4-text-templates.md) en cualquier aplicación que genere archivos de texto, plantillas de texto precompiladas son un método fácil y confiable para definir el texto. Sin embargo, este método no se puede usar para las plantillas de texto que cambian en tiempo de ejecución.

 [Generación de código en tiempo de diseño mediante el uso de plantillas de texto T4](../modeling/design-time-code-generation-by-using-t4-text-templates.md) generar código y otros recursos de un modelo permite actualizar la aplicación al actualizar el modelo.

 [Generación de código en un proceso de compilación](../modeling/code-generation-in-a-build-process.md) si ha instalado [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] de visualización y modelado de SDK, puede asegurarse de que el software generado se mantendrá actualizado con los cambios en el modelo.
 ...
 [Tutorial: Generar código mediante plantillas de texto](../modeling/walkthrough-generating-code-by-using-text-templates.md) una demostración de cómo usar la generación de código.
 ...
 [Generar archivos con la utilidad TextTransform](../modeling/generating-files-with-the-texttransform-utility.md) la herramienta de línea de comandos que puede usar para ejecutar transformaciones de plantilla de texto.
