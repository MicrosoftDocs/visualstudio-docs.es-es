...
## <a name="compileroptions-attribute"></a>compilerOptions (atributo)
 ...
 Los valores válidos: cualquier opción del compilador válida.
...
## <a name="culture-attribute"></a>culture (atributo)
 ...
 Los valores válidos: "", la referencia cultural invariable, que es el valor predeterminado.
...
```
 ...
 Los valores válidos: `true, false`. False es la opción predeterminada.
...
```
 ...
 Los valores válidos: `true, false, trueFromBase`. False es la opción predeterminada.
...
## <a name="language-attribute"></a>language (atributo)
 ...
 Los valores válidos: `C#` (valor predeterminado)
...
## <a name="linepragmas-attribute"></a>Atributo LinePragmas
 ...
 Los valores válidos: `true` (valor predeterminado)
...
## <a name="visibility-attribute"></a>Atributo visibility
 ...
 Los valores válidos: `public` (valor predeterminado)
