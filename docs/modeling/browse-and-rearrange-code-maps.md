...
description: Obtenga información acerca de cómo reorganizar los elementos en mapas de código para que sean más fáciles de leer y mejorar su rendimiento.
...
|**To**|**Siga estos pasos**|
|-|-|
|Examinar el mapa.|Arrastre el mapa en cualquier dirección con el mouse.<br /><br /> o bien<br /><br /> Mantenga presionada la **tecla Mayús** y gire la rueda del mouse para desplazarse horizontalmente. Mantenga presionada la tecla **MAYÚS**  +   y gire la rueda del mouse para desplazarse horizontalmente.|
