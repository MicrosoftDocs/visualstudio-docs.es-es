...
description: Obtenga información sobre los distintos tipos básicos de formas que puede usar para mostrar información en un diagrama en un lenguaje específico de dominio (DSL).
...
ms.locfileid: "112385752"
---
# <a name="define-shapes-and-connectors"></a>Definición de formas y conectores
...
Un diagrama dsl muestra una colección de *formas* entrelazadas por líneas o *conectores*. Normalmente, aunque no siempre:
...
|-|-|
|Forma geométrica|Forma elíptica o rectangular con fines generales. Puede mostrar elementos Decorator de texto e icono en posiciones específicas relativas a los límites de la forma. También puede anidar formas dentro de formas de geometría.|
