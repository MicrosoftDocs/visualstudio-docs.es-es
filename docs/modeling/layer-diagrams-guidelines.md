...
description: Obtenga información sobre cómo describir la arquitectura de la aplicación en un nivel alto mediante la creación de diagramas de dependencia en Visual Studio.
