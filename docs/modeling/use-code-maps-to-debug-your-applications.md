...
description: Aprenda a usar mapas de código para ayudarle a evitar la pérdida de grandes bases de código, código desconocido o código heredado.
...
![Mapa de código &#45; relaciones de mapa en el código](../modeling/media/codemapstoryboardpaint.png)
...
## <a name="start-mapping-the-code"></a>Empezar a asignar el código
 ...
 ![Mapa de código &#45; método Mostrar y campos relacionados](../modeling/media/codemapstoryboardpaint3.png)
...
## <a name="find-the-problem-by-examining-the-map"></a>Buscar el problema examinando la asignación
 ...
 ![Mapa de código &#45; buscar llamada al método que falta](../modeling/media/codemapstoryboardpaint11.png)
...
## <a name="share-your-discovery-and-next-steps"></a>Compartir la información y pasos siguientes
 ...
 ![Mapa de código &#45; elementos de marca y comentario para seguimiento](../modeling/media/codemapstoryboardpaint12.png)

 Por ejemplo, puede agregar comentarios al mapa y marcar los elementos con colores.

 ![Mapa de código &#45; elementos comentados y marcados](../modeling/media/codemapstoryboardpaint12a.png)
 ...
 ![Mapa de código &#45; recurso compartido, exportación y correo](../modeling/media/codemapstoryboardpaint13.png)
...
## <a name="fix-the-problem-and-show-what-you-did"></a>Corregir el problema y mostrar lo que hizo
 ...
 ![Mapa de código &#45; agregar llamada al método que falta](../modeling/media/codemapstoryboardpaint14.png)
 ...
 ![Mapa de código &#45; confirmar corrección del código](../modeling/media/codemapstoryboardpaint15.png)

 Puede actualizar el mapa para mostrar la corrección que realizó.

 ![Mapa de código &#45; mapa de actualización con la llamada a método que falta](../modeling/media/codemapstoryboardpaint16.png)
