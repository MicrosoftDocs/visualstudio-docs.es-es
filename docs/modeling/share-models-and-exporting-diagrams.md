---
title: "Compartir modelos y diagramas de exportación | Documentos de Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="reading-and-reviewing-models"></a>Leer y revisar modelos  
 Los miembros del equipo con algunas versiones de Visual Studio (que no se puede crear modelos) pueden leer modelos, diagramas de modelado y gráficos dirigidos, pero no pueden modificar.  Para ver qué versiones de Visual Studio admiten esta característica, vea [Version support for architecture and modeling tools](../modeling/what-s-new-for-design-in-visual-studio.md#VersionSupport).  
