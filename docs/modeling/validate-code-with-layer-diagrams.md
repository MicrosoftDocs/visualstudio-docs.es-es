...
- Solución que tiene un proyecto de modelado con un diagrama de dependencia. Este diagrama de dependencia debe estar vinculado a artefactos en C# o Visual Basic proyectos que desea validar. Vea [crear diagramas de dependencia desde el código](../modeling/create-layer-diagrams-from-your-code.md).
...
* La validación en directo es compatible con C# y Visual Basic.
