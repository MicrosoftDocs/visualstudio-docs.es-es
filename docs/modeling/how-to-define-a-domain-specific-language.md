...
##  <a name="a-nametemplatesa-selecting-a-template-solution"></a><a name="templates"></a>Selección de una solución de plantilla  
...
1.  Crear una solución con la **lenguaje específico de dominio** plantilla, que se encuentra en **otros tipos y extensibilidad de proyectos** en el **nuevo proyecto** cuadro de diálogo.  
...
2.  Haga clic en cada plantilla para ver una descripción. Elija la solución que más se parezca a lo que quiere crear.  
    ...
    -   Seleccione **modelos de componentes** para crear un DSL que tiene puertos. Los puertos son pequeñas formas en el borde de una forma mayor.  
...
### <a name="test-the-solution"></a>Probar la solución  
 ...
 Si se ejecuta una solución que ha creado desde el **lenguaje mínimo** plantilla, la instancia experimental [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] se asemejarán al ejemplo siguiente:  
...
-   La clase raíz aparece en la parte superior izquierda del diagrama de la definición de DSL, bajo **clases y relaciones**. Asígnele otro nombre según el DSL. Por ejemplo, un DSL denominado **MusicLibrary** podría tener una clase raíz denominada **música**.  
  
-   La clase de diagrama aparece en la esquina inferior derecha del diagrama de definición de DSL, en la **elementos del diagrama** columna. Quizás tenga que desplazarse a la derecha para verlo. Normalmente se denomina *Sudsl***diagrama**.  
  
-   Si ha usado la **flujo de tareas** plantilla y desea crear diagramas con calles, mantener y cambiar el nombre de la clase de dominio Actor y la forma ActorSwimlane.  
  
 Elimine o cambie el nombre de otras clases para que se ajusten a sus necesidades.  
  
##  <a name="a-namepatternsa-patterns-for-defining-a-dsl"></a><a name="patterns"></a>Patrones para definir un DSL  
...
##  <a name="a-nameclassesa-defining-domain-classes"></a><a name="classes"></a>Definir clases de dominio  
 Las clases de dominio representan los conceptos de su DSL. Las instancias son *elementos del modelo*. Por ejemplo, en un **MusicLibrary** DSL podría tener las clases de dominio **álbum** y **Song**.  
  
 Para crear una clase de dominio, puede arrastrar desde el **con el nombre de clase de dominio** herramienta al diagrama y, a continuación, cambie el nombre de la clase.  
...
|Elemento en una lista en una forma; el elemento se elimina si el contenedor se elimina.<br /><br /> Puerto en el borde de una forma.|Clase de dominio que se asigna a la forma del contenedor.|Diagrama de clase: clase de atributos.<br /><br /> Diagrama de componentes: clase de puerto.|  
...
|No se muestra directamente.|Clase de la que forma parte.||  
 ...
 Para crear una clase de dominio y su incrustación al mismo tiempo, haga clic en el **relación de incrustación** herramienta, a continuación, haga clic en la clase primaria y, a continuación, haga clic en una parte en blanco del diagrama.  
 ...
 Para obtener más información, consulte [propiedades de las relaciones de dominio](../modeling/properties-of-domain-relationships.md) y [propiedades de funciones específicas del dominio](../modeling/properties-of-domain-roles.md).  
 ...
 **Establecer una propiedad de nombre de elemento.** Seleccione una propiedad de dominio que puede usarse para identificar los elementos en el explorador del lenguaje. Por ejemplo, en la clase de dominio Song que pueda seleccionar la propiedad de dominio Title (Título). En el **propiedades** ventana, establezca **es el nombre del elemento** a `true`.  
...
### <a name="create-derived-domain-classes"></a>Crear clases de dominio derivadas  
 ...
 Cree la clase derivada con el **clase de dominio** herramienta.  
  
 Haga clic en el **herencia** de herramientas, haga clic en la clase derivada y, a continuación, haga clic en la clase base.  
  
 Considere la opción de la **modificador de herencia** de la clase base para **abstracta**. Si cree que puede necesitar instancias de la clase base, considere la posibilidad de crear en su lugar una clase derivada diferente para ellas.  
...
### <a name="tidy-the-dsl-definition-diagram"></a>Ordenar el diagrama DSL Definition (Definición de DSL)  
 Cuando se agregan relaciones, algunas de las clases aparecen en más de un lugar. Para reducir el número de apariciones y ampliar el diagrama, haga clic en la clase de destino de una relación y, a continuación, haga clic en **Traer árbol aquí**. El efecto opuesto, haga clic en la clase de destino de una relación y haga clic en **división árbol**. Si no ve estos comandos del menú, asegúrese de que solo está seleccionada la clase de dominio.  
...
##  <a name="a-nameshapesa-defining-shapes-on-the-diagram"></a><a name="shapes"></a>Definir formas en el diagrama  
...
3.  **Defina una imagen, si crea una forma de imagen**.  
...
4.  **Agregar elementos Decorator de texto a la forma, para mostrar las propiedades del dominio.**  
     ...
     Haga clic en el encabezado de la clase shape, seleccione **agregar**y, a continuación, haga clic en **Decorator de texto**. Establezca el nombre del elemento decorator y en la ventana de propiedades establecidas sus **posición**.  
  
5.  **Conectar cada forma con una asignación de elemento de diagrama a la clase de dominio que se debe mostrar**.  
  
     Haga clic en el **asignación de elemento de diagrama** herramienta, a continuación, haga clic en la clase de dominio, haga clic en la clase shape.  
  
6.  **Asignar las propiedades a los elementos Decorator de texto.**  
    ...
    2.  En el **detalles de DSL** ventana, haga clic en el **Decorator Maps** ficha. Si no ve el **detalles de DSL** ventana, en la **vista** menú, seleccione **otras ventanas** y, a continuación, haga clic en **detalles de DSL**. Normalmente es necesario levantar la parte superior de esta ventana para ver todo su contenido.  
    ...
    3.  Seleccione el nombre de un elemento Decorator. En **Mostrar propiedad**, seleccione el nombre de una propiedad de la clase de dominio. Repita este paso para cada elemento Decorator.  
         ...
         Si desea mostrar una propiedad de un elemento relacionado, haga clic en el Explorador de árbol desplegable en **ruta para mostrar la propiedad**.  
...
7.  **Asegúrese de un elemento de cuadro de herramientas para crear elementos de la clase de dominio.**  
    ...
    1.  En **DSL Explorer**, expanda la **Editor** nodo y todos sus nodos secundarios.  
    ...
    5.  Establecer **icono cuadro de herramientas** a un icono que aparecerá en el cuadro de herramientas. Puede establecerlo en un icono nuevo o en un icono que ya se haya usado para otra herramienta.  
         ...
         Volver al diagrama de definición de DSL, seleccione la herramienta y en la ventana Propiedades, haga clic en **[...] ** en **icono cuadro de herramientas**. En el **Seleccionar mapa de bits** cuadro de diálogo, seleccione la. Archivo BMP en el menú desplegable.  
  
 Para obtener más información, consulte [propiedades de formas geométricas](../modeling/properties-of-geometry-shapes.md) y [propiedades de imagen formas](../modeling/properties-of-image-shapes.md).  
...
5.  **Compruebe que aparece cada elemento decorator de texto,** y que:  
    ...
    1.  Se puede editar, a menos que se ha establecido la **Is UI Read Only** marca en la propiedad de dominio.  
...
##  <a name="a-namereferencesa-defining-reference-relationships"></a><a name="references"></a>Definir relaciones de referencia  
 ...
 **Considere la posibilidad de cambiar el nombre de las funciones**. Por ejemplo, en una relación entre personas, quizás quiera cambiar los nombres predeterminados por Padres e Hijos, Director y Subordinados, Profesor y Estudiante, etc.  
 ...
 **Agregar propiedades de dominio a la relación.** En la ilustración, la relación Artist-Album tiene una propiedad de función.  
 ...
 **Establece la propiedad permite duplicados de la relación** si más de un vínculo de la misma clase puede existir entre el mismo par de elementos de modelo. Por ejemplo, podría permitir que un Profesor enseñe más de una Asignatura al mismo Estudiante.  
 ...
 ![Asignaciones de conectores de forma](../modeling/media/music_connector.png "Music_Connector")  
...
### <a name="define-a-connector-to-display-the-relationship"></a>Definir un conector para mostrar la relación  
 ...
 Arrastre el **conector** herramienta al diagrama de definición de DSL.  
  
 Agregue elementos Decorator de texto si quiere mostrar etiquetas en el conector. Establezca sus posiciones. Para permitir que el usuario mueva un elemento decorator de texto, establezca su **es Moveable** propiedad.  
  
 Utilice la **asignación de elemento de diagrama** herramienta para vincular el conector a la relación de referencia.  
  
 Con la asignación de elemento de diagrama seleccionada, abra el **detalles de DSL** ventana y abra la **Decorator Maps** ficha.  
...
### <a name="define-a-connection-builder-tool"></a>Definir una herramienta Connection Builder (Generador de conexiones)  
 En el **DSL Explorer** ventana, expanda la **Editor** nodo y todos sus subnodos.  
  
 Haga clic en el nodo que tiene el mismo nombre que su DSL y, a continuación, haga clic en **agregar una nueva herramienta de conexión**.  
...
##  <a name="a-namecompartmentsa-defining-shapes-that-contain-lists-compartment-shapes"></a><a name="compartments"></a>Definir formas que contienen listas: compartimiento de formas  
 ...
 ![Asignación de forma](../modeling/media/music_mapcomp.png "Music_MapComp")  
  
 Para obtener más información, consulte [propiedades de las formas de compartimiento](../modeling/properties-of-compartment-shapes.md).  
...
2.  **Crear la clase de dominio de elemento de lista**. Haga clic en el **relación de incrustación** de herramientas, haga clic en la clase de contenedor (Album) y, a continuación, haga clic en una parte en blanco del diagrama. Esto crea la clase de dominio llamada Song en la figura de ejemplo.  
...
4.  **Crear la forma de compartimiento**. Arrastre desde el **forma de compartimiento** herramienta al diagrama de definición de DSL.  
  
     Agregue un elemento Decorator de texto y establezca su nombre.  
  
     Agregue un compartimiento y establezca su nombre.  
  
5.  Para que el usuario pueda ocultar los compartimientos de lista, haga clic en la clase de la forma de compartimiento, elija **agregar**y, a continuación, haga clic en **decorador de expandir o contraer**. En la ventana Properties (Propiedades), establezca la posición del elemento Decorator.  
  
6.  Haga clic en el **asignación de elemento de diagrama** de herramientas, haga clic en la clase de contenedor de dominio y, a continuación, haga clic en la forma de compartimiento.  
...
7.  Seleccione el vínculo de la asignación de elemento de diagrama entre la clase de dominio y la forma. En el **detalles de DSL** ventana:  
    ...
    2.  Haga clic en el **asignaciones compartimiento** ficha.  
  
         Haga clic en el nombre del compartimiento.  
  
         En **ruta de recopilación de elementos mostrados**, vaya a la clase de elemento de lista (Song). Haga clic en la flecha hacia abajo para usar la herramienta de navegador.  
...
2.  En **DSL Explorer**, expanda la **Editor** nodo y todos sus nodos secundarios.  
...
6.  Establecer **icono cuadro de herramientas** a un icono que aparecerá en el cuadro de herramientas. Puede establecerlo en un icono nuevo o en un icono que ya se haya usado para otra herramienta.  
     ...
     Volver al diagrama de definición de DSL, seleccione la herramienta y en la ventana Propiedades, haga clic en **[...] ** en **icono cuadro de herramientas**. En el **Seleccionar mapa de bits** cuadro de diálogo, seleccione el archivo BMP en el menú desplegable.  
...
1.  **Agregue un compartimiento a la forma de compartimiento**. En el diagrama de la definición de DSL, haga clic en la clase de la forma de compartimiento, elija **agregar**y, a continuación, haga clic en **compartimiento**.  
  
2.  Establecer **ruta de recopilación de elementos mostrados** para navegar hasta el vínculo, en lugar de su elemento de destino. Haga clic en el menú desplegable y use la vista de árbol para seleccionar la relación de referencia en lugar de su destino. En el ejemplo, la relación es **ArtistAppearedOnAlbums**.  
  
3.  Establecer **ruta de acceso a la propiedad de presentación** para desplazarse desde el vínculo al elemento de destino. En el ejemplo, esto es **artista**.  
  
4.  Establecer **propiedad Display** en la propiedad correspondiente del elemento de destino, por ejemplo **nombre**.  
  
5.  **Transformar todas las plantillas**, compile y ejecute el DSL y abrir un modelo de prueba.  
...
##  <a name="a-nameportsa-defining-ports-on-the-boundary-of-another-shape"></a><a name="ports"></a>Definir los puertos en los límites de otra forma  
...
-   Las clases de dominio de puerto se asignan a formas de puerto. Puede asignar las clases derivadas a clases de forma de puerto diferentes, o asignar la clase base a una clase de forma de puerto.  
 ...
 En otros aspectos, formas de puerto se comportan como se describe en [definir formas](#shapes).  
  
 Para obtener más información, consulte [formas de propiedades de puerto](../modeling/properties-of-port-shapes.md).  
  
##  <a name="a-nameswimlanesa-defining-a-dsl-that-has-swimlanes"></a><a name="swimlanes"></a>Definir un DSL que tiene calles  
...
##  <a name="a-nameaddtypesa-adding-property-types"></a><a name="addTypes"></a>Agregar tipos de propiedad  
...
### <a name="domain-enumerations-and-literals"></a>Literales y enumeradores de dominio  
 ...
 Para agregar una enumeración de dominio, haga clic en la raíz del modelo en el **DSL Explorer** y, a continuación, haga clic en **agregar nueva enumeración de dominio**. El elemento aparecerá en el **DSL Explorer** en el **tipos de dominio** nodo. Este elemento no aparece en el diagrama.  
 ...
 De forma predeterminada, una propiedad que tiene un tipo de enumeración solo se puede establecer en un valor de la enumeración al mismo tiempo. Si desea que los usuarios y programadores puedan establecer cualquier combinación de valores, un "campo de bits," establecer la **IsFlags** propiedad de la enumeración.  
...
##  <a name="a-namecustoma-customizing-the-dsl"></a><a name="custom"></a>Personalizar el DSL  
...
### <a name="changing-the-dsl-definition"></a>Cambiar la definición de DSL  
 ...
 Consulte también [Cómo: cambiar el Namespace de un lenguaje específico de dominio](../modeling/how-to-change-the-namespace-of-a-domain-specific-language.md).  
  
##  <a name="a-nametroublea-troubleshooting"></a><a name="trouble"></a>Solución de problemas  
 En la tabla siguiente se enumeran algunos de los problemas más comunes que se encuentran al diseñar un DSL, además de sugerencias para solucionarlos. Más consejos está disponible en la [foro de extensibilidad de las herramientas de visualización](http://go.microsoft.com/fwlink/?LinkId=186074).  
  
|Problema|Sugerencia|  
|-------------|----------------|  
|Los cambios que he hecho en el archivo de definición de DSL no surten efecto.|Haga clic en **Transformar todas las plantillas** en la barra de herramientas encima de explorador de soluciones y, a continuación, volver a generar la solución.|  
|Las formas muestran el nombre de un elemento Decorator en lugar del valor de la propiedad.|Configure la asignación del elemento Decorator. En el diagrama DSL Definition (Definición de DSL), haga clic en la asignación de elemento de diagrama, que es la línea gris entre la clase de dominio y la clase de forma.<br /><br /> Abra la **detalles de DSL** ventana. Si no puede ver, en el menú Ver, elija **otras ventanas**y, a continuación, haga clic en **detalles de DSL**.<br /><br /> Haga clic en el **Decorator Maps** ficha. Seleccione el nombre del elemento Decorator. Asegúrese de que la casilla situada junto a él está activada. En **Mostrar propiedad**, seleccione el nombre de una propiedad de dominio.<br /><br /> Para obtener más información, consulte [formas del diagrama](#shapes).|  
...
|En el explorador de mi DSL, los elementos se muestran solo con sus nombres de tipo.|En la definición de DSL, seleccione una propiedad de dominio de la clase y en las propiedades de la ventana, establezca **es el nombre del elemento** en true.|  
