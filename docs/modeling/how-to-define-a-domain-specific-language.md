...
1. Cree un nuevo proyecto **de lenguaje específico del dominio** .
   ...
   ::: moniker-end
    ...
    Se abre el **Asistente para lenguajes específicos de dominio** y se muestra una lista de las soluciones DSL de plantilla.
...
### <a name="test-the-solution"></a>Probar la solución
 ...
 Si ejecuta una solución que ha creado a partir de la plantilla de **lenguaje mínima** , su Visual Studio experimental será similar al ejemplo siguiente:
