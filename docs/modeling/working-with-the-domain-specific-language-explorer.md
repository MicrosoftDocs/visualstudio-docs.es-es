...
-   **Editor**. Una lista de **cuadro de herramientas** fichas y los elementos que contienen y configuración de la validación para el modelo. Para obtener más información acerca de la validación, consulte [validación en un lenguaje específico de dominio](../modeling/validation-in-a-domain-specific-language.md).  
