...
## <a name="use-domain-specific-language-tools-to-generate-a-directive-processor"></a>Usar Herramientas del lenguaje específico de dominio para generar un procesador de directivas
