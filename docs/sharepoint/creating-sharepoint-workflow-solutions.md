...
### Utilizar el asistente  
 ...
 Después de crear el flujo de trabajo, puede modificar sus propiedades en la ventana Propiedades.  Aunque la mayoría de las propiedades de flujo de trabajo se pueden cambiar directamente en la ventana Propiedades, algunas requieren que haga clic en un botón de puntos suspensivos \(![Elipse del Diseñador de ASP.NET Mobile](~/docs/sharepoint/media/mwellipsis.gif "Elipse del Diseñador de ASP.NET Mobile")\) para cambiar sus valores.  Este botón reinicia el **Asistente para la personalización de SharePoint**.  Después de realizar los cambios de valores de propiedad, elija el botón de **Finalizar** para finalizarlos.  
