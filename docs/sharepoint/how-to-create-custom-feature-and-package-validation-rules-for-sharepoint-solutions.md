...
ms.openlocfilehash: 44a89b86b1ecd393c2e6e4dd0e0b04ff74b3df7a
ms.contentlocale: es-es
ms.lasthandoff: 08/30/2017

---
# <a name="how-to-create-custom-feature-and-package-validation-rules-for-sharepoint-solutions"></a>How to: Create Custom Feature and Package Validation Rules for SharePoint Solutions
...
### <a name="to-create-a-custom-package-validation-rule"></a>To create a custom package validation rule  
...
## <a name="example"></a>Example  
 ...
 [!code-vb[SPExtensibility.FeatureValidation#1](../sharepoint/codesnippet/VisualBasic/featurevalidation/extension/customvalidationrule.vb#1)] [!code-csharp[SPExtensibility.FeatureValidation#1](../sharepoint/codesnippet/CSharp/featurevalidation/extension/customfeaturevalidationrule.cs#1)]  
