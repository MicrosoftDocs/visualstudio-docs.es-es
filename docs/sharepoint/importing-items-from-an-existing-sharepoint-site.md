...
helpviewer_keywords: 
  ...
  - "desarrollo de SharePoint en Visual Studio, importar archivos .wsp"
...
## Restaurar los atributos de la característica que faltan  
 Cuando se importan soluciones, algunos atributos de características opcionales se omiten en el manifiesto de la función importada. Si desea restaurar estos atributos en el nuevo archivo de la característica, identifique los atributos que faltan comparando el archivo de la característica original con el nuevo manifiesto de la característica y siga las instrucciones en el tema [Cómo: Personalizar una característica de SharePoint](../sharepoint/how-to-customize-a-sharepoint-feature.md).  
...
## Límite de carácter de nombre de elemento  
...
## El atributo SharePointProductVersion  
...
## Vea también  
 [Tutorial: Importar elementos de un sitio de SharePoint](../sharepoint/walkthrough-import-items-from-an-existing-sharepoint-site.md)   
