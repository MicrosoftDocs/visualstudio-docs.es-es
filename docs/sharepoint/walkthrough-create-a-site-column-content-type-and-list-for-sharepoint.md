...
14. En la lista de **Propiedades** , elija la propiedad de **Ordenar y agrupar** , y elija los puntos suspensivos ![Icono Puntos suspensivos](~/docs/sharepoint/media/ellipsisicon.gif "Icono Puntos suspensivos") para mostrar el cuadro de diálogo de **Ordenar y agrupar** .  
