...
description: Localice soluciones de SharePoint quitando las cadenas codificadas de forma rígida del código y abstrayéndolas en archivos de recursos basados en XML (.resx) que contienen cadenas traducidas.
