...
3.  En la ventana de **Propiedades** , elija la propiedad de **Propiedades personalizadas** , y elija los puntos suspensivos \(![Elipse del Diseñador de ASP.NET Mobile](~/docs/sharepoint/media/mwellipsis.gif "Elipse del Diseñador de ASP.NET Mobile")\).  
