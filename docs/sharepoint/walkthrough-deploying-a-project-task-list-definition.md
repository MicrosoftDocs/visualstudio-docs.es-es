...
2.  En el cuadro de diálogo de **Publicar** , elija el botón de opción de **Publicar en el sistema de archivos** .  
     ...
     Puede cambiar la ubicación de destino en el cuadro de diálogo de **Publicar** eligiendo el botón de puntos ![Icono Puntos suspensivos](~/docs/sharepoint/media/ellipsisicon.gif "Icono Puntos suspensivos") suspensivos y después navegar a otra ubicación.  
