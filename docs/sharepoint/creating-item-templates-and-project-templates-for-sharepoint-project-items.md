---
title: Elemento los elementos de proyecto de plantillas de proyecto y plantillas para SharePoint
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
| *Schema.xml* | El archivo de esquema para definiciones de lista. Para obtener más información, consulte [bloques de creación: Las listas y bibliotecas de documentos](http://go.microsoft.com/fwlink/?LinkId=177792) y [Schema.xml](http://go.microsoft.com/fwlink/?LinkId=177793). |
