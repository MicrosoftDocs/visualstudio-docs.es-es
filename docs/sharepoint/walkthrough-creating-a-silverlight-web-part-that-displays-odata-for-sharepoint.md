...
9. En el archivo de código MainPage. XAML (*mainpage.Xaml.CS* para C# visual o *mainpage. Xaml. VB* para Visual Basic), agregue las siguientes referencias de espacio de nombres.
