...
titleSuffix: ''
description: Agregar un elemento de menú contextual a un elemento de proyecto de SharePoint existente mediante una extensión de elemento de proyecto en Visual Studio.
