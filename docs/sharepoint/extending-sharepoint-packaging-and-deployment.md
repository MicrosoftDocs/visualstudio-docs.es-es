...
ms.locfileid: "34767026"
---
# <a name="extend-sharepoint-packaging-and-deployment"></a>Extender SharePoint empaquetado e implementación
...
## <a name="handle-deployment-conflicts"></a>Controlar los conflictos de implementación
