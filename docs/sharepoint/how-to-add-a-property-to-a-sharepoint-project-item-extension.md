...
titleSuffix: ''
description: Use una extensión de elemento de proyecto de SharePoint para agregar una propiedad a cualquier elemento de proyecto de SharePoint que ya esté instalado en Visual Studio.
