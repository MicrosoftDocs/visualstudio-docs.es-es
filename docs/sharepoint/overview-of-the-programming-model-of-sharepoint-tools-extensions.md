...
### Modelo de objetos de automatización de Visual Studio  
 ...
 Para obtener más información sobre el modelo de objetos de automatización, vea [Ampliar el entorno de Visual Studio](../Topic/Extending%20the%20Visual%20Studio%20Environment.md) y [Referencia de automatización y extensibilidad](../Topic/Automation%20and%20Extensibility%20Reference.md).  
