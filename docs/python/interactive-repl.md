...
Por último, puede seleccionar código en el archivo y usar el comando [send code to interactive command](#send-code-to-interactive) (enviar código a comando interactivo) descrito a continuación.
