...
1. Presione Ctrl+F5 o seleccione **Depurar > Iniciar sin depurar** para ejecutar el programa. Si ve el parámetro `FileNotFoundError` para `koans.txt`, compruebe la configuración del directorio de trabajo tal y como se describe en el paso anterior.
