...
![Comando PyLint en el menú contextual para proyectos de Python](~/docs/python/media/code-pylint-command.png)
...
![Lista de errores de PyLint](~/docs/python/media/code-pylint-error-list.png)
