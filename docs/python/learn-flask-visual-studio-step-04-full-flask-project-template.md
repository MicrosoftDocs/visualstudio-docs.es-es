...
ms.locfileid: "34752191"
---
# <a name="tutorial-step-4-use-the-full-flask-web-project-template"></a>Paso 4 del tutorial: Usar la plantilla completa Proyecto web de Flask
...
- [Jade en GitHib (documentación)](https://github.com/liuliqiang/pyjade) (github.com)
- Código fuente del tutorial en GitHub: [Microsoft/python-sample-vs-learn-flask](https://github.com/Microsoft/python-sample-vs-learn-flask)