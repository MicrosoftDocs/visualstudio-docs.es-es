...
![Cuadro de diálogo de configuración de generación de perfiles](~/python/media/profiling-start.png)
...
![Informe de rendimiento de generación de perfiles](~/python/media/profiling-results.png)
