...
![Finalizaciones de miembros](~/python/media/code-editing-completions-simple.png)
...
![Finalizaciones de miembros con filtrado](~/python/media/code-editing-completion-filtering.png)
...
![Finalización de miembros en varios tipos](~/python/media/code-editing-completion-types.png)
...
![Finalización de miembros privados](~/python/media/code-editing-completion-dunder.png)
...
![Finalización de importaciones](~/python/media/code-editing-completion-import.png)
...
![Finalización de excepciones](~/python/media/code-editing-completion-exception.png)
...
![Finalización de decoradores](~/python/media/code-editing-completion-decorator.png)
...
![Ayuda para la firma](~/python/media/code-editing-signature-help.png)
...
![Información rápida](~/python/media/code-editing-quick-info.png)
...
![Coloración de código](~/python/media/code-editing-code-coloring.png)
...
![Opciones de fuentes y colores](~/python/media/code-editing-customize-colors.png)
...
![Fragmentos de código](~/python/media/code-editing-code-snippets.png)
...
![Administrador de fragmentos de código](~/python/media/code-editing-code-snippets-manager.png)
...
![Barra de navegación](~/python/media/code-editing-navigation-bar.png)
...
![Ir a definición](~/python/media/code-editing-go-to-definition.png)
...
![Navegar a](~/python/media/code-editing-navigate-to.png)
...
![Resultados de Buscar todas las referencias](~/python/media/code-editing-find-all-references.png)
