...
1. En el diálogo **Rename** (Cambiar nombre) que aparece, escriba el nuevo nombre del identificador y seleccione **OK** (Aceptar):
  ...
  ![Mensaje de cambio de nombre para el nuevo nombre identificado](~/docs/python/media/code-refactor-rename-1.png)
...
1. En el siguiente diálogo, seleccione los archivos y las instancias del código al que se va a aplicar el cambio de nombre; seleccione cualquier instancia individual para obtener una vista previa del cambio concreto:
  ...
  ![Diálogo de cambio de nombre para seleccionar dónde aplicar los cambios](~/docs/python/media/code-refactor-rename-2.png)
...
1. En el diálogo que aparece, escriba un nuevo nombre de método, indique dónde extraerlo y seleccione las variables de cierre. Las variables no seleccionadas para cierre se convierten en los argumentos de método:
  ...
  ![Diálogo de extracción de método](~/docs/python/media/code-refactor-extract-method-1.png)

1. Seleccione **OK** (Aceptar); el código se modifica en consecuencia:

  ![Efecto de la extracción de un método](~/docs/python/media/code-refactor-extract-method-2.png)
...
![Agregar etiqueta inteligente de importación](~/docs/python/media/code-refactor-add-import-1.png)
...
![Resultado de agregar una importación](~/docs/python/media/code-refactor-add-import-2.png)
...
![Menú para quitar importaciones](~/docs/python/media/code-refactor-remove-imports-1.png)

Después, Visual Studio realiza los cambios adecuados en el código:

![Efecto de quitar importaciones](~/docs/python/media/code-refactor-remove-imports-2.png)
