---
title: "Inicio rápido: Creación de un proyecto de Python mediante Cookiecutter en Visual Studio | Microsoft Docs"
description: "Empiece a trabajar rápidamente con Python mediante una plantilla de Cookiecutter en Visual Studio."
ms.custom: 
ms.date: 09/22/2017
ms.reviewer: 
ms.suite: 
