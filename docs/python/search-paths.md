---
title: "Aplicación de las rutas de acceso de búsqueda de Python en Visual Studio | Microsoft Docs"
ms.custom: 
ms.date: 02/20/2018
ms.reviewer: 
ms.suite: 
...
---
# <a name="how-visual-studio-uses-python-search-paths"></a>Cómo Visual Studio usa las rutas de acceso de búsqueda de Python
