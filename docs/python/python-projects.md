...
- [Incorporación de archivos, asignación de un archivo de inicio y establecimiento de entornos](#adding-file-assigning-a-startup-file-and-setting-environments)
