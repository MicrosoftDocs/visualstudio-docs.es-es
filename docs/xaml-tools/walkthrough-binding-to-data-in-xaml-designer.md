...
description: Obtenga información sobre cómo enlazar datos a un control en el diseñador XAMl estableciendo las propiedades de enlace de datos mediante la mesa de la mesa y el ventana Propiedades.
