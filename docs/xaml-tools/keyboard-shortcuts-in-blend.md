...
|----------------|-------------|
|Creación de un nuevo proyecto|**Ctrl**+**Shift**MAYÚS+**N**|
|Abrir un proyecto o una solución (no un sitio)|**Ctrl**+**Shift**MAYÚS+**O**|
|Cerrar una solución|**Ctrl**+**Shift**MAYÚS+**C**|
|Guardar una copia de la solución o el sitio|**Ctrl**+**Shift**MAYÚS+**P**|
|Agregar un elemento existente al proyecto|**Ctrl**+**I**|
|Agregar una referencia a un archivo DLL (WPF)|**Alt**+**Shift**Shift+**R**|
|Compilación del proyecto|**Ctrl**+**Shift**MAYÚS+**B**|
...
|Guardar todos los documentos|**Ctrl**+**Shift**MAYÚS+**S**|
|Cerrar el documento activo|**Ctrl**+**W**|
|Cerrar todos los documentos abiertos|**Ctrl**+**Shift**MAYÚS+**W**|
|Deshacer la última acción|**Ctrl**+ Z|
|Rehacer la última acción deshecha|**Ctrl**+Y o **Ctrl**+**Mayús**+**Z**|
|Crear una anotación en tiempo de diseño|**Ctrl**+**Shift**MAYÚS+**T**|
|Cortar|**Ctrl**+**X**|
|Copiar|**Ctrl**+**C**|
|Pegar|**Ctrl**+**V**|
|Eliminar|**Eliminar**|
...
|Igualar el ancho de los objetos seleccionados|**Ctrl**+**Shift**MAYÚS+**1**|
|Igualar el alto de los objetos seleccionados|**Ctrl**+**Shift**MAYÚS+**2**|
|Igualar el tamaño de los objetos seleccionados|**Ctrl**+**Shift**MAYÚS+**9**|
|Voltear horizontalmente el objeto seleccionado|**Ctrl**+**Shift**MAYÚS+**3**|
|Voltear verticalmente el objeto seleccionado|**Ctrl**+**Shift**MAYÚS+**4**|
...
|Anclar el contenedor activo|**Ctrl**+**Shift**MAYÚS+**D**|
|Desplazar los objetos seleccionados|Teclas de **Dirección**|
|Ajustar ancho automáticamente|**Ctrl**+**Shift**MAYÚS+**5**|
|Ajustar alto automáticamente|**Ctrl**+**Shift**MAYÚS+**6**|
|Agrupar objetos en un panel de diseño|**Ctrl**+**G**|
|Desagrupar objetos|**Ctrl**+**Shift**MAYÚS+**G**|
|Traer al frente el objeto seleccionado|**Ctrl**+**Shift**MAYÚS+**]**|
|Traer adelante|**Ctrl**+**]**|
|Enviar atrás el objeto seleccionado|**Ctrl**+**Shift**MAYÚS+**[**|
|Enviar atrás|**Ctrl**+**[**|
...
|Separar un trazado de recorte|**Ctrl**+**Shift**MAYÚS+**7**|
|Crear un trazado compuesto|**Ctrl**+**8**|
|Separar un trazado compuesto|**Ctrl**+**Shift**MAYÚS+**8**|
|Bloquear selección|**Ctrl**+**L**|
|Desbloquear todos los objetos|**Ctrl**+**Shift**MAYÚS+**L**|
|Mostrar selección|**Ctrl**+**T**|
|Ocultar selección|**Ctrl**+**3**|
|Seleccionar todos los objetos|**Ctrl**+**A**|
|Desactivar la selección de todos los objetos|**Ctrl**+**Shift**MAYÚS+**A**|
...
|Acercar en la mesa de trabajo|**Ctrl**+**igual signo** (**=**)|
...
|Mostrar u ocultar los límites de los objetos|**Ctrl**+**Shift**MAYÚS+**H**|
...
|Mostrar u ocultar el panel **Activos**|**Ctrl**+(**período** )|
|Mostrar u ocultar el panel **Resultados**|**F12**|
|Mostrar u ocultar todos los paneles|**F4**|
|Restablecer diseño del área de trabajo activa|**Ctrl**+**Shift**MAYÚS+**R**|
