...
manager: "crdun"
---
# Introducci&#243;n a Visual Studio Tools para Unity
...
## Su primer proyecto de Unity con Visual Studio Tools para Unity  
...
### Unity 5.2 y versiones posteriores \(requiere VSTU 2.1 o posterior\)  
...
#### 2. Configure el Editor de Unity para que utilice Visual Studio Tools para Unity  
 ...
 Para asegurarse de que la compatibilidad integrada de Visual Studio Tools para Unity está ahora habilitada, vea el cuadro de diálogo **Acerca de Unity**. En el editor de Unity, en el menú principal, elija **Ayuda, Acerca de Unity.** Si Visual Studio Tools para Unity está instalado y configurado correctamente, se mostrará un mensaje en la esquina inferior izquierda del cuadro de diálogo **Acerca de Unity**.  
 ...
 ![Establezca la configuración de compilación de Unity para la depuración.](../cross-platform/media/vstu_debugging_build_settings.png "vstu\_debugging\_build\_settings")  
  
#### 3. Inicie Visual Studio desde el Editor de Unity  
...
### Versiones anteriores de Unity \(anteriores a la versión 5.2\)  
...
#### 2. Configure el Editor de Unity para que utilice Visual Studio Tools para Unity  
 ...
 ![Importe el paquete VSTU en el proyecto de Unity.](../cross-platform/media/vstu_configure_unity_import_vstu.png "vstu\_configure\_unity\_import\_vstu")  
...
#### 3. Inicie Visual Studio desde el Editor de Unity  
 ...
 ![Abra el proyecto de Unity en Visual Studio.](../cross-platform/media/vstu_configure_open_in_visual_studio.png "vstu\_configure\_open\_in\_visual\_studio")  
  
## Pasos siguientes  
 Para obtener información sobre el uso y la depuración de su proyecto Unity en Visual Studio, vea [Using Visual Studio Tools for Unity](../cross-platform/getting-started-with-visual-studio-tools-for-unity.md).  
