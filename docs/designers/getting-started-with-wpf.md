...
|Novedades de .NET|[Información general acerca de .NET Framework](/dotnet/framework/get-started/overview)<br /><br /> [Elementos esenciales de aplicaciones](/dotnet/standard/application-essentials)<br /><br /> [Introducción a Visual C# y Visual Basic](../ide/quickstart-visual-basic-console.md)|
