---
title: ¿Qué es WPF?
description: Introducción a Windows Presentation Foundation, un marco para crear aplicaciones cliente de escritorio que admite un amplio conjunto de características de desarrollo.
...
|Más información sobre WPF...|[Información general sobre WPF](/dotnet/framework/wpf/introduction-to-wpf)<br /><br />[Información general sobre XAML (WPF)](/dotnet/framework/wpf/advanced/xaml-overview-wpf)<br /><br />[Controles](/dotnet/framework/wpf/controls/)<br /><br />[Introducción al enlace de datos](/dotnet/desktop-wpf/data/data-binding-overview)<br /><br />[Enlace de datos de WPF con LINQ to XML](/dotnet/framework/wpf/data/wpf-data-binding-with-linq-to-xml-overview)|
