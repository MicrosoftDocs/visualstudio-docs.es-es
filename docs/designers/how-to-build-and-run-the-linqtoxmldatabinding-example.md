...
Para obtener más información acerca de Visual Studio, consulte [Introducción al IDE de Visual Studio](../ide/visual-studio-ide.md).

## <a name="creating-and-populating-the-project"></a>Creación y completado del proyecto
