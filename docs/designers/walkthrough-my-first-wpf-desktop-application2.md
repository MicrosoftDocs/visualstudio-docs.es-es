...
<a name="introduction"></a> Este tutorial proporciona una introducción al desarrollo en Windows Presentation Foundation \(WPF\). Podrá crear una aplicación básica que incluya los elementos que son comunes a la mayoría de las aplicaciones de escritorio WPF: marcado XAML, código subyacente, definiciones de aplicación, controles, diseño, enlace de datos y estilos.  
...
4.  En el cuadro de texto **Nombre**, escriba `Expenselt` y elija el botón **Aceptar**.  
...
#### Para modificar la ventana principal  
...
4.  En la ventana **Propiedades**, expanda el nodo de categoría **Común** y elija la propiedad **Título**. A continuación, escriba `ExpenseIt` y presione la tecla **Entrar**.  
...
#### Para modificar el archivo de código subyacente \(C\#\):  
...
#### Para agregar una pantalla principal  
  
1.  En el **Explorador de soluciones**, abra el menú contextual del nodo **Expenselt** y elija **Agregar**, **Página**.  
  
2.  En el cuadro de diálogo **Agregar nuevo elemento**, elija el cuadro de texto **Nombre** y escriba `ExpenseItHome` y, a continuación, elija el botón **Agregar**.  
...
#### Para agregar una ventana de detalles  
  
1.  En el **Explorador de soluciones**, abra el menú contextual del nodo **Expenselt** y elija **Agregar**, **Página**.  
  
2.  En el cuadro de diálogo **Agregar nuevo elemento**, elija el cuadro de texto **Nombre** y escriba `ExpenseReportPage` y, a continuación, elija el botón **Agregar**.  
...
2.  En la ventana **Propiedades** ventana, expanda el nodo de categoría **Diseño** y establezca los valores de **Margen** en `10`, `10`, `0` y `10`, que corresponden a los márgenes izquierdo, derecho, superior e inferior.  
...
#### Para agregar el código al botón  
...
#### Para crear la interfaz de usuario para la página de informes  
...
## Conectarse a datos  
 En esta sección, podrá crear un proveedor de datos y una plantilla de datos y, a continuación, conectar los controles para mostrar los datos.  
  
#### Cómo enlazar datos a un control  
...
#### Para conectar datos a controles  
...
#### Para actualizar la interfaz de usuario con plantillas de datos  
