...
description: Aprenda sobre las herramientas de Visual Studio que puede usar para crear o modificar modelos 3D, texturas y sombreadores para aplicaciones y juegos basados en DirectX.
...
En este artículo, se describen las herramientas de Visual Studio que puede usar para crear o modificar modelos 3D, texturas y sombreadores para aplicaciones y juegos basados en DirectX.
