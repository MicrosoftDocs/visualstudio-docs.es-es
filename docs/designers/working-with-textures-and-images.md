...
description: Aprenda a usar el Editor de imágenes en Visual Studio para crear y modificar texturas e imágenes en formatos como los que se usan en el desarrollo de aplicaciones de DirectX.
