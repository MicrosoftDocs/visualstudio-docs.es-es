...
---
# Teclas modificadoras de la herramienta Selecci&#243;n directa en Blend
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

La siguiente tabla contiene los métodos abreviados que puede usar para modificar la forma de un trazado existente con la herramienta **Selección directa** ![](../designers/media/6dd6571f-c116-451d-8dd2-1f88b8406362.png "6dd6571f\-c116\-451d\-8dd2\-1f88b8406362").  Para agregar puntos a un trazado, quitar puntos de un trazado o unir dos trazados existentes, utilice la herramienta **Pluma**.  
  
|Para esta acción|Haga esto|Puntero|  
|----------------------|---------------|-------------|  
|Hacer que aparezcan manipuladores de tangente para un punto de un trazado|Hacer clic en un punto del trazado|![](~/docs/designers/media/cfcc5f41-a666-4524-a958-50b9051130ca.png "cfcc5f41\-a666\-4524\-a958\-50b9051130ca")<br /><br /> Mover puntero de punto|  
|Mover un punto de un trazado|Arrastrar un punto de un trazado|![](~/docs/designers/media/cfcc5f41-a666-4524-a958-50b9051130ca.png "cfcc5f41\-a666\-4524\-a958\-50b9051130ca")<br /><br /> Mover puntero de punto|  
...
|Mover un segmento entre dos puntos de un trazado|Arrastrar un segmento de un trazado|![](../designers/media/2ace930f-98fa-410b-92cf-7a4b88503ee7.png "2ace930f\-98fa\-410b\-92cf\-7a4b88503ee7")<br /><br /> Mover puntero de segmento|  
...
|Crear un punto en un vértice agudo o reducir la tangente a cero|Desplazar el puntero sobre un punto, mantener presionada la tecla ALT y hacer clic en el punto|![](~/docs/designers/media/21197b10-aba4-4a9d-8145-647d0ba8e518.png "21197b10\-aba4\-4a9d\-8145\-647d0ba8e518")<br /><br /> Convertir puntero de punto|  
|Convertir un vértice agudo suave \(o, si ya es suave, cambiar el ángulo de la curva a medida que pasa por el punto en que se ha hecho clic\)|Desplazar el puntero sobre un punto, mantener presionada la tecla ALT y arrastrar el punto|![](~/docs/designers/media/21197b10-aba4-4a9d-8145-647d0ba8e518.png "21197b10\-aba4\-4a9d\-8145\-647d0ba8e518")<br /><br /> Convertir puntero de punto|  
