...
Windows Presentation Foundation (WPF) le permite crear aplicaciones de cliente de escritorio para Windows con experiencias de usuario visualmente impactantes.  
 ...
 ![Ejemplo UI de Contoso Healthcare](~/docs/designers/media/wpfintrofigure24.png "WPFIntroFigure24")  
...
```  
 ...
 ![Ventana que contiene un botón](~/docs/designers/media/wpfintrofigure10.png "WPFIntroFigure10")  
...
```  
 ...
 ![Cuadro de mensaje](~/docs/designers/media/wpfintrofigure25.png "WPFIntroFigure25")  
...
>  Una propiedad implementada por un control principal para que la usen los controles secundarios es una construcción de WPF denominada [propiedad asociada](https://msdn.microsoft.com/en-us/library/ms749011\(v=vs.100\).aspx).  
 ...
 ![Página de DockPanel](~/docs/designers/media/wpfintrofigure11.png "WPFIntroFigure11")  
...
### <a name="2-d-shapes"></a>Formas 2D  
 ...
 ![Elipses y rectángulos](~/docs/designers/media/wpfintrofigure4.PNG "WPFIntroFigure4")  
 ...
 ![Ventana con el texto "ha hecho clic en la elipse"](~/docs/designers/media/wpfintrofigure12.png "WPFIntroFigure12")  
...
### <a name="2-d-geometries"></a>Geometrías 2D  
 ...
 ![Diversos usos de un trayecto](~/docs/designers/media/wpfintrofigure5.PNG "WPFIntroFigure5")  
...
### <a name="2-d-effects"></a>Efectos 2D  
 ...
 ![Ilustración de diferentes pinceles](~/docs/designers/media/wpfintrofigure6.PNG "WPFIntroFigure6")  
...
### <a name="3-d-rendering"></a>Representación 3D  
 ...
 ![Captura de pantalla de ejemplo de Visual3D](~/docs/designers/media/wpfintrofigure13.png "WPFIntroFigure13")  
...
##  <a name="Animation"></a> Animación  
 ...
 ![Imágenes de un cubo animado](~/docs/designers/media/wpfintrofigure7.png "WPFIntroFigure7")  
...
### <a name="images"></a>Imágenes  
 ...
 ![Imágenes en miniatura e imagen en tamaño total](~/docs/designers/media/wpfintrofigure8.PNG "WPFIntroFigure8")  
...
### <a name="video-and-audio"></a>Vídeo y audio  
 ...
 ![Control MediaElement con audio y vídeo](~/docs/designers/media/wpfintrofigure1.png "WPFIntroFigure1")  
...
-   Compatibilidad con fuentes internacionales y mecanismos de reserva.  
 ...
 ![Texto con diversas decoraciones de texto](~/docs/designers/media/wpfintrofigure23.png "WPFIntroFigure23")  
...
[!code-xml[IntroToWPFSnippets#TextBoxContentMARKUP3](../designers/codesnippet/Xaml/introduction-to-wpf_12.xaml)]  
 ...
 ![Control TextBox que contiene texto](~/docs/designers/media/wpfintrofigure21.png "WPFIntroFigure21")  
...
[!code-xml[IntroToWPFSnippets#ButtonContentMARKUP3](../designers/codesnippet/Xaml/introduction-to-wpf_15.xaml)]  
 ...
 ![Botón que tiene varios tipos de contenido](~/docs/designers/media/wpfintrofigure22.png "WPFIntroFigure22")  
...
### <a name="control-templates"></a>Plantillas de control  
 ...
 ![Botón elíptico y una segunda ventana](~/docs/designers/media/wpfintrofigure2.png "WPFIntroFigure2")  
...
### <a name="data-templates"></a>Plantillas de datos  
 ...
 ![Cuadro de lista con el aspecto predeterminado](~/docs/designers/media/wpfintrofigure18.png "WPFIntroFigure18")  
...
[!code-xml[IntroToWPFSnippets#DataTemplateMARKUP4](../designers/codesnippet/Xaml/introduction-to-wpf_21.xaml)]  
 ...
 ![Cuadro de lista que usa una plantilla de datos](~/docs/designers/media/wpfintrofigure19.png "WPFIntroFigure19")  
...
[!code-xml[IntroToWPFSnippets#StyleMARKUP4](../designers/codesnippet/Xaml/introduction-to-wpf_25.xaml)]  
 ...
 ![Dos botones de color naranja](~/docs/designers/media/wpfintrofigure20.png "WPFIntroFigure20")  
...
-   **Modelo de elemento de marco de trabajo**. Un control personalizado se deriva de <xref:System.Windows.FrameworkElement> cuando su apariencia se define mediante la lógica de representación personalizada (no mediante plantillas).  
 ...
 ![Control de usuario personalizado](~/docs/designers/media/wpfintrofigure3.png "WPFIntroFigure3")  
