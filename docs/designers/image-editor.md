...
|**Primitiva 2D**|**Suavizado**<br /> Dibuja las primitivas que tienen bordes suavizados. Esto les proporciona una apariencia más suave.<br /><br /> **Thickness**<br /> Define el grosor de la línea que constituye el límite de la primitiva.<br /><br /> **Radio X**<br /> (Solo rectángulo redondeado) Define el radio de redondeo para los bordes superior e inferior de la primitiva.<br /><br /> **Radio Y**<br /> (Solo rectángulo redondeado) Define el radio de redondeo para los bordes izquierdo y derecho de la primitiva.|
