...
description: Obtenga información sobre los nodos de textura que muestren varios tipos de textura y geometrías, y genere o transforme coordenadas de textura en el Diseñador de sombras.
