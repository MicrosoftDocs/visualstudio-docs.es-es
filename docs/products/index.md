            ...
            <li>
                ...
                <ul id="products">
                    <li>
                        ...
                        <p style="font-size:1.12em">Herramientas de desarrollo, servicios en la nube, software, soporte y aprendizaje</p>
                    <p style="margin-top:24px;">
                                <a href="https://aka.ms/vs-subscriptions/">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Suscripción a Visual Studio<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </p></div>
                    </li>
                </ul>
