---
title: "Iniciar una sesión de depuración para una aplicación de UWP en Visual Studio (VB, C#, C++ y XAML) | Documentos de Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="start-a-debugging-session-for-a-uwp-app-in-visual-studio-vb-c-c-and-xaml"></a>Iniciar una sesión de depuración para una aplicación de UWP en Visual Studio (VB, C#, C++ y XAML)
![Se aplica a Windows y Windows Phone](../debugger/media/windows_and_phone_content.png "windows_and_phone_content")  
  
 En este tema se describe cómo iniciar una sesión de depuración para aplicaciones UWP escritas en XAML y Visual C++, Visual C# o Visual Basic. Para depurar una aplicación, hay que configurar la sesión de depuración y elegir la manera de iniciar la aplicación.  
...
2.  Realiza las acciones siguientes para abrir la página de propiedades de depuración del proyecto:  
    ...
    -   Para aplicaciones de Visual C# y Visual Basic, elige **Depurar**.  
         ...
         ![C &#35; &#47; Página de propiedades de depuración de proyecto VB](../debugger/media/dbg_csvb_debugpropertypage.png "DBG_CsVb_DebugPropertyPage")  
  
    -   Para aplicaciones de Visual C++, expande el nodo **Propiedades de configuración**  y, después, elige **Depuración**.  
  
         ![C &#43; &#43; Página de propiedades de depuración de la aplicación UWP](../debugger/media/dbg_cpp_debugpropertypage.png "DBG_CPP_DebugPropertyPage")  
...
###  <a name="BKMK_Choose_the_deployment_target"></a> Elegir el destino de implementación  
 ...
 Puede implementar y depurar una aplicación UWP en el equipo de Visual Studio, en el simulador de Visual Studio en el equipo local o en un dispositivo remoto.  
...
-   Elige el equipo remoto en el cuadro de diálogo **Seleccionar conexión del depurador remoto** .  
    ...
    -   Para las aplicaciones de C++, elija la flecha hacia abajo en la **nombre de la máquina** cuadro y elija  **\<buscar... >**.  
 ...
 Puede implementar y depurar una aplicación de Windows Phone en un dispositivo o en uno de los emuladores de teléfono de Visual Studio. Seleccione el dispositivo o emulador en la lista **Dispositivo de destino** .  
...
|**Solo GPU**|Depura el código de C++ nativo que se ejecuta en una unidad de procesamiento gráfico (GPU).|  
 ...
 Para las aplicaciones de Windows Phone, también puede elegir el depurador que se utilizará para procesos en segundo plano de la **proceso de la tarea en segundo plano**.  
