...
##  <a name="BKMK_Overview"></a> Establecer un punto de interrupción de función en código fuente  
 ...
 ![Establecer un punto de interrupción](~/docs/debugger/media/basicbreakpoint.png "BasicBreakpoint")  
 ...
 ![Ejecución de punto de interrupción detenida](~/docs/debugger/media/breakpointexecution.png "BreakpointExecution")  
