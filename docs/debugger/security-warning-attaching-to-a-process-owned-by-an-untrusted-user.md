---
title: 'Advertencia de seguridad: Adjuntar a un proceso que pertenezca a un usuario que no sea de confianza puede ser peligroso. Si la siguiente información es sospechosa o no está seguro, no se adjunte a este proceso | Microsoft Docs'
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
...
## <a name="uielement-list"></a>Lista de UIElement
 Nombre del ensamblado solicitado para depurar

 Usuario actual del usuario

 Attach Press para continuar con la depuración mediante la Asociación

 No adjuntar no asociar al proceso
