...
Para obtener más información sobre las mejoras de Visual Studio 2015 Update 3, vea [ C++ editar y continuar en Visual Studio 2015 Update 3](https://devblogs.microsoft.com/cppblog/c-edit-and-continue-in-visual-studio-2015-update-3/).
...
> [!IMPORTANT]
> Para obtener la configuración de compilación requerida y otra información sobre la compatibilidad de las características, vea [ C++ editar y continuar en Visual Studio 2015 Update 3](https://devblogs.microsoft.com/cppblog/c-edit-and-continue-in-visual-studio-2015-update-3/).
...
4. Para habilitar, seleccione **Habilitar editar y continuar**. Para deshabilitarla, desactive la casilla.
