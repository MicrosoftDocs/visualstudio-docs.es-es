...
manager: "ghogen"
---
# Error: El equipo remoto no ha podido iniciar comunicaciones DCOM
...
1.  Si el equipo local tiene el Firewall de Windows habilitado, vea [Configurar las herramientas remotas en el dispositivo](../Topic/Set%20Up%20the%20Remote%20Tools%20on%20the%20Device.md) para obtener instrucciones sobre cómo configurar el firewall para la depuración local.  
