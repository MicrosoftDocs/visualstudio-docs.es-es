...
dev_langs: 
  ...
  - "C++"
helpviewer_keywords: 
  - "Cuadro de diálogo Inspección rápida, especificadores de formato en C++"
  - "variables [depurador], símbolos de variables de inspección"
  - "símbolos, aplicar formato a variables de inspección"
  - "cuadro de diálogo Inspección rápida, uso de especificadores de formato"
  - "expresiones [C++], especificadores de formato"
  - "especificadores, formato de variables de inspección"
  - "especificadores"
  - "ventana Inspección, especificadores de formato en C++"
...
|**sb**|cadena const char\*|\<ubicación\> "hola a todos"|hola a todos|  
|s8|cadena const char\*|\<ubicación\> "hola a todos"|"hola a todos"|  
|**s8b**|cadena const char\*|\<ubicación\> "hola a todos"|"hola a todos"|  
|su|const wchar\_t\* const<br /><br /> cadena char16\_t\*|\<ubicación\> L"hola a todos"|L"hola a todos"<br /><br /> u"hola a todos"|  
|sub|const wchar\_t\* const<br /><br /> cadena char16\_t\*|\<ubicación\> L"hola a todos"|hola a todos|  
...
|hr|HRESULT o código de error Win32. \(Ahora, el depurador descodifica los valores HRESULT automáticamente, de modo que este especificador no es necesario en esos casos\).|S\_OK|S\_OK|  
|wc|Marcador de clase de ventana|0x0010|WC\_DEFAULTCHAR|  
|wm|Números de mensajes de Windows|16|WM\_CLOSE|  
...
|su|const wchar\_t\*<br /><br /> const char16\_t\*|\<ubicación\>|L"hola a todos"|  
|sub|const wchar\_t\*<br /><br /> const char16\_t\*|\<ubicación\>|hola a todos|  
|s8|const char\*|\<ubicación\>|"hola a todos"|  
|hr|HRESULT o código de error Win32. \(Ahora, el depurador descodifica los valores HRESULT automáticamente, de modo que este especificador no es necesario en esos casos\).|S\_OK|S\_OK|  
|wc|Marcador de clase de ventana.|0x00000040,|WC\_DEFAULTCHAR|  
|wm|Números de mensajes de Windows|0x0010|WM\_CLOSE|  
|\!|Sin formato, omite cualquier personalización de vistas de tipos de datos|\<representación personalizada\>|4|  
