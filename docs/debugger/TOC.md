...
## [Depuración de ASP.NET en IIS o IIS Express](how-to-enable-debugging-for-aspnet-applications.md)
...
## [Consideraciones sobre el tipo de aplicación](debugging-applications.md)
...
#### [Desencadenado de eventos de suspensión, reanudación y de segundo plano para aplicaciones de Microsoft Store](how-to-trigger-suspend-resume-and-background-events-for-windows-store-apps-in-visual-studio.md)
