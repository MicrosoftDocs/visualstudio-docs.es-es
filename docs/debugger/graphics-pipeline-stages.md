...
La ventana Etapas de canalización de gráficos ayuda a entender cómo cada etapa de la canalización de gráficos Direct3D transforma una llamada a draw individual.  
 ...
 ![Un objeto 3D recorre las etapas de canalización.](../debugger/media/gfx_diag_demo_pipeline_stages_orientation.png "gfx\_diag\_demo\_pipeline\_stages\_orientation")  
...
### Vínculos a objetos gráficos relacionados  
 ...
 **Etapa del teselador** \(solo Direct3D 11 y Direct3D 12\)  
 ...
 **Sombreador de dominio** \(solo Direct3D 11 y Direct3D 12\)  
...
### Vista previa del sombreador de vértices  
 Al seleccionar la etapa del sombreador de vértices en la ventana **Etapas de canalización de gráficos**, se muestra el panel **Búferes de entrada**.  Aquí encontrará detalles sobre la lista de vértices proporcionada al sombreador de vértices después de que se ensamblen en la etapa del ensamblador de entrada.  
  
 ![El visor de búfer de entrada de la fase de sombreador de vértices](../debugger/media/gfx_diag_vertex_shader_inbuffers.png "gfx\_diag\_vertex\_shader\_inbuffers")  
 ...
 ![La vista previa de resultados de la fase de sombreador de vértices](../debugger/media/gfx_diag_vertex_shader_preview.png "gfx\_diag\_vertex\_shader\_preview")  
