...
ms.locfileid: "51607632"
---
# <a name="debug-dlls-in-visual-studio"></a>Depurar archivos DLL en Visual Studio
...
- C#o biblioteca de clases de Visual Basic 
- C#o en la biblioteca de controles (WCF) de formularios de Windows de Visual Basic 
- Biblioteca de C++ vínculos dinámicos (DLL)

Para obtener más información, consulte [técnicas de depuración de MFC](../debugger/mfc-debugging-techniques.md).
...
- [Configuración de proyectos para C# configuraciones de depuración](../debugger/project-settings-for-csharp-debug-configurations.md)
...
- [Cómo: conjunto Debug y Release](../debugger/how-to-set-debug-and-release-configurations.md)  
...
- Acceso a través de una dirección URL y la ubicación en la web.  
...
- Adjuntar a una aplicación que ya está implementado y ejecutándose en un equipo de prueba o producción. Utilice este método para archivos DLL en sitios Web o en aplicaciones web. Para obtener más información, consulte [Cómo: adjuntar a un proceso en ejecución](../debugger/attach-to-running-processes-with-the-visual-studio-debugger.md).  
...
Durante la depuración, puede usar el **módulos** ventana para comprobar los archivos DLL y *.exe* archivos se cargue la aplicación. Para abrir el **módulos** ventana, durante la depuración, seleccione **depurar** > **Windows** > **módulos**. Para obtener más información, consulte [Cómo: utilizar la ventana módulos](../debugger/how-to-use-the-modules-window.md). 
...
>[!NOTE]
>Puede usar el **inmediato** ventana en tiempo de diseño con la mayoría de los tipos de proyecto. Actualmente no se admite para proyectos web, SQL o .NET Core.
...
1. Aún puede depurar `Test` colocando un punto de interrupción dentro de él y, a continuación, vuelva a evaluar la función.  
   
   Se alcanzará el punto de interrupción y podrá recorrer `Test`. Después de ejecución haya abandonado `Test`, será el depurador en modo de diseño.

##  <a name="vxtskdebuggingdllprojectsmixedmodedebugging"></a> Depuración en modo mixto  

Puede escribir una aplicación de llamada para un archivo DLL en código administrado o nativo. Si su aplicación nativa llama a un archivo DLL administrado y desea depurar ambos, puede habilitar a los depuradores administrados y nativos en las propiedades del proyecto. El proceso exacto depende de si desea iniciar la depuración desde el proyecto DLL o el proyecto de aplicación que realiza la llamada. Para obtener más información, consulte [Cómo: depurar en modo mixto](../debugger/how-to-debug-in-mixed-mode.md). 
