...
dev_langs: 
  ...
  - "C++"
helpviewer_keywords: 
  - "CRT, comprobaciones en tiempo de ejecución"
  - "depurador, comprobaciones nativas en tiempo de ejecución"
  - "depurar [Visual Studio], rutinas en tiempo de ejecución"
...
```  
 ...
 Una vez instalada la función de generación de informes de errores predeterminada, puede instalar otras funciones del mismo tipo con `_RTC_SetErrorFuncW`.  Para obtener más información, vea [\_RTC\_SetErrorFuncW](/visual-cpp/c-runtime-library/reference/rtc-seterrorfuncw).  
