...
manager: "ghogen"
---
# C&#243;digo de ejemplo de navegaci&#243;n del depurador (JavaScript)
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

El código de este tema es el archivo de ejemplo para el tema [Controlar la ejecución en una sesión de depuración \(JavaScript\)](../debugger/control-execution-of-a-store-app-in-a-visual-studio-debug-session-for-windows-store-apps-javascript.md).  
  
## Código de ejemplo de default.js  
