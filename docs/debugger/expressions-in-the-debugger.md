...
dev_langs: 
  ...
  - "VBScript"
helpviewer_keywords: 
  - "depurador, evaluar expresiones"
  - "depurar [Visual Studio], evaluación de expresiones"
  - "depurar [Visual Studio], expresiones"
  - "depurar [Visual Studio], evaluación de variables"
  - "evaluación de expresiones, evaluador de depuración"
  - "evaluadores de expresiones"
  - "expresiones [depurador]"
  - "evaluación de expresiones nativas"
...
## Expresiones de C\+\+  
 Para obtener información sobre el uso de operadores de contexto con las expresiones de C\+\+, vea [Operador de contexto \(C\+\+\)](../debugger/context-operator-cpp.md).  
...
|**Varios**|\_\_log2<br /><br /> Devuelve el logaritmo en base dos de un entero especificado, redondeado al entero más bajo más próximo.|  
...
### Objetos dinámicos  
 Puede usar variables en expresiones del depurador que tengan tipos estáticos como dinámicos. Cuando los objetos que implementan la interfaz [IDynamicMetaObjectProvider Interfaz](../Topic/IDynamicMetaObjectProvider%20Interface.md) se evalúan en la ventana Inspección, se agrega el nodo Vista dinámica. El nodo Vista dinámica muestra los miembros de objetos, pero no permite editar los valores de los miembros.  
