...
description: Use la variante de compresión de textura BC para permitir la compresión de bloques (BC) en las texturas que tengan un formato de píxel que sea una variación de B8G8R8X8, B8G8R8A8 o R8G8B8A8.
