---
title: Información general sobre diagnóstico de gráficos de Visual Studio | Documentos de Microsoft
ms.custom: ''
ms.date: 02/09/2017
...
## <a name="directx-version-compatibility"></a>Compatibilidad de versiones de DirectX  
 Diagnóstico de gráficos admite aplicaciones que usan Direct3D 10 o superior y proporciona compatibilidad limitada para las aplicaciones que utilizan Direct2D. No admite las aplicaciones que usan versiones anteriores de Direct3D, DirectDraw u otras API gráficas.  
...
## <a name="graphics-analyzer"></a>Analizador de gráficos  
 ...
 ![Todos los gráficos ventanas del depurador](media/graphicsdebuggerwindows.png "GraphicsDebuggerWindows")  
...
### <a name="the-graphics-toolbar-graphics-analyzer"></a>Barra de herramientas Gráficos (Analizador de gráficos)  
 ...
 ![La barra de herramientas de gráficos en modo de diagnóstico de gráficos](media/vsg_toolbar.png "vsg_toolbar")  
...
### <a name="graphics-log-document"></a>Documento de registro de gráficos  
 ...
 El [documento de registro de gráficos](graphics-log-document.md) es también el punto de entrada a la herramienta de análisis de fotogramas, que le ayudará a comprender el rendimiento de un marco cambiando la forma en que se configuran algunos aspectos de la representación y proporciona los resultados a comparar con el original.  
...
### <a name="pipeline-stages"></a>Etapas de canalización  
 ...
 El [etapas de canalización](graphics-pipeline-stages.md) ventana muestra el resultado de cada fase de forma independiente, para que pueda determinar más fácilmente qué fase un problema de representación aparece por primera vez en. Una vez determinada la fase, puede comenzar a depurar a su sombreador directamente desde la ventana Etapas de canalización.  
...
### <a name="graphics-state"></a>Estado de gráficos  
 ...
 El [estado](graphics-state.md) ventana recopila la información de estado pertinente para cada llamada a draw en un solo lugar para que resulte más fácil buscar y también resalta los cambios de estado que se han producido desde la anterior la llamada a draw.  
