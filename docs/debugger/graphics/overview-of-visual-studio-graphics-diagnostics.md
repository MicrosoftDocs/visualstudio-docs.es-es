...
### <a name="frame-analysis"></a>Análisis de fotogramas  
 Gráficos de su aplicación no solo deben ser correctos: deben ser rápido, demasiado. Incluso en dispositivos menos potentes, como equipos portátiles con gráficos integrados o teléfonos móviles. Y también deben tener una apariencia inmejorable.  
