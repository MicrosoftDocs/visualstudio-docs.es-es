...
description: Si el costo de rendimiento de una variante de filtrado de punto, bilineal, trilineal o anisotrópico de textura es significativo, puede considerar si el costo por su uso vale la pena.
