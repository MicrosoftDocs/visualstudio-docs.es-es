...
|-------------|-----------------|  
|**Tamaño de ventanilla 1x1**|Reduce las dimensiones de la ventanilla de todos los objetivos de presentación a 1x1 píxeles.<br /><br /> Para más información, vea [1x1 Viewport Size Variant](1x1-viewport-size-variant.md) (Variante de tamaño de ventanilla 1x1).|  
