...
## <a name="remarks"></a>Comentarios
 ...
 Para capturar un intervalo, debe preparar la aplicación para capturar y grabar información de gráficos, es decir, debe haber llamado a [init](init.md) a través de una instancia de la clase `VsgDbg` antes de llamar a `BeginCapture` o `EndCapture`.
