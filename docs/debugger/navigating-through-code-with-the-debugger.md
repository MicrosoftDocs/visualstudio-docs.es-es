---
title: Navegar por código con el depurador de Visual Studio | Microsoft Docs
...
ms.locfileid: "49933773"
---
# <a name="navigate-code-with-the-visual-studio-debugger"></a>Navegar por código con el depurador de Visual Studio
...
-   **Establecer puntos de interrupción en el código**  
     ...
     ![Establezca un punto de interrupción](../debugger/media/dbg_basics_setbreakpoint.png "DBG_Basics_SetBreakpoint")  
...
-   **Hacer clic y ejecutar** 
    ...
    Para ejecutar hasta un punto en el código mientras está en pausa en el depurador, seleccione el **ejecutar hasta aquí** icono de flecha verde (verá el icono al mantener el mouse sobre una línea de código). Esto elimina la necesidad de establecer puntos de interrupción temporales.
...
##  <a name="BKMK_Set_the_next_statement_to_execute"></a> Mueva el puntero para cambiar el flujo de ejecución  
 ...
 ![Mover el puntero](../debugger/media/dbg_basics_example3.gif "DBG_Basics_Example3")
...
## <a name="BKMK_Restrict_stepping_to_Just_My_Code"></a>Ir al código que no es de usuario  
