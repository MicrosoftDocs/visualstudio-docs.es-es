...
[Solución de problemas](xaml-hot-reload-troubleshooting.md)de recargas[en caliente XAML de XAML para Xamarin. Forms](/xamarin/xamarin-forms/xaml/hot-reload) 
