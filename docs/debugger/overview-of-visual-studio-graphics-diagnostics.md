...
### Interfaz de captura de diagnóstico  
...
### Barra de herramientas Gráficos \(Analizador de gráficos\)  
 ...
 ![Barra de herramientas de gráficos en el modo de diagnóstico de gráficos](~/debugger/graphics/media/vsg_toolbar.png "vsg\_toolbar")  
