...
ms.openlocfilehash: 1d047337ed94cab4fb1feb015ec012e4294a6459
ms.contentlocale: es-es
ms.lasthandoff: 08/22/2017

---
# <a name="view-disassembly-code-in-the-visual-studio-debugger"></a>View Disassembly Code in the Visual Studio Debugger
...
### <a name="to-display-the-disassembly-window"></a>To display the Disassembly window  
  
-   While you are debugging, select **Debug > Windows** and then click **Disassembly**.
  
### <a name="to-turn-optional-information-on-or-off"></a>To turn optional information on or off  
