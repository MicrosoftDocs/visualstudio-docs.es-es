---
title: "C&#243;mo: Utilizar la ventana Desensamblado | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
dev_langs: 
  ...
  - "C++"
helpviewer_keywords: 
  - "lenguaje ensamblador, depurar código de ensamblado en línea"
  - "puntos de interrupción, ventana Desensamblado"
...
manager: "ghogen"
---
# C&#243;mo: Utilizar la ventana Desensamblado
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

Esta característica sólo está disponible si está habilitada la depuración de nivel de dirección en el cuadro de diálogo **Opciones**, nodo **Depuración**.  No está disponible para la depuración de script ni de SQL.  
...
-   Haga clic con el botón secundario del mouse en la ventana **Desensamblado** y active o desactive las opciones que desee en el menú contextual.  
     ...
     Para obtener más información, vea [Retroceder o avanzar en la memoria](../debugger/how-to-page-up-or-down-in-memory.md).  
