...
ms.openlocfilehash: f4f5f54ba1b17862e00b74172d01f33fd8430bef
ms.contentlocale: es-es
ms.lasthandoff: 08/22/2017

---

# <a name="remote-debug-aspnet-core-on-iis-and-azure-in-visual-studio-2017"></a>Remote Debug ASP.NET Core on IIS and Azure in Visual Studio 2017
...
## <a name="create-the-aspnet-core-application-on-the-visual-studio-2017-computer"></a>Create the ASP.NET Core application on the Visual Studio 2017 computer 
...
## <a name="remote-debug-aspnet-core-on-an-azure-app-service"></a>Remote Debug ASP.NET Core on an Azure App Service
...
#### <a name="to-deploy-the-app-and-remote-debug"></a>To deploy the app and remote debug
...
### <a name="install-aspnet-core-on-windows-server"></a>Install ASP.NET Core on Windows Server
