---
title: 'Cómo: usar la herramienta de búsqueda | Documentos de Microsoft'
ms.custom: ''
ms.date: 11/04/2016
...
ms.locfileid: "31476190"
---
# <a name="how-to-use-the-finder-tool"></a>Cómo: Usar la herramienta de búsqueda
Puede usar la herramienta de búsqueda en el **Buscar ventana** cuadro de diálogo para mostrar la ventana Propiedades o mensajes. La herramienta de búsqueda también puede encontrar ventanas secundarias deshabilitadas y discernir qué ventana resaltar si deshabilita secundarios superposición de windows.  
...
3.  Arrastre el **herramienta de búsqueda** sobre la ventana de destino.  
...
5.  Press **OK**.  
     ...
     Si seleccionó **propiedades**, [cuadro de diálogo de propiedades de ventana](../debugger/window-properties-dialog-box.md) se abre. Si seleccionó **mensajes**, [vista mensajes](../debugger/messages-view.md) abre la ventana.  
