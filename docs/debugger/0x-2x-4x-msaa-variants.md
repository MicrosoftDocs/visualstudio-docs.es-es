...
-   El objeto `D3D11_TEXTURE2D_DESC` pasado en `pDesc` describe un objetivo de presentación, que es:  
    ...
    -   El miembro BindFlags tiene el conjunto de marcadores marcador D3D11\_BIND\_TARGET o marcador D3D11\_BIND\_DEPTH\_STENCIL.  
