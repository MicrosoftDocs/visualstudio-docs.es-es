...
-   Realizar otras tareas, como borrar la pantalla. Consulta [Comandos de la Consola JavaScript](../debugger/javascript-console-commands.md) para ver la lista completa de comandos.  
...
> [!TIP]
>  Si la ventana Consola JavaScript está cerrada, elija **Depurar** \> **Ventanas** \> **Consola JavaScript** para abrirla de nuevo. La ventana únicamente aparece durante las sesiones de depuración de script.  
  
 La ventana Consola JavaScript le permite interactuar con su aplicación sin tener que detener y reiniciar el depurador. Para obtener más información, consulta [Actualizar una aplicación \(JavaScript\)](../debugger/refresh-an-app-javascript.md). Para obtener más información sobre otras funciones de depuración de JavaScript, como el uso del Explorador DOM y la configuración de los puntos de interrupción, consulte [Inicio rápido: Depurar HTML y CSS](../debugger/quickstart-debug-html-and-css.md) y [Depurar aplicaciones en Visual Studio](../debugger/debug-store-apps-in-visual-studio.md).  
...
9. Mientras la aplicación `FlipView` se está ejecutando en el simulador o en el emulador de Windows Phone, escriba `Data.items` en el indicador de entrada de la ventana de la consola \(junto al símbolo "\>\>"\) y presione Entrar.  
     ...
     ![Ventana de la Consola JavaScript](../debugger/media/js_console_window.png "JS\_Console\_Window")  
...
18. Detenga la depuración eligiendo **Depurar** \> **Detener depuración** o presionando Mayús\+F5. Luego, corrija el código fuente.  
     ...
     Para obtener la página de default.html completa que contiene el código de ejemplo corregido, consulta [Depurar código de ejemplo HTML, CSS y JavaScript](../debugger/debug-html-css-and-javascript-sample-code.md).  
...
3.  Elija **Depurar** \> **Iniciar depuración** o presione F5.  
     ...
     ![Usar modo de interrupción con la Consola JavaScript](../debugger/media/js_breakmode.png "JS\_BreakMode")  
...
5.  Selecciona la función en la ventana de la consola para mostrar la implementación de la función.  
     ...
     ![Ventana de la Consola JavaScript donde se muestra un visualizador](../debugger/media/js_console_function_visualizer.png "JS\_Console\_Function\_Visualizer")  
