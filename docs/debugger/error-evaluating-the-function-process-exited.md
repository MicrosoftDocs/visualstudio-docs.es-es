---
title: 'Error: El proceso de destino terminó con el código &#39;code&#39; al evaluar la función &#39;function&#39; | Microsoft Docs'
ms.date: 4/06/2018
...
* Cambie el método por otro tipo de código además de un método captador de propiedad o ToString y el problema desaparecerá.
    o bien
...
Si las soluciones anteriores no solucionan el problema, vaya a **Herramientas** > **Opciones** y desactive la configuración **Depuración** > **General** > **Habilitar la evaluación de propiedades y otras llamadas a función implícitas**. El resultado es que se deshabilitarán la mayoría de las evaluaciones de función implícitas y el problema se resolverá.
