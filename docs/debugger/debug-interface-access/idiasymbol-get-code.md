---
title: 'Idiasymbol:: Get_code | Documentos de Microsoft'
ms.custom: ''
ms.date: 11/04/2016
...
#### <a name="parameters"></a>Parámetros  
 `pRetVal`  
 [out] Devuelve `TRUE` si el símbolo hace referencia a una dirección de código, en caso contrario, devuelve `FALSE`.  
