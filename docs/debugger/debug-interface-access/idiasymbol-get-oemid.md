...
Recupera el valor de identificador del fabricante \(OEM\) de equipo original de símbolos.  
...
#### Parámetros  
 `pRetVal`  
 \[out\]  devuelve un valor único que identifique OEM.  
