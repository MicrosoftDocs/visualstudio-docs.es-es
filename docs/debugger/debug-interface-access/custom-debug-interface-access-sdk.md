...
ms.locfileid: "72745388"
---
# <a name="custom-debug-interface-access-sdk"></a>Personalizado (Debug Interface Access SDK)
Algunos compiladores introducen símbolos que no están identificados por ninguno de los tipos de símbolos léxicos estándar. Estos símbolos se identifican mediante una etiqueta de `SymTagCustom`.
