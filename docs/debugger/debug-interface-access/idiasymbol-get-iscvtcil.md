---
title: 'Idiasymbol:: Get_iscvtcil | Documentos de Microsoft'
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
#### <a name="parameters"></a>Parámetros  
 `pFlag`  
 [out] Devuelve `TRUE` si el módulo se convirtió de CIL en código nativo; en caso contrario, devuelve `FALSE`.  
