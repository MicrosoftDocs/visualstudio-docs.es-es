---
title: 'Idiaenuminjectedsources:: Get__newenum | Documentos de Microsoft'
ms.custom: ''
ms.date: 11/04/2016
...
#### <a name="parameters"></a>Parámetros  
 pRetVal  
 [out, retval] Devuelve el `IUnknown` interfaz que representa la <xref:System.Runtime.InteropServices.ComTypes.IEnumVARIANT> versión de este enumerador.  
