---
title: 'Idiasymbol:: Get_hascastoperator | Documentos de Microsoft'
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Recupera una marca que especifica si el tipo de datos definido por el usuario tiene los operadores de conversión definidos.  
