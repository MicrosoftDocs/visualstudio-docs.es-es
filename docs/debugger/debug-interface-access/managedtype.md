...
ms.locfileid: "72738657"
---
# <a name="managedtype"></a>ManagedType
Un tipo administrado (cualquier símbolo definido por metadatos o nativo para la funcionalidad de administración de memoria y recursos de lenguajes como C#) se identifica mediante un símbolo de `SymTagManagedType`.
