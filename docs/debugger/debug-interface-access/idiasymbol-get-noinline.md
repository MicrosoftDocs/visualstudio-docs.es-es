---
title: 'Idiasymbol:: Get_noinline | Documentos de Microsoft'
ms.custom: ''
ms.date: 11/04/2016
...
#### <a name="parameters"></a>Parámetros  
 `pFlag`  
 [out] Devuelve `TRUE` si la función tiene la `noinline` atributo; en caso contrario, devuelve `FALSE`.  
