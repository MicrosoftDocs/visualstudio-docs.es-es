...
> [!NOTE]
>  Dado que la enumeración `CV_HREG_e` es demasiado grande duplicar en su totalidad aquí, una versión abreviada se proporciona como referencia.  Las entradas que falta notated en cursiva.  La enumeración completa está disponible en el archivo de encabezado cvconst.h.  
...
## Elementos \(Elements\)  
 CV\_REG\_\*  
 Registros utilizados por los procesadores 80x86 e ix86 Intel, y p\- código.  
  
 CV\_R68\_\*  
 Registros utilizados por el procesador 68K.  
  
 CV\_M4\_\*  
 Los registros usados por MIPS el procesador de 4000 ejecuciones.  
  
 CV\_ALPHA\_\*  
 Registros utilizados por el procesador de la ejecución de Digital Equipment Corporation Alpha AXP.  
  
 CV\_PPC\_\*  
 Registros utilizados por el procesador de Motorola\/IBM PowerPC.  
  
 CV\_SH3\_\* y CV\_SH\_\*  
 Registros utilizados por procesador SH de la ejecución de Hitachi SH3 y de Hitachi.  
  
 CV\_ARM\_\*  
 Registros utilizados por los procesadores de \(ARM\) de equipo de la Computación avanzada RISC.  
  
 CV\_IA64\_\*  
 Registros utilizados por los procesadores de la ejecución de Intel IA64.  
  
 CV\_TRI\_\*  
 Registros utilizados por el procesador de Infineon Technologies TriCore.  
  
 CV\_AM33\_\*  
 Registros utilizados por Matsushita\/Panasonic AM33 y procesadores relacionados.  
  
 CV\_M32R\_\*  
 Registros utilizados por el procesador de Mitsubishi M32R.  
