...
#### Parámetros  
 `pRetVal`  
 \[out\]  Devuelve un valor de enumeración de [UdtKind \(Enumeración\)](../../debugger/debug-interface-access/udtkind.md) que especifica el tipo de un UDT: estructura, clase, o unión.  
