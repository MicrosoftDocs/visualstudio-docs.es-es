---
title: "Usar Microsoft Monitoring Agent | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Usar Microsoft Monitoring Agent
...
1.  Asegúrese de que:  
    ...
    -   El servidor web ejecuta [versiones compatibles de Internet Information Services \(IIS\)](http://technet.microsoft.com/en-us/library/dn465154.aspx).  
...
1.  En el servidor web, abra una ventana de símbolo del sistema de **Windows PowerShell** o **Windows PowerShell ISE** como administrador.  
     ...
     ![Abrir Windows PowerShell como administrador](../debugger/media/ffr_powershellrunadmin.png "FFR\_PowerShellRunAdmin")  
...
#### P: ¿Qué valores recopila el agente?  
...
### Guardar los eventos registrados pero seguir supervisando  
...
### Guardar los eventos registrados y detener la supervisión  
