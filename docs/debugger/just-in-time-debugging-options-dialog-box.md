 ...
 **Se detectaron errores de registro de depuración Just-in-Time. Para reparar, habilite la depuración Just-in-Time o ejecute la reparación de Visual Studio.**
 ...
 **Acceso denegado. Haga que un administrador habilite la depuración Just-in-Time o repare la instalación de Visual Studio.**
