...
manager: "ghogen"
---
# Informaci&#243;n de carga de s&#237;mbolos (Cuadro de di&#225;logo)
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

El cuadro de diálogo **Información de carga de símbolos** se abre al hacer clic con el botón secundario en la ventana **Módulos** y elegir **Información de carga de símbolos**.  
