...
|----------|---------------|------------|
|Configuración de|**Espacio**|Se usa en lugar de **Entrar** en cualquier lugar excepto en los campos de edición.|
|Configuración de|**F1**|Abrir la **Ayuda** sobre el elemento de la interfaz de usuario actual.|
