...
description: Vea la lista de teclas de método abreviado en Visor de Ayuda de Microsoft. Usar teclas de método abreviado para la navegación, la administración de ventanas y la administración de contenido.
ms.date: 11/02/2017
ms.topic: reference
helpviewer_keywords:
...
|Barra de herramientas|**Ctrl**+**F**|Mostrar la barra **Buscar** en el área de temas para poder buscar texto en el tema actual.|
...
|Buscar|**Entrar**|Cambiar el foco al elemento siguiente.|
