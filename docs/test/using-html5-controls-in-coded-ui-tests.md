---
title: "Usar controles HTML5 en pruebas de IU codificada | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
 ...
 **Control de audio:** las acciones en el control de audio de HTML5 se graban y se reproducen correctamente.  
 ...
 ![Control Audio de HTML5](../test/media/codedui_html5_audio.png "CodedUI\_HTML5\_Audio")  
 ...
 **Control de vídeo:** las acciones en el control de vídeo de HTML5 se graban y se reproducen correctamente.  
 ...
 ![Control Video de HTML5](../test/media/codedui_html5_video.png "CodedUI\_HTML5\_Video")  
 ...
 **Control deslizante:** las acciones en el control deslizante de HTML5 se graban y se reproducen correctamente.  
 ...
 ![Control Slider de HTML5](../test/media/codedui_html5_slider.png "CodedUI\_HTML5\_Slider")  
 ...
 **Control de barra de progreso:** la barra de progreso es un control no interactuable.  Puede agregar aserciones en las propiedades `Value` y `Max` de este control.  
  
 ![Control ProgressBar de HTML5](../test/media/codedui_html5_progressbar.png "CodedUI\_HTML5\_ProgressBar")  
