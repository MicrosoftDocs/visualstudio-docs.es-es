---
title: Recopilación de información de diagnóstico con la configuración de pruebas en Visual Studio
ms.date: 10/03/2016
ms.topic: conceptual
helpviewer_keywords:
