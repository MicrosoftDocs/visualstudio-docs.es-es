---
title: "Usar stubs para aislar las partes de la aplicaci&#243;n entre s&#237; para las pruebas unitarias | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
-   [Códigos auxiliares para las diferentes clases de miembros de tipo](../test/using-stubs-to-isolate-parts-of-your-application-from-each-other-for-unit-testing.md#BKMK_Stub_basics)  
    ...
    -   [Códigos auxiliares de clases virtuales](../test/using-stubs-to-isolate-parts-of-your-application-from-each-other-for-unit-testing.md#BKMK_Partial_stubs)  
...
##  <a name="How"></a> Usar códigos auxiliares  
...
###  <a name="GeneratingStubs"></a> Generar códigos auxiliares  
...
###  <a name="WriteTest"></a> Escribir la prueba con códigos auxiliares  
...
##  <a name="BKMK_Stub_basics"></a> Códigos auxiliares para las diferentes clases de miembros de tipo  
...
###  <a name="BKMK_Partial_stubs"></a> Códigos auxiliares de clases virtuales  
...
2.  Las clases o métodos estáticos sellados no pueden procesarse con stub porque los tipos de código auxiliar dependen del envío del método virtual.  En tales casos, use los tipos de correcciones de compatibilidad que se describen en [Usar correcciones de compatibilidad \(shim\) para aislar la aplicación de otros ensamblados para las pruebas unitarias](../test/using-shims-to-isolate-your-application-from-other-assemblies-for-unit-testing.md)  
