...
-   ![Requisito previo](~/docs/test/media/prereq.png "Prereq") Las pruebas de IU codificadas para las aplicaciones de SharePoint solo son compatibles con SharePoint 2010.  
  
-   ![Requisito previo](~/docs/test/media/prereq.png "Prereq") No se pueden usar controles de Visio y PowerPoint 2010 en la aplicación de SharePoint.  
...
## <a name="creating-a-coded-ui-test-for-your-sharepoint-app"></a>Crear una prueba de IU codificada para la aplicación de SharePoint  
 ...
 ![Elementos web de SharePoint](~/docs/test/media/cuit_sharepoint.png "CUIT_SharePoint")  
