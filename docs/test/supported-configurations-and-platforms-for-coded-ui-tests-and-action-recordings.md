...
description: En este artículo se enumeran las configuraciones y plataformas compatibles con las pruebas automatizadas de IU de Visual Studio Enterprise.
...
| Architecture | x86 y x64 **Nota:**  Internet Explorer no es compatible en modo de 64 bits excepto cuando se ejecuta en [!INCLUDE[win8](../debugger/includes/win8_md.md)] o versiones posteriores. |
