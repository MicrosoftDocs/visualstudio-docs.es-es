...
ms.locfileid: "55947775"
---
# <a name="how-to-set-up-your-test-agent-to-run-tests-that-interact-with-the-desktop"></a>Filtrar Configurar el agente de pruebas para ejecutar pruebas que interactúen con el escritorio
