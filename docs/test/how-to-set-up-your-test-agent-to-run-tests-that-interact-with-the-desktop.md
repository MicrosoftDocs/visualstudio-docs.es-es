...
description: Aprenda a ejecutar pruebas automatizadas que interactúen con el escritorio mediante la configuración del agente para que se ejecute como un proceso y no como un servicio.
