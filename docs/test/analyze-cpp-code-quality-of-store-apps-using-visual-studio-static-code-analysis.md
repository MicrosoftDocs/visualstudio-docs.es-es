...
2.  En la página de propiedades del proyecto, elija **Análisis de código** y, después, **Habilitar análisis de código para C\/C\+\+ al compilar**.  
 ...
 ![Ventana Análisis de código](../test/media/ca_cpp_collapsed.png "CA\_CPP\_Collapsed")  
...
##  <a name="BKMK_Analyze"></a> Analizar y resolver advertencias del análisis de código  
 ...
 ![Advertencia de análisis de código expandido](../test/media/ca_cpp_expanded_callout.png "CA\_CPP\_Expanded\_Callout")  
 ...
 ![Código fuente resaltado](../test/media/ca_cpp_sourceline.png "CA\_CPP\_SourceLine")  
  
 Cuando haya entendido el problema, podrá resolverlo en el código.  Después, ejecuta otra vez el análisis de código, para asegurarte de que no vuelve a aparecer en la ventana Análisis de código y de que la corrección no generó otras advertencias.  
...
3.  Elija **Suprimir mensaje** y después elija **En origen**.  
  
 Al suprimir un mensaje, se inserta `#pragma(warning:`*WarningId*`)`, que suprime la advertencia para la línea de código.  
...
|[C6507](http://msdn.microsoft.com/es-es/18f88cd1-d035-4403-a6a4-12dd0affcf21)|No coincidencia Null en desreferenciación cero|  
...
|[C6519](http://msdn.microsoft.com/es-es/2b6326b0-0539-4d26-8fb1-720114933232)|Anotación no válida: el valor de la propiedad 'NeedsRelease' debe ser Yes o No|  
|[C6521](http://msdn.microsoft.com/es-es/e98d0ae3-6f13-47b2-9a15-15d4055af9ef)|Desreferenciación de cadena de tamaño no válida|  
...
|[C6526](http://msdn.microsoft.com/es-es/59c590c7-0098-4166-a1ac-87f324596002)|Tipo de búfer de cadena de tamaño no válido|  
...
|[C28205](../code-quality/c28205.md)|\_Success\_ o \_On\_failure\_ usados en un contexto no válido|  
...
|[C28220](../code-quality/c28210.md)|Las anotaciones del contexto \_\_on\_failure no deben estar en un contexto previo explícito|  
...
|[C28222](../code-quality/c28222.md)|Se esperaba \_\_yes, \_\_no o \_\_maybe para la anotación|  
...
|[C28264](http://msdn.microsoft.com/es-es/bf6ea983-a06e-4752-a042-747a7dbf338c)|Los valores de listas de resultados deben ser constantes.|  
...
|[C28275](../code-quality/c28275.md)|El parámetro para \_Macro\_value\_ es null|  
