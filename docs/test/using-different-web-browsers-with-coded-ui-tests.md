...
-   ![Requisito previo](~/docs/test/media/prereq.png "Req previo") El explorador web Apple Safari no se admite.  
  
-   ![Requisito previo](~/docs/test/media/prereq.png "Req previo") La acción de iniciar el explorador web debe formar parte de la prueba automatizada de IU.  
...
-   ![Requisito previo](~/docs/test/media/prereq.png "Req previo") No se admite la automatización de acciones de IU específicas del explorador como maximizar, minimizar y restaurar.  
  
 **Sugerencias**  
  
-   ![Sugerencia](~/docs/test/media/tip.png "Sugerencia") Puede configurar la salida para incluir capturas de pantalla en los registros de pruebas automatizadas de IU. Para ello, debe establecer algunas opciones de configuración en el archivo QTAgent32.exe.config. De forma predeterminada, este archivo se instala en la siguiente ubicación:  
