...
- Si no se muestra la ventana Propiedades, mantenga pulsada la tecla **Alt** mientras presiona **ENTRAR** o, como alternativa, presione **F4**.

- Para deshacer los cambios de propiedad realizados, seleccione **Deshacer** desde el menú **Editar** o presione Ctrl+Z.
...
- Para deshacer la división, elija **Deshacer** desde el menú **Editar** o presione Ctrl+Z.
