...
## <a name="using-testinitialize-and-testcleanup-attributes-to-create-a-dual-use-test-class"></a>Usar los atributos TestInitialize y TestCleanup para crear una clase de prueba de doble uso
