...
description: Aprenda a mostrar paneles que proporcionan diferentes maneras de analizar los resultados de una ejecución de prueba de carga, como un grafo a lo largo del tiempo o tablas detalladas.
...
|-|-|
|Errors|Muestra una lista de errores producidos durante la ejecución de la prueba de carga. Para obtener más información, vea la [tabla Errores](../test/analyze-load-test-results-and-errors-in-the-tables-view.md#the-errors-table) en este tema, así como [Analizar resultados de pruebas de carga](../test/analyze-load-test-results-using-the-load-test-analyzer.md).|
...
|**Tiempo de transacción**|Tiempo de ejecución de la transacción de una prueba de carga. Para las pruebas de rendimiento web, el tiempo de reflexión está incluido en el cálculo. Las unidades son segundos.|No|
...
|**Tiempo de respuesta al 90 %**|El 90º valor de percentil para el tiempo de transacción. No incluye los tiempos de reflexión. **Nota:** Esto es diferente de Visual Studio Team System 2008 Test Load Agent, que usaba el valor **90 % del tiempo de la transacción**.|No|
|**Tiempo de respuesta al 95 %**|El 95º valor de percentil para el tiempo de transacción. No incluye los tiempos de reflexión. **Nota:** Esto es diferente de Visual Studio Team System 2008 Test Load Agent, que usaba el valor **95 % del tiempo de la transacción**.|No|
...
|Count|Número de errores de este tipo que se produjeron durante la prueba de carga. Las entradas de esta columna aparecen como hipervínculos. Puede elegir cualquier hipervínculo para ver una lista de errores individuales.|Sí|
...
|Columna|Descripción|
|-|-|
|**Time**|Hora durante la prueba de carga en la que se produjo el error.|
...
|**Tipo**|Tipo del error. Por ejemplo, HttpError.|
