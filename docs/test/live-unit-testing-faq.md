...
Sí. Live Unit Testing funciona con .NET Core y .NET Frameworks. Se ha agregado recientemente compatibilidad con .NET Core en la versión preliminar de Visual Studio 2017 versión 15.3. 
