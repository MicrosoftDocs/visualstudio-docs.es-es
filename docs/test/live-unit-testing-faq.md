...
## <a name="whats-new-in-live-unit-testing-for-visual-studio-2017-version-153"></a>What's new in Live Unit Testing for Visual Studio 2017 version 15.3? 

**Answer:**

- Support for .NET Core/.NET Standard and performance improvements are the two major enhancements. You'll notice that performance is significantly faster after the first full build and run of tests under Live Unit Testing. You'll also notice significant performance improvement in subsequent starts of Live Unit Testing on the same solution. We now persist data generated by Live Unit Testing and reuse it as much as possible with up-to-date checks. Besides these major additions, Live Unit Testing includes the following enhancements: 
...
## <a name="does-live-unit-testing-work-with-net-core"></a>Does Live Unit Testing work with .NET Core?  
...
## <a name="why-doesnt-live-unit-testing-work-when-i-turn-it-on"></a>Why doesn't Live Unit Testing work when I turn it on? 
...
## <a name="can-i-customize-my-live-unit-testing-builds"></a>Can I customize my Live Unit Testing builds? 
...
## <a name="error-messages-with-ltoutputpathgt-or-ltoutdirgt"></a>Error messages with &lt;OutputPath&gt; or &lt;OutDir&gt;
...
## <a name="setting-the-location-of-live-unit-testing-build-artifacts"></a>Setting the location of Live Unit Testing build artifacts
...
## <a name="how-is-running-tests-from-test-explorer-window-different-from-running-tests-in-live-unit-testing"></a>How is running tests from Test Explorer window different from running tests in Live Unit Testing? 
...
## <a name="how-do-i-exclude-tests-from-participating-in-live-unit-testing"></a>How do I exclude tests from participating in Live Unit Testing?
...
## <a name="why-are-win32-pe-headers-different-in-instrumented-assemblies-built-by-live-unit-testing"></a>Why are Win32 PE headers different in instrumented assemblies built by Live Unit testing? 
...
## <a name="why-does-live-unit-testing-keep-building-my-solution-all-the-time-even-if-i-am-not-making-any-edits"></a>Why does Live Unit testing keep building my solution all the time even if I am not making any edits? 
...
## <a name="how-does-live-unit-testing-work-with-the-lightweight-solution-load-feature"></a>How does Live Unit testing work with the Lightweight Solution Load feature? 
...
## <a name="why-does-live-unit-testing-does-not-capture-coverage-from-a-new-process-created-by-a-test"></a>Why does Live Unit Testing does not capture coverage from a new process created by a test?
 
**Answer:**

This is a known issue and should be fixed in a subsequent update of Visual Studio 2017. 

## <a name="why-does-nothing-happen-after-i-include-or-exclude-tests-from-the-live-test-set"></a>Why does nothing happen after I include or exclude tests from the Live Test set? 
...
## <a name="live-unit-testing-and-editor-icons"></a>Live Unit Testing and editor icons 
...
## <a name="how-do-i-collect-more-detailed-logs-to-file-bug-reports"></a>How do I collect more detailed logs to file bug reports? 
