...
7.  [Comprobar cobertura](https://msdn.microsoft.com/en-us/library/fc8hec9e.aspx). Las pruebas unitarias son más útiles cuanto más código ponen a prueba. Puede detectar qué partes del código han utilizado las pruebas.  
...
5.  En el Explorador de pruebas, elija **Ejecutar todas**.  
     ...
     ![Explorador de pruebas unitarias: prueba básica superada](~/docs/test/media/utecpp10.png "UteCpp10")  
