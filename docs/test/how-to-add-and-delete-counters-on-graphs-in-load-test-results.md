---
title: Agregar y eliminar contadores de los gráficos de resultados de pruebas de carga en Visual Studio | Microsoft Docs
ms.date: 10/19/2016
ms.topic: article
helpviewer_keywords:
...
Puede usar el panel Contadores para agregar contadores de rendimiento a un gráfico.
 ...
 ![Contador agregado a un gráfico](../test/media/ltest_selectcounter.png "LTest_SelectCounter")
