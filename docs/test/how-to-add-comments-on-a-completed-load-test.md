---
title: Agregar comentarios mientras se analiza una prueba de carga completada en Visual Studio | Microsoft Docs
ms.date: 10/19/2016
ms.topic: conceptual
helpviewer_keywords:
...
## <a name="to-add-a-comment-to-a-load-test"></a>Para agregar comentarios a una prueba de carga

1.  Después de completarse una prueba de carga o después de cargar el resultado de una prueba, elija **Agregar notas de análisis** en la barra de herramientas del Analizador de pruebas de carga.
