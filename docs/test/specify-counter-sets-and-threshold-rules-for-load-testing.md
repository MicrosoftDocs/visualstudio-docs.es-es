...
description: Aprenda a especificar conjuntos de contadores y reglas de umbral en una prueba de carga. Agregue los servidores sometidos a prueba a la lista de equipos en los que se van a recopilar contadores.
