...
description: Aprenda a crear pruebas unitarias para un archivo DLL de C++ para aplicaciones de la Plataforma universal de Windows con el marco de pruebas de Microsoft para C++.
