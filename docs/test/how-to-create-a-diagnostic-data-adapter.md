...
description: Aprenda a crear un adaptador de datos de diagnóstico mediante la creación de una biblioteca de clases con Visual Studio y la adición de las API de dicho adaptador.
