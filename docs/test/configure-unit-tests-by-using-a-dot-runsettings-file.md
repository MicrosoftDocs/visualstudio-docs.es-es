---
title: Configuración de pruebas unitarias en Visual Studio con un archivo .runsettings | Microsoft Docs
ms.date: 02/28/2018
...
Para personalizar cualquier otro tipo de adaptador de datos de diagnóstico, debe usar un [archivo de configuración de pruebas](../test/collect-diagnostic-information-using-test-settings.md).
