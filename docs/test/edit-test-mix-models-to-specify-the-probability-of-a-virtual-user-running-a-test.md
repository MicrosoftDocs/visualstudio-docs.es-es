...
description: Aprenda cómo el modelo de combinación de pruebas le permite tener varios flujos de trabajo. Este modelo se aproxima más a cómo interactúan los usuarios finales con las aplicaciones.
