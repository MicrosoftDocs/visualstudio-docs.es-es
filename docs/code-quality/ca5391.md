---
title: 'CA5391: uso de tokens antifalsificación en controladores MVC de ASP.NET Core'
...
ms.locfileid: "85289868"
---
# <a name="ca5391-use-antiforgery-tokens-in-aspnet-core-mvc-controllers"></a>CA5391: uso de tokens antifalsificación en controladores MVC de ASP.NET Core

|||
|-|-|
|Identificador de comprobación|CA5391|
