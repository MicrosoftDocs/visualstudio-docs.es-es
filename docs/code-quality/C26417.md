...
** C++ Directrices básicas**: R.35: Tome un parámetro shared_ptr @ no__t-0widget > & para expresar que una función puede volver a colocar el puntero compartido
