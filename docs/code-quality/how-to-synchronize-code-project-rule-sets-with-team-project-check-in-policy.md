---
title: Filtrar Sincronizar conjuntos de reglas del proyecto de código con la directiva de protección del proyecto de equipo
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
...
ms.locfileid: "55945448"
---
# <a name="how-to-synchronize-code-project-rule-sets-with-an-azure-devops-project-check-in-policy"></a>Filtrar Sincronizar conjuntos de reglas del proyecto de código con una directiva de protección de Azure DevOps Projects
