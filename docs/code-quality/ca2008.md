---
title: 'CA2008: no crear tareas sin pasar un TaskScheduler'
ms.date: 08/26/2020
ms.topic: reference
f1_keywords:
- CA2008
...
---
# <a name="ca2008-do-not-create-tasks-without-passing-a-taskscheduler"></a>CA2008: no crear tareas sin pasar un TaskScheduler
