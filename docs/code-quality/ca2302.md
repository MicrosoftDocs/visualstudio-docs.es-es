...
- Restrinja los tipos deserializados. Implementar un personalizado <xref:System.Runtime.Serialization.SerializationBinder?displayProperty=nameWithType> . Antes de deserializar con <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> , establezca la <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> propiedad en una instancia de su personalizado <xref:System.Runtime.Serialization.SerializationBinder> . En el método invalidado <xref:System.Runtime.Serialization.SerializationBinder.BindToType%2A> , si el tipo es inesperado, inicie una excepción para detener la deserialización.
  - Asegúrese de que todas las rutas de acceso de código tienen <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> establecida la propiedad.
