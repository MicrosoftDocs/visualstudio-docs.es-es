...
ms.locfileid: "81649293"
---
# <a name="native-recommended-rules-rule-set"></a>Conjunto de reglas Reglas recomendadas nativas

Las reglas recomendadas nativas se centran en los problemas más críticos y comunes en el código nativo, incluidos los posibles agujeros de seguridad y los bloqueos de aplicaciones. Este conjunto de reglas incluye todas las reglas del conjunto de reglas [mínimas nativas.](native-minimum-rules-rule-set.md)

Incluya este conjunto de reglas en cualquier conjunto de reglas personalizado que cree para proyectos nativos.
...
|[C6031](../code-quality/c6031.md)|Valor devuelto ignorado|
|[C6053](../code-quality/c6053.md)|Terminación en cero de la llamada|
|[C6054](../code-quality/c6054.md)|Falta la terminación cero|
...
|[C6214](../code-quality/c6214.md)|HRESULT de fundido no válido a BOOL|
|[C6215](../code-quality/c6215.md)|BOOL de Cast no válido a HRESULT|
|[C6216](../code-quality/c6216.md)|BOOL de fundición insertada por el compilador no válido a HRESULT|
|[C6217](../code-quality/c6217.md)|Prueba HRESULT no válida CON NO|
|[C6220](../code-quality/c6220.md)|HRESULT no válido Comparar con -1|
|[C6226](../code-quality/c6226.md)|Asignación HRESULT no válida a -1|
|[C6230](../code-quality/c6230.md)|Uso HRESULT no válido como booleano|
|[C6235](../code-quality/c6235.md)|Constante distinta de cero con lógica o|
|[C6236](../code-quality/c6236.md)|Lógico-O con constante distinta de cero|
|[C6237](../code-quality/c6237.md)|Cero con efectos secundarios lógicos y perdidos|
|[C6242](../code-quality/c6242.md)|Desenredado local forzado|
|[C6248](../code-quality/c6248.md)|Creación de DACL nulo|
|[C6250](../code-quality/c6250.md)|Descriptores de direcciones inéditos|
|[C6255](../code-quality/c6255.md)|Uso desprotegido de Alloca|
|[C6258](../code-quality/c6258.md)|Uso de Terminate Thread|
|[C6259](../code-quality/c6259.md)|Código muerto en bit a bit o interruptor limitado|
|[C6260](../code-quality/c6260.md)|Uso de la aritmética de bytes|
|[C6262](../code-quality/c6262.md)|Uso excesivo de la pila|
|[C6263](../code-quality/c6263.md)|Uso de Alloca In Loop|
|[C6268](../code-quality/c6268.md)|Faltan paréntesis en el reparto|
|[C6269](../code-quality/c6269.md)|Desreferencia del puntero ignorada|
...
|[C6280](../code-quality/c6280.md)|Asignación de memoria-Desasignación de coincidencia|
|[C6281](../code-quality/c6281.md)|Precedencia de relación bit a bit|
|[C6282](../code-quality/c6282.md)|Prueba de reemplazos de asignación|
|[C6283](../code-quality/c6283.md)|Matriz primitiva-Nueva coincidencia escalar-eliminar|
|[C6284](../code-quality/c6284.md)|Argumento de objeto no válido para la función de formato|
|[C6285](../code-quality/c6285.md)|Lógico-O De Constantes|
|[C6286](../code-quality/c6286.md)|Efectos secundarios no lógicos o perdedores|
|[C6287](../code-quality/c6287.md)|Prueba redundante|
|[C6288](../code-quality/c6288.md)|La inclusión mutua sobre la lógica y es falsa|
|[C6289](../code-quality/c6289.md)|La exclusión mutua sobre Lógico-O es verdadera|
...
|[C6292](../code-quality/c6292.md)|Recuentos de bucles desde el máximo|
|[C6293](../code-quality/c6293.md)|Recuentos de bucles hacia abajo desde un mínimo|
|[C6294](../code-quality/c6294.md)|Cuerpo de bucle nunca ejecutado|
|[C6295](../code-quality/c6295.md)|Infinite Loop|
|[C6296](../code-quality/c6296.md)|Bucle solo ejecutado una vez|
|[C6297](../code-quality/c6297.md)|Resultado de Shift Cast a mayor tamaño|
...
|[C6308](../code-quality/c6308.md)|Fuga de Realloc|
|[C6310](../code-quality/c6310.md)|Constante de filtro de excepción ilegal|
|[C6312](../code-quality/c6312.md)|Bucle de ejecución de comprobación de excepción|
|[C6314](../code-quality/c6314.md)|Precedencia bit a bit o|
|[C6317](../code-quality/c6317.md)|No complemento|
|[C6318](../code-quality/c6318.md)|Excepción Continuar búsqueda|
|[C6319](../code-quality/c6319.md)|Ignorado por coma|
|[C6324](../code-quality/c6324.md)|Copiar cadena en lugar de comparar cadenas|
|[C6328](../code-quality/c6328.md)|Error de coincidencia de tipo de argumento potencial|
|[C6331](../code-quality/c6331.md)|VirtualFree Indicadores no válidos|
|[C6332](../code-quality/c6332.md)|VirtualFree Parámetro no válido|
|[C6333](../code-quality/c6333.md)|VirtualFree Tamaño no válido|
|[C6335](../code-quality/c6335.md)|Mango de proceso de fugas|
|[C6381](../code-quality/c6381.md)|Falta información de apagado|
|[C6383](../code-quality/c6383.md)|Sobreejecución de búfer de recuento de bytes de recuento de elementos|
|[C6384](../code-quality/c6384.md)|División de tamaño del puntero|
...
|[C26101](../code-quality/c26101.md)|No utilizar correctamente el funcionamiento entrelazado|
|[C26110](../code-quality/c26110.md)|Llamada que no puede mantener el bloqueo|
|[C26111](../code-quality/c26111.md)|Llamada que no puede liberar el bloqueo|
|[C26112](../code-quality/c26112.md)|El autor de la llamada no puede mantener ningún bloqueo|
|[C26115](../code-quality/c26115.md)|No liberar el bloqueo|
|[C26116](../code-quality/c26116.md)|No adquirir o mantener el bloqueo|
|[C26117](../code-quality/c26117.md)|Liberación del bloqueo no retenido|
...
|[C28022](../code-quality/c28022.md)|Las clases de función de esta función no coinciden con las clases de función de la definición de tipo utilizada para definirla.|
|[C28023](../code-quality/c28023.md)|La función que se \_asigna\_\_ o pasa debe tener una anotación de clase Function para al menos una de las clases|
|[C28024](../code-quality/c28024.md)|El puntero de función al que se asigna se anota con la clase de función, que no está contenida en la lista de clases de función.|
|[C28039](../code-quality/c28039.md)|El tipo de parámetro real debe coincidir exactamente con el tipo|
|[C28112](../code-quality/c28112.md)|Siempre se debe acceder a una variable a la que se accede a través de una función entrelazadas a través de una función de interbloqueo.|
...
|[C28138](../code-quality/c28138.md)|El argumento constante debe ser variable en su lugar|
...
|[C28163](../code-quality/c28163.md)|Nunca se debe llamar a la función desde un bloque try/except|
...
|[C28183](../code-quality/c28183.md)|El argumento podría ser un valor, y es una copia del valor encontrado en el puntero|
...
|[C28209](../code-quality/c28209.md)|La declaración para el símbolo tiene una declaración contradictoria|
...
|[C28244](../code-quality/c28244.md)|La anotación para la función tiene un parámetro no separable/anotación externa|
