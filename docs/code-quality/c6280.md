...
## <a name="see-also"></a>Vea también
 [calloc](/cpp/c-runtime-library/reference/calloc) [malloc](/cpp/c-runtime-library/reference/malloc) [libre](/cpp/c-runtime-library/reference/free) [new (operador)](/cpp/cpp/new-operator-cpp) [delete (operador)](/cpp/cpp/delete-operator-cpp) [shared_ptr](/cpp/standard-library/shared-ptr-class) [unique_ptr](/cpp/standard-library/unique-ptr-class) [punteros inteligentes](/cpp/cpp/smart-pointers-modern-cpp)