...
Solo se debe suprimir una advertencia de esta regla si se declara un tipo de <xref:System.Runtime.Serialization.ISerializationSurrogate?displayProperty=fullName> que permita la serialización y deserialización de las instancias del campo.
