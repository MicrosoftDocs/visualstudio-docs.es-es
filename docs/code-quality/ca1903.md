...
Para cambiar el marco de trabajo de destino de un proyecto, vea [Cómo: usar como destino una versión de .net](../ide/how-to-target-a-version-of-the-dotnet-framework.md).
