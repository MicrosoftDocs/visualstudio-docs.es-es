...
Para cambiar el marco de trabajo de destino de un proyecto, vea [How para: Establecer una versión de .NET como destino](../ide/how-to-target-a-version-of-the-dotnet-framework.md).
