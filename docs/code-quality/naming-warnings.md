...
|[CA1724: Los nombres de tipo no deberían coincidir con los espacios de nombres](../code-quality/ca1724-type-names-should-not-match-namespaces.md)|Los nombres de tipo no deben coincidir con los nombres de los espacios de nombres de .NET. Una infracción de esta regla puede reducir la facilidad de uso de la biblioteca.|
