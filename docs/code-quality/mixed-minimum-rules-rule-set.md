...
ms.date: 11/04/2016
description: Obtenga información sobre el conjunto de reglas reglas mínimas mixtas en Visual Studio. Vea las descripciones de las reglas para los proyectos de C++ compatibles con Common Language Runtime.
