...
Puede configurar qué partes del código analiza esta regla. Para obtener más información, vea [configurar los analizadores de calidad de código de .net](configure-fxcop-analyzers.md).
