...
ms.locfileid: "72746242"
---
# <a name="c6333"></a>C6333
ADVERTENCIA C6333: parámetro no válido: no se permite pasar MEM_RELEASE y un parámetro dwSize que no sea cero a \<function >. Esto provocará un error en la llamada
