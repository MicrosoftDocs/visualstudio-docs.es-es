...
ms.locfileid: "72012780"
---
# <a name="c6333"></a>C6333
C6333 de ADVERTENCIA: Parámetro no válido: no se permite pasar MEM_RELEASE y un parámetro dwSize distinto de cero al > \<function. Esto provocará un error en la llamada
...
```
 ...
 También puede usar VirtualFree (lpvBase, PAGELIMIT * dwPageSize, MEM_DECOMMIT); Llame a las páginas de anulación de confirmación y, después, suéltelos mediante la marca MEM_RELEASE.
