...
[USE_GSL_FINALLY C26448](c26448.md) Considere la posibilidad de usar `gsl::finally` si la acción final está prevista. Consulte [C++ Core Guidelines: GSL.util: utilidades](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#SS-utilities).
