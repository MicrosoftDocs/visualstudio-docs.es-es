...
Para corregir una infracción de esta regla, a menos que existan problemas de tamaño o compatibilidad, use <xref:System.Int32>. En situaciones en las que <xref:System.Int32> no es lo suficientemente grande como para contener los valores, utilice <xref:System.Int64>. Si la compatibilidad con versiones anteriores requiere un tipo de datos más pequeño, use <xref:System.Byte> o <xref:System.Int16>.
