...
ms.locfileid: "72012868"
---
# <a name="c6331"></a>C6331
C6331 de ADVERTENCIA: Parámetro no válido: no se permite pasar MEM_RELEASE y MEM_DECOMMIT junto con @no__t > 0function. Esto provocará un error en la llamada
