...
** C++ Directrices básicas**: R.36: Tome un parámetro const shared_ptr @ no__t-0widget > & para expresar que podría conservar un recuento de referencias en el objeto
