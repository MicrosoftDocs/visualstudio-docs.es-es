...
ms.locfileid: "72017966"
---
# <a name="c6277"></a>C6277
C6277 de ADVERTENCIA: Nombre de aplicación NULL con una ruta de acceso sin comillas en la llamada a \<function >: da como resultado una vulnerabilidad de seguridad si la ruta contiene espacios
