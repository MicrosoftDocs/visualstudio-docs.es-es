...
Los métodos que implementan el patrón **Try\<algo >** , como <xref:System.Int32.TryParse%2A?displayProperty=fullName>, no generan esta infracción. En el ejemplo siguiente se muestra una estructura (tipo de valor) que implementa el método <xref:System.Int32.TryParse%2A?displayProperty=fullName>.
