...
Un método establece la propiedad <xref:System.Data.IDbCommand.CommandText%2A?displayProperty=fullName> utilizando una cadena que se genera a partir de un argumento de cadena para el método.
