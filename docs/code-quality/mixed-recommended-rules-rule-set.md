...
ms.locfileid: "81649307"
---
# <a name="mixed-recommended-rules-rule-set"></a>Conjunto de reglas Reglas recomendadas mixtas

Las reglas recomendadas mixtas de Microsoft se centran en los problemas más comunes y críticos de los proyectos de C++ que admiten Common Language Runtime, incluidos posibles agujeros de seguridad, bloqueos de aplicaciones y otros errores importantes de lógica y diseño. Este conjunto de reglas incluye todas las reglas del conjunto de reglas [mínimas mixtas.](mixed-minimum-rules-rule-set.md)
