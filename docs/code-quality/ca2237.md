...
En el ejemplo siguiente se muestra un tipo que infringe la regla. Quite la marca de comentario de la línea de atributo de <xref:System.SerializableAttribute> para satisfacer la regla.
