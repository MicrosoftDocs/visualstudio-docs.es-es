---
title: 'CA5360: no llamar a métodos peligrosos en la deserialización'
...
ms.locfileid: "85289878"
---
# <a name="ca5360-do-not-call-dangerous-methods-in-deserialization"></a>CA5360: no llamar a métodos peligrosos en la deserialización

|||
|-|-|
|Identificador de comprobación|CA5360|
...
Todos los métodos cumplen uno de los siguientes requisitos podrían ser la devolución de llamada de la deserialización:
