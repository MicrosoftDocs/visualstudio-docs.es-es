...
Para corregir una infracción de esta regla, cambie el parámetro a un tipo <xref:System.Uri>; se trata de un cambio importante. Como alternativa, proporcione una sobrecarga del método que toma un parámetro <xref:System.Uri>; se trata de un cambio no problemático.
