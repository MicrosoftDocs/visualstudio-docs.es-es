...
No suprima las advertencias del código de producción. Sin embargo, es seguro suprimir esta advertencia para el código de prueba. Puede suprimir las advertencias de esta regla estableciendo su [gravedad](use-roslyn-analyzers.md#configure-severity-levels) en **ninguno**.
