---
title: 'CA3010: revisar el código para las vulnerabilidades de inyección de XAML'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809873"
---
# <a name="ca3010-review-code-for-xaml-injection-vulnerabilities"></a>CA3010: revisar el código para las vulnerabilidades de inyección de XAML
...
Esta regla intenta buscar la entrada de las solicitudes HTTP que alcanza un método Load <xref:System.Windows.Markup.XamlReader?displayProperty=nameWithType>.
