...
|----------|------------------------|  
|**Crear y usar directivas de protección:** puede crear directivas de protección mediante la configuración del proyecto de equipo de [!INCLUDE[esprscc](../code-quality/includes/esprscc_md.md)].|[Establecer y aplicar pruebas de calidad](http://msdn.microsoft.com/Library/bdc5666e-6cf0-45b2-a0a1-133c3f61e852)|  
