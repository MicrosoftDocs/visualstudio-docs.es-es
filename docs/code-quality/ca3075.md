...
- la propiedad <xref:System.Xml.XmlReaderSettings.DtdProcessing%2A> está establecida en Parse.
...
- Asegúrese de que la propiedad <xref:System.Data.DataViewManager.DataViewSettingCollectionString%2A?displayProperty=nameWithType> esté asignada desde una fuente de confianza.
