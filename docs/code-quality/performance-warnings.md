...
helpviewer_keywords: 
  - "advertencias, rendimiento"
  - "advertencias de rendimiento"
  - "rendimiento, advertencias"
  - "advertencias de análisis de código administrado, advertencias de rendimiento"
...
|[CA1811: Evitar código privado al que no se llama](../code-quality/ca1811-avoid-uncalled-private-code.md)|Un miembro interno o privado \(nivel de ensamblado\) no tiene llamadores en el ensamblado, no es invocado por Common Language Runtime ni tampoco por un delegado.|  
...
|[CA1823: Evitar los campos privados no utilizados](../code-quality/ca1823-avoid-unused-private-fields.md)|Se detectaron campos privados a los que no parece que se tenga acceso en el ensamblado.|  
