...
Se llamó a un método de deserialización <xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType> o se hizo referencia a él y la propiedad <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> puede ser null.

## <a name="rule-description"></a>Descripción de la regla

[!INCLUDE[insecure-deserializers-description](includes/insecure-deserializers-description-md.md)]

Esta regla busca llamadas o referencias al método de deserialización <xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType> cuando el valor de <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> puede ser null. Si desea no permitir la deserialización con <xref:System.Runtime.Serialization.NetDataContractSerializer> independientemente de la propiedad <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder>, deshabilite esta regla y [CA2311](ca2311.md)y habilite la regla [CA2310](ca2310.md).
