...
`NetDataContractSerializer` no es seguro y no se puede proteger. Para obtener más información, vea la [Guía de seguridad BinaryFormatter](/dotnet/standard/serialization/binaryformatter-security-guide).
