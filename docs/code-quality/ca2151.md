...
Para corregir una infracción de esta regla, marque el campo con el atributo <xref:System.Security.SecurityCriticalAttribute> o haga que el tipo al que hace referencia el campo sea transparente para la seguridad o crítico para la seguridad.
