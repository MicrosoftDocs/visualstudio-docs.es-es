...
ms.openlocfilehash: a163568bd154babc00f7c6963e7599eabcf5cf96
ms.contentlocale: es-es
ms.lasthandoff: 08/30/2017

---
# <a name="ca1003-use-generic-event-handler-instances"></a>CA1003: Use generic event handler instances
|||  
|-|-|  
...
## <a name="example"></a>Example  
 ...
 [!code-vb[FxCop.Design.CustomEventHandler#1](../code-quality/codesnippet/VisualBasic/ca1003-use-generic-event-handler-instances_1.vb)] [!code-csharp[FxCop.Design.CustomEventHandler#1](../code-quality/codesnippet/CSharp/ca1003-use-generic-event-handler-instances_1.cs)]  
