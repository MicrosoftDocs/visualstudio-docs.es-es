...
ms.locfileid: "74877798"
---
# <a name="c6400"></a>C6400
ADVERTENCIA C6400: se usa \<nombre de función > para realizar una comparación sin distinción entre mayúsculas y minúsculas con la cadena constante \<el nombre de cadena >. Se proporcionarán resultados inesperados en las configuraciones regionales que no estén en inglés
