---
title: 'CA2354: un conjunto de objetos no seguro o DataTable en el gráfico de objetos deserializados puede ser vulnerable a ataques de ejecución de código remoto'
ms.date: 07/14/2020
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "86393397"
---
# <a name="ca2354-unsafe-dataset-or-datatable-in-deserialized-object-graph-can-be-vulnerable-to-remote-code-execution-attack"></a>CA2354: un conjunto de objetos no seguro o DataTable en el gráfico de objetos deserializados puede ser vulnerable a ataques de ejecución de código remoto

|Elemento|Value|
|-|-|
|Identificador de comprobación|CA2354|
