...
ms.locfileid: "62578229"
---
# <a name="c6332"></a>C6332
warning C6332: Parámetro no válido: pasar cero como el parámetro dwFreeType en \<función > no está permitido. Esto provocará un error en la llamada
