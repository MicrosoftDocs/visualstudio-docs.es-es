...
ms.locfileid: "72017555"
---
# <a name="c6332"></a>C6332
C6332 de ADVERTENCIA: Parámetro no válido: no se permite pasar cero como el parámetro dwFreeType a \<function >. Esto provocará un error en la llamada
