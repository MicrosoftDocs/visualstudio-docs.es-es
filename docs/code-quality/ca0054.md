---
title: 'CA0054: el ensamblado de regla personalizado tiene recursos XML no válidos.'
description: Esto sucede si un ensamblado de regla personalizado tiene recursos XML no válidos que describen sus reglas.
ms.date: 10/19/2016
ms.topic: reference
f1_keywords:
- CA0054
...
ms.locfileid: "102468369"
---
# <a name="ca0054"></a>CA0054
El ensamblado de regla personalizada tiene recursos XML no válidos.

Esto sucede si un ensamblado de regla personalizado tiene recursos XML no válidos que describen sus reglas. El formato correcto es el siguiente:
