---
title: CA0054 | Documentos de Microsoft
ms.custom: 
ms.date: 10/19/2016
ms.reviewer: 
ms.suite: 
...
Ensamblado de regla personalizada tiene recursos XML no válidos  
  
 Esto se produce si un ensamblado de regla personalizada tiene recursos XML no válidos que describen sus reglas. El formato correcto es como sigue:  
