...
> [!NOTE]
> El procedimiento siguiente no se aplica a los proyectos de .NET Core o .NET Standard, que no admiten las mismas características en la pestaña de propiedades de **análisis de código** .
