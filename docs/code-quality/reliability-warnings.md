...
|[CA2004: Quitar las llamadas a GC.KeepAlive](../code-quality/ca2004-remove-calls-to-gc-keepalive.md)|Al efectuar la conversión para utilizar SafeHandle, quite todas las llamadas a GC.KeepAlive \(objeto\).  En este caso, las clases no deben tener que llamar a GC.KeepAlive, puesto que se supone que no tienen un finalizador sino que dependen de SafeHandle para que se encargue de finalizar el indicador OS.|  
