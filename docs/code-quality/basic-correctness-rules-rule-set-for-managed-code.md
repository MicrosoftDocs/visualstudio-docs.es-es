...
ms.date: 11/04/2016
description: Obtenga información sobre el conjunto de reglas reglas de corrección básicas de Visual Studio, que se centra en los errores lógicos y los errores comunes de API de .NET Framework. Vea las descripciones de las reglas.
