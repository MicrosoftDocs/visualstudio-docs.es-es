...
| [CA1504: Revise los nombres de campos erróneos](../code-quality/ca1504-review-misleading-field-names.md) | El nombre de un campo de instancia comienza por "s_", o el nombre de un campo estático (compartido en [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)]) comienza por "m_". |
