...
| [CA1504: Revisar los nombres de campos erróneos](../code-quality/ca1504.md) | El nombre de un campo de instancia comienza por "s_", o el nombre de un campo estático (compartido en [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] ) comienza por "m_". |
...
| [CA1507: Usar nameof en lugar de la cadena](../code-quality/ca1507.md) | Un literal de cadena se usa como argumento en el que se `nameof` podría utilizar una expresión. |
