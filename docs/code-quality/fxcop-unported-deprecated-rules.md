---
description: Las siguientes reglas de análisis heredado de FxCop están desusadas y no se implementarán como analizadores.
title: Reglas en desuso
ms.date: 05/21/2019
ms.topic: reference
helpviewer_keywords:
- fxcop rules
