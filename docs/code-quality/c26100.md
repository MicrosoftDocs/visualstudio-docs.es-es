...
ms.locfileid: "72015762"
---
# <a name="c26100"></a>C26100
C26100 de ADVERTENCIA: Condición de carrera. La variable \<var > debe protegerse mediante Lock \<lock >.
...
## <a name="example"></a>Ejemplo
 En el ejemplo siguiente se genera la advertencia C26100 porque hay una infracción del contrato `_Guarded_by_`.
