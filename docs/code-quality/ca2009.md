---
title: 'CA2009: no llama a ToImmutableCollection en un valor de ImmutableCollection'
ms.date: 04/29/2020
ms.topic: reference
f1_keywords:
- CA2009
...
ms.locfileid: "82587676"
---
# <a name="ca2009-do-not-call-toimmutablecollection-on-an-immutablecollection-value"></a>CA2009: no llama a ToImmutableCollection en un valor de ImmutableCollection

|||
|-|-|
|TypeName|DoNotCallToImmutableCollectionOnAnImmutableCollectionValueAnalyzer|
|Identificador de comprobación|CA2009|
|Category|Microsoft.Reliability|
|Cambio importante|Poco problemático|

## <a name="cause"></a>Causa

`ToImmutable`se llamó innecesariamente al método en una colección inmutable desde el espacio de <xref:System.Collections.Immutable> nombres.
...
Estos tipos definen métodos de extensión que crean una nueva colección inmutable a <xref:System.Collections.Generic.IEnumerable%601> partir de una colección existente.
...
> [!NOTE]
> La regla CA2009 no está disponible en el análisis heredado. Se incluyó por primera vez en la versión 2.9.6 de los [analizadores de FxCop](https://www.nuget.org/packages/Microsoft.CodeAnalysis.FxCopAnalyzers) .

## <a name="how-to-fix-violations"></a>Cómo corregir infracciones

Para corregir las infracciones, quite `ToImmutable` la llamada redundante en una colección inmutable. Por ejemplo, los dos fragmentos de código siguientes muestran una infracción de la regla y cómo corregirlos:
