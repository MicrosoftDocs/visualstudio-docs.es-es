...
Dado que el valor asignado al campo de destino es calculable en tiempo de compilación, cambie la declaración a un campo `const` para que el valor se calcule en tiempo de compilación en lugar de en tiempo de ejecución.
