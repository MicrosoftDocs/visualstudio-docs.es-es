...
Para corregir una infracción de esta regla, marque el método con el atributo <xref:System.Security.SecurityCriticalAttribute> o <xref:System.Security.SecuritySafeCriticalAttribute> o quite el código no comprobable.
