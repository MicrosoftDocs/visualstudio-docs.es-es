...
ms.locfileid: "72009211"
---
# <a name="c6053"></a>C6053
ADVERTENCIA C6053: la llamada a @no__t-> 0function no puede ser una cadena terminada en cero \<variable >
...
## <a name="example"></a>Ejemplo
 El siguiente código de ejemplo corrige esta advertencia con la función de manipulación de cadenas seguras `strncpy_s`:
