...
ms.locfileid: "89176944"
---
# <a name="ca2249-consider-using-stringcontains-instead-of-stringindexof"></a>CA2249: considere la posibilidad de usar String. Contains en lugar de String. IndexOf

|Elemento|Value|
|-|-|
|Identificador de comprobación|CA2249|
