...
Los campos de matriz de solo lectura están exentos de esta regla pero, en su lugar, causan una infracción del [CA2105: Los campos de matriz no deben ser de solo lectura @ no__t-0.
