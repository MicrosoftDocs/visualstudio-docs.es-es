...
description: Un tipo extiende System. Windows. Forms. control y contiene dos o más controles de nivel superior que tienen claves de acceso idénticas que se almacenan en un archivo de recursos.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1301
