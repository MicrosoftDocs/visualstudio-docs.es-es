...
author: gewarren
manager: douge
ms.openlocfilehash: 3ea14057f084b892de3392f294f82c8c3304ba6b
ms.sourcegitcommit: ae46be4a2b2b63da7e7049e9ed67cd80897c8102
ms.translationtype: HT
ms.contentlocale: es-ES
ms.lasthandoff: 12/05/2018
ms.locfileid: "52896775"
---
# <a name="code-analysis-in-visual-studio"></a>Análisis de código en Visual Studio

Visual Studio proporciona varias herramientas distintas para analizar y mejorar la calidad del código.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Analizar la calidad del código administrado</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Analizar la calidad del código de C y C++</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Medir el mantenimiento de código con las métricas del código</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Advertencias de análisis de código administrado</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Advertencias de análisis de código de C++</h3>
                    </div>
                </div>
            </div>
        </div>
