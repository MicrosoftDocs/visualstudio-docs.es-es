...
description: Un tipo público está sellado y declara un método que es virtual (reemplazable en Visual Basic) y no final. Esta regla no notifica las infracciones de los tipos de delegado, que deben seguir este patrón.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
