...
## <a name="see-also"></a>Vea también
 [Control de versiones de ensamblado](/dotnet/framework/app-domains/assembly-versioning) [Cómo: crear una directiva de publicador](/dotnet/framework/configure-apps/how-to-create-a-publisher-policy)