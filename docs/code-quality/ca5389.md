---
title: 'CA5389: no agregar la ruta de acceso del elemento de almacenamiento a la ruta de acceso del sistema de archivos de destino'
...
ms.locfileid: "74809354"
---
# <a name="ca5389-do-not-add-archive-items-path-to-the-target-file-system-path"></a>CA5389: no agregar la ruta de acceso del elemento de almacenamiento a la ruta de acceso del sistema de archivos de destino
...
- `destinationFileName` de parámetro del método <xref:System.IO.Compression.ZipFileExtensions.ExtractToFile%2A?displayProperty=nameWithType>
- Ruta de acceso de parámetro del método <xref:System.IO.File.Open%2A?displayProperty=nameWithType>
- Ruta de acceso de parámetro del método <xref:System.IO.File.OpenWrite%2A?displayProperty=nameWithType>
- Ruta de acceso de parámetro del método <xref:System.IO.File.Create%2A?displayProperty=nameWithType>
- Ruta de acceso del parámetro del constructor <xref:System.IO.FileStream?displayProperty=nameWithType>
- Ruta de acceso del parámetro de `fileName` <xref:System.IO.FileInfo?displayProperty=nameWithType>
