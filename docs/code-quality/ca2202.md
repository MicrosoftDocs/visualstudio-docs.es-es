...
description: Una implementación de método contiene rutas de acceso de código que podrían provocar varias llamadas a System. IDisposable. Dispose o a un equivalente de Dispose, como un método de cierre en algunos tipos, en el mismo objeto.
ms.date: 07/16/2019
ms.topic: reference
f1_keywords:
- CA2202
