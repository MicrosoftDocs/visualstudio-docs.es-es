---
title: 'CA1835: preferir las sobrecargas basadas en memoria de los métodos ReadAsync/WriteAsync en clases basadas en secuencias'
ms.date: 05/11/2020
ms.topic: reference
f1_keywords:
...
|Identificador de comprobación|CA1835|
...
![Corrección de código para CA1836: preferir las sobrecargas basadas en memoria de los métodos ReadAsync/WriteAsync en clases basadas en secuencias](media/ca1836-codefix.png)
...
Estos son algunos ejemplos de las invocaciones en las que **no** se desencadenará la regla:
