...
ms.locfileid: "74877785"
---
# <a name="c6401"></a>C6401
ADVERTENCIA C6401: se usa \<nombre de función > en una configuración regional predeterminada para realizar una comparación sin distinción entre mayúsculas y minúsculas con la cadena constante \< el nombre de cadena >. Se proporcionarán resultados inesperados en las configuraciones regionales que no estén en inglés
