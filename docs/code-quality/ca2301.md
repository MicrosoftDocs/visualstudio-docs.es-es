...
Se llamó a un método de deserialización <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType> o se hizo referencia a él sin el conjunto de propiedades <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder>.

## <a name="rule-description"></a>Descripción de la regla

[!INCLUDE[insecure-deserializers-description](includes/insecure-deserializers-description-md.md)]

Esta regla busca llamadas o referencias al método de deserialización <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType>, cuando <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> no tiene su @no__t 2 establecido. Si desea no permitir la deserialización con <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> independientemente de la propiedad <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder>, deshabilite esta regla y [CA2302](ca2302.md)y habilite la regla [CA2300](ca2300.md).
