...
ms.locfileid: "31897106"
---
# <a name="c6262"></a>C6262
Advertencia C6262: función utiliza \<constante > bytes de la pila: supera / analyze: stacksize\<constante 2 >. Considere mover algunos datos al montón
...
## <a name="see-also"></a>Vea también
 [/Stack (asignaciones de la pila)](/cpp/build/reference/stack-stack-allocations) [_resetstkoflw](/cpp/c-runtime-library/reference/resetstkoflw) [Cómo: utilizar comprobaciones nativas en tiempo de ejecución](../debugger/how-to-use-native-run-time-checks.md)