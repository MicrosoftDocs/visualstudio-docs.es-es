...
Un ensamblado contiene un recurso basado en **resx**pero no tiene el <xref:System.Resources.NeutralResourcesLanguageAttribute?displayProperty=fullName> aplicado.
