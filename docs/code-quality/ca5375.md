---
title: 'CA5375: no usar firma de acceso compartido de cuenta'
...
ms.locfileid: "85289876"
---
# <a name="ca5375-do-not-use-account-shared-access-signature"></a>CA5375: no usar firma de acceso compartido de cuenta

|||
|-|-|
|Identificador de comprobación|CA5375|
...
[CA5377: usar la Directiva de acceso de nivel de contenedor](ca5377.md)
