...
ms.locfileid: "68418593"
---
# <a name="warning-c26812-prefer-enum-class-over-enum-enum3"></a>Warning C26812 prefiero ' ENUM Class ' Over ' ENUM ' (enum. 3)
El tipo de enumeración% Type% no tiene ámbito. Preferir ' ENUM Class ' Over ' ENUM ' (enum. 3)
