...
ms.locfileid: "72014395"
---
# <a name="c28250"></a>C28250
C28250 de ADVERTENCIA: Anotación incoherente de la función: la instancia anterior tiene un error.

 Nota: Hay varios prototipos para esta función. Esta advertencia compara el primer prototipo con el número de instancia @no__t > 0number.
