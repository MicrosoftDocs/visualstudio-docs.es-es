...
> [!NOTE]
> La regla CA1070 no está disponible en el análisis heredado. Se incluyó por primera vez en la versión 3.0.0 de los [analizadores de FxCop](https://www.nuget.org/packages/Microsoft.CodeAnalysis.FxCopAnalyzers) .
