...
|[CA2221: Los finalizadores deben estar protegidos](../code-quality/ca2221.md)|Los finalizadores deben utilizar el modificador de acceso de familia.|
...
|[CA2230: Usar parámetros en argumentos de variable](../code-quality/ca2230.md)|Un tipo público o protegido contiene un método público o protegido que utiliza la convención de llamada VarArgs en lugar de la palabra clave params.|
