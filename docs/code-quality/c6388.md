...
ms.locfileid: "72017379"
---
# <a name="c6388"></a>C6388
ADVERTENCIA C6388: es posible que el > \<argument no esté \<value >: esto no cumple con la especificación de la función \<function nombre >: Líneas: x, y
