---
title: 'CA2246: No asignar un símbolo y su miembro en la misma instrucción'
ms.date: 04/30/2020
ms.topic: reference
f1_keywords:
- CA2246
...
|||
|-|-|
|Identificador de comprobación|CA2246|
...
> [!NOTE]
> La regla CA2246 no está disponible en el análisis heredado. Se incluyó por primera vez en la versión 2.9.6 de los [analizadores de FxCop](https://www.nuget.org/packages/Microsoft.CodeAnalysis.FxCopAnalyzers) .
