...
ms.locfileid: "72009093"
---
# <a name="c6250"></a>C6250
C6250 de ADVERTENCIA: Llamar a \<function > VirtualFree sin la marca MEM_RELEASE puede liberar memoria pero no descriptores de dirección (VAD); produce pérdidas de espacio de direcciones
