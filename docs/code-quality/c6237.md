...
ms.locfileid: "72013550"
---
# <a name="c6237"></a>C6237
ADVERTENCIA C6237: (\<zero > & & \<expression >) siempre es cero. el > \<expression nunca se evalúa y puede tener efectos secundarios
 ...
 La expresión (`0 && n`) no produce efectos secundarios y se usa normalmente para elegir selectivamente las rutas de acceso del código.
