...
`LosFormatter` no es seguro y no se puede convertir en seguro. Para obtener más información, vea la [Guía de seguridad BinaryFormatter](/dotnet/standard/serialization/binaryformatter-security-guide).
