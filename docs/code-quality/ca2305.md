...
Se llamó a un método de deserialización <xref:System.Web.UI.LosFormatter?displayProperty=nameWithType> o se hizo referencia a él.

## <a name="rule-description"></a>Descripción de la regla

[!INCLUDE[insecure-deserializers-description](includes/insecure-deserializers-description-md.md)]

Esta regla busca llamadas o referencias al método de deserialización <xref:System.Web.UI.LosFormatter?displayProperty=nameWithType>.
