...
description: Un método de un ensamblado con el atributo System. Security. AllowPartiallyTrustedCallersAttribute llama a un método de un ensamblado que no tiene el atributo.
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
