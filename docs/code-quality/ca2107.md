...
Solo los usuarios con conocimientos avanzados de seguridad de .NET deben usar la acción de seguridad <xref:System.Security.CodeAccessPermission.Deny%2A?displayProperty=fullName>. Debería realizarse una revisión de la seguridad del código que utiliza estas acciones de seguridad.
