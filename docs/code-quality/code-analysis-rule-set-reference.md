...
Al configurar el análisis de código para los proyectos de código administrado en Visual Studio, se le presentará una lista integrados de *conjuntos de reglas*. Se puede usar uno de los conjuntos de reglas estándar o puede personalizar un conjunto de reglas para ajustarse a los requisitos del proyecto.
