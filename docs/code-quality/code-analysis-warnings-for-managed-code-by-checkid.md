...
| CA1003 | [CA1003: Utilizar instancias genéricas de controlador de eventos](../code-quality/ca1003.md) |Un tipo contiene un delegado que devuelve void cuya firma contiene dos parámetros (el primero un objeto y el segundo un tipo asignable a EventArgs), y el ensamblado que contiene tiene como destino Microsoft .NET Framework 2.0. |
...
| CA1504 | [CA1504: Revise los nombres de campos erróneos](../code-quality/ca1504.md) | El nombre de un campo de instancia empieza por "s_" o el nombre de un campo estático de (Shared en Visual Basic) empieza por "m_". |
...
| CA2128 |[CA2147: Los métodos transparentes no pueden usar aserciones de seguridad](../code-quality/ca2147.md) | Esta regla analiza todos los métodos y tipos de un ensamblado que es 100 por ciento transparente o mixto transparente y crítico y marca cualquier uso declarativo o imperativo de Assert. |
