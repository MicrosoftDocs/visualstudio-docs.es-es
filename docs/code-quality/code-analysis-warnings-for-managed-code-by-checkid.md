...
| CA2107 | [CA2107: Revisar el uso de Deny y PermitOnly](../code-quality/ca2107-review-deny-and-permit-only-usage.md) |Las acciones de seguridad método PermitOnly y CodeAccessPermission. deny solo las deben usar los usuarios con conocimientos avanzados de seguridad de .NET. Debería realizarse una revisión de la seguridad del código que utiliza estas acciones de seguridad. |
...
| CA2127 | [CA2136: Los miembros no deben tener anotaciones de transparencia en conflicto](../code-quality/ca2136-members-should-not-have-conflicting-transparency-annotations.md) | No se puede producir código crítico en un ensamblado de 100 por ciento transparente. Esta regla analiza los ensamblados del 100 por ciento transparentes para las anotaciones de SecurityCritical en los niveles de tipo, campo y método. |
| CA2128 |[CA2147: Los métodos transparentes no pueden usar aserciones de seguridad](../code-quality/ca2147-transparent-methods-may-not-use-security-asserts.md) | Esta regla analiza todos los métodos y tipos de un ensamblado que es 100 por ciento transparente o mixto y crítico, y marca cualquier uso declarativo o imperativo de Assert. |
