---
title: 'CA1833: Use asspan o asmemory en lugar de indexadores basados en intervalos para obtener la parte de intervalo o de memoria de una matriz.'
ms.date: 06/04/2020
ms.topic: reference
f1_keywords:
...
ms.locfileid: "85289899"
---
# <a name="ca1833-use-asspan-or-asmemory-instead-of-range-based-indexers-for-getting-span-or-memory-portion-of-an-array"></a>CA1833: Use asspan o asmemory en lugar de indexadores basados en intervalos para obtener la parte de intervalo o de memoria de una matriz.

|||
|-|-|
|Identificador de comprobación|CA1833|
...
> [!TIP]
> Hay disponible una corrección de código para esta regla en Visual Studio. Para usarlo, coloque el cursor en la infracción de la matriz y presione **Ctrl** + **.** (punto). Elija **usar asmemory en lugar del indexador basado en intervalo en una matriz** de la lista de opciones que se presenta.
>
...
- [CA1831: Use asspan en lugar de indexadores basados en intervalos para la cadena cuando corresponda.](ca1831.md)
