...
Solo <xref:System.Security.CodeAccessPermission.Deny%2A?displayProperty=fullName> los usuarios con conocimientos avanzados de seguridad de .net deben usar la acción de seguridad. Debería realizarse una revisión de la seguridad del código que utiliza estas acciones de seguridad.
