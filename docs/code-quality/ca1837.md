...
---
# <a name="ca1837-use-environmentprocessid-instead-of-processgetcurrentprocessid"></a>CA1837: Use Environment. ProcessId en lugar de Process. GetCurrentProcess (). Sesión
