...
Las reglas mínimas nativas de Microsoft se centran en los problemas más críticos del código nativo, incluidos los posibles agujeros de seguridad y los bloqueos de aplicaciones.
