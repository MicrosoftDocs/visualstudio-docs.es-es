...
## <a name="example"></a>Ejemplo
 El código siguiente genera esta advertencia porque la variable `i` solo se inicializa si `b` es true; de lo contrario, se devuelve un @no__t no inicializado:
