...
Una enumeración sin un @no__t aplicado-0 no define ningún miembro que tenga un valor de cero. O bien, una enumeración que tiene un @no__t aplicado-0 define un miembro que tiene un valor de cero pero su nombre no es ' none '. O bien, la enumeración define varios miembros de valor cero.
