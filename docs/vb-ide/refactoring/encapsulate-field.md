---
title: "Encapsular campo - refactorización (Visual Basic) | Documentos de Microsoft"
ms.custom: 
ms.date: 12/14/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="encapsulate-a-field-in-visual-basic"></a>Encapsular un campo en Visual Basic
