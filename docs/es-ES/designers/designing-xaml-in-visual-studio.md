...
Para obtener más información sobre el diseño XAML avanzado, consulte [Creación de una interfaz de usuario con Blend para Visual Studio](../designers/creating-a-ui-by-using-blend-for-visual-studio.md).
