...
Si elige ignorar una notificación, Visual Studio dejará de mostrarla. Si quiere restablecer la lista de notificaciones omitidas, haga clic en el botón **Configuración** en la Central de notificaciones.
