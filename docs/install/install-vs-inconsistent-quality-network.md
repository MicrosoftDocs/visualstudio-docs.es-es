...
- El nuevo modelo basado en la carga de trabajo significa menos instalaciones que con las versiones anteriores de Visual Studio.
...
Para crear un diseño local, abra un símbolo del sistema y use uno de los comandos de los ejemplos siguientes. En ellos se asume que ha descargado el programa de inicio de Visual Studio Community: ajuste el comando como sea adecuado para su edición.
