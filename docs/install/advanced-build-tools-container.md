...
description: Obtenga información sobre un ejemplo avanzado de contenedores de Docker. En el Dockerfile de este ejemplo se usa una etiqueta de versión específica de la imagen de microsoft/dotnet-framework.
...
>[!IMPORTANT]
> Visual Studio 2022 está actualmente en versión preliminar y no tiene [licencia](https://visualstudio.microsoft.com/license-terms/vs2022-prerelease/) para su uso en entornos de producción.
...
Después de que termine de ejecutarse la última línea, abra "%TEMP%\vslogs.zip" en el equipo o envíe un problema en el sitio web de la [comunidad de desarrolladores](https://aka.ms/feedback/suggest?space=8).
