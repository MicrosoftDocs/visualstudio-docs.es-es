...
Si no ve un tipo de archivo o proyecto que debería estar incluido aquí, vea la [versión de Visual Studio 2015 de este tema](https://msdn.microsoft.com/library/hh266747.aspx) y notifíquelo más abajo en los comentarios.
