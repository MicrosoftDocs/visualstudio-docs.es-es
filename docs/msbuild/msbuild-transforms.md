...
description: Obtenga información sobre cómo usa MSBuild las transformaciones, las conversiones una a una de una lista de elementos a otra, para compilar proyectos de forma más eficaz.
