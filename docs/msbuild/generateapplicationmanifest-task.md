...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - "GenerateApplicationManifest (tarea) [MSBuild]"
  - "HostInBrowser (propiedad) (MSBuild)"
  - "MSBuild, GenerateApplicationManifest (tarea)"
...
|`ErrorReportUrl`|Parámetro [String](assetId:///String?qualifyHint=False&autoUpgrade=True) opcional.<br /><br /> Especifica la dirección URL de la página web que se muestra en los cuadros de diálogo durante los informes de errores de las instalaciones ClickOnce.|  
...
|`HostInBrowser`|Parámetro [Boolean](assetId:///Boolean?qualifyHint=False&autoUpgrade=True) opcional.<br /><br /> Si es `true`, la aplicación se aloja en un explorador \(como las aplicaciones de explorador web de WPF\).|  
...
|`TargetFrameworkMoniker`|Parámetro assetId:///String?qualifyHint=False&autoUpgrade=True opcional.<br /><br /> Especifica el moniker de la versión de .NET Framework de destino.|  
|`TargetFrameworkProfile`|Parámetro assetId:///String?qualifyHint=False&autoUpgrade=True opcional.<br /><br /> Especifica el perfil de la versión de .NET Framework de destino.|  
|`TargetFrameworkSubset`|Parámetro assetId:///String?qualifyHint=False&autoUpgrade=True opcional.<br /><br /> Especifica el nombre del subconjunto de .NET Framework de destino.|  
|`TargetFrameworkVersion`|Parámetro assetId:///String?qualifyHint=False&autoUpgrade=True opcional.<br /><br /> Especifica la versión de .NET Framework de destino del proyecto.|  
...
|`UseApplicationTrust`|Parámetro assetId:///Boolean?qualifyHint=False&autoUpgrade=True opcional.<br /><br /> Si es true, las propiedades `Product`, `Publisher` y `SupportUrl` se escriben en el manifiesto de aplicación.|  
...
## Comentarios  
 ...
 Para obtener información acerca de cómo se utiliza la tarea `GenerateDeploymentManifest`, vea [GenerateApplicationManifest Task](../msbuild/generateapplicationmanifest-task.md).  
