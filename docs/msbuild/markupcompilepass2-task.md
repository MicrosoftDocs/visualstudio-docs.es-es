...
description: Obtenga información sobre cómo MSBuild usa la tarea MarkupCompilePass2 para realizar la compilación de marcado de segundo paso en archivos XAML que hacen referencia a los tipos del mismo proyecto.
