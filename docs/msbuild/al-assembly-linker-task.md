...
description: Use la tarea Assembly Linker (AL) de MSBuild para encapsular AL.exe, una herramienta que se distribuye con el kit de desarrollo de software de Windows.
