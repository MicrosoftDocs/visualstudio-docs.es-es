...
|`Condition`|Atributo opcional.<br /><br /> Condición que se va a evaluar. Para obtener más información, consulta [Condiciones](../msbuild/msbuild-conditions.md).|  
...
>   
>  Para solucionar este problema, coloque las importaciones condicionales en los archivos .targets o coloque código en un bloque condicional, como un bloque [Elemento Choose \(MSBuild\)](../msbuild/choose-element-msbuild.md).  
