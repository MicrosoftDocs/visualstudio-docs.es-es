...
description: Obtenga información sobre cómo establecer tareas de MSBuild seleccionadas a fin de ejecutarlas en el entorno de destino, independientemente del entorno del equipo de desarrollo.
