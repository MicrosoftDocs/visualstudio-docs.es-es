...
## Artículos de Knowledge Base  
 En Knowledge Base \(KB\), puede buscar en línea artículos sobre problemas con productos.  No todos los problemas tienen su correspondiente artículo de Knowledge Base, pero normalmente están documentados aquellos que han detectado un número significativo de clientes.  Puede obtener acceso a los artículos de Knowledge Base desde el sitio web [Knowledge Base \(resultados de la búsqueda de MSBuild\)](http://search.microsoft.com/supportresults.aspx?q=knowledge+base+MSBuild&x=0&y=0).  
