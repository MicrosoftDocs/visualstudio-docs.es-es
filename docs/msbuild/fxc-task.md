...
description: Obtenga información sobre los parámetros que la tarea FXC de MSBuild usa para los compiladores de sombreador de HLSL en el proceso de compilación.
