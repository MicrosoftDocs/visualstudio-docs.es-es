...
|`FullFrameworkFolders`|Parámetro <xref:System.String?displayProperty=fullName>`[]` opcional.<br /><br /> Especifica el conjunto de carpetas que contiene un directorio RedistList. Este directorio representa el marco de trabajo completo para un perfil de cliente determinado, por ejemplo, %programfiles%\reference assemblies\microsoft\framework\v4.0.|  
