...
description: Obtenga información sobre cómo MSBuild usa la tarea RegisterAssembly para leer los metadatos de un ensamblado especificado y agregar las entradas necesarias al registro.
