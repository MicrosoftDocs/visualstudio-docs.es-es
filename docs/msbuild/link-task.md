...
- **AdditionalManifestDependencies**
  ...
  Para obtener más información, vea [/MANIFESTDEPENDENCY (Especificar las dependencias del manifiesto)](/cpp/build/reference/manifestdependency-specify-manifest-dependencies). Vea también [Publisher configuration files](/windows/desktop/SbsCs/publisher-configuration-files) (Archivos de configuración del publicador).
