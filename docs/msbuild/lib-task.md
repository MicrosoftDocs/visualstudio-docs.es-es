...
|**AdditionalOptions**|Parámetro **String** opcional.<br /><br /> Una lista de opciones de lib.exe especificada en la línea de comando. Por ejemplo, **"***/option1 /option2 /option#*". Use este parámetro para especificar opciones de lib.exe que no están representadas por ningún otro parámetro de tarea **LIB**.<br /><br /> Para más información, vea [Ejecutar LIB](/cpp/build/reference/running-lib).|  
