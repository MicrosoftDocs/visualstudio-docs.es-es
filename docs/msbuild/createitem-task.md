...
description: Use la tarea CreateItem de MSBuild para rellenar colecciones de elementos con elementos de entrada, lo que permite que los elementos se copien de una lista a otra.
