...
description: En este tutorial, aprenderá a crear una aplicación de Node.js simple mediante el marco de trabajo web de la aplicación Express en Visual Studio.
ms.date: 03/25/2021
...
En este tutorial para el desarrollo de Visual Studio con Node.js y Express, se crea una sencilla aplicación web de Node.js, agregará código, explorará algunas características del IDE y ejecutará la aplicación. 
...
1. Agregue los paréntesis para convertirla en una llamada de función, `getData()`.
...
> [!div class="nextstepaction"]
> [Extensión del servicio de lenguaje AngularJS](https://devblogs.microsoft.com/visualstudio/angular-language-service-for-visual-studio)
