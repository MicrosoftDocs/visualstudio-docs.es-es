---
title: Administrar paquetes de npm en Visual Studio
...
Visual Studio facilita la interacción con npm y la emisión de comandos de npm a través de la interfaz de usuario, using o directly. Puede usar los siguientes métodos:
