...
1. [Siga las instrucciones](/visualstudio/ide/quickstart-nodejs?toc=/visualstudio/javascript/toc.json) para instalar la carga de trabajo de desarrollo de Node.js y el runtime de Node.js.
