...
description: Use la ventana orígenes de datos para enlazar una imagen de una base de datos a un control de la aplicación de Visual Studio.
ms.date: 11/04/2016
ms.topic: how-to
helpviewer_keywords:
