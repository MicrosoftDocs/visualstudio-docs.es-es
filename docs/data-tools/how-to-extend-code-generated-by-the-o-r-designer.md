...
ms.openlocfilehash: 17e79e03bac795c2c6162d6a277ee119d8175c3c
ms.contentlocale: es-es
ms.lasthandoff: 09/07/2017

---
# <a name="how-to-extend-code-generated-by-the-or-designer"></a>How to: Extend Code Generated by the O/R Designer
...
## <a name="adding-code-to-an-entity-class"></a>Adding Code to an Entity Class  
  
#### <a name="to-create-a-partial-class-and-add-code-to-an-entity-class"></a>To create a partial class and add code to an entity class  
...
## <a name="adding-code-to-a-datacontext"></a>Adding Code to a DataContext  
  
#### <a name="to-create-a-partial-class-and-add-code-to-a-datacontext"></a>To create a partial class and add code to a DataContext  
