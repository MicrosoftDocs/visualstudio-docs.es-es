...
5.  Use la **mostrar datos de tabla** de características en **Explorador de servidores** para tener acceso a la `Customers` datos y un registro de cambio de la tabla.
...
## <a name="create-a-new-project"></a>Crear un proyecto nuevo
 Primer paso del tutorial creando una nueva aplicación de Windows Forms.
...
1.  En el **datos** menú, elija **Agregar nuevo origen de datos**.
     ...
     El [Asistente para configuración de origen de datos](../data-tools/media/data-source-configuration-wizard.png) se abre.
...
### <a name="add-code-to-handle-the-concurrency-exception"></a>Agregue código para controlar la excepción de simultaneidad
 ...
 En esta sección, agregue código que intenta actualizar la base de datos. El usuario controle también cualquier <xref:System.Data.DBConcurrencyException> que puedan generarse, así como cualquier otra excepción.

> [!NOTE]
>  El `CreateMessage` y `ProcessDialogResults` se agregan métodos más adelante en este tutorial.
