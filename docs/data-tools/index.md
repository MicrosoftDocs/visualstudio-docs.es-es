        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Obtenga información sobre cómo diseñar, implementar y mantener bases de datos con SQL Server Data Tools</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p>Acceder a datos en Visual Studio</p>
                    </div>
                </div>
            </div>
        </div>
