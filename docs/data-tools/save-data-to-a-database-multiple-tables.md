...
-   Establecer los controles de los elementos de la [ventana Orígenes de datos](add-new-data-sources.md). Para obtener más información, consulte [establecer el control que se creará al arrastrar desde la ventana Orígenes de datos](../data-tools/set-the-control-to-be-created-when-dragging-from-the-data-sources-window.md).
