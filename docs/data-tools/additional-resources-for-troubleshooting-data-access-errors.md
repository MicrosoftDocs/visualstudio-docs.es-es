...
description: Busque ayuda para solucionar errores y advertencias en los foros públicos. Vea una lista de foros relacionados con los datos.
...
ms.locfileid: "112425654"
---
# <a name="troubleshoot-data-access-errors-on-the-forums"></a>Solución de errores de acceso a datos en los foros
...
- [Windows Forms controles de datos y enlace de datos](https://social.msdn.microsoft.com/Forums/windows/en-US/home?forum=winformsdatacontrols)

- [ADO.NET foro de DataSet](https://social.msdn.microsoft.com/Forums/en-US/home?forum=adodotnetdataset)

- [ADO.NET Entity Framework y LINQ to Entities](https://social.msdn.microsoft.com/Forums/en-US/home?forum=adodotnetentityframework)
...
- [LINQ to SQL foro](https://social.msdn.microsoft.com/Forums/en-US/home?forum=linqtosql)

- [ADO.NET foro de proveedores de datos](https://social.msdn.microsoft.com/Forums/en-US/home?forum=adodotnetdataproviders)

Para obtener información sobre cómo solucionar problemas de conectividad SQL Server, vea Solución de problemas de conexión al motor [de base de SQL Server de datos .](https://social.technet.microsoft.com/wiki/contents/articles/2102.how-to-troubleshoot-connecting-to-the-sql-server-database-engine.aspx)
