...
![Nivel intermedio de](../data-tools/media/ntiermid.png) componentes de nivel intermedio
...
![Capa de datos](../data-tools/media/ntierdatatier.png) de componentes de capa de datos
