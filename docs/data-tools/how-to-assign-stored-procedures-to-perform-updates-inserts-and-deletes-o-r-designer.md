...
ms.openlocfilehash: 43cc30e0eae7bb889cfd99710a9d2c364175b9f4
ms.contentlocale: es-es
ms.lasthandoff: 09/07/2017

---
# <a name="how-to-assign-stored-procedures-to-perform-updates-inserts-and-deletes-or-designer"></a>How to: Assign stored procedures to perform updates, inserts, and deletes (O/R Designer)
...
## <a name="configuring-the-update-behavior-of-an-entity-class"></a>Configuring the Update Behavior of an Entity Class  
...
#### <a name="to-assign-stored-procedures-to-override-the-default-behavior-of-an-entity-class"></a>To assign stored procedures to override the default behavior of an entity class  
