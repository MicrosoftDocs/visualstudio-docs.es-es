---
title: "Cómo: instalar ensamblados de interoperabilidad primarios de Office | Documentos de Microsoft"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
2.  Instale Microsoft Office y asegúrese de que el **compatibilidad con programación de .NET** característica está seleccionada para las aplicaciones que desee ampliar (esta característica se incluye en la instalación predeterminada).  
  
    > [!WARNING]  
    >  De forma predeterminada, los PIA se incrusta en la solución al compilarla, por lo que no es necesario distribuir PIA a los usuarios como requisito previo para usar el complemento de VSTO o personalización.  
