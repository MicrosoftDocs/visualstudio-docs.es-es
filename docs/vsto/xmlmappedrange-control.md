...
# XmlMappedRange (Control)
 ...
 ![vínculo a vídeo](../vsto/media/playvideo.png "vínculo a vídeo") Para obtener una demostración en vídeo relacionada, vea [How Do I: Use XML Mapping in Excel?](http://go.microsoft.com/fwlink/?LinkID=130288).  
