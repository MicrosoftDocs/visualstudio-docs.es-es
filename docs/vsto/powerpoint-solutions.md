...
# Soluciones de PowerPoint
 ...
 ![vínculo a vídeo](~/data-tools/media/playvideo.gif "vínculo a vídeo") Para ver una demostración en vídeo relacionada, consulte [Cómo: crear un complemento para Microsoft PowerPoint](http://go.microsoft.com/fwlink/?LinkId=132767).  
