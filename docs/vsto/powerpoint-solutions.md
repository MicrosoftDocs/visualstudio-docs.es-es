...
### <a name="primary-interop-assembly-reference"></a>Referencia de ensamblado de interoperabilidad primario  
 ...
 Para obtener más información sobre el diseño de los PIA de PowerPoint, como las diferencias entre las clases e interfaces en el PIA y cómo se implementan los eventos en los PIA, consulte [información general de las clases e interfaces de los ensamblados de interoperabilidad primarios de Office ](http://go.microsoft.com/fwlink/?LinkId=199885).  
