...
Para obtener información sobre cómo crear un archivo Windows Installer mediante [!INCLUDE[vs_dev10_long](../sharepoint/includes/vs-dev10-long-md.md)] , vea [implementar una solución de Visual Studio 2010 Tools para Office con Windows Installer](/previous-versions/visualstudio/visual-studio-2010/ff937654(v=msdn.10)).
...
## <a name="configure-a-vsto-add-in"></a><a name="ConfigureRegistry"></a>Configurar un complemento de VSTO
...
11. En el cuadro de diálogo de **Browse for a Destination File** (Buscar un archivo de destino), vaya al archivo **SetExcelDocumentProperties.Primary.output** y elija el botón **Abrir** .
    ...
    En los pasos siguientes, obtendrá el identificador de la solución del documento y, a continuación, pasará ese identificador como un parámetro a la aplicación de consola. También pasará la ubicación del documento, el manifiesto de implementación y el ensamblado del documento.
...
- [Implementar una solución de Visual Studio 2010 Tools para Office con Windows Installer](/previous-versions/visualstudio/visual-studio-2010/ff937654(v=msdn.10))