...
- [Decidir cómo desea conceder confianza a la solución](#Trust)

- [Ayudar a los usuarios a instalar la solución](#Helping)

- [Colocar el documento de una solución en el equipo del usuario final (solo en personalizaciones de nivel de documento)](#Put)

- [Colocar el documento de una solución en un servidor que ejecute SharePoint (solo personalizaciones de nivel de documento)](#SharePoint)
...
- [Reversión de una solución a una versión anterior](#Roll)

  Para obtener más información sobre cómo implementar una solución de Office mediante la creación de un archivo de Windows Installer, vea [implementar una solución de Office mediante Windows Installer](../vsto/deploying-an-office-solution-by-using-windows-installer.md).
...
8. En la lista **Elija los requisitos previos que se van a instalar** , active las casillas de **Windows Installer 4,5** y el paquete de .NET Framework adecuado.
    ...
    Por ejemplo, si la solución tiene como destino el [!INCLUDE[net_v45](../vsto/includes/net-v45-md.md)], active las casillas de **Windows Installer 4,5** y **Microsoft .NET Framework 4,5 Full**.
...
## <a name="Trust"></a>Decidir cómo desea conceder confianza a la solución
...
## <a name="Put"></a>Colocar el documento de una solución en el equipo del usuario final (solo en personalizaciones de nivel de documento)
...
8. Cambie el nombre de la clase a `FileCopyPDA` y reemplace el contenido del archivo con el código. Este código realiza las tareas siguientes:
   ...
   - Cambia la propiedad _ Assemblylocation de una ruta de acceso relativa a una ruta de acceso completa para el manifiesto de implementación.
...
10. En el cuadro de diálogo **Agregar elemento existente** , vaya al directorio de salida del proyecto **ExcelWorkbook** , elija el archivo **ExcelWorkbook. xlsx** y, a continuación, elija el botón **Agregar** .
...
1. En la carpeta **%userprofile%\Documents\Visual Studio 2013 \ Projects\ExcelWorkbook\ExcelWorkbook** , copie el archivo de certificado **ExcelWorkbook_TemporaryKey. pfx** y péguelo en la carpeta *carpetadepublicación* **\Application files \ ExcelWorkbook**\_carpeta _versiónpublicadamásreciente_

2. Abra el símbolo del sistema de Visual Studio y, a continuación, cambie los directorios a la carpeta **C:\publish\archivos excelworkbook**\__versiónpublicadamásreciente_ (por ejemplo, **c:\publish\archivos Files\ExcelWorkbook_1_0_0 _4**).
...
5. Copie el archivo *ExcelWorkbook. VSTO* en el directorio **C:\publish\archivos ExcelWorkbook**\__versiónpublicadamásreciente_ .

## <a name="SharePoint"></a>Colocar el documento de una solución en un servidor que ejecute SharePoint (solo personalizaciones de nivel de documento)
 ...
 *%COMMONPROGRAMFILES%\Microsoft shared\VSTO\10.0\VSTOInstaller.exe*
 ...
 Si la herramienta no está en esa ubicación, puede usar el registro **HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\VSTO en** tiempo de ejecución de Setup\v4\InstallerPath o **HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\VSTO Runtime Setup\v4\InstallerPath** clave para encontrar la ruta de acceso a esa herramienta.
...
|-100|Una o más opciones de la línea de comandos no son válidas o se establecieron más de una vez. Para obtener más información, escriba "VSTOInstaller/?". o vea [crear un instalador personalizado para una solución de Office ClickOnce](https://msdn.microsoft.com/3e5887ed-155f-485d-b8f6-3c02c074085e).|
...
2. Ejecute el programa de instalación e incluya el parámetro `/url`, que toma la nueva ruta de instalación como una cadena.
   ...
   En el caso de las personalizaciones de nivel de documento, los usuarios deben abrir el documento y, a continuación, actualizar su propiedad _ Assemblylocation. Los pasos siguientes describen cómo los usuarios pueden realizar esta tarea.
...
3. En la pestaña **personalizado** de la lista **propiedades** , elija _ assemblylocation, tal como se muestra en la siguiente ilustración.

     ![La propiedad AssemblyLocation.](../vsto/media/vsto-assemblylocationproperty.png "Propiedad AssemblyLocation.")

     El cuadro **valor** contiene el identificador del manifiesto de implementación.

4. Antes del identificador, escriba la ruta de acceso completa del documento, seguida de una barra, en la ruta de *acceso* de formato|*identificador* (por ejemplo, *File://servername/FolderName/FILENAME|74744e4b-e4d6-41eb-84f7-ad20346fe2d9*.
...
## <a name="Roll"></a>Reversión de una solución a una versión anterior
...
- [Cómo: instalar una solución de Office ClickOnce](https://msdn.microsoft.com/14702f48-9161-4190-994c-78211fe18065)
...
- [Crear un instalador personalizado para una solución de Office ClickOnce](https://msdn.microsoft.com/3e5887ed-155f-485d-b8f6-3c02c074085e)