---
title: Trabajar con contactos | Documentos de Microsoft
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="working-with-contact-items"></a>Trabajar con contactos
...
|Buscar contactos cuya dirección de correo electrónico contenga un dominio específico.|[Cómo: Buscar una dirección de correo en los contactos mediante programación](../vsto/how-to-programmatically-search-for-an-e-mail-address-in-contacts.md)|  
