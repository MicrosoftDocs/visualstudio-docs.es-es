...
# <a name="how-to-remove-managed-code-extensions-from-documents"></a>Cómo: quitar extensiones de código administrado de documentos
 ...
 ![vínculo a vídeo](../vsto/media/playvideo.gif "vínculo al vídeo") para una demostración en vídeo relacionada, vea [cómo hacer lo hago?: asociar o desasociar un ensamblado de VSTO desde un documento de Word?](http://go.microsoft.com/fwlink/?LinkId=136782).  
...
## <a name="see-also"></a>Vea también  
 ...
 [Cómo: adjuntar administrado extensiones a los documentos de código](../vsto/how-to-attach-managed-code-extensions-to-documents.md)  
