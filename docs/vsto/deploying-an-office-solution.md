...
description: Puede implementar soluciones de Office mediante ClickOnce o Windows Installer. Con ClickOnce, se reduce el número de pasos que requiere la implementación de la solución.
