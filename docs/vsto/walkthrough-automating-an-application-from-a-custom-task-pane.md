---
title: 'Tutorial: Automatización de una aplicación desde un panel de tareas personalizado'
...
ms.locfileid: "107824671"
---
# <a name="walkthrough-automate-an-application-from-a-custom-task-pane"></a>Tutorial: Automatización de una aplicación desde un panel de tareas personalizado
...
## <a name="create-the-add-in-project"></a>Creación del proyecto de complemento
...
## <a name="automate-powerpoint-from-the-custom-task-pane"></a>Automatización de PowerPoint desde el panel de tareas personalizado
...
2. Agregue el código siguiente en la parte superior del archivo. Este código crea alias para los espacios <xref:Microsoft.Office.Core> de nombres y de [PowerPoint.](/previous-versions/office/developer/office-2010/ff763170%28v%3doffice.14%29)
...
3. Agregue el siguiente código a la clase `MyUserControl` . Este código declara un [objeto Shape](/previous-versions/office/developer/office-2010/ff760244(v=office.14)) como miembro de `MyUserControl` . En el paso siguiente, usará esta forma [para](/previous-versions/office/developer/office-2010/ff760244(v=office.14)) agregar un cuadro de texto a una diapositiva en la presentación activa.
...
3. Agregue el siguiente código a la clase `ThisAddIn` . Este código declara instancias de `MyUserControl` y <xref:Microsoft.Office.Tools.CustomTaskPane> como miembros de la clase `ThisAddIn` .
...
- Crear un botón de la cinta de opciones que se pueda usar para ocultar o mostrar un panel de tareas personalizado. Para obtener más información, vea [Tutorial: Sincronizar un panel de tareas personalizado con un botón de cinta de opciones](../vsto/walkthrough-synchronizing-a-custom-task-pane-with-a-ribbon-button.md).
