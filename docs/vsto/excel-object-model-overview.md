...
-   <xref:Microsoft.Office.Interop.Excel.Range>  
 ...
 ![vínculo a vídeo](~/docs/data-tools/media/playvideo.gif "vínculo a vídeo") Puede ver una demostración en vídeo relacionada en estas dos páginas sobre [cómo usar los controladores de eventos en un complemento de Excel 2007](http://go.microsoft.com/fwlink/?LinkID=130291) y [cómo usar las formas para crear un gráfico de burbujas en Excel](http://go.microsoft.com/fwlink/?LinkID=130313).  
