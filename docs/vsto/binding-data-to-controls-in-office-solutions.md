...
# <a name="bind-data-to-controls-in-office-solutions"></a>Enlazar datos a controles en soluciones de Office
 ...
 ![vínculo a vídeo](../vsto/media/playvideo.gif "vínculo al vídeo") para una demostración en vídeo relacionada, vea [¿Cómo: consumir datos de base de datos en Excel?](http://go.microsoft.com/fwlink/?LinkID=130287).  
