---
title: Enlazar datos a controles en soluciones de Office | Documentos de Microsoft
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
---
# <a name="binding-data-to-controls-in-office-solutions"></a>Enlazar datos a controles en soluciones de Office
 ...
 Los controles host extienden objetos que están en los modelos de objetos de Word y Excel, como los controles de contenido de Word y los intervalos con nombre en Excel. Para obtener más información, consulta [Host Items and Host Controls Overview](../vsto/host-items-and-host-controls-overview.md).  
  
 Los controles de Windows Forms y host utilizan el modelo de enlace de datos de Windows Forms, que admite tanto *enlace de datos simple* como *enlace de datos complejo* a orígenes de datos como conjuntos de datos y tablas de datos. Para obtener información completa sobre el modelo de enlace de datos en formularios Windows Forms, vea [enlace de datos y formularios Windows Forms](/dotnet/framework/winforms/data-binding-and-windows-forms).  
  
 ![vínculo a vídeo](../vsto/media/playvideo.gif "vínculo a vídeo") para una demostración en vídeo relacionada, vea [Cómo: usar base de datos de datos en Excel?](http://go.microsoft.com/fwlink/?LinkID=130287).  
...
## <a name="simple-data-binding"></a>enlace de datos simple  
 ...
 Para realizar el enlace de datos simple a un control host, agregue un <xref:System.Windows.Forms.Binding> a la propiedad de enlaces de datos del control. Un objeto <xref:System.Windows.Forms.Binding> representa el enlace simple entre un valor de propiedad del control y el valor de un elemento de datos.  
...
## <a name="complex-data-binding"></a>enlace de datos complejo  
 ...
 Para realizar el enlace de datos complejo, establezca la propiedad de origen de datos del control a un objeto de origen de datos que sea compatible con el enlace de datos complejo. Por ejemplo, la propiedad <xref:Microsoft.Office.Tools.Excel.ListObject.DataSource%2A> del control <xref:Microsoft.Office.Tools.Excel.ListObject> puede estar enlazada a varias columnas de una tabla de datos. Todos los datos de la tabla de datos aparecen en el control <xref:Microsoft.Office.Tools.Excel.ListObject> y, como los datos de la tabla de datos cambian, el elemento <xref:Microsoft.Office.Tools.Excel.ListObject> también cambia. Para obtener una lista de los orígenes de datos que puede usar para el enlace de datos complejo, vea [Data Sources Supported by Windows Forms](/dotnet/framework/winforms/data-sources-supported-by-windows-forms).  
 ...
 Para ver tutoriales que muestran el enlace de datos complejo, consulte [Tutorial: enlace de datos complejo en un proyecto de nivel de documento](../vsto/walkthrough-complex-data-binding-in-a-document-level-project.md) para un proyecto de nivel de documento y [Tutorial: enlace de datos complejo en VSTO agregar en el proyecto ](../vsto/walkthrough-complex-data-binding-in-vsto-add-in-project.md) para un proyecto de complemento de VSTO.  
  
## <a name="displaying-data-in-documents-and-workbooks"></a>Visualización de datos en documentos y libros  
 En los proyectos de nivel de documento, puede utilizar la ventana **Orígenes de datos** para agregar controles enlazados a datos a los documentos o libros con facilidad, del mismo modo que los usa para Windows Forms. Para obtener más información sobre el uso de la **orígenes de datos** ventana, consulte [enlazar controles formularios Windows Forms a datos en Visual Studio](../data-tools/bind-windows-forms-controls-to-data-in-visual-studio.md) y [agregar nuevos orígenes de datos](../data-tools/add-new-data-sources.md).  
  
### <a name="dragging-controls-from-the-data-sources-window"></a>Arrastrar controles desde la ventana Orígenes de datos  
...
### <a name="binding-data-in-document-level-projects-at-design-time"></a>Enlace de datos en proyectos de nivel de documento en tiempo de diseño  
...
### <a name="binding-data-in-vsto-add-in-projects"></a>Enlace de datos en proyectos de complemento de VSTO  
...
## <a name="updating-data-that-is-bound-to-host-controls"></a>Actualización de datos que están enlazados a controles host  
 ...
 Para obtener más información, consulte [Cómo: Actualizar un origen de datos con datos de un control Host](../vsto/how-to-update-a-data-source-with-data-from-a-host-control.md).  
...
## <a name="see-also"></a>Vea también  
 ...
 [Creación de un control con enlace simple en Windows Forms](/dotnet/framework/winforms/how-to-create-a-simple-bound-control-on-a-windows-form)   
