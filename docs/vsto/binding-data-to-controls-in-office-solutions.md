...
# <a name="bind-data-to-controls-in-office-solutions"></a>Enlazar datos a controles en soluciones de Office
 ...
 ![vínculo a vídeo](../vsto/media/playvideo.gif "vínculo a vídeo") para una demostración en vídeo relacionada, vea [¿Cómo: consumir datos de base de datos en Excel?](http://go.microsoft.com/fwlink/?LinkID=130287).  
...
## <a name="complex-data-binding"></a>Enlace de datos complejo  
 ...
 Para realizar el enlace de datos complejo, establezca la `DataSource` propiedad del control a un objeto de origen de datos que sea compatible con el enlace de datos complejo. Por ejemplo, la propiedad <xref:Microsoft.Office.Tools.Excel.ListObject.DataSource%2A> del control <xref:Microsoft.Office.Tools.Excel.ListObject> puede estar enlazada a varias columnas de una tabla de datos. Todos los datos de la tabla de datos aparecen en el control <xref:Microsoft.Office.Tools.Excel.ListObject> y, como los datos de la tabla de datos cambian, el elemento <xref:Microsoft.Office.Tools.Excel.ListObject> también cambia. Para obtener una lista de los orígenes de datos que puede usar para el enlace de datos complejo, consulte [orígenes de datos compatibles con formularios Windows Forms](/dotnet/framework/winforms/data-sources-supported-by-windows-forms).  
...
### <a name="drag-controls-from-the-data-sources-window"></a>Arrastre controles desde la ventana de orígenes de datos  
...
### <a name="bind-data-in-vsto-add-in-projects"></a>Enlazar datos en proyectos de complemento de VSTO  
 En proyectos de complemento de VSTO, puede agregar controles en tiempo de ejecución. Los temas siguientes muestran ejemplos de enlace de datos en tiempo de ejecución:  
...
## <a name="see-also"></a>Vea también  
 ...
 [Enlace de datos y formularios Windows Forms](/dotnet/framework/winforms/data-binding-and-windows-forms)   
 [Cómo: crear un control con enlace simple en un formulario Windows Forms](/dotnet/framework/winforms/how-to-create-a-simple-bound-control-on-a-windows-form)   
