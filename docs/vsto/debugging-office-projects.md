...
## <a name="display-exceptions"></a>Mostrar excepciones  
 ...
 De forma predeterminada, Visual Studio tampoco muestra errores de depuración de Just-In-Time para proyectos de Office. Sin embargo, puede habilitar esta característica para ver los errores que se produzcan. Para obtener más información, consulte [en Visual Studio la depuración Just-In-Time](/visualstudio/debugger/just-in-time-debugging-in-visual-studio).  
