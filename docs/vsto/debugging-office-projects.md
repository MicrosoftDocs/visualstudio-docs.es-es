...
## <a name="display-exceptions"></a>Mostrar excepciones  
 ...
 De forma predeterminada, Visual Studio tampoco muestra errores de depuración de Just-In-Time para proyectos de Office. Sin embargo, puede habilitar esta característica para ver los errores que se produzcan. Para obtener más información, consulte [depurar en Visual Studio Just-In-Time](/visualstudio/debugger/just-in-time-debugging-in-visual-studio).  
...
## <a name="debug-cached-datasets-in-a-document-level-project"></a>Depurar conjuntos de datos almacenados en caché en un proyecto de nivel de documento  
...
## <a name="troubleshoot-installation-errors-by-using-the-event-viewer"></a>Solucionar problemas de errores de instalación mediante el Visor de eventos  
...
## <a name="troubleshoot-startup-errors-by-using-a-log-file-and-error-messages"></a>Solucionar problemas de errores de inicio mediante un mensajes de error y el archivo de registro  
