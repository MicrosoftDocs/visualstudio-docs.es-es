...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "documentos [desarrollo de Office en Visual Studio], texto"
  - "documentos de Office [desarrollo de Office en Visual Studio], texto"
  - "texto [desarrollo de Office en Visual Studio]"
  - "Word [desarrollo de Office en Visual Studio], texto"
...
|Hacer que un intervalo sea mayor o menor.|[Cómo: ampliar rangos en documentos mediante programación](../vsto/how-to-programmatically-extend-ranges-in-documents.md)|  
