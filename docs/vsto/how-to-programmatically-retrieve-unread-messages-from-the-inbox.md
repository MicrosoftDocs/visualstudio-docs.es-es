---
title: Obtener mensajes no leídos de la Bandeja de entrada mediante programación
description: Obtenga información sobre cómo puede usar Visual Studio recuperar mediante programación mensajes no leídos de la Bandeja de entrada en Microsoft Outlook.
...
ms.locfileid: "107823954"
---
# <a name="how-to-programmatically-retrieve-unread-messages-from-the-inbox"></a>Cómo: Recuperar mensajes no leídos de la Bandeja de entrada mediante programación
  En este ejemplo se recuperan los mensajes de correo electrónico no leídos de la bandeja de entrada **de** Outlook y se muestra el número de elementos.
