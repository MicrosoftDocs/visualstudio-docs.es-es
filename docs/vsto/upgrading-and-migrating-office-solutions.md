...
description: Debe actualizar el proyecto para usarlo en las versiones actuales de Visual Studio si tiene un proyecto Offince que se creó en una versión anterior de Visual Studio.
