---
description: El elemento entryPointsCollection del espacio de nombres vstav3 contiene todos los elementos entryPoints asociados a las soluciones de Office.
...
### <a name="entrypoints"></a>entryPoints
 Obligatorio. El rol del `entryPoints` elemento en el `vstav3` espacio de nombres se define en [&#60;elemento&#62; entryPoints &#40;el desarrollo de Office en Visual Studio&#41;](../vsto/entrypoints-element-office-development-in-visual-studio.md).
