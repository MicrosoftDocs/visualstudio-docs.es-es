...
description: El modelo de objetos de Word consta de clases e interfaces que se proporcionan en el ensamblado de interoperabilidad primario de Word y que se definen en el espacio de nombres de Word.
