...
##  <a name="applevel"></a> Desarrollar complementos de VSTO para Excel  
 ...
 ![vínculo a vídeo](~/docs/data-tools/media/playvideo.gif "vínculo a vídeo") Para ver una demostración en vídeo relacionada con el tema, consulte [Cómo automatizar PowerPoint desde un complemento de Excel](http://go.microsoft.com/fwlink/?LinkID=130300).  
