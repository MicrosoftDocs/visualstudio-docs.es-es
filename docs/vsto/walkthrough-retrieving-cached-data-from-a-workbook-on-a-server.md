---
title: 'Tutorial: Recuperar datos en caché de un libro en un servidor'
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "54867434"
---
# <a name="walkthrough-retrieve-cached-data-from-a-workbook-on-a-server"></a>Tutorial: Recuperar datos en caché de un libro en un servidor
