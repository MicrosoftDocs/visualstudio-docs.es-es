...
#### <a name="to-add-or-remove-controls-when-the-user-clicks-the-check-boxes-on-the-ribbon"></a>Para agregar y quitar controles cuando el usuario hace clic en las casillas en la cinta de opciones  
