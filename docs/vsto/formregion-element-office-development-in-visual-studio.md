...
|---------------|-----------------|
|`name`|Necesario. Identifica el nombre del área de formulario.|
...
|Atributo|Descripción|
|---------------|-----------------|
|`name`|Necesario. Identifica el formulario asociado a este área de formulario.|
