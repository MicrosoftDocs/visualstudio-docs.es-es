---
title: 'Tutorial: Crear el primer complemento VSTO para Word | Documentos de Microsoft'
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
-   Compilar y depurar los complementos VSTO para Word: [compilar soluciones de Office](../vsto/building-office-solutions.md).  
