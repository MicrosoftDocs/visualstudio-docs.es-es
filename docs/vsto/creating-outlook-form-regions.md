...
## <a name="Enhance"></a>Ventajas del uso de áreas de formulario
...
## <a name="UsingFormRegionDesignedOutlook"></a>Importar un área de formulario diseñada en Outlook
 ...
 Para controlar eventos en un proyecto de C#, suscríbase a los eventos de control en el método <xref:Microsoft.Office.Tools.Outlook.FormRegionControl.FormRegionShowing>. Para obtener más información, vea [Cómo: Suscríbase &#40;a la guía&#35; &#41;](/dotnet/csharp/programming-guide/events/how-to-subscribe-to-and-unsubscribe-from-events)de programación de eventos C y cancele la suscripción.
...
### <a name="HandlingFormRegionEvents"></a>Controlar eventos del área de formulario
...
|evento|Descripción|
|-----------|-----------------|
|FormRegionInitializing|Se produce antes de inicializarse el área de formulario. Puede comprobar las condiciones de este controlador de eventos para determinar si Outlook debe mostrar el área de formulario. Para obtener más información, vea [Cómo: Impedir que Outlook muestre un área](../vsto/how-to-prevent-outlook-from-displaying-a-form-region.md)de formulario.|
