...
-   Microsoft [!INCLUDE[Outlook_15_short](../vsto/includes/outlook-15-short-md.md)] o Microsoft Outlook 2010.  
 ...
 ![vínculo a vídeo](~/data-tools/media/playvideo.gif "vínculo a vídeo") Para una demostración en vídeo relacionada, vea [Cómo usar paneles de tareas en Outlook](http://go.microsoft.com/fwlink/?LinkID=130309).  
