---
title: Filtrar Asignar columnas ListObject a datos
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "56639900"
---
# <a name="how-to-map-listobject-columns-to-data"></a>Filtrar Asignar columnas ListObject a datos
