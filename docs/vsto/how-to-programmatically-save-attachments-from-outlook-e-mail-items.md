---
title: "C&#243;mo: Guardar datos adjuntos de elementos de correo electr&#243;nico de Outlook mediante programaci&#243;n | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Outlook [desarrollo de Office en Visual Studio], datos adjuntos"
  - "correo electrónico [desarrollo de Office en Visual Studio], datos adjuntos"
  - "guardar datos adjuntos de correo electrónico"
  - "elementos de correo electrónico [desarrollo de Office en Visual Studio], datos adjuntos"
  - "datos adjuntos [desarrollo de Office en Visual Studio]"
...
> [!IMPORTANT]  
>  Este ejemplo solo funciona si se agrega una carpeta denominada **TestFileSave** en la raíz del directorio C.  
