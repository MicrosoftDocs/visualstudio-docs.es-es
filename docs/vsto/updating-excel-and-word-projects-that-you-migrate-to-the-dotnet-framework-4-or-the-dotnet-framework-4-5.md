...
description: Debe modificar el código si la versión de .NET Framework de destino se cambia a la .NET Framework 4 o posterior cuando tiene un proyecto de Excel o Word que usa características específicas.
