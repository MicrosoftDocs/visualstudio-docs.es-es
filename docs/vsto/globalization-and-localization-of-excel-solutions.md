---
title: Globalización y localización de soluciones de Excel
description: Obtenga información sobre las consideraciones especiales Microsoft Office soluciones de Excel que se ejecutarán en equipos que tengan una configuración que no esté en inglés para Windows.
...
## <a name="format-data-in-excel-with-various-regional-settings"></a>Dar formato a los datos en Excel con varias configuraciones regionales
...
### <a name="understand-how-the-excel-object-model-always-expects-locale-id-1033"></a>Comprender cómo el modelo de objetos de Excel siempre espera el identificador de configuración regional 1033
...
## <a name="localize-document-text"></a>Localización del texto del documento
...
### <a name="text-direction"></a>Dirección del texto
 En Excel, puede establecer una propiedad de la hoja de cálculo para representar el texto de derecha a izquierda. Los controles host, o cualquier control que tenga una propiedad , que se coloca en el diseñador coinciden automáticamente con `RightToLeft` esta configuración en tiempo de ejecución. Word no tiene una configuración de documento para el texto bidireccional (solo cambia la alineación del texto), por lo que los controles no se pueden asignar a esta configuración. En su lugar, debe establecer la alineación del texto para cada control. Es posible escribir código para recorrer todos los controles y hacer que representen el texto de derecha a izquierda.
...
## <a name="install-the-language-packs"></a>Instalación de los paquetes de idioma
 ...
 Además, los paquetes de idioma de .NET Framework redistribuibles son necesarios para mensajes de ClickOnce. Los .NET Framework de idioma están disponibles en el Centro [de descarga de Microsoft](https://www.microsoft.com/download).
...
### <a name="excel-worksheet-functions"></a>Funciones de hoja de cálculo de Excel
 Los nombres de función de hoja de cálculo se traducen internamente para la mayoría de las versiones de idioma de Excel. Sin embargo, debido a posibles problemas de lenguaje y interoperabilidad COM, se recomienda usar solo nombres de función en inglés en el código.
...
- [Cómo: Dirigirse a la interfaz de usuario multilingüe de Office](../vsto/how-to-target-the-office-multilingual-user-interface.md)
