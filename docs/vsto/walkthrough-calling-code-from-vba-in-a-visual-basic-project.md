...
helpviewer_keywords: 
  ...
  - "ThisDocument (clase)"
  - "Word [desarrollo de Office en Visual Studio], código de llamada desde VBA"
  - "Visual Basic [desarrollo de Office en Visual Studio], código de llamada desde VBA"
  - "VBA [desarrollo de Office en Visual Studio], código de llamada en personalizaciones de nivel de documento"
  - "Documentos de Office [desarrollo de Office en Visual Studio, Visual Basic para aplicaciones y"
  - "llamar a código desde VBA"
  - "personalizaciones de nivel de documento [desarrollo de Office en Visual Studio], código de llamada"
...
-   Llamar a código en una personalización de Visual C\# desde VBA. Este proceso es diferente del proceso de Visual Basic. Para obtener más información, consulta [Tutorial: llamar a código desde VBA en un proyecto de Visual C&#35;](../vsto/walkthrough-calling-code-from-vba-in-a-visual-csharp-project.md).  
  
-   Llamar a código en un complemento de VSTO desde VBA. Para obtener más información, consulta [Tutorial: Llamar a código en un complemento de VSTO desde VBA](../vsto/walkthrough-calling-code-in-a-vsto-add-in-from-vba.md).  
