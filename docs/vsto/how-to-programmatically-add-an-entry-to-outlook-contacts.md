---
title: "Cómo: agregar una entrada mediante programación a los contactos de Outlook | Documentos de Microsoft"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="how-to-programmatically-add-an-entry-to-outlook-contacts"></a>Cómo: Agregar una entrada a los contactos de Outlook mediante programación
  Este ejemplo crea un nuevo contacto y escribe datos en el nuevo contacto.  
...
## <a name="see-also"></a>Vea también  
 ...
 [Cómo: Buscar una dirección de correo en los contactos mediante programación](../vsto/how-to-programmatically-search-for-an-e-mail-address-in-contacts.md)  
