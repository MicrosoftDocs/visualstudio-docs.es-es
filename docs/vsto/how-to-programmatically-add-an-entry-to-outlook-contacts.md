...
ms.openlocfilehash: 64112f235b08c734641a2653376b2cf02bd7e431
ms.contentlocale: es-es
ms.lasthandoff: 08/30/2017

---
# <a name="how-to-programmatically-add-an-entry-to-outlook-contacts"></a>How to: Programmatically Add an Entry to Outlook Contacts
  This example creates a new contact and enters data into the new contact.  
  
 [!INCLUDE[appliesto_olkallapp](../vsto/includes/appliesto-olkallapp-md.md)]  
  
## <a name="example"></a>Example  
 [!code-vb[Trin_OL_AddContact#1](../vsto/codesnippet/VisualBasic/Trin_OL_AddContact/thisaddin.vb#1)] [!code-csharp[Trin_OL_AddContact#1](../vsto/codesnippet/CSharp/Trin_OL_AddContact/thisaddin.cs#1)]  
