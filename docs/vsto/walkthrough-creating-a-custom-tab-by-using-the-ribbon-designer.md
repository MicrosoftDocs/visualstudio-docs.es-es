...
- Cree un proyecto de libro de Excel con el nombre **MyExcelRibbon**. Para obtener más información, vea [Cómo: Cree proyectos de Office en Visual](../vsto/how-to-create-office-projects-in-visual-studio.md)Studio.
...
## <a name="BKMK_CreateCustomTab"></a>Crear una pestaña personalizada
...
## <a name="BKMK_HideShowActionsPane"></a>Ocultar y Mostrar paneles de acciones con los botones de la pestaña personalizada
