...
4.  Junto a la propiedad **\(Avanzado\)**, haga clic en el botón de puntos suspensivos \(![Captura de pantalla de VisualStudioEllipsesButton](~/docs/vsto/media/vbellipsesbutton.png "Captura de pantalla de VisualStudioEllipsesButton")\).  
