...
4.  En la ventana **Propiedades**, seleccione la propiedad **Fichas** y, a continuación, haga clic en el botón de puntos suspensivos \(![Elipse del Diseñador de ASP.NET Mobile](~/sharepoint/media/mwellipsis.gif "Elipse del Diseñador de ASP.NET Mobile")\).  
