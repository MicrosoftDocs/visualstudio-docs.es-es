---
title: Tutoriales para Word | Documentos de Microsoft
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
## <a name="document-level-walkthroughs"></a>Tutoriales de nivel de documento  
 ...
 Muestra cómo crear una personalización básica de nivel de documento para Word.  
 ...
 Muestra cómo agregar texto a un documento de Word cuando los usuarios escriben texto en los controles de un panel de acciones.  
 ...
 Muestra cómo enlazar datos a los controles en un panel de acciones. Los controles muestran una relación principal-detalle entre las tablas de una base de datos de SQL Server.  
 ...
 Muestra cómo usar las casillas de verificación en un documento de Word para cambiar el formato.  
  
 [Tutorial: Mostrar texto en un cuadro de texto en un documento mediante un botón](../vsto/walkthrough-displaying-text-in-a-text-box-in-a-document-using-a-button.md)  
 Muestra cómo usar los botones y cuadros de texto en documentos de Word.  
  
 [Tutorial: Actualización de un gráfico en un documento mediante botones de radio](../vsto/walkthrough-updating-a-chart-in-a-document-using-radio-buttons.md)  
 ...
 [Tutorial: Creación de menús contextuales para marcadores](../vsto/walkthrough-creating-shortcut-menus-for-bookmarks.md)  
 Muestra cómo crear un menú contextual que se puede usar para dar formato al texto en un marcador.  
 ...
 Muestra cómo llamar al código en un ensamblado de personalización desde código de VBA en el documento.  
 ...
 Muestra cómo usar los controles de contenido para crear contenido estructurado y reutilizable en una plantilla de Word.  
...
## <a name="application-level-walkthroughs"></a>Tutoriales de nivel de aplicación  
 ...
 Muestra cómo crear un complemento básico de VSTO para Word.  
  
 [Tutorial: Agregar controles a un documento en tiempo de ejecución en un complemento VSTO](../vsto/walkthrough-adding-controls-to-a-document-at-run-time-in-a-vsto-add-in.md)  
 ...
 Muestra cómo crear una pestaña personalizada de la cinta de opciones mediante un archivo de descriptor XML en un complemento de VSTO.  
