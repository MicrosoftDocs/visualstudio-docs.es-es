...
[!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)] proporciona la capacidad de depurar flujos de trabajo y personalizar actividades. El proceso y comportamiento son similares a los del depurador [!INCLUDE[vs2010](../misc/includes/vs2010_md.md)] predeterminado. Los temas en esta sección describen cómo efectuar procedimientos de depuración tradicionales así como depurar código XAML y expresiones.  
