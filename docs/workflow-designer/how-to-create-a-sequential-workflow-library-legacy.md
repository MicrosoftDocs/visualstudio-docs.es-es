---
title: 'Diseñador de flujo de trabajo: Cómo: crear una biblioteca de flujos de trabajo secuenciales (heredado)'
ms.date: 11/04/2016
ms.topic: conceptual
