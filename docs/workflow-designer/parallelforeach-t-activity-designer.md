...
description: Obtenga información sobre cómo la <T> actividad ParallelForEach enumera los elementos de una colección y ejecuta una instrucción incrustada para cada elemento de la colección en paralelo.
