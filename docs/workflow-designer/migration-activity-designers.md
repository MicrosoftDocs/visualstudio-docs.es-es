...
Los diseñadores de actividad de migración se utilizan para llamar 3.0/3.5 actividades de flujo de trabajo desde un flujo de trabajo como destino .NET Framework 4. Los temas contenidos en esta sección proporcionan instrucciones sobre cómo utilizar los diseñadores de actividad del Diseñador de flujo de trabajo.
