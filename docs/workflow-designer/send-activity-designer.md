...
Como alternativa, el diseñador de plantillas **SendAndReceiveReply** en la categoría **Mensajería** del **cuadro de herramientas** se puede usar para crear un par de actividades y configuradas previamente <xref:System.ServiceModel.Activities.Send> <xref:System.ServiceModel.Activities.ReceiveReply> . Para obtener más información sobre el uso de las plantillas **SendAndReceiveReply** y **ReceiveReplyForSend** , vea el tema [SendAndReceiveReply](../workflow-designer/sendandreceivereply-template-designer.md) .
