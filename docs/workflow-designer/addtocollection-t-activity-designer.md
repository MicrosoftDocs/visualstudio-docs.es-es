...
ms.locfileid: "76115327"
---
# <a name="addtocollectiont-activity-designer"></a>Diseñador de actividades de AddToCollection\<T >

El diseñador de actividades **AddToCollection\<t >** se usa para crear y configurar una actividad <xref:System.Activities.Statements.AddToCollection%601>.

## <a name="the-addtocollectiont-activity"></a>Actividad de > AddToCollection\<T
...
- [Diseñador de actividades de AddToCollection\<T >](../workflow-designer/addtocollection-t-activity-designer.md)
