...
description: Obtenga información sobre cómo puede usar la plantilla SendAndReceiveReply para crear un par de actividades de envío y ReceiveReply preconfiguradas.
