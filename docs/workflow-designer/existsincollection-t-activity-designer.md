...
description: Obtenga información sobre cómo puede usar el <T> Diseñador de actividades ExistsInCollection para crear y configurar una <T> actividad ExistsInCollection.
