...
Esta sección contiene temas de Ayuda contextual para [!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)] heredado en [!INCLUDE[vs2010](../misc/includes/vs2010_md.md)]. Use el diseñador heredado cuando deba tener como destino [!INCLUDE[netfx35_long](../workflow-designer/includes/netfx35_long_md.md)] o [!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)].  
  
 Puede tener acceso a estos temas desde la [!INCLUDE[vs_current_long](../misc/includes/vs_current_long_md.md)] interfaz de usuario presionando **F1** cuando heredado [!INCLUDE[wfd2](../workflow-designer/includes/wfd2_md.md)] cuadro de diálogo está abierto.  
