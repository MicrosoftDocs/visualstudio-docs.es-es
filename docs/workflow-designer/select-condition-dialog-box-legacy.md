---
title: "Seleccione el cuadro de diálogo de condición (heredado) | Documentos de Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|**Cambiar el nombre de...**|Haga clic en esta opción para abrir un cuadro de diálogo usado para cambiar el nombre de la condición seleccionada.|  
