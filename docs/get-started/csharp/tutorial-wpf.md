...
Cuando inicie Visual Studio por primera vez, se le pedirá que inicie sesión. Este paso es opcional en este tutorial. Después, probablemente aparezca un cuadro de diálogo que le pide que elija la configuración de desarrollo y el tema de color. Mantenga los valores predeterminados y elija **Iniciar Visual Studio**.
...
1. Cree un nuevo proyecto. En la barra de menús, seleccione **Archivo** > **Nuevo** > **Proyecto**.
     ...
     ::: moniker-end
     ::: moniker range=">=vs-2019"
     [En la barra de menús, seleccione Archivo, Nuevo, Proyecto](../media/vs-2019/exploreide-filenewproject-vs2019.png)
     ::: moniker-end

::: moniker range="vs-2017"
2. En el cuadro de diálogo **Nuevo proyecto**, seleccione la categoría **Instalados** > **Visual C#** > **Escritorio de Windows** y, luego, seleccione la plantilla **Aplicación de WPF (.NET Framework)**. Asígnele al proyecto el nombre **HelloWPFApp** y haga clic en **Aceptar**.
...
2. En la pantalla **Crear un nuevo proyecto**, busque "WPF", elija **Aplicación de WPF (.NET Framework)** y haga clic en **Siguiente**.
   ...
   ![Plantilla de aplicación de WPF en el cuadro de diálogo Nuevo proyecto de Visual Studio](media/vs-2019/exploreide-newprojectcsharp-vs2019.png)
...
1. Escriba **Ctrl**+**Q** para invocar a **Inicio rápido** y escriba **Cuadro de herramientas**. Elija **Ver > Cuadro de herramientas** en la lista de resultados.
...
2. Agregue dos controles RadioButton a la superficie de diseño. Para ello, elija el elemento **RadioButton** y arrástrelo a la ventana en la superficie de diseño. Mueva los botones (para hacerlo, selecciónelos y use las teclas de dirección) de modo que aparezcan uno junto al otro bajo el control TextBlock.
     ...
     ![Formulario Greetings con bloque de texto y dos botones de radio](../media/exploreide-greetingswithradiobuttons.png)
...
5. En la ventana **Greetings** , elija el botón de radio **Hello** y después elija el botón **Mostrar** .
    ...
    ![Captura de pantalla del punto de interrupción en el depurador](media/exploreide-debugbreakpoint.png)
