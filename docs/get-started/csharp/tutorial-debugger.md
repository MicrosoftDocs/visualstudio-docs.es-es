...
1. En el cuadro de búsqueda de la ventana **Crear un proyecto**, escriba *consola*. Seguidamente, elija **C#** en la lista de lenguajes y luego, **Windows** en la lista de plataformas. 
   ...
   ![Elección de la plantilla de C# para Aplicación de consola](../csharp/media/vs-2019/get-started-create-console-project.png)
...
1. En la ventana **Configurar el nuevo proyecto**, escriba *GetStartedDebugging* en el cuadro **Nombre del proyecto**. Después, elija **Siguiente**.
