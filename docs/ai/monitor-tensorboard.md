...
1. Observe que el error disminuye con el tiempo, lo que significa que la calidad está mejorando

    ![ejecutar tensorboard](media\monitor-tensorboard\tensorboard.png)