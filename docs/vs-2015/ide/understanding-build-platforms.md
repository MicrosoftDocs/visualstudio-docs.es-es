...
## <a name="in-this-section"></a>En esta sección
 [Cómo: Configurar proyectos para plataformas de destino](../ide/how-to-configure-projects-to-target-platforms.md) Explica cómo configurar un proyecto destinado a una plataforma específica.
