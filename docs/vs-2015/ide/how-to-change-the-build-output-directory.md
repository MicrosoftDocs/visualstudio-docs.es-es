...
## <a name="see-also"></a>Otras referencias
 [Página compilar, diseñadorC#de proyectos ()](../ide/reference/build-page-project-designer-csharp.md) [Página de propiedades general (proyecto)](https://msdn.microsoft.com/library/593b383c-cd0f-4dcd-ad65-9ec9b4b19c45) [compilar y generar](../ide/compiling-and-building-in-visual-studio.md)
