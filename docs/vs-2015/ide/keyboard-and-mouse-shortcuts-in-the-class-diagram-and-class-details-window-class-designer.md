...
- [Usar el mouse en el ventana Detalles de clase](../ide/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window-class-designer.md#MouseClassDetails)
...
## <a name="using-the-mouse-in-the-class-details-window"></a><a name="MouseClassDetails"></a> Usar el mouse en la ventana Detalles de clase
...
|Delete|Sobre las formas de tipo y de comentario|Invoca el comando **Quitar del diagrama**.|
...
|SPACE|Todos los contextos|Alterna la selección sobre el elemento actual.|

## <a name="using-the-keyboard-in-the-class-details-window"></a><a name="KeyboardClassDetails"></a> Usar el teclado en la ventana Detalles de clase
