...
## <a name="working-with-resources"></a>Trabajar con recursos
 ...
 Para obtener información sobre cómo trabajar con recursos en proyectos de C++, vea [How to: Create a Resource](https://msdn.microsoft.com/library/aad44914-9145-45a3-a7d8-9de89b366716) (Cómo: Crear un recurso).
