...
ms.locfileid: "47581431"
---
# <a name="designing-classes-and-types-class-designer"></a>Diseñar clases y tipos (Diseñador de clases)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [diseñar clases y tipos (Diseñador de clases)](https://docs.microsoft.com/visualstudio/ide/designing-classes-and-types-class-designer).  
