...
|\Snippets|Carpeta de fragmentos de código. Contiene fragmentos de código para el lenguaje.|
 ...
 En Windows,% UserProfile% se resuelve en la ruta de acceso: c:\Users \\ *\<user name>* . Si la carpeta de extensiones no existe en el sistema, debe crearla. Si la carpeta ya existe, estará oculta.
