...
```  
 ...
 Para obtener más información sobre cómo usar el tipo `typedef`, vea [typedef (Especificador)](http://msdn.microsoft.com/cc96cf26-ba93-4179-951e-695d1f5fdcf1).  
...
## <a name="see-also"></a>Vea también  
 ...
 [typedef (Especificador)](http://msdn.microsoft.com/cc96cf26-ba93-4179-951e-695d1f5fdcf1)
