...
### <a name="configuring-a-build"></a>Configurar una compilación
 ...
 Para empezar, use **Depuración** y **x86** como configuración de compilación y plataforma, respectivamente. Cuando haya terminado la codificación y la depuración, cambie la configuración a **versión** y tenga como destino una plataforma específica. (Las versiones anteriores de Visual Studio proporcionan una plataforma predeterminada **AnyCPU** para los proyectos de código de .NET).

 Nota: al compilar un proyecto, se usan también los valores de configuración y plataforma para determinar la ruta de acceso al directorio del proyecto que se creará para almacenar el archivo ejecutable. Normalmente, se trata ** \<path-to-project> \\ de<la \> \\ \> \\ \> plataforma de configuración de<<**. Por ejemplo, un proyecto con una configuración de `Debug` y una plataforma de `x86` se encontraría en `Projects\MyProjectNameHere\MyProjectNameHere\bin\Debug\x86`. Esto puede ser útil si tiene sus propias herramientas o scripts que administran estos ejecutables compilados.
...
### <a name="building-your-code"></a>Compilar el código
 ...
 ![Selección del menú de proyecto de compilación de Visual Studio](../ide/media/vs-ide-gs-debug-build-menu-item.png "Vs_ide_gs_debug_build_menu_item")
 ...
 ![Resultados de compilación correcta de Visual Studio](../ide/media/vs-ide-gs-debug-success-build.PNG "vs_ide_gs_debug_success_build")

### <a name="reviewing-the-error-list"></a>Revisar la lista de errores
 Salvo que no haya realizado ninguna modificación en un código que ya se haya compilado correctamente, es probable que tenga un error. Si no está familiarizado con la codificación, probablemente tenga muchos. Los errores a veces son obvios, como un simple error de sintaxis o nombre de variable incorrecto, y a veces son difíciles de entender solo con un código críptico como guía. Para obtener una vista más clara de los problemas, vaya a la parte inferior de la ventana de **salida** de la compilación y haga clic en la pestaña **lista de errores** . Esto le lleva a una vista más organizada de los errores y advertencias del proyecto y también ofrece algunas opciones adicionales.

 ![Salida y lista de errores de Visual Studio 2015](../ide/media/vs-ide-gs-debug-bad-build-error-list.PNG "Vs_ide_gs_debug_bad_build_error_list")

 Haga clic en la línea del error en la ventana **Lista de errores** para ir a la línea donde se ha producido el error. (O bien, para activar los números de línea, haga clic en la barra **Inicio rápido** en la parte superior derecha, escriba "números de línea" en él y presione Entrar. Esta es la forma más rápida de acceder a la entrada de la ventana **Opciones** donde puede activar los números de línea. Obtenga información sobre cómo usar la barra **Inicio rápido** y ahórrese muchos clics en la interfaz de usuario).
 ...
 ![Error de Visual Studio al mantener el ratón](../ide/media/vs-ide-gs-debug-error-hover1.png "Vs_ide_gs_debug_error_hover1")
...
### <a name="performing-static-code-analysis"></a>Realizar análisis estáticos de código
 ...
 ![Elemento de menú Análisis de código de Visual Studio 2015](../ide/media/vs-ide-gs-debug-run-code-analysis.png "Vs_ide_gs_debug_run_code_analysis")
 ...
 ![Lista de errores con advertencias de Visual Studio 2015](../ide/media/vs-ide-gs-debug-code-analysis-warning-error-list.PNG "vs_ide_gs_debug_code_analysis_warning_error_list")
 ...
 ![Advertencia de análisis de Visual Studio Code al mantener el mouse](../ide/media/vs-ide-gs-debug-code-analysis-warning-hover.png "vs_ide_gs_debug_code_analysis_warning_hover")
...
### <a name="using-light-bulbs-to-fix-or-refactor-code"></a>Usar bombillas para corregir o refactorizar código
 ...
 ![Opciones rápidas de bombilla de Visual Studio 2015](../ide/media/vs-ide-gs-debug-light-bulb1.png "Vs_ide_gs_debug_light_bulb1")

 Verá una lista de posibles correcciones o refactorizaciones que puede aplicar a esa línea de código.

 ![Vista previa de bombilla de Visual Studio 2015](../ide/media/vs-ide-gs-debug-light-bulb-preview-changes.PNG "Vs_ide_gs_debug_light_bulb_preview_changes")
 ...
 ![Texto de bombilla "ninguna opción" de Visual Studio 2015](../ide/media/vs-ide-gs-debug-light-bulb-no-options.PNG "Vs_ide_gs_debug_light_bulb_no_options")
...
### <a name="debugging-your-running-code"></a>Depurar el código en ejecución
 ...
 ![Ventanas Automático y Pila de llamadas de VS2015](../ide/media/vs-ide-gs-debug-autos-and-call-stack.PNG "Vs_ide_gs_debug_autos_and_call_stack")
 ...
 ![Botón Interrumpir todos de Visual Studio](../ide/media/vs-ide-gs-debug-break-all-button.png "vs_ide_gs_debug_break_all_button")

 Presione F5 para continuar la ejecución de la aplicación (o haga clic en el botón **Continuar**).

 ![Botón Continuar de depuración de Visual Studio](../ide/media/vs-ide-gs-debug-continue-button.png "Vs_ide_gs_debug_continue_button")
 ...
 Si el código se ejecuta perfectamente y tal y como se esperaba, ¡enhorabuena! Cambie la configuración de compilación a **Versión** y recompílela para su implementación. (Sin embargo, los profesionales pueden querer saltar al bit en las pruebas unitarias al final). Sin embargo, si deja de responder o se bloquea, o le dio resultados extraños, necesitará encontrar el origen de esos problemas y corregir los errores.
...
1. Para reducir el origen de un bloqueo o programa que no responde, dispersos por todo el código de la llamada al método que cree que está causando el error. A medida que ejecute el código paso a paso, quite y restablezca los puntos de interrupción más próximos entre sí hasta que encuentre la línea de código incorrecta.
...
4. Si está escribiendo código de C o C++, use puntos de interrupción para detener el código y poder inspeccionar los valores de dirección (busque NULL) y los recuentos de referencias al depurar errores relacionados con la memoria.
   ...
   Para obtener más información sobre el uso de puntos de interrupción, lea [uso de puntos de interrupción](../debugger/using-breakpoints.md)
...
### <a name="setting-conditional-breakpoints"></a>Establecer puntos de interrupción condicionales
 ...
 ![Punto de interrupción condicional de Visual Studio 2015](../ide/media/vs-ide-gs-debug-breakpoint-conditional.PNG "Vs_ide_gs_debug_breakpoint_conditional")
...
### <a name="inspecting-your-code-at-run-time"></a>Inspeccionar el código en tiempo de ejecución
 ...
 ![Inspección del valor de tiempo de&#45;de ejecución de Visual Studio 2015](../ide/media/vs-ide-gs-debug-inspect-value.PNG "vs_ide_gs_debug_inspect_value")
 ...
 Además, Visual Studio 2015 muestra la ventana Herramientas de diagnóstico, donde puede observar el uso que hace la aplicación de la memoria y la CPU con el tiempo. Puede usarlas para buscar un uso intensivo de la CPU o una asignación de memoria imprevistos. Úselo junto con la ventana **inspección** y los puntos de interrupción para determinar qué está causando un uso intensivo inesperado o recursos no liberados.

 ![Ventana de Herramientas de diagnóstico de Visual Studio 2015](../ide/media/vs-ide-gs-debug-diagnostic-tools.PNG "Vs_ide_gs_debug_diagnostic_tools")
