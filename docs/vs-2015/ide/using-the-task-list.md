...
ms.locfileid: "47565885"
---
# <a name="using-the-task-list"></a>Usar la Lista de tareas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [mediante la lista de tareas](https://docs.microsoft.com/visualstudio/ide/using-the-task-list).  
