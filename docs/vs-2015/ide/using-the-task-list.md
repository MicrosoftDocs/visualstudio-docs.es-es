...
- En el menú **Ver**, elija **Lista de tareas** (teclado: CTRL+\\, T).
     ...
     ![Ventana Lista de tareas](../ide/media/vs2015-task-list.png "|::ref1::|")
...
2. Abra la carpeta **Entorno** y, a continuación, elija **Lista de tareas**.
     ...
     ![Lista de tareas de Visual Studio](../ide/media/vs2015-task-list-options.png "|::ref2::|")
...
## <a name="shortcuts"></a> Accesos directos
 ...
 ![Icono de acceso directo a lista de tareas de Visual Studio](../ide/media/vs2015-task-list-bookmark.png "|::ref3::|")
