...
ms.locfileid: "47580991"
---
# <a name="step-2-create-a-random-addition-problem"></a>Paso 2: Crear un problema de suma aleatoria
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [paso 2: crear un problema de suma aleatoria](https://docs.microsoft.com/visualstudio/ide/step-2-create-a-random-addition-problem).  
