...
ms.locfileid: "47565643"
---
# <a name="help-viewer-administrator-guide"></a>Guía del administrador del Visor de Ayuda
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Guía del administrador del Visor de Ayuda](https://docs.microsoft.com/visualstudio/ide/help-viewer-administrator-guide).  
