---
title: 'Paso 1: Crear un proyecto de aplicación de Windows Forms | Documentos de Microsoft'
ms.date: 11/15/2016
...
ms.locfileid: "63442000"
---
# <a name="step-1-create-a-windows-forms-application-project"></a>Paso 1: creación de un proyecto de Aplicación de Windows Forms
...
- Para ir al siguiente paso del tutorial, vea [Paso 2: Ejecute el programa](../ide/step-2-run-your-program.md).  
