...
ms.locfileid: "47574252"
---
# <a name="step-6-add-a-timer"></a>Paso 6: Agregar un temporizador
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [paso 6: agregar un temporizador](https://docs.microsoft.com/visualstudio/ide/step-6-add-a-timer).  
