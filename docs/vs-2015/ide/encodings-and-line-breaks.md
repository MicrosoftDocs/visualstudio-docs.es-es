...
ms.locfileid: "47577392"
---
# <a name="encodings-and-line-breaks"></a>Codificaciones y saltos de línea
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [codificaciones y saltos de línea](https://docs.microsoft.com/visualstudio/ide/encodings-and-line-breaks).  
