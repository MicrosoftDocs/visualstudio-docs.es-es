...
Para ver un tipo existente y sus miembros, agregue su forma a un diagrama de clases.
 ...
 Para diseñar nuevos tipos en diagramas de clases, vea [Cómo: crear tipos mediante diseñador de clases](../ide/how-to-create-types-by-using-class-designer.md).
...
> Si la Vista de clases no está abierta, abra la Vista de clases desde el menú **Ver**. Para obtener más información sobre la vista de clases, consulte [Ver clases y sus miembros](https://msdn.microsoft.com/71e9e8f3-261a-4e0c-87bf-5ec48b8bf333).
 ...
 Para mostrar tipos en las ubicaciones predeterminadas del diagrama, seleccione uno o más tipos en Vista de clases, haga clic con el botón secundario en los tipos seleccionados y elija **ver diagrama de clases**.
