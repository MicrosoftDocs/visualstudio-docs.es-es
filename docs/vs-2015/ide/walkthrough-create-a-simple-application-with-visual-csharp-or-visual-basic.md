...
La versión más reciente de este tema puede encontrarse en [Tutorial: crear una aplicación sencilla con Visual C# o Visual Basic](https://docs.microsoft.com/visualstudio/ide/walkthrough-create-a-simple-application-with-visual-csharp-or-visual-basic).  
