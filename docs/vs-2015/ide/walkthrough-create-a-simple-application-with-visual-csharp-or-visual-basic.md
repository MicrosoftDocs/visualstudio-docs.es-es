...
2. Para elegir la plantilla Aplicación WPF de Visual C# o Visual Basic, elija en el panel izquierdo **Instaladas**, **Plantillas**, **Visual C#**, **Windows**, por ejemplo y, después, elija Aplicación WPF en el panel central.  Asigne al proyecto el nombre HelloWPFApp en la parte inferior del cuadro de diálogo Nuevo proyecto.
    ...
    ![Creación de un proyecto de WPF de Visual Basic, HelloWPFApp](../ide/media/exploreide-newprojectvb.png "ExploreIDE-NewProjectVB")

    O

    ![Creación de un proyecto de Visual C&#35; WPF, HelloWPFApp](../ide/media/exploreide-newprojectcsharp.png "ExploreIDE-NewProjectcsharp")

   Visual Studio crea el proyecto HelloWPFApp y la solución y el **Explorador de soluciones** muestra los distintos archivos. WPF Designer muestra una vista de diseño y una vista XAML de MainWindow.xaml en una vista en dos paneles. Puede deslizar el divisor para mostrar más o menos de cualquiera de las vistas.  Puede elegir ver solo la vista visual o solo la vista XAML. (Para obtener más información, vea [WPF Designer For Windows Forms Developers](https://msdn.microsoft.com/47ad0909-e89b-4996-b4ac-874d929f94ca)). Los elementos siguientes aparecen en el **Explorador de soluciones**:
...
3. Guarde los cambios presionando Ctrl-s o usando el elemento de menú **Archivo** .
   ...
   A continuación, agregará dos controles [RadioButton](https://msdn.microsoft.com/library/6c9ba847-eab7-4bba-9c74-6b56ef72067b) al formulario.
...
2. Abra el menú contextual de RadioButton2 presionando el botón secundario del mouse mientras selecciona RadioButton2, elija **Editar texto**y, luego, escriba `Goodbye`.
   ...
   El último elemento de la interfaz de usuario que agregará es un control de [botón](https://msdn.microsoft.com/library/a9d8f5a5-c98c-463e-808a-5a4e63173098) .
...
2. Elija el botón **Aceptar** y después detenga el depurador.
    ...
    ![Comando Detener depuración del menú Depurar](../ide/media/exploreide-stopdebugging.png "ExploreIDE-detener depuración")
...
2. Cambie la configuración de compilación para HelloWPFApp de **depurar** a **liberar** mediante el control de lista desplegable de la barra de herramientas (dice "depurar" actualmente).
