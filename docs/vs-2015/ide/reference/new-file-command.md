...
ms.locfileid: "47580430"
---
# <a name="new-file-command"></a>Nuevo archivo (Comando)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [comando nuevo archivo](https://docs.microsoft.com/visualstudio/ide/reference/new-file-command).  
