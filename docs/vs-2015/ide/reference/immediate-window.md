...
ms.locfileid: "47576207"
---
# <a name="immediate-window"></a>Inmediato (ventana)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ventana Inmediato](https://docs.microsoft.com/visualstudio/ide/reference/immediate-window).  
