...
ms.locfileid: "47579130"
---
# <a name="project-properties-reference"></a>Referencia de propiedades del proyecto
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [referencia de propiedades de proyecto](https://docs.microsoft.com/visualstudio/ide/reference/project-properties-reference).  
