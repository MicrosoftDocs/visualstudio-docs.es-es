...
ms.locfileid: "47582826"
---
# <a name="add-existing-item-command"></a>Agregar elemento existente (Comando)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [agregar existente (comando) elemento](https://docs.microsoft.com/visualstudio/ide/reference/add-existing-item-command).  
