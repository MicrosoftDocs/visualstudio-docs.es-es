...
ms.locfileid: "47580805"
---
# <a name="find-command"></a>Buscar (Comando)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [comando Buscar](https://docs.microsoft.com/visualstudio/ide/reference/find-command).  
