...
ms.locfileid: "47578937"
---
# <a name="list-call-stack-command"></a>Mostrar pila de llamadas (Comando)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [comando de lista Call Stack](https://docs.microsoft.com/visualstudio/ide/reference/list-call-stack-command).  
