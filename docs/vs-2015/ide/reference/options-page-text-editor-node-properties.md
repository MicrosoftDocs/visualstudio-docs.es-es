...
ms.locfileid: "47577881"
---
# <a name="options-page-text-editor-node-properties"></a>Página de opciones, Propiedades de nodo Editor de texto
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [página de opciones, propiedades de nodo Editor de texto](https://docs.microsoft.com/visualstudio/ide/reference/options-page-text-editor-node-properties).  
