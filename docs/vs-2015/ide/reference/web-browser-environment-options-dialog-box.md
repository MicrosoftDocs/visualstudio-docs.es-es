...
> Al abrir determinados archivos o componentes de la Web, se puede ejecutar código en el equipo.
 ...
 Página principal establece la página que se muestra al abrir el explorador Web del IDE.

 La página Buscar le permite designar una página de búsqueda para el explorador Web interno. Esta ubicación puede diferir de la página de búsqueda que usan las instancias de Internet Explorer iniciadas fuera del entorno de desarrollo integrado (IDE).

 Ver código fuente en establece el editor que se usa para abrir una página web cuando se elige **Ver código fuente** en la página desde el explorador Web interno.
