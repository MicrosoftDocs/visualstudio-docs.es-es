...
ms.author: gewarren
manager: ghogen
ms.openlocfilehash: d304aa422022a77d46c1f416f7cd41af60864db0
ms.sourcegitcommit: 55f7ce2d5d2e458e35c45787f1935b237ee5c9f8
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 08/22/2018
ms.locfileid: "47566776"
---
# <a name="web-browser-environment-options-dialog-box"></a>Explorador web, Entorno, Opciones (Cuadro de diálogo)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [cuadro de diálogo de explorador Web, entorno, opciones](https://docs.microsoft.com/visualstudio/ide/reference/web-browser-environment-options-dialog-box).  
