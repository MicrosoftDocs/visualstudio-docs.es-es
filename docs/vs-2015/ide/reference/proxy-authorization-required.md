...
- Puede quitar la https://go.microsoft.com dirección de la lista de permitidos para que se muestre el cuadro de diálogo de autenticación de proxy para los https://go.microsoft.com puntos de conexión de dirección y de servidor cuando se reinicie Visual Studio.
