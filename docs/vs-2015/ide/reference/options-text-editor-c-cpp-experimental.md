 ...
 **Habilitar expandir precedencia** Si está habilitada, puede escribir "(" en el editor de texto para rodear el texto seleccionado entre paréntesis.
 ...
 Para conocer las características adicionales del editor de texto de la Galería de Visual Studio, consulte la lista [aquí](https://marketplace.visualstudio.com/). Un ejemplo es [C++ Quick Fixes](https://visualstudiogallery.msdn.microsoft.com/be91feef-8dc3-4f7a-ac9f-f34e7ca5918f), que admite lo siguiente:
