...
La versión más reciente de este tema puede encontrarse en [servicios y productos de accesibilidad de Microsoft](https://docs.microsoft.com/visualstudio/ide/reference/accessibility-products-and-services-from-microsoft).  
