...
```
 ...
 Captura de pantalla de **entrada (enviar)** ![HTMLpageToolbarSubmitButton](../../ide/reference/media/vxsubmit.gif "|::ref4::|")
...
```
 ...
 Captura de pantalla de **entrada (texto)** ![HTMLpageToolbarTextField](../../ide/reference/media/vxtextfield.gif "|::ref5::|")
...
> Se recomienda que valide todos los datos proporcionados por el usuario. Para obtener más información, consulte [Validar la información especificada por el usuario en ASP.NET Web Pages](https://msdn.microsoft.com/library/4ad3dacb-89e0-4cee-89ac-40a3f2a85461).
 ...
 ![Campo de archivo de página HTML](../../ide/reference/media/vxfilefield.gif "|::ref6::|") de **entrada (archivo)**
 ...
 **Entrada (contraseña)** ![campo de contraseña de Visual Studio](../../ide/reference/media/vxpassword.gif "|::ref7::|")
...
```
 ...
 Captura de pantalla de **entrada (radio)** ![VisualStudioHTMLpageRadioButton](../../ide/reference/media/vxradio.gif "|::ref9::|")
 ...
 **Entrada oculta (oculta)** de la ![página html](../../ide/reference/media/vxhidden.gif "|::ref10::|")
...
```
 ...
 Área de texto de la barra de herramientas **TextArea** ![la](../../ide/reference/media/vxtextarea.gif "|::ref11::|")
...
> Se recomienda que valide todos los datos proporcionados por el usuario. Para obtener más información, consulte [Validar la información especificada por el usuario en ASP.NET Web Pages](https://msdn.microsoft.com/library/4ad3dacb-89e0-4cee-89ac-40a3f2a85461).
 ...
 Captura de pantalla de la **tabla** ![HTMLpageToolbarTable](../../ide/reference/media/vxtable.gif "|::ref12::|")
 ...
 **Seleccionar** ![cuadro de herramientas de página html](../../ide/reference/media/vxdropdown.gif "|::ref14::|")
