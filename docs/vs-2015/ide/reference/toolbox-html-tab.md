...
La pestaña **HTML** del cuadro de herramientas proporciona componentes que resultan útiles en páginas web y formularios Web Forms. Para ver esta pestaña, abra primero un documento para editarlo en el Diseñador HTML. En el menú **Ver**, haga clic en **Cuadro de herramientas** y después haga clic en la pestaña **HTML** del cuadro de herramientas.
...
- [Cómo: Manipular las fichas del cuadro de herramientas](https://msdn.microsoft.com/21285050-cadd-455a-b1f5-a2289a89c4db)
 ...
 **Puntero** ![ASP.net del diseñador móvil la](../../ide/reference/media/vxpointer.gif "vxPointer")
 ...
 **Entrada (botón)** ![botón Página Web html](../../ide/reference/media/vxbutton.gif "vxButton")
...
```
 ...
 Captura de pantalla de **entrada (restablecer)** ![HTMLpageResetButton](../../ide/reference/media/vxreset.gif "vxReset")
...
```
 ...
 Para obtener más información, consulte [HTML Input Controls](https://msdn.microsoft.com/library/2ba82c6b-dff7-4b73-b1c2-9e76a48a69de) (Controles de entrada HTML), [Sintaxis declarativa del control de servidor HtmlInputReset](https://msdn.microsoft.com/cfc1f1fb-d33a-464d-9bb5-204e66174979), <xref:System.Web.UI.HtmlControls.HtmlInputButton> y <xref:System.Web.UI.WebControls.Button>.

 Captura de pantalla de **entrada (enviar)** ![HTMLpageToolbarSubmitButton](../../ide/reference/media/vxsubmit.gif "vxSubmit")
...
```
 ...
 Para obtener más información, consulte [HTML Input Controls](https://msdn.microsoft.com/library/2ba82c6b-dff7-4b73-b1c2-9e76a48a69de) (Controles de entrada HTML), [Sintaxis declarativa del control de servidor HtmlInputSubmit](https://msdn.microsoft.com/eef2a157-f184-4ce9-b256-d1eacc7930f2), <xref:System.Web.UI.HtmlControls.HtmlInputButton> y <xref:System.Web.UI.WebControls.Button>.

 Captura de pantalla de **entrada (texto)** ![HTMLpageToolbarTextField](../../ide/reference/media/vxtextfield.gif "vxTextfield")
...
```
 ...
 Para obtener más información, consulte [HTML Input Controls](https://msdn.microsoft.com/library/2ba82c6b-dff7-4b73-b1c2-9e76a48a69de) (Controles de entrada HTML), [Sintaxis declarativa del control de servidor HtmlInputText](https://msdn.microsoft.com/87060d90-a11c-434d-9fc9-b03a8487041e), [TextBox Web Server Control Overview](https://msdn.microsoft.com/library/ab354bc1-f23a-48fc-93d8-d4d7c1b7396f) (Información general del control del servidor web TextBox), <xref:System.Web.UI.HtmlControls.HtmlInputText> y <xref:System.Web.UI.WebControls.TextBox>.

> [!IMPORTANT]
> Se recomienda que valide todos los datos proporcionados por el usuario. Para obtener más información, consulte [Validar la información especificada por el usuario en ASP.NET Web Pages](https://msdn.microsoft.com/library/4ad3dacb-89e0-4cee-89ac-40a3f2a85461).

 ![Campo de archivo de página HTML](../../ide/reference/media/vxfilefield.gif "vxFilefield") de **entrada (archivo)**
...
```
 ...
 Para obtener más información, consulte [HTML Input Controls](https://msdn.microsoft.com/library/2ba82c6b-dff7-4b73-b1c2-9e76a48a69de) (Controles de entrada HTML), [Sintaxis declarativa del control de servidor HtmlInputFile](https://msdn.microsoft.com/a817b4a0-056f-4c17-a696-b9fdcde43db6) y <xref:System.Web.UI.HtmlControls.HtmlInputFile>.

> [!IMPORTANT]
> Se recomienda que valide todos los datos proporcionados por el usuario. Para obtener más información, consulte [Validar la información especificada por el usuario en ASP.NET Web Pages](https://msdn.microsoft.com/library/4ad3dacb-89e0-4cee-89ac-40a3f2a85461).

 **Entrada (contraseña)** ![campo de contraseña de Visual Studio](../../ide/reference/media/vxpassword.gif "vxPassword")
 ...
 **Entrada (casilla)** ![opción de casilla cuadro de herramientas de página web html](../../ide/reference/media/vxcheckbox.gif "vxCheckbox")
...
```
 ...
 Captura de pantalla de **entrada (radio)** ![VisualStudioHTMLpageRadioButton](../../ide/reference/media/vxradio.gif "vxRadio")
...
```
 ...
 Para obtener más información, consulte [HTML Input Controls](https://msdn.microsoft.com/library/2ba82c6b-dff7-4b73-b1c2-9e76a48a69de) (Controles de entrada HTML), [Sintaxis declarativa del control de servidor HtmlInputRadioButton](https://msdn.microsoft.com/6e60ff63-cc57-46ef-bf96-e829e204ba33), [CheckBox and CheckBoxList Web Server Controls Overview](https://msdn.microsoft.com/library/20eb383c-4b59-432b-bba3-e9d785107747) (Información general de los controles de servidor web RadioButton y RadioButtonList), <xref:System.Web.UI.HtmlControls.HtmlInputRadioButton> y <xref:System.Web.UI.WebControls.RadioButton>.

 **Entrada oculta (oculta)** de la ![página html](../../ide/reference/media/vxhidden.gif "vxhidden")
...
```
 ...
 Para obtener más información, consulte [HTML Input Controls](https://msdn.microsoft.com/library/2ba82c6b-dff7-4b73-b1c2-9e76a48a69de) (Controles de entrada HTML), [Sintaxis declarativa del control de servidor HtmlInputHidden](https://msdn.microsoft.com/4194e44d-1d74-4bfc-9cc7-743a2e1ea5f9) y <xref:System.Web.UI.HtmlControls.HtmlInputHidden>.

 Área de texto de la barra de herramientas **TextArea** ![la](../../ide/reference/media/vxtextarea.gif "vxTextarea")
...
```
 ...
 Para obtener más información, consulte [Sintaxis declarativa del control de servidor HtmlTextArea](https://msdn.microsoft.com/5a103ffa-235b-4452-ba2b-a4fb8ba8cb87), <xref:System.Web.UI.HtmlControls.HtmlTextArea> y <xref:System.Web.UI.WebControls.TextBox> .

> [!IMPORTANT]
> Se recomienda que valide todos los datos proporcionados por el usuario. Para obtener más información, consulte [Validar la información especificada por el usuario en ASP.NET Web Pages](https://msdn.microsoft.com/library/4ad3dacb-89e0-4cee-89ac-40a3f2a85461).

 Captura de pantalla de la **tabla** ![HTMLpageToolbarTable](../../ide/reference/media/vxtable.gif "vxTable")
 ...
 **Image** ![Elemento de imagen de página html](../../ide/reference/media/vximage.gif "vxImage") de imagen
...
```
 ...
 Para obtener más información, consulte [Sintaxis declarativa del control de servidor HtmlImage](https://msdn.microsoft.com/528430e8-ced1-47d1-8db2-942e734a61f6), [información general sobre el control de servidor Web de imágenes](https://msdn.microsoft.com/library/096a8d8d-58ee-4ee8-ab82-6594a0f3a0a9),, <xref:System.Web.UI.HtmlControls.HtmlImage> <xref:System.Web.UI.HtmlControls.HtmlInputImage> y <xref:System.Web.UI.WebControls.Image> .

 **Seleccionar** ![cuadro de herramientas de página html](../../ide/reference/media/vxdropdown.gif "vxDropdown")
...
```
 ...
 ![Elemento de regla horizontal de página HTML](../../ide/reference/media/vxhorizontal.gif "vxHorizontal") de **regla horizontal**
 ...
 **Div** ![Etiqueta de página html](../../ide/reference/media/vxlabel.gif "vxLabel") de div
