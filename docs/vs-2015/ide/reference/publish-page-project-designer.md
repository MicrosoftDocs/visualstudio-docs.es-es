 ...
 **Modo de instalación y configuración** Determina si la aplicación se ejecuta directamente desde la **Ubicación de publicación** (cuando **la aplicación solo está disponible en línea** ) o se instala y se agrega al menú **Inicio** y al elemento **Agregar o quitar programas** de **Panel de control** (cuando **la aplicación está disponible sin conexión también** está seleccionada).
