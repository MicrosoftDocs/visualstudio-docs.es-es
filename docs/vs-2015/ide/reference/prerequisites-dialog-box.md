...
ms.locfileid: "47576910"
---
# <a name="prerequisites-dialog-box"></a>Cuadro de diálogo Requisitos previos
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Prerequisites Dialog Box](https://docs.microsoft.com/visualstudio/ide/reference/prerequisites-dialog-box).  
