...
ms.locfileid: "47579779"
---
# <a name="toolbox-components-tab"></a>Cuadro de herramientas, Componentes (Pestaña)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [cuadro de herramientas, pestaña componentes](https://docs.microsoft.com/visualstudio/ide/reference/toolbox-components-tab).  
