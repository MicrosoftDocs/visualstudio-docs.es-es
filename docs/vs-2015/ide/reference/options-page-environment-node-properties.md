...
## <a name="see-also"></a>Otras referencias
 [Controlar la configuración de opciones](https://msdn.microsoft.com/library/a09ed242-7494-4cde-bbd1-7a8ec617965d) [determinar los nombres de los elementos de propiedad en las páginas de opciones](https://msdn.microsoft.com/library/d450422d-47c7-4eeb-9f9f-3286264bc5aa) [Página opciones, propiedades de nodo fuentes y colores](../../ide/reference/options-page-fonts-and-colors-node-properties.md) [, página Opciones de nodo del editor de texto](../../ide/reference/options-page-text-editor-node-properties.md) [cuadro de diálogo Opciones de entorno](../../ide/reference/environment-options-dialog-box.md)
