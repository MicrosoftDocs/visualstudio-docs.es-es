...
## <a name="uielement-list"></a>Lista de UIElement
 Nombre de objeto muestra el objeto o los objetos seleccionados actualmente. Solo están visibles los objetos del editor o diseñador activo. Si selecciona varios objetos, solo aparecen propiedades comunes a todos los objetos seleccionados.

 Clasificadas muestra todas las propiedades y los valores de propiedad para el objeto seleccionado, por categoría. Una categoría se puede contraer para reducir el número de propiedades visibles. Cuando se contrae o expande una categoría, aparece un signo más (+) o un signo menos (-) a la izquierda del nombre de la categoría. Las categorías se muestran por orden alfabético.
