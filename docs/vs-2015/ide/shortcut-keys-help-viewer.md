...
|Configuración de|F11|Alternar entre la vista de pantalla completa y la vista normal.|
|ToolBar|Retroceso<br /><br /> O BIEN<br /><br /> Alt + flecha izquierda|Mostrar la página anterior.|
|ToolBar|Alt + flecha derecha|Mostrar la página siguiente.|
|ToolBar|Alt + Inicio|Mostrar la página principal del revisor de ayuda.|
|ToolBar|Ctrl + S|Resaltar el tema actual en la tabla de contenido (en la pestaña **Contenido**).|
...
|ToolBar|Ctrl + P|Imprimir la página actual.|
|ToolBar|Ctrl + F2|Mostrar una vista previa de impresión de la página actual.|
|ToolBar|Ctrl + O|Mostrar el cuadro de diálogo **Opciones del Visor**.|
...
|Tab|Cambiar el foco al **movimiento...** .|
