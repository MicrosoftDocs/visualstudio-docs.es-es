...
ms.locfileid: "47579740"
---
# <a name="shortcut-keys-help-viewer"></a>Teclas de método abreviado (Visor de Ayuda)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [teclas de método abreviado (Visor de Ayuda)](https://docs.microsoft.com/visualstudio/ide/shortcut-keys-help-viewer).  
