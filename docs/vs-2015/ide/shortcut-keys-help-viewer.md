...
|----------|---------------|------------|
|Aplicación general|Space|Usar en lugar de Entrar en cualquier lugar excepto en los campos de edición.|
|Aplicación general|F1|Abrir Ayuda sobre el elemento de la interfaz de usuario actual.|
...
|Navegadores|Alt + C<br /><br /> O<br /><br /> Ctrl + Mayús + C|Mostrar la pestaña **Contenido**.|
|Navegadores|Alt + I<br /><br /> O<br /><br /> Ctrl + Mayús + I|Mostrar la pestaña **Índice**.|
...
|Tema|End|Moverse al final del documento.|
...
|Buscar|Escriba|Cambiar el foco al elemento siguiente.|
|Buscar|Mayús + Entrar|Cambiar el foco al elemento anterior.|
...
|Pestaña|Cambiar el foco al **movimiento...** .|
...
|Space|Agregar un elemento a la lista de **Cambios pendientes**.|
...
|Space|Quitar un elemento de la lista de **Cambios pendientes**.|
