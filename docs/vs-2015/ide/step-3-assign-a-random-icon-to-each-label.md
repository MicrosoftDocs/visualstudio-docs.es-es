...
ms.locfileid: "47574031"
---
# <a name="step-3-assign-a-random-icon-to-each-label"></a>Paso 3: Asignar un icono aleatorio a cada etiqueta
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [paso 3: asignar un icono aleatorio a cada etiqueta](https://docs.microsoft.com/visualstudio/ide/step-3-assign-a-random-icon-to-each-label).  
