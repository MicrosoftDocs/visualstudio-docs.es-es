...
>
> Para ver el código de Visual Basic, elija la pestaña **VB** en la parte superior de los bloques de código y para ver el código de Visual C#, elija la pestaña **C#** . Si le interesa obtener más información sobre Visual C++, vea el tutorial sobre el lenguaje de [Introducción](../misc/getting-started-with-visual-cpp-in-visual-studio-2015.md) y [C++](http://www.cplusplus.com/doc/tutorial/).
>
