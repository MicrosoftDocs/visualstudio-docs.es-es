...
2. En el cuadro de diálogo **nuevo proyecto** , en el nodo **Visual Basic** , seleccione **Windows** y, a continuación, la plantilla **aplicación para Windows** . Dé un nombre al proyecto `VBWinApp`.
