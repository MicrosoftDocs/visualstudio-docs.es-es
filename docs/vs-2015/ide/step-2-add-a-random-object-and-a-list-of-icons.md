---
title: 'Paso 2: Agregar un objeto aleatorio y una lista de iconos | Documentos de Microsoft'
ms.date: 11/15/2016
...
- Para volver al paso anterior del tutorial, vea [Paso 1: Cree un proyecto y agregar una tabla al formulario](../ide/step-1-create-a-project-and-add-a-table-to-your-form.md).
