---
title: Cómo desbloquear Visual Studio | Documentos de Microsoft
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47578331"
---
# <a name="how-to-unlock-visual-studio"></a>Cómo desbloquear Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [cómo desbloquear Visual Studio](https://docs.microsoft.com/visualstudio/ide/how-to-unlock-visual-studio).  
