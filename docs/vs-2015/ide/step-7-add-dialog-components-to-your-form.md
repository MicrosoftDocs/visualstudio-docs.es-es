...
1. Elija el Diseñador de Windows Forms (Form1.cs [diseño] o Form1. VB [diseño]) y, a continuación, abra el grupo **cuadros de diálogo** en el cuadro de herramientas.
...
3. Elija el icono de **OpenFileDialog1** en el área de la parte inferior del diseñador de Windows Forms. Establezca dos propiedades:
