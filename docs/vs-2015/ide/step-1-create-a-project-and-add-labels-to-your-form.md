...
La versión más reciente de este tema puede encontrarse en [paso 1: crear un proyecto y agregar etiquetas al formulario](https://docs.microsoft.com/visualstudio/ide/step-1-create-a-project-and-add-labels-to-your-form).  
...
7.  Seleccione el signo más (+) situado junto a la propiedad **Font** y, después, cambie el valor de la propiedad **Size** a **15,75**.  
     ...
     ![Ventana Propiedades en la que se muestra el tamaño de fuente](../ide/media/express-setfontsize.png "Express_setFontSize")  
...
16. Cambie el valor de la propiedad **(Name)** del control **NumericUpDown** a **suma**.  
     ...
     ![Primera fila de prueba matemática](../ide/media/express-firstrow.png "Express_firstRow")  
...
7.  Establezca el valor de la propiedad **TabIndex** del control de suma NumericUpDown en **2**, del control de diferencia en **3**, del control de producto en **4** y del control de cociente en **5**.  
     ...
     ![Formulario de prueba matemática inicial](../ide/media/express-formlaidout.png "Express_FormLaidOut")  
