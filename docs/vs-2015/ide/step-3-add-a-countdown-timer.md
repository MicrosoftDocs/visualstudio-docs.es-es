---
title: 'Paso 3: Agregar un temporizador de cuenta atrás | Documentos de Microsoft'
ms.date: 11/15/2016
...
- Para volver al paso anterior del tutorial, vea [Paso 2: Crear un problema de sumas aleatorias](../ide/step-2-create-a-random-addition-problem.md).
