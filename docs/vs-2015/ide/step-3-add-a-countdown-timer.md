...
ms.locfileid: "47580591"
---
# <a name="step-3-add-a-countdown-timer"></a>Paso 3: Agregar un temporizador de cuenta atrás
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [paso 3: agregar un temporizador](https://docs.microsoft.com/visualstudio/ide/step-3-add-a-countdown-timer).  
