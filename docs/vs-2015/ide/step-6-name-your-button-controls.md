...
ms.locfileid: "47574513"
---
# <a name="step-6-name-your-button-controls"></a>Paso 6: Asignar un nombre a los controles de botón
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [paso 6: nombre de los controles de botón](https://docs.microsoft.com/visualstudio/ide/step-6-name-your-button-controls).  
