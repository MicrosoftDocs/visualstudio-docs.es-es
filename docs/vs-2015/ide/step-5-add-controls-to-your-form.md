...
ms.locfileid: "47574049"
---
# <a name="step-5-add-controls-to-your-form"></a>Paso 5: Agregar controles al formulario
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [paso 5: agregar controles al formulario](https://docs.microsoft.com/visualstudio/ide/step-5-add-controls-to-your-form).  
