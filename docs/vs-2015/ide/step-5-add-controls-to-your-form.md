---
title: 'Paso 5: Agregar controles al formulario | Documentos de Microsoft'
ms.date: 11/15/2016
...
ms.locfileid: "60081585"
---
# <a name="step-5-add-controls-to-your-form"></a>Paso 5: adición de controles al formulario
...
- Para ir al siguiente paso del tutorial, vea [Paso 6: Nombre de los controles de botón](../ide/step-6-name-your-button-controls.md).  
