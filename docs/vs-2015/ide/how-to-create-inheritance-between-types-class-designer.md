...
La versión más reciente de este tema puede encontrarse en [Cómo: crear la herencia entre tipos (Diseñador de clases)](https://docs.microsoft.com/visualstudio/ide/how-to-create-inheritance-between-types-class-designer).  
