...
## <a name="see-also"></a>Consulte también
 [Inheritance](https://msdn.microsoft.com/library/81d64ee4-50f9-4d6c-a8dc-257c348d2eea) [Conceptos básicos de herencia](https://msdn.microsoft.com/library/dfc8deba-f5b3-4d1d-a937-7cb826446fc5) de herencia [Cómo: ver la herencia entre tipos (Diseñador de clases)](../ide/how-to-view-inheritance-between-types-class-designer.md) [Visual C++ clases en diseñador de clases](../ide/visual-cpp-classes-in-class-designer.md)
