...
ms.locfileid: "47580958"
---
# <a name="codeindex-command"></a>CodeIndex (Comando)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CodeIndex (comando)](https://docs.microsoft.com/visualstudio/ide/codeindex-command).  
