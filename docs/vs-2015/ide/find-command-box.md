...
ms.locfileid: "47574125"
---
# <a name="findcommand-box"></a>Buscar/Comando (cuadro)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [cuadro Buscar / comando](https://docs.microsoft.com/visualstudio/ide/find-command-box).  
