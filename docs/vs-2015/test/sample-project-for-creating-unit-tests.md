...
## <a name="working-with-the-code"></a>Trabajar con el código  
 Para trabajar con este código, primero tiene que crear un proyecto para él en [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]. Siga los pasos descritos en la sección "Preparar el tutorial" en [Tutorial: Crear y ejecutar pruebas unitarias para código administrado](../test/walkthrough-creating-and-running-unit-tests-for-managed-code.md).  
...
## <a name="see-also"></a>Vea también  
 ...
 [Tutorial: Ejecutar pruebas y ver cobertura de código](https://msdn.microsoft.com/d4aab8e2-2140-4975-b4e3-41ef3fa944c8)   
