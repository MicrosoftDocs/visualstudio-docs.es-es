...
La versión más reciente de este tema puede encontrarse en [la calidad del código C++ de análisis de aplicaciones de Store con análisis de código estático de Visual Studio](https://docs.microsoft.com/visualstudio/test/analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis).  
