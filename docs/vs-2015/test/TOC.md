...
#### [Tutorial: Creación y ejecución de pruebas unitarias para código administrado](walkthrough-creating-and-running-unit-tests-for-managed-code.md)
...
##### [Tutorial: Uso de un archivo de configuración para definir un origen de datos](walkthrough-using-a-configuration-file-to-define-a-data-source.md)
...
### [Tutorial: Crear, editar y mantener una prueba automatizada de IU](walkthrough-creating-editing-and-maintaining-a-coded-ui-test.md)
