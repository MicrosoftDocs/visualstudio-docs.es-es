...
## <a name="example-the-y2k-bug"></a><a name="BKMK_Example__The_Y2K_bug"></a> Ejemplo: el error Y2K
...
## <a name="how-to-use-shims"></a><a name="BKMK_Fakes_requirements"></a> Cómo usar las correcciones de compatibilidad (shim)

### <a name="add-fakes-assemblies"></a><a name="AddFakes"></a> Agregar ensamblados de Fakes
...
### <a name="use-shimscontext"></a><a name="ShimsContext"></a> Usar ShimsContext
...
### <a name="write-a-test-with-shims"></a><a name="WriteShims"></a> Escribir pruebas con correcciones de compatibilidad (shim)
...
## <a name="shims-for-different-kinds-of-methods"></a><a name="BKMK_Shim_basics"></a> Correcciones de compatibilidad (shim) para diferentes tipos de métodos
...
### <a name="static-methods"></a><a name="BKMK_Static_methods"></a> Métodos estáticos
...
### <a name="instance-methods-for-all-instances"></a><a name="BKMK_Instance_methods__for_all_instances_"></a> Métodos de instancia (para todas las instancias)
...
### <a name="instance-methods-for-one-runtime-instance"></a><a name="BKMK_Instance_methods__for_one_instance_"></a> Métodos de instancia (para una instancia en tiempo de ejecución)
...
### <a name="constructors"></a><a name="BKMK_Constructors"></a> Constructores
...
### <a name="base-members"></a><a name="BKMK_Base_members"></a> Miembros base
...
### <a name="finalizers"></a><a name="BKMK_Finalizers"></a> Los finalizadores
 Los finalizadores no se admiten en Fakes.

### <a name="private-methods"></a><a name="BKMK_Private_methods"></a> Métodos privados
...
### <a name="binding-interfaces"></a><a name="BKMK_Binding_interfaces"></a> Interfaces de enlace
...
## <a name="changing-the-default-behavior"></a><a name="BKMK_Changing_the_default_behavior"></a> Cambiar el comportamiento predeterminado
...
## <a name="detecting-environment-accesses"></a><a name="BKMK_Detecting_environment_accesses"></a> Detectar accesos al entorno
...
## <a name="concurrency"></a><a name="BKMK_Concurrency"></a> Simultaneidad
...
## <a name="calling-the-original-method-from-the-shim-method"></a><a name="BKMK_Calling_the_original_method_from_the_shim_method"></a> Llamar al método original desde el método Shim
