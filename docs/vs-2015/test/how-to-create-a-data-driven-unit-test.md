...
ms.locfileid: "47575557"
---
# <a name="how-to-create-a-data-driven-unit-test"></a>Cómo: Crear una prueba unitaria controlada por datos
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: crear una prueba unitaria controlada por datos de](https://docs.microsoft.com/visualstudio/test/how-to-create-a-data-driven-unit-test).  
