...
- [Método sometido a prueba.](../test/how-to-create-a-data-driven-unit-test.md#BKMK_The_method_under_test)
...
- [Escribir el método de prueba](../test/how-to-create-a-data-driven-unit-test.md#BKMK_Writing_the_test_method)
  ...
  - [Especificar DataSourceAttribute](../test/how-to-create-a-data-driven-unit-test.md#BKMK_Specifying_the_DataSourceAttribute)
...
## <a name="the-method-under-test"></a><a name="BKMK_The_method_under_test"></a> El método sometido a prueba
...
## <a name="creating-a-data-source"></a><a name="BKMK_Creating_a_data_source"></a> Crear un origen de datos
...
## <a name="adding-a-testcontext-to-the-test-class"></a><a name="BKMK_Adding_a_TestContext_to_the_test_class"></a> Agregar un TestContext para la clase de prueba
...
## <a name="writing-the-test-method"></a><a name="BKMK_Writing_the_test_method"></a> Escribir el método de prueba
...
### <a name="specifying-the-datasourceattribute"></a><a name="BKMK_Specifying_the_DataSourceAttribute"></a> Especificar el DataSourceAttribute
...
### <a name="using-testcontextdatarow-to-access-the-data"></a><a name="BKMK_Using_TestContext_DataRow_to_access_the_data"></a> Usar TestContext.DataRow para tener acceso a los datos
...
## <a name="running-the-test-and-viewing-results"></a><a name="BKMK_Running_the_test_and_viewing_results"></a> Ejecutar la prueba y ver los resultados
 Cuando haya terminado de escribir un método de prueba, compile el proyecto de prueba. El método de prueba aparece en la ventana Explorador de pruebas en el grupo **Pruebas no ejecutadas**. Al ejecutar, escribir y volver a ejecutar las pruebas, el Explorador de pruebas muestra los resultados en los grupos de **Pruebas no superadas**, **Pruebas superadas** y **Pruebas no ejecutadas**. Puede elegir **ejecutar todas** para ejecutar todas las pruebas o elegir **Ejecutar...** para elegir un subconjunto de pruebas que se va a ejecutar.
...
## <a name="see-also"></a>Consulte también
 ...
 [Cómo: crear y ejecutar una](https://msdn.microsoft.com/5e0f43cf-5e51-48e2-9c98-0eb9324bdc48) prueba unitaria de pruebas unitarias [el código](../test/unit-test-your-code.md) [ejecutar pruebas unitarias con el explorador de pruebas](../test/run-unit-tests-with-test-explorer.md) [escribir pruebas unitarias para el .NET Framework con el marco de pruebas unitarias de Microsoft para código administrado](../test/writing-unit-tests-for-the-dotnet-framework-with-the-microsoft-unit-test-framework-for-managed-code.md)
