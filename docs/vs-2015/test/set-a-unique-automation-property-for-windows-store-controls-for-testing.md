...
La versión más reciente de este tema puede encontrarse en [establecer una única propiedad para Windows Store los controles de automatización de pruebas](https://docs.microsoft.com/visualstudio/test/set-a-unique-automation-property-for-windows-store-controls-for-testing).  
