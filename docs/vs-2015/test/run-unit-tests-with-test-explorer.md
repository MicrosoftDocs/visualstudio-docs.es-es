...
La versión más reciente de este tema puede encontrarse en [ejecutar pruebas unitarias con el Explorador de pruebas](https://docs.microsoft.com/visualstudio/test/run-unit-tests-with-test-explorer).  
