...
ms.locfileid: "47577268"
---
# <a name="using-the-assert-classes"></a>Utilizar las clases Assert
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [mediante las clases Assert](https://docs.microsoft.com/visualstudio/test/using-the-assert-classes).  
