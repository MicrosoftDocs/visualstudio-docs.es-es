...
|**Realice análisis de esfuerzo y rendimiento usando pruebas de carga para las pruebas unitarias**: puede crear una prueba de carga y agregarle sus pruebas unitarias para ayudar a aislar los problemas de rendimiento y esfuerzo de la aplicación. **Nota:** La creación y el uso de pruebas de carga requiere Visual Studio Enterprise.|-   [Crear y editar pruebas de carga](http://msdn.microsoft.com/e2985d15-60a7-4177-93b4-f986c2936337)<br />-   [Cómo: Agregar pruebas de rendimiento web y pruebas unitarias a un escenario de prueba de carga](http://msdn.microsoft.com/03cc073e-9bdf-4530-ae46-504a51884594)<br />-   [Cómo: eliminar pruebas de web y pruebas unitarias desde un escenario de prueba de carga](http://msdn.microsoft.com/3d6128d2-82b0-42fc-bda2-23a8aa03be07)|  
...
## <a name="related-tasks"></a>Tareas relacionadas  
 [Revisar los resultados de pruebas en Microsoft Test Manager](http://msdn.microsoft.com/9fb3e429-78df-4fe2-89ed-0ad1db0738f4)  
