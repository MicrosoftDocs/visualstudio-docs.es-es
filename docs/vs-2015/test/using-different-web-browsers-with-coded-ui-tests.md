...
La versión más reciente de este tema puede encontrarse en [utilizando diferentes exploradores Web con pruebas de IU codificadas](https://docs.microsoft.com/visualstudio/test/using-different-web-browsers-with-coded-ui-tests).  
