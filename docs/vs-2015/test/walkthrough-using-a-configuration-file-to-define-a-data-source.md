...
La versión más reciente de este tema puede encontrarse en [Tutorial: uso de un archivo de configuración para definir un origen de datos](https://docs.microsoft.com/visualstudio/test/walkthrough-using-a-configuration-file-to-define-a-data-source).  
