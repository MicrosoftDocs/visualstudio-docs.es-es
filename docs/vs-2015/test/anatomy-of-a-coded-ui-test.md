...
ms.locfileid: "47575647"
---
# <a name="anatomy-of-a-coded-ui-test"></a>Anatomía de una prueba de IU codificada
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Anatomía de una prueba de IU codificada](https://docs.microsoft.com/visualstudio/test/anatomy-of-a-coded-ui-test).  
