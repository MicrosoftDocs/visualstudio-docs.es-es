...
La versión más reciente de este tema puede encontrarse en [generación de código, compilación y convenciones de nomenclatura en Microsoft Fakes](https://docs.microsoft.com/visualstudio/test/code-generation-compilation-and-naming-conventions-in-microsoft-fakes).  
