...
La versión más reciente de este tema puede encontrarse en [Tutorial: crear y ejecutar pruebas unitarias para Windows Store Apps](https://docs.microsoft.com/visualstudio/test/walkthrough-creating-and-running-unit-tests-for-windows-store-apps).  
...
## <a name="see-also"></a>Vea también  
 ...
 [Compilar y probar una aplicación de la Tienda Windows mediante Team Foundation Build](http://msdn.microsoft.com/library/d0ca17bb-deae-4f3d-a18d-1a99bebceaa9)
