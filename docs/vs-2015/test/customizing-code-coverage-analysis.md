...
3. En la página **Proceso**, expanda **Pruebas automatizadas**, **Origen de la prueba**, **Parámetros de ejecución**. Seleccione el archivo **.runsettings**.
   ...
   - <em>Pero el **ensamblado de prueba</em>* aparece en lugar de **origen de prueba**. Cuando intento establecer el campo **parámetros de ejecución** , solo puedo seleccionar archivos. testsettings.*
