...
La versión más reciente de este tema puede encontrarse en [diagramas de clases de propiedades de las asociaciones de UML](https://docs.microsoft.com/visualstudio/modeling/properties-of-associations-on-uml-class-diagrams).  
