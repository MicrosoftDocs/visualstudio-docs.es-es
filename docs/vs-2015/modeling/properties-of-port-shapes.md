...
ms.locfileid: "47577334"
---
# <a name="properties-of-port-shapes"></a>Propiedades de las formas de puerto
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [las propiedades de las formas de puerto](https://docs.microsoft.com/visualstudio/modeling/properties-of-port-shapes).  
