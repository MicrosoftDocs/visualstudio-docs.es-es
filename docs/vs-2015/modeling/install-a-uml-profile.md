...
ms.locfileid: "47582071"
---
# <a name="install-a-uml-profile"></a>Instalar un perfil UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [instalar un perfil UML](https://docs.microsoft.com/visualstudio/modeling/install-a-uml-profile).  
