...
La versión más reciente de este tema puede encontrarse en [Cómo: abrir un modelo desde un archivo de código de programa](https://docs.microsoft.com/visualstudio/modeling/how-to-open-a-model-from-file-in-program-code).  
