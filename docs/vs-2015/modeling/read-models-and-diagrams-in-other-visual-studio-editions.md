...
La versión más reciente de este tema puede encontrarse en [leer modelos y diagramas en otras ediciones de Visual Studio](https://docs.microsoft.com/visualstudio/modeling/read-models-and-diagrams-in-other-visual-studio-editions).  
