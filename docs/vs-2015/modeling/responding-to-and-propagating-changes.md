...
ms.locfileid: "47579112"
---
# <a name="responding-to-and-propagating-changes"></a>Responder a los cambios y propagarlos
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [responde a y propagar los cambios](https://docs.microsoft.com/visualstudio/modeling/responding-to-and-propagating-changes).  
