...
La versión más reciente de este tema puede encontrarse en [navegar y actualizar un modelo en el código de programa](https://docs.microsoft.com/visualstudio/modeling/navigating-and-updating-a-model-in-program-code).  
