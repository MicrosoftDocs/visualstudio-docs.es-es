...
- [Descripción de los requisitos de usuario: diagramas de casos de uso](#UnderstandUseCases)
...
### <a name="UnderstandUseCases"></a>Descripción de los requisitos de usuario: diagramas de casos de uso
...
- Durante un mensaje *sincrónico* , el objeto remitente espera a que el control se < \<return > > como en una llamada de función normal. Durante un mensaje *asincrónico* , el remitente puede continuar de inmediato.
