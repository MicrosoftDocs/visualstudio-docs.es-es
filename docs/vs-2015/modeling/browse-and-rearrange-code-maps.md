---
title: Explorar y reorganizar los mapas de códigos ? Microsoft Docs
ms.date: 11/15/2016
...
- Observe los clústeres de dependencia naturales en el código. En la barra de herramientas del mapa, elija el botón **Diseño**, **Clústeres rápidos**![de clústeres rápidos en](../modeling/media/quickclustersicon.gif "QuickClustersIcon")la barra de herramientas del gráfico . Consulte [Cambiar el diseño del mapa](#Selecting).

     ![Gráfico de dependencia &#45; diseño de clústeres rápidos](../modeling/media/dependencygraph-quickclusters.png "DependencyGraph_QuickClusters")
...
|------------|-----------------------------|
|Organizar el flujo de dependencias de todo el mapa en una dirección concreta. Esto puede ayudarle a ver las capas de la arquitectura del código.|En la barra de herramientas del mapa, elija **Diseño**y, a continuación:<br /><br /> -   **Botón** de gráfico de arriba a abajo ![de arriba a abajo](../modeling/media/topbottomgraphbutton.gif "TopBottomGraphButton")<br />-   **Botón de** gráfico de abajo a abajo de abajo ![a superior](../modeling/media/bottomtopgraphbutton.gif "BottomTopGraphButton")<br />-   **Botón** de diseño de izquierda a derecha ![de izquierda a derecha](../modeling/media/leftrightgraphbutton.gif "LeftRightGraphButton")<br />-   **Botón** de gráfico de derecha a ![izquierda a izquierda](../modeling/media/rightleftgraphbutton.gif "RightLeftGraphButton")|
|Consultar los clústeres de dependencia naturales en el código con los nodos más dependientes en el centro de los clústeres y los nodos menos dependientes fuera de dichos clústeres.|En la barra de herramientas del mapa, elija el botón **Diseño**y, a continuación,![el botón Clústeres rápidos](../modeling/media/quickclustersicon.gif "QuickClustersIcon")de **clústeres rápidos**en la barra de herramientas del gráfico .|
...
|Cambiar el diseño de un grupo independientemente del resto de nodos y grupos del mapa.|Seleccione un nodo y abra el menú contextual. Elija **Diseño** y seleccione un estilo de diseño.<br /><br /> O bien<br /><br /> Seleccione un nodo y expándalo para mostrar los nodos secundarios. Haga clic en el título del nodo para mostrar la barra de herramientas emergente del grupo y abra la barra de herramientas **cambiar el estilo de diseño del grupo**Gráfico de dependencia &#45; barra de herramientas de grupo &#45; lista de![diseño.](../modeling/media/dependencygraph-grouptoolbar.gif "DependencyGraph_GroupToolbar") Seleccione uno de los diseños de árbol, **Clústeres rápidos**o Vista de **lista** (que organiza el contenido del grupo en una lista).<br /><br /> Consulte [Agrupar nodos](#OrganizeGroups) para obtener más detalles.|
...
|Cambiar el diseño de un grupo.|Seleccione el grupo, abra el menú contextual, elija **Diseño**y seleccione el estilo de diseño que desee.<br /><br /> O bien<br /><br /> 1. Seleccione el grupo y asegúrese de que está expandido.<br />2. Vuelva a hacer clic en el encabezado del grupo y aparecerá la barra de herramientas del grupo.<br />     ![Gráfico de dependencia &#45; barra de herramientas del grupo](../modeling/media/dependencygraph-group.png "DependencyGraph_Group")<br />3. Abra el **Cambiar el estilo de diseño de la** lista de grupos Gráfico de dependencia &#45; barra de herramientas de grupo &#45; ![diseño](../modeling/media/dependencygraph-grouptoolbar.gif "DependencyGraph_GroupToolbar") y elija el estilo de diseño que desee.<br /><br /> **Vista** de lista reorganiza los miembros del grupo en la lista. **Gráfico predeterminado** restablece el diseño de grupo al diseño predeterminado del mapa. Para otras opciones, consulte [Cambiar el diseño del mapa.](#Selecting)|
...
|Agrupar nodos seleccionados.|1. Seleccione los nodos que desea agrupar. Aparece una barra de herramientas emergente por encima del último nodo seleccionado.<br />     ![Barra de herramientas del gráfico de dependencia](../modeling/media/depedencygraph-toolbar.png "DepedencyGraph_Toolbar")<br />2. En la barra de herramientas, elija el cuarto icono **Agrupar los nodos seleccionados** (si el nodo está expandido tendrá cinco en lugar de cuatro iconos). Escriba el nombre del nuevo grupo y pulse **Retorno**.<br />     O bien<br />     Seleccione los nodos que quiere agrupar y abra el menú contextual de la selección. Elija **Group (Grupo),** **Add Parent Group (Agregar grupo primario),** escriba el nombre del nuevo grupo y pulse **Return (Retorno).**<br /><br /> Puede cambiar el nombre de un grupo. Abra el menú contextual del grupo y elija **Editar**, **Propiedades** para abrir la ventana Propiedades de Visual Studio. En la propiedad **Label,** cambie el nombre del grupo según sea necesario.|
...
1. Seleccione el elemento de código de origen. Aparece una barra de herramientas por encima del elemento de código.
    ...
    ![Barra de herramientas del gráfico de dependencia](../modeling/media/depedencygraph-toolbar.png "DepedencyGraph_Toolbar")
...
3. Escriba sus comentarios. Para escribir en una nueva línea, pulse **SHIFT** + **RETURN**.
...
2. Escriba sus comentarios. Para escribir en una nueva línea, pulse **SHIFT** + **RETURN**.
...
2. Pulse **F2**o abra el menú contextual y elija **Editar**, **Cambiar nombre**.
...
5. Edite la **propiedad Label** en la ventana Propiedades de Visual Studio.
...
2. Si el elemento o vínculo forma parte de un grupo, el botón **Refetch Children** ![Icon](../modeling/media/dependencygraph-deletednodesicon.png "DependencyGraph_DeletedNodesIcon") aparece dentro del grupo. Haga clic aquí para recuperar los elementos y vínculos que faltan.
...
2. Abra el menú contextual y elija **Editar**, **Marcar para Seguimiento**.
...
## <a name="see-also"></a>Consulte también
 [Asignar dependencias entre las soluciones](../modeling/map-dependencies-across-your-solutions.md) Use mapas de [código para depurar las aplicaciones](../modeling/use-code-maps-to-debug-your-applications.md) Buscar posibles problemas [mediante analizadores](../modeling/find-potential-problems-using-code-map-analyzers.md) de mapas de código Personalizar mapas de código editando la referencia de lenguaje de marcado de gráficos dirigidos (DGML) de [archivos DGML editando la](../modeling/customize-code-maps-by-editing-the-dgml-files.md) referencia de lenguaje de marcado de [gráficos dirigidos (DGML)](../modeling/directed-graph-markup-language-dgml-reference.md) de archivos DGML