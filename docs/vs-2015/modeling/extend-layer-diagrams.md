...
ms.locfileid: "47577261"
---
# <a name="extend-layer-diagrams"></a>Extend layer diagrams
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ampliar diagramas de dependencia](https://docs.microsoft.com/visualstudio/modeling/extend-layer-diagrams).  
...
-   [SDK de modelado para Visual Studio 2015](http://www.microsoft.com/download/details.aspx?id=48148)  
 ...
 Para ver qué versiones de Visual Studio admiten diagramas de capas, vea [compatibilidad con la versión de arquitectura y las herramientas de modelado](../modeling/what-s-new-for-design-in-visual-studio.md#VersionSupport).  
