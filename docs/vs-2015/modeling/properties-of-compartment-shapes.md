...
ms.locfileid: "47567719"
---
# <a name="properties-of-compartment-shapes"></a>Propiedades de las formas de compartimiento
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [las propiedades de las formas de compartimiento](https://docs.microsoft.com/visualstudio/modeling/properties-of-compartment-shapes).  
