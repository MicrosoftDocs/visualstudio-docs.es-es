...
ms.locfileid: "47574580"
---
# <a name="defining-shapes-and-connectors"></a>Definir formas y conectores
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [definir formas y conectores](https://docs.microsoft.com/visualstudio/modeling/defining-shapes-and-connectors).  
