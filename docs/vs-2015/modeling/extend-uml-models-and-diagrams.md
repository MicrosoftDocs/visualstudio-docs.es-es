---
title: Extender los modelos y diagramas de UML Microsoft Docs
ms.date: 11/15/2016
...
En este tema se resumen los distintos mecanismos mediante los que se pueden ampliar las herramientas de modelado de UML de Visual Studio. Para ver qué versiones de Visual Studio admite cada tipo de modelo y herramienta, vea [Version support for architecture and modeling tools](../modeling/what-s-new-for-design-in-visual-studio.md#VersionSupport).
 ...
 Para obtener más información, consulte este vídeo: ![enlace al vídeo](../data-tools/media/playvideo.gif "PlayVideo")MSDN How Do I[Series: UML Tools and Extensibility](https://msdn.microsoft.com/vstudio/ff859492).
...
## <a name="custom-toolbox-items"></a>Elementos del cuadro de herramientas personalizados
 ...
 Para obtener más información, consulte Definir un elemento de cuadro de herramientas de [modelado personalizado.](../modeling/define-a-custom-modeling-toolbox-item.md)
...
## <a name="menu-commands"></a>Comandos de menú
 ...
 Consulte Definir un comando de [menú en un diagrama](../modeling/define-a-menu-command-on-a-modeling-diagram.md)de modelado .
...
## <a name="team-foundation-server-integration"></a>Integración de Team Foundation Server
 ...
 Para obtener más información, vea Definir un controlador de [vínculode elemento](../modeling/define-a-work-item-link-handler.md)de trabajo .
...
## <a name="tools-that-update-models"></a>Herramientas que actualizan modelos
 ...
 Para obtener más información, consulte Lectura de [un modelo UML en el código](../modeling/read-a-uml-model-in-program-code.md)de programa .

## <a name="domain-specific-languages"></a>Lenguajes específicos del dominio
 Si usa un determinado tipo de modelo frecuentemente, puede ser útil crear un lenguaje específico del dominio. Esto se puede realizar para ajustar sus necesidades comerciales con más detalle que un modelo UML, pero su compilación y mantenimiento requiere más esfuerzo. Para obtener más información, vea [Modelado de SDK para Visual Studio - Lenguajes específicos de dominio](../modeling/modeling-sdk-for-visual-studio-domain-specific-languages.md).

## <a name="external-resources"></a>Recursos externos

|**Categoría**|**Enlaces**|
|------------------|---------------|
|**Vídeos**|![enlace al vídeo](../data-tools/media/playvideo.gif "PlayVideo") [MSDN How Do I Series: UML Tools and Extensibility](https://msdn.microsoft.com/vstudio/ff859492)<br /><br /> ![enlace al vídeo](../data-tools/media/playvideo.gif "PlayVideo") [Channel 9: UML con Visual Studio](https://channel9.msdn.com/posts/clinted/)|
...
## <a name="see-also"></a>Consulte también
 [Crear modelos para](../modeling/create-models-for-your-app.md) la referencia de API de la aplicación [para la extensibilidad](../modeling/api-reference-for-uml-modeling-extensibility.md) de modelado UML
