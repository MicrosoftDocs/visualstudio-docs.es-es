---
title: Editar diagramas de secuencia de UML mediante la API de UML | Microsoft Docs
ms.date: 11/15/2016
...
- [Definir un elemento personalizado en un cuadro de herramientas de modelado](../modeling/define-a-custom-modeling-toolbox-item.md)
