---
title: Controladores de cambios de valor de propiedad de dominio | Microsoft Docs
ms.date: 11/15/2016
...
### <a name="alternative-technique-change-rules"></a>Técnica alternativa: cambiar reglas
 Si define una regla de cambio, se ejecuta al final de una transacción en la que cambia el valor de una propiedad.  Para obtener más información, vea [propagar los cambios dentro del modelo](../modeling/rules-propagate-changes-within-the-model.md).
