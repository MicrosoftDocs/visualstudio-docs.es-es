---
title: Compartir modelos y exportar diagramas | Documentos de Microsoft
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47567026"
---
# <a name="share-models-and-exporting-diagrams"></a>Compartir modelos y exportar diagramas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [compartir modelos y exportar diagramas](https://docs.microsoft.com/visualstudio/modeling/share-models-and-exporting-diagrams).  
...
## <a name="working-on-a-model-as-a-team"></a>Trabajar en un modelo como equipo  
 Los usuarios de Visual Studio pueden crear y editar modelos, diagramas de capas y gráficos dirigidos.  
 ...
 Para obtener más información, consulte [administrar modelos y diagramas con control de versiones](../modeling/manage-models-and-diagrams-under-version-control.md).  
...
|[Leer modelos y diagramas en otras ediciones de Visual Studio](../modeling/read-models-and-diagrams-in-other-visual-studio-editions.md)|Los usuarios de algunas versiones de Visual Studio no pueden crear modelos, pero sí leer modelos y diagramas.|  
