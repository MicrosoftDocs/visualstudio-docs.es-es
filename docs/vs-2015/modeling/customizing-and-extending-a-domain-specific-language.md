...
## <a name="in-this-section"></a><a name="customShapes"></a> En esta sección
...
|Propagar los cambios a recursos como otras [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] extensiones fuera del almacén.|Vea [los controladores de eventos propagan los cambios fuera del modelo](../modeling/event-handlers-propagate-changes-outside-the-model.md).|
...
|Eliminar, Reenlazar o volver a vincular elementos relacionados cuando se elimina un elemento.|Establezca **propaga** el valor de eliminación de un rol de relación. Para efectos más complejos, invalide `ShouldVisitRelationship` y `ShouldVisitRolePlayer` métodos en la `MyDslDeleteClosure` clase, definidos en **DomainModel.CS**<br /><br /> Consulte [personalizar el comportamiento de eliminación](../modeling/customizing-deletion-behavior.md)|
