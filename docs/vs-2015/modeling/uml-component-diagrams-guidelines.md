...
En Visual Studio, puede dibujar un *Diagrama de componentes* para mostrar la estructura de un sistema de software. Para ver una demostración en vídeo, vea [diseñar la estructura física mediante diagramas de componentes](https://channel9.msdn.com/blogs/clinted/uml-with-vs-2010-part-6-designing-a-projects-physical-structure).
