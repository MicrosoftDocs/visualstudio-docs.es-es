...
ms.locfileid: "47575296"
---
# <a name="develop-tests-from-a-model"></a>Desarrollar pruebas en un modelo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [desarrollar pruebas en un modelo](https://docs.microsoft.com/visualstudio/modeling/develop-tests-from-a-model).  
