...
En el [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] SDK de visualización y modelado, puede crear una definición de DSL incompleta que se puede importar en otro DSL. Esto le permite factorizar partes comunes de modelos similares.
