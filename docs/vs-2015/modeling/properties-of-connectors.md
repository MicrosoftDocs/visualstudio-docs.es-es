...
ms.locfileid: "47582583"
---
# <a name="properties-of-connectors"></a>Propiedades de los conectores
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [propiedades de conectores](https://docs.microsoft.com/visualstudio/modeling/properties-of-connectors).  
