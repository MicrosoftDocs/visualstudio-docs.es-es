---
title: Referencia de API para plantillas de texto T4 | Microsoft Docs
ms.date: 11/15/2016
...
|[Modelado](/previous-versions/ee844312(v=vs.140))|Proporciona utilidades de transformación de texto relacionadas con modelos UML y lenguajes específicos del dominio, tales como el acceso a ModelBus de [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].|
