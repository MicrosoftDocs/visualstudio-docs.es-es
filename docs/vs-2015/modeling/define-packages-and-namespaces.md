---
title: Definir los paquetes y los espacios de nombres | Microsoft Docs
ms.date: 11/15/2016
...
En Visual Studio, un *paquete* es un contenedor para las definiciones de elementos UML, como clases, casos de uso y componentes. Un paquete también puede contener otros paquetes.
...
## <a name="in-this-topic"></a>En este tema
 ...
 [Referencias de un espacio de nombres a otro](#References)
...
1. Abra el **Explorador de modelos UML**. En el menú **arquitectura** , elija **ventanas**y, a continuación, haga clic en el **Explorador de modelos UML**.
...
- Establezca la propiedad **LinkedPackage** de un diagrama para que los nuevos elementos creados en el diagrama se coloquen dentro del paquete que especifique. Los diagramas de clases, los diagramas de componentes y los diagramas de casos de uso se pueden vincular a un paquete de esta manera.

- Mover elementos dentro o fuera de un paquete en el Explorador de modelos UML.

  Un elemento en un paquete aparece debajo del paquete en el Explorador de modelos UML y su nombre completo comienza con el nombre completo del paquete. Para ver el nombre completo de cualquier elemento, haga clic con el botón secundario en el elemento y, a continuación, haga clic en **propiedades**. La propiedad **nombre completo** aparece en la ventana **propiedades** .
...
1. Abra el **Explorador de modelos UML**. En el menú **Ver** , seleccione **otras ventanas**y, a continuación, haga clic en explorador de **modelos UML**.
...
1. Abra un diagrama de clases en el que aparezca el paquete.
    ...
    - Para que un paquete existente aparezca en un diagrama de clases, puede arrastrar el paquete desde el **Explorador de modelos UML** hasta el diagrama de clases.
...
3. Abra las propiedades del diagrama. Haga clic con el botón secundario en una parte en blanco del diagrama y, a continuación, haga clic en **propiedades**.

4. En la propiedad **paquete vinculado** , elija el paquete que desea que contenga el contenido del diagrama.
...
1. En un diagrama de clases UML, seleccione todos los elementos que desea copiar. Haga clic con el botón secundario en uno de ellos y, a continuación, haga clic en **copiar**.
...
- Especificar el tipo del atributo mediante el nombre completo `SalesCommon::CustomerAddress`. Debe hacer esto solo si `CustomerAddress` tiene su propiedad **Visibility** establecida en **Public**.
...
|**Estereotipos**|(vacío)|Estereotipos aplicados a este paquete. La lista de estereotipos disponibles está determinada por los perfiles que eligió para este paquete y los paquetes que lo contienen. Para obtener más información, vea [personalizar el modelo con perfiles y estereotipos](../modeling/customize-your-model-with-profiles-and-stereotypes.md).|

## <a name="how-packages-are-stored"></a>Cómo se almacenan los paquetes
 Cuando se crea un nuevo paquete, se crea un nuevo archivo **. UML** en la carpeta del proyecto **ModelDefinition** . El modelo raíz, que también es un paquete, también se almacena en un archivo **. UML** .
