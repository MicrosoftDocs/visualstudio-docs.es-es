...
## <a name="see-also"></a>Vea también
 [Ampliar modelos y diagramas UML](../modeling/extend-uml-models-and-diagrams.md) [navegar por el ejemplo de modelo UML](../modeling/navigate-the-uml-model.md) [: alinear formas en un comando de menú de diagrama](http://go.microsoft.com/fwlink/?LinkId=213809) [ejemplo: crear elementos, formas y estereotipos](http://go.microsoft.com/fwlink/?LinkId=213811)
