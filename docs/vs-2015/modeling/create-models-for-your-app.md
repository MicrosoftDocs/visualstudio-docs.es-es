...
|[Definir espacios de nombres y paquetes](../modeling/define-packages-and-namespaces.md)|**Cree paquetes** para dividir un modelo en unidades en las que los distintos miembros del equipo pueden trabajar.|
|[Generar código a partir de diagramas de clases UML](../modeling/generate-code-from-uml-class-diagrams.md)|**Genere código de C# a partir de diagramas de clases** para iniciar la implementación.|
