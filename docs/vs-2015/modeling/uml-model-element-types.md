---
title: Tipos de elementos del modelo UML | Microsoft Docs
ms.date: 11/15/2016
...
Puede leer y manipular un modelo UML a través de una interfaz de programación. En este tema se resume la jerarquía de los tipos de elemento. La jerarquía es la misma que la que se define en la especificación de UML.
 ...
 Los detalles de cada tipo se proporcionan en [referencia de API para la extensibilidad del modelado UML](../modeling/api-reference-for-uml-modeling-extensibility.md).
...
## <a name="see-also"></a>Vea también
 [Definir un perfil para ampliar](../modeling/define-a-profile-to-extend-uml.md) las [restricciones de validación de definición de UML para modelos UML](../modeling/define-validation-constraints-for-uml-models.md) [referencia de la API para la EXtensibilidad del modelado UML](../modeling/api-reference-for-uml-modeling-extensibility.md)
