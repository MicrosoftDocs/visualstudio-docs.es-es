---
title: Directiva de plantilla T4 | Microsoft Docs
ms.date: 11/15/2016
...
### <a name="inheritance-in-a-design-time-text-template"></a>Herencia en una plantilla de texto en tiempo de diseño
 ...
 Para obtener más información, vea ["herencia en las plantillas de texto" en el blog de Gareth Jones](https://go.microsoft.com/fwlink/?LinkId=208373).
