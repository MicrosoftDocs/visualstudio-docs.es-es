...
## <a name="testing-the-directive-processor"></a>Probar el procesador de directivas  
 ...
 En este ejemplo, la plantilla de texto llama a la directiva y le pasa en el nombre de un archivo XML que contiene documentación para un archivo de clase. Para obtener más información, consulte [comentarios de documentación XML](https://msdn.microsoft.com/library/803b7f7b-7428-4725-b5db-9a6cff273199).  
