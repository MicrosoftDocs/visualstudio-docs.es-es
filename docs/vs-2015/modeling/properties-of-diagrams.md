...
|Expone el color de relleno como propiedad|Si `True`, el usuario puede establecer el color de relleno del diagrama del diseñador generado. Para establecer esto, haga clic con el botón secundario en la forma de diagrama y haga clic en **Agregar explosed**.|False|
|Expone el color del texto como propiedad|Si `True`, el usuario puede establecer el color del texto del diagrama en el diseñador generado. Para establecer esto, haga clic con el botón secundario en la forma de diagrama y haga clic en **Agregar explosed**.|False|
