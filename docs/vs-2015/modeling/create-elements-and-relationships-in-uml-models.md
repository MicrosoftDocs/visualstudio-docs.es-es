...
ms.locfileid: "47579489"
---
# <a name="create-elements-and-relationships-in-uml-models"></a>Crear elementos y relaciones en modelos UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [crear elementos y relaciones en modelos UML](https://docs.microsoft.com/visualstudio/modeling/create-elements-and-relationships-in-uml-models).  
