...
- Se agrega una referencia a `ModelBusAdapter` al proyecto `DslPackage`. `ModelBusAdapter` tiene una referencia al proyecto de `Dsl`.

- En **DslPackage\source.extention.TT**, se agrega `|ModelBusAdapter|` como componente MEF.
