...
La versión más reciente de este tema puede encontrarse en [propiedades de elementos de diagramas de actividades UML](https://docs.microsoft.com/visualstudio/modeling/properties-of-elements-on-uml-activity-diagrams).  
