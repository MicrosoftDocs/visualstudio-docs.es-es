...
ms.locfileid: "47581021"
---
# <a name="generate-files-from-a-uml-model"></a>Generar archivos a partir de un modelo UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [generar archivos a partir de un modelo UML](https://docs.microsoft.com/visualstudio/modeling/generate-files-from-a-uml-model).  
