...
## <a name="edition-support-for-architecture-and-modeling-tools"></a><a name="VersionSupport"></a> Compatibilidad de edición con las herramientas de arquitectura y modelado
...
|**Característica**|**Empresa**|**Profesional**|**Comunidad**|**Express**|
|-----------------|--------------------|----------------------|-------------------|-----------------|
