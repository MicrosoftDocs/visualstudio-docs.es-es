...
## <a name="see-also"></a>Consulte también
 <xref:System.ServiceModel.Activities.Receive>Cuadro de [diálogo Agregar CorrelationInitializers](../workflow-designer/add-correlationinitializers-dialog-box.md) [inicializar correlación (cuadro](../workflow-designer/initialize-correlation-dialog-box.md) de diálogo)