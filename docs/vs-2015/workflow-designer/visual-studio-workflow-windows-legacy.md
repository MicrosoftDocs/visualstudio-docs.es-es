---
title: Ventanas de flujo de trabajo de Visual Studio (heredado) | Microsoft Docs
ms.date: 11/15/2016
...
El [!INCLUDE[wfd2](../includes/wfd2-md.md)] heredado proporcionado por [!INCLUDE[vs2010](../includes/vs2010-md.md)] se puede usar para tener como destino [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] o [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)]. El diseñador heredado es un diseñador visual que puede usar para crear un flujo de trabajo. Puede arrastrar actividades desde el **cuadro de herramientas** hasta la superficie de diseño y, a continuación, configurarlas aquí. Como ventana del editor de [!INCLUDE[vsprvs](../includes/vsprvs-md.md)], ocupa el área de la ventana principal usada por otras ventanas del editor de [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]. El nombre del flujo de trabajo se muestra en la barra de título de la ventana de [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].
