...
|<xref:System.Activities.Statements.While.Condition%2A>|Verdadero|Contiene la expresión de [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] que se evalúa para determinar si se va a ejecutar la actividad en la propiedad <xref:System.Activities.Statements.While.Body%2A>.|
