...
> Haga clic aquí para obtener las notas de la versión para [Visual Studio 2017](https://www.visualstudio.com/news/releasenotes/vs2017-relnotes).
 ...
 Descarga [Visual Studio Community 2015](https://visualstudio.microsoft.com/vs/older-downloads/) gratis para empezar a codificar de inmediato. Si opta por un desarrollo multiplataforma, asegúrese de instalar los paquetes opcionales. Puede obtener más características con Visual Studio Professional o Visual Studio Enterprise.

 Póngase manos a la obra de inmediato: cree un nuevo proyecto y empiece a escribir código. Elija el tipo de aplicación que desea crear. O bien, puede realizar un recorrido por el [IDE](./ide/visual-studio-ide.md) de Visual Studio para familiarizarse con las herramientas.
...
## <a name="extend-visual-studio"></a>Ampliar Visual Studio
 ...
 Puede usar [.NET Compiler Platform (Roslyn)](https://github.com/dotnet/Roslyn) para escribir sus propios analizadores de código y generadores de código. 

 Busque extensiones para el IDE de Visual Studio en [Visual Studio Marketplace](https://visualstudiogallery.msdn.microsoft.com/). Las extensiones en Marketplace son creadas por los desarrolladores de Microsoft, así como por nuestra comunidad de desarrollo.
...
## <a name="build-apps-for-android-ios-and-windows"></a>Compilar aplicaciones para Android, iOS y Windows
 ...
 Para obtener información acerca de las aplicaciones universales de Windows (UWP), consulta ¿Qué es una aplicación para la Plataforma universal de [Windows (UWP)?](https://docs.microsoft.com/windows/uwp/get-started/universal-application-platform-guide).
...
- [C++ para el desarrollo móvil multiplataforma:](./cross-platform/visual-cpp-for-cross-platform-mobile-development.md)bibliotecas de código y aplicaciones compartidas en C++
...
## <a name="write-great-web-apps-with-aspnet"></a>Escribir grandes aplicaciones web con ASP.NET
 [ASP.NET 5](https://docs.microsoft.com/aspnet/core/?view=aspnetcore-3.0) es una actualización principal para MVC, WebAPI y SignalR, y se ejecuta en Windows, Mac y Linux.  ASP.NET se ha diseñado desde cero para proporcionarle una pila de .NET ajustada y componible para crear aplicaciones y servicios web modernos basados en la nube.
...
|||||
|-|-|-|-|
|[Novedades de Visual Studio 2015](./what-s-new-in-visual-studio-2015.md)|[Novedades de C #](https://msdn.microsoft.com/library/9f18dc26-27fa-4603-a639-b573f07a117b)|[Novedades de .NET Framework](https://msdn.microsoft.com/library/1d971dd7-10fc-4692-8dac-30ca308fc0fa)|[Novedades de Azure DevOps Server](/azure/devops/server/whats-new)|
|[Novedades de C++](https://docs.microsoft.com/previous-versions/hh409293(v=vs.140))|[Novedades de Visual Basic](https://msdn.microsoft.com/library/d7e97396-7f42-4873-a81c-4ebcc4b6ca02)|[Novedades de JavaScript](https://docs.microsoft.com/visualstudio/javascript/javascript-in-visual-studio?view=vs-2015#whats-new-in-javascript)||
