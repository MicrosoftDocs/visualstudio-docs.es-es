...
Por Visual Basic, Visual Studio 2015 presentó no los cambios que impedirán que una aplicación Visual Basic creada en Visual Studio 2013 se compile. El comportamiento en tiempo de ejecución de las aplicaciones Visual Basic que se vuelven a compilar con Visual Studio 2015 no cambiará.
...
|Visual Basic 6 y Visual C++ 6|Visual Studio 2012 y Visual Studio 2013 no admiten la depuración de aplicaciones compiladas C++ con Visual Basic 6 o visual 6; para depurar estas aplicaciones, use versiones anteriores de Visual Studio.|
...
|Depurador de clúster MPI|Si la misma versión del motor en tiempo de ejecución o las herramientas de está instalada en los equipos que ejecutan Visual Studio 2013, Visual Studio 2012 o Visual Studio 2010 SP1, puede abrir este proyecto en las tres versiones.|
...
|Office 2007 VSTO|Si actualiza el proyecto para que tenga como destino Office 2013 y el .NET Framework 4, puede abrir este proyecto en Visual Studio 2013, Visual Studio 2012 o Visual Studio 2010 SP1.|
|Office 2010 VSTO|Si el proyecto tiene como destino el .NET Framework 4, puede abrirlo en Visual Studio 2013, Visual Studio 2012 y Visual Studio 2010 SP1. Todos los demás proyectos requieren una actualización unidireccional.|
...
|Archivos de definición de informe de cliente (.rdlc)|Puede abrir estos archivos en Visual Studio 2013 y el esquema se actualiza automáticamente si agrega Visual Studio 2013 características y controles.|
