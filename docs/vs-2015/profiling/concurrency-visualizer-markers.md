...
ms.locfileid: "47575668"
---
# <a name="concurrency-visualizer-markers"></a>Marcadores del Visualizador de simultaneidad
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [marcadores del visualizador de simultaneidad](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer-markers).  
