...
ms.locfileid: "47575060"
---
# <a name="da0023-high-gc-cpu-time"></a>DA0024: Tiempo elevado de CPU de GC
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [DA0023: tiempo elevado de CPU de GC](https://docs.microsoft.com/visualstudio/profiling/da0023-high-gc-cpu-time).  
  
Id. de regla | DA0023 |  
| Categoría |. Uso de .NET Framework |  
| Método de generación de perfiles | Todos los |  
| Mensaje | % de tiempo del GC es bastante alto. Esta indicación de una cantidad excesiva de sobrecarga de la recolección de elementos no utilizados podría estar afectando a la capacidad de respuesta de la aplicación. Puede recopilar memoria de .NET asignación datos y objeto de duración información para entender el patrón de asignación de memoria de la aplicación utiliza mejor. |  
