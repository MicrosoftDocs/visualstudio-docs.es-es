...
ms.locfileid: "47577474"
---
# <a name="cvinitprovider-function"></a>CvInitProvider (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CvInitProvider (función)](https://docs.microsoft.com/visualstudio/profiling/cvinitprovider-function).  
