...
ms.locfileid: "47574096"
---
# <a name="vsinstr-warnings"></a>Advertencias de VSInstr
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [advertencias de VSInstr](https://docs.microsoft.com/visualstudio/profiling/vsinstr-warnings).  
