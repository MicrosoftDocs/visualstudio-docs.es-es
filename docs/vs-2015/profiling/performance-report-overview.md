...
ms.locfileid: "47576233"
---
# <a name="performance-report-overview"></a>Información general sobre el informe de rendimiento
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [información general sobre el informe de rendimiento](https://docs.microsoft.com/visualstudio/profiling/performance-report-overview).  
