...
La versión más reciente de este tema puede encontrarse en [Cómo: límite de instrumentación a funciones específicas](https://docs.microsoft.com/visualstudio/profiling/how-to-limit-instrumentation-to-specific-functions).  
