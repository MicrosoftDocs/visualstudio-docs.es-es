...
1. En Visual Studio, establezca la configuración de soluciones en **Versión** y elija el destino de implementación.  
    ...
    ![Selección de Versión y Máquina local](../profiling/media/cpuuse-selectreleaselocalmachine.png "CPUUSE_SelectReleaseLocalMachine")  
   ...
   - En el caso de las aplicaciones Windows Phone, la recopilación de datos directamente desde el **dispositivo** proporciona los datos más precisos.  
  
2. En el menú **depurar** , elija **generador de perfiles de rendimiento..**..  
  
3. Elija **Uso de CPU** y luego elija **Iniciar**.  
  
    ![Escoger el uso de CPU](../profiling/media/cpuuse-lib-choosecpuusage.png "CPUUSE_LIB_ChooseCpuUsage")  
