...
ms.locfileid: "47566218"
---
# <a name="marks-view"></a>Vista Marcas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [vista marcas](https://docs.microsoft.com/visualstudio/profiling/marks-view).  
