...
ms.locfileid: "47575563"
---
# <a name="performance-report-view-filter"></a>Filtro de vista Informe de rendimiento
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [filtro de vista de informe de rendimiento](https://docs.microsoft.com/visualstudio/profiling/performance-report-view-filter).  
