...
## <a name="whats-new-in-update-1"></a>Novedades de Update 1  
 ...
 Se agregaron opciones de búsqueda y filtrado en la ficha **Eventos** de la ventana **Herramientas de diagnóstico** . Para obtener más información, consulte [integradas del depurador de generación de perfiles](http://msdn.microsoft.com/library/a1f40370-7b61-42c2-afc4-0e13eba98859) y [búsqueda y filtrado de la ficha eventos de la ventana de herramientas de diagnóstico](http://blogs.msdn.com/b/visualstudioalm/archive/2015/11/12/searching-and-filtering-the-events-tab-of-the-diagnostic-tools-window.aspx).  
