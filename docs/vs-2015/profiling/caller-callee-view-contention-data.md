...
ms.locfileid: "47581269"
---
# <a name="caller--callee-view----contention-data"></a>Vista Llamador y destinatario: datos de contención
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [vista llamador y destinatario: datos de contención](https://docs.microsoft.com/visualstudio/profiling/caller-callee-view-contention-data).  
