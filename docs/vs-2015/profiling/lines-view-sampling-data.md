...
ms.locfileid: "47573756"
---
# <a name="lines-view---sampling-data"></a>Vista Líneas: datos de muestreo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [vista líneas: datos de muestreo](https://docs.microsoft.com/visualstudio/profiling/lines-view-sampling-data).  
