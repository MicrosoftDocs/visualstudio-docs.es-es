...
ms.locfileid: "47575052"
---
# <a name="cvwritemessage-function"></a>CvWriteMessage (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CvWriteMessage (función)](https://docs.microsoft.com/visualstudio/profiling/cvwritemessage-function).  
