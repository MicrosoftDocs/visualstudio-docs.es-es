...
ms.locfileid: "47575131"
---
# <a name="empty-timeline-segment"></a>Segmento de escala de tiempo vacío
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [segmento de escala de tiempo vacío](https://docs.microsoft.com/visualstudio/profiling/empty-timeline-segment).  
