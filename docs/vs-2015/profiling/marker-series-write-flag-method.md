...
ms.locfileid: "47579720"
---
# <a name="markerserieswriteflag-method"></a>marker_series::write_flag (Método)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [marker_series::write_flag método](https://docs.microsoft.com/visualstudio/profiling/marker-series-write-flag-method).  
