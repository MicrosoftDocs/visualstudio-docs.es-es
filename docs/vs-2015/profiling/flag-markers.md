...
ms.locfileid: "47574985"
---
# <a name="flag-markers"></a>Marcadores de marca
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [marcadores de marca](https://docs.microsoft.com/visualstudio/profiling/flag-markers).  
