...
La versión más reciente de este tema puede encontrarse en [mediante generación de perfiles de los métodos para recopilar datos de rendimiento desde la línea de comandos](https://docs.microsoft.com/visualstudio/profiling/using-profiling-methods-to-collect-performance-data-from-the-command-line).  
