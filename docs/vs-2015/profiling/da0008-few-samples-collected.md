...
ms.locfileid: "47582954"
---
# <a name="da0008-few-samples-collected"></a>DA0008: Pocos ejemplos recolectados
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [DA0008: pocos ejemplos recolectados](https://docs.microsoft.com/visualstudio/profiling/da0008-few-samples-collected).  
