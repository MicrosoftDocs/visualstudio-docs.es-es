...
|------------|-----------------|----------------|-------------------|  
|Consulta|Devuelve si la recolección se puede iniciar.|None|0 si la recolección está lista para comenzar.<br /><br /> 1 si la recolección ya está en curso.<br /><br /> 2 Si la recolección no está en curso, pero una o varias de las sesiones de [ETW](https://msdn.microsoft.com/library/ac99a063-e2d2-40cc-b659-d23c2f783f92) necesarias ya están habilitadas.|  
