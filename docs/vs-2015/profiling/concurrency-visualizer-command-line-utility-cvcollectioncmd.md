...
La versión más reciente de este tema puede encontrarse en [utilidad visualizador de simultaneidad de línea de comandos (Cvcollectioncmd.exe)](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer-command-line-utility-cvcollectioncmd).  
