...
ms.locfileid: "47580729"
---
# <a name="gpu-activity-graph"></a>Gráfico de actividad de GPU
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [gráfico de actividad de GPU](https://docs.microsoft.com/visualstudio/profiling/gpu-activity-graph).  
