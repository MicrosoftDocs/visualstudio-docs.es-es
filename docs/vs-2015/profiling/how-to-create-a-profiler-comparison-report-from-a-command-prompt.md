...
---
# <a name="how-to-create-a-profiler-comparison-report-from-a-command-prompt"></a>Procedimiento Creación de un informe de comparación de generador de perfiles desde un símbolo del sistema
