...
ms.locfileid: "47577206"
---
# <a name="spanspan-constructor"></a>span::span (Constructor)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [span::span Constructor](https://docs.microsoft.com/visualstudio/profiling/span-span-constructor).  
