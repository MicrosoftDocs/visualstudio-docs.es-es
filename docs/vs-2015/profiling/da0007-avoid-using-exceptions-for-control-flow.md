...
La versión más reciente de este tema puede encontrarse en [DA0007: Evite utilizar excepciones para el flujo de control](https://docs.microsoft.com/visualstudio/profiling/da0007-avoid-using-exceptions-for-control-flow).  
