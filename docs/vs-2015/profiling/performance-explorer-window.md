...
ms.locfileid: "47581664"
---
# <a name="performance-explorer-window"></a>Ventana Explorador de rendimiento
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ventana Explorador de rendimiento](https://docs.microsoft.com/visualstudio/profiling/performance-explorer-window).  
