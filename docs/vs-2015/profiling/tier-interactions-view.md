...
ms.locfileid: "47578645"
---
# <a name="tier-interactions-view"></a>Interacciones de capas (vista)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [vista interacciones de capas](https://docs.microsoft.com/visualstudio/profiling/tier-interactions-view).  
