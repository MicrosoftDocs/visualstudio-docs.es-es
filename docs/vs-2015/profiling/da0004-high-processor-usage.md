...
| Mensaje | El uso del procesador se encuentra por encima del 75%. Considere la posibilidad de usar el modo de muestreo para aplicaciones enlazadas a la CPU.|  
