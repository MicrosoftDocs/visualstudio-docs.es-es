...
ms.locfileid: "47567257"
---
# <a name="html-ui-responsiveness"></a>Capacidad de respuesta de IU HTML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [analizar HTML de la IU en aplicaciones para UWP](https://docs.microsoft.com/visualstudio/profiling/html-ui-responsiveness).  
