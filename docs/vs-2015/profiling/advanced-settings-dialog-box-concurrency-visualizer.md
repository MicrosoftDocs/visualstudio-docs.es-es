...
La versión más reciente de este tema puede encontrarse en [cuadro de diálogo de configuración avanzada (Visualizador de simultaneidad)](https://docs.microsoft.com/visualstudio/profiling/advanced-settings-dialog-box-concurrency-visualizer).  
