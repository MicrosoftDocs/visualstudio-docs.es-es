...
La versión más reciente de este tema puede encontrarse en [DA0014: tasas extremadamente altas de paginación de memoria activa en el disco](https://docs.microsoft.com/visualstudio/profiling/da0014-extremely-high-rates-of-paging-active-memory-to-disk).  
