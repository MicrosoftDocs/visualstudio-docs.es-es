...
La versión más reciente de este tema puede encontrarse en [DA0018: aplicación de 32 bits que se ejecuta en proceso de los límites de memoria administrada](https://docs.microsoft.com/visualstudio/profiling/da0018-32-bit-application-running-at-process-managed-memory-limits).  
