...
| Mensaje | La recopilación de mediciones de interacción para aplicaciones de varios niveles le ayudará a comprender los patrones de uso de la base de datos y los retrasos de acceso a datos clave. Intente generar de nuevo el perfil de la aplicación con la opción de generación de perfiles de interacción de capas habilitada.|  
