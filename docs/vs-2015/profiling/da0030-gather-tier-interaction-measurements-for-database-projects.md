...
La versión más reciente de este tema puede encontrarse en [DA0030: mediciones de recopilar la interacción de capas para proyectos de base de datos de](https://docs.microsoft.com/visualstudio/profiling/da0030-gather-tier-interaction-measurements-for-database-projects).  
