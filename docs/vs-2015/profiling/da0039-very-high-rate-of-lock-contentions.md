...
ms.locfileid: "58355462"
---
# <a name="da0039-very-high-rate-of-lock-contentions"></a>DA0039: Tasa muy alta de contenciones de bloqueo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Para obtener la documentación más reciente de Visual Studio, consulte [DA0039: muy alta frecuencia de contenciones de bloqueo](https://docs.microsoft.com/visualstudio/profiling/da0039-very-high-rate-of-lock-contentions) en docs.microsoft.com.  
