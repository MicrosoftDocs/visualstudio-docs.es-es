...
ms.locfileid: "47575802"
---
# <a name="process-view"></a>Vista Proceso
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [vista proceso](https://docs.microsoft.com/visualstudio/profiling/process-view).  
