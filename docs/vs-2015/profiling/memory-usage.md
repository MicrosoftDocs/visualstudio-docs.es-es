...
- También puede comparar (diff) dos instantáneas de una aplicación para buscar las áreas del código que generen un aumento del uso de la memoria con el tiempo.  
  ...
  También puede usar la herramienta de memoria fuera del depurador. Vea [uso de memoria sin depuración](https://msdn.microsoft.com/library/8883bc5f-df86-4f84-aa2b-a21150f499b0).  
...
>   
> ![Habilitación de las instantáneas](../profiling/media/dbgdiag-mem-mixedtoolbar-enablesnapshot.png "DBGDIAG_MEM_MixedToolbar_EnableSnapshot")  
>   
> Detenga la depuración (tecla de método abreviado: **Mayús + F5**) y reiníciela.  
 ...
 ![Toma de instantáneas](../profiling/media/dbgdiag-mem-mixedtoolbar-takesnapshot.png "DBGDIAG_MEM_MixedToolbar_TakeSnapshot")  
...
### <a name="managed-types-reports"></a>Informes de tipos administrados  
 ...
 ![Informe de tipo de depurador administrado: rutas de acceso al nodo raíz](../profiling/media/dbgdiag-mem-managedtypesreport-pathstoroot.png "DBGDIAG_MEM_ManagedTypesReport_PathsToRoot")  
 ...
 ![Vista de informe de tipos de referencia adminstrados](../profiling/media/dbgdiag-mem-managedtypesreport-referencedtypes.png "DBGDIAG_MEM_ManagedTypesReport_ReferencedTypes")  
  
 Para mostrar las instancias de un tipo seleccionado en el panel superior, elija el icono ![Instancia](../profiling/media/dbgdiag-mem-instanceicon.png "DBGDIAG_MEM_InstanceIcon").  
...
- Elija una instantánea de la lista **Comparar con** en un informe administrado o nativo.  
   ...
   ![Elección de una instantánea en la lista Comparar con](../profiling/media/dbgdiag-mem-choosecompareto.png "DBGDIAG_MEM_ChooseCompareTo")  
