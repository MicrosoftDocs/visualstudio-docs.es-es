...
|        `Xmlns`         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 Atributo Required (en MSBuild 15. x y versiones anteriores).<br /><br /> El atributo `xmlns` debe tener el valor de `http://schemas.microsoft.com/developer/msbuild/2003`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
