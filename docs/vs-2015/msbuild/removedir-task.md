...
ms.locfileid: "47582572"
---
# <a name="removedir-task"></a>RemoveDir (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [RemoveDir (tarea)](https://docs.microsoft.com/visualstudio/msbuild/removedir-task).  
