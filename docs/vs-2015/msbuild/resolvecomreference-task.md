...
ms.locfileid: "47582010"
---
# <a name="resolvecomreference-task"></a>ResolveComReference (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ResolveComReference (tarea)](https://docs.microsoft.com/visualstudio/msbuild/resolvecomreference-task).  
