...
ms.locfileid: "47582841"
---
# <a name="msbuild-command-line-reference"></a>Referencia de la línea de comandos de MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [referencia de línea de comandos de MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-command-line-reference).  
