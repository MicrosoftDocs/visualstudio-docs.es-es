...
ms.locfileid: "47582704"
---
# <a name="msbuild-properties1"></a>MSBuild Properties1
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [las propiedades de MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-properties).  
