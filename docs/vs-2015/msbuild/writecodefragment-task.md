...
ms.locfileid: "47581935"
---
# <a name="writecodefragment-task"></a>WriteCodeFragment (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [WriteCodeFragment (tarea)](https://docs.microsoft.com/visualstudio/msbuild/writecodefragment-task).  
