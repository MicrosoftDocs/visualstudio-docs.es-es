...
ms.locfileid: "47576490"
---
# <a name="item-element-msbuild"></a>Elemento Item (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [elemento Item (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/item-element-msbuild).  
