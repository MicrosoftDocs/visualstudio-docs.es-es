...
ms.locfileid: "47567251"
---
# <a name="wpf-msbuild-task-reference"></a>Referencia de tareas de MSBuild para WPF
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [referencia tareas de MSBuild para WPF](https://docs.microsoft.com/visualstudio/msbuild/wpf-msbuild-task-reference).  
