...
ms.locfileid: "47575259"
---
# <a name="creating-forwarding-loggers"></a>Crear registradores de reenvío
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [crear registradores de reenvío](https://docs.microsoft.com/visualstudio/msbuild/creating-forwarding-loggers).  
