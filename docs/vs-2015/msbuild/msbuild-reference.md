...
ms.locfileid: "47576884"
---
# <a name="msbuild-reference"></a>Referencia de MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [referencia de MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-reference).  
