...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe algunas de las tareas habituales que se incluyen en [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)].  
  
 [Condiciones](../msbuild/msbuild-conditions.md)  
 Describe las condiciones que están disponibles en los archivos [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)].  
 ...
 Proporciona vínculos a sitios web y grupos de noticias de [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)].  
  
 [Referencia de MSBuild para WPF](../msbuild/wpf-msbuild-reference.md)  
 Contiene una referencia de destino y tarea [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] para Windows Presentation Foundation (WPF).  
...
## <a name="related-sections"></a>Secciones relacionadas  
 [Información general sobre MSBuild](https://msdn.microsoft.com/e39f13f7-1e1d-4435-95ca-0c222bca071c) Presenta [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] y proporciona vínculos a temas que explican cómo usarlo para compilar proyectos.  
