...
ms.locfileid: "47582803"
---
# <a name="assignprojectconfiguration-task"></a>AssignProjectConfiguration (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [tarea AssignProjectConfiguration](https://docs.microsoft.com/visualstudio/msbuild/assignprojectconfiguration-task).  
