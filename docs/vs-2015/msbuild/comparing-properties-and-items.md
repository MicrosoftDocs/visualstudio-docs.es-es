...
ms.locfileid: "47574684"
---
# <a name="comparing-properties-and-items"></a>Comparar propiedades y elementos
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [comparar propiedades y elementos](https://docs.microsoft.com/visualstudio/msbuild/comparing-properties-and-items).  
