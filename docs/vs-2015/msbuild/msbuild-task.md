...
ms.locfileid: "47576890"
---
# <a name="msbuild-task"></a>MSBuild (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [tarea MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-task).  
