...
La versión más reciente de este tema puede encontrarse en [Cómo: usar el mismo destino en varios archivos de proyecto](https://docs.microsoft.com/visualstudio/msbuild/how-to-use-the-same-target-in-multiple-project-files).  
