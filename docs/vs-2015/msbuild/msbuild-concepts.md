...
ms.locfileid: "47581997"
---
# <a name="msbuild-concepts"></a>Conceptos de MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [conceptos de MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-concepts).  
...
|[MSBuild](http://msdn.microsoft.com/en-us/e39f13f7-1e1d-4435-95ca-0c222bca071c)|Ofrece información general sobre el esquema XML de un archivo del proyecto y muestra cómo controla los procesos que compilan el software.|
