...
## <a name="creating-an-msbuild-project"></a>Crear un proyecto de MSBuild  
...
## <a name="examining-the-project-file"></a>Examinar el archivo del proyecto.  
...
1. En **Explorador de soluciones**, haga clic en el nodo del proyecto BuildApp.  
  
2. En el explorador de **propiedades** , observe que la propiedad del **archivo de proyecto** es BuildApp. csproj. Todos los nombres de los archivos del proyecto llevan el sufijo "proj". Si hubiera creado un proyecto de Visual Basic, el nombre del archivo del proyecto sería BuildApp.vbproj.  
...
- Un destino es una secuencia con nombre de tareas. Hay dos destinos al final del archivo del proyecto incluidos actualmente en comentarios HTML: BeforeBuild y AfterBuild.  
  ...
  ```  
   ...
   Para obtener más información, consulte el tema [Destinos](../msbuild/msbuild-targets.md).  
...
```  
 ...
 El destino Build no se define en el archivo del proyecto. En su lugar, se importa del archivo Microsoft.CSharp.targets mediante el elemento [Import](../msbuild/import-element-msbuild.md).  
...
## <a name="adding-a-target-and-a-task"></a>Agregar un destino y una tarea  
...
## <a name="building-the-target"></a>Compilar el destino  
...
```  
 ...
 define la propiedad denominada TargetFrameworkVersion, dándole el valor de cadena "v12.0".  
...
## <a name="examining-a-property-value"></a>Examinar el valor de una propiedad  
...
4. Examine los resultados. Debe ver esta línea:  
   ...
   Para obtener más información, consulte [caracteres especiales de MSBuild](../msbuild/msbuild-special-characters.md).  
...
## <a name="whats-next"></a>Pasos siguientes  
 Para obtener información sobre cómo crear un archivo de proyecto sencillo paso a paso, pruebe el [Tutorial: crear un archivo de proyecto de MSBuild desde el principio](../msbuild/walkthrough-creating-an-msbuild-project-file-from-scratch.md).  
