...
ms.locfileid: "47582143"
---
# <a name="how-to-clean-a-build"></a>Cómo: Limpiar los resultados de una compilación
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: limpiar una compilación](https://docs.microsoft.com/visualstudio/msbuild/how-to-clean-a-build).  
