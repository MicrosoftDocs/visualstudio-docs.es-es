...
ms.locfileid: "47575924"
---
# <a name="cppclean-task"></a>CPPClean (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CPPClean (tarea)](https://docs.microsoft.com/visualstudio/msbuild/cppclean-task).  
