...
ms.locfileid: "47567432"
---
# <a name="converttoabsolutepath-task"></a>ConvertToAbsolutePath (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ConvertToAbsolutePath (tarea)](https://docs.microsoft.com/visualstudio/msbuild/converttoabsolutepath-task).  
