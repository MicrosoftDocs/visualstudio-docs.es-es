...
ms.locfileid: "47575517"
---
# <a name="xmlpoke-task"></a>XmlPoke (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [XmlPoke (tarea)](https://docs.microsoft.com/visualstudio/msbuild/xmlpoke-task).  
