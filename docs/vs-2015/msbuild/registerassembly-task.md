...
ms.locfileid: "47582690"
---
# <a name="registerassembly-task"></a>RegisterAssembly (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [RegisterAssembly (tarea)](https://docs.microsoft.com/visualstudio/msbuild/registerassembly-task).  
