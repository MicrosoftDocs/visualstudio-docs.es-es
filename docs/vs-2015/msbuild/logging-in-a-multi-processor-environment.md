...
ms.locfileid: "47582809"
---
# <a name="logging-in-a-multi-processor-environment"></a>Registrar en un entorno de varios procesadores
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [registrar en un entorno de varios procesadores](https://docs.microsoft.com/visualstudio/msbuild/logging-in-a-multi-processor-environment).  
