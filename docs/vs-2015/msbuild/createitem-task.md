...
ms.locfileid: "47574678"
---
# <a name="createitem-task"></a>CreateItem (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CreateItem (tarea)](https://docs.microsoft.com/visualstudio/msbuild/createitem-task).  
