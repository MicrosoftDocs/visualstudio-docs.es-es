...
|`LangVersion`|Parámetro <!-- TODO: review code entity reference <xref:assetId:///String?qualifyHint=False&amp;autoUpgrade=True>  -->String opcional.<br /><br /> Especifica la versión del idioma, "9" o "10".|  
