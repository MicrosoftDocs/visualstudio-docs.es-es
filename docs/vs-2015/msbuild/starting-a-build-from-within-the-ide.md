...
ms.locfileid: "47577286"
---
# <a name="starting-a-build-from-within-the-ide"></a>Iniciar una compilación desde el IDE
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [iniciar una compilación desde el IDE](https://docs.microsoft.com/visualstudio/msbuild/starting-a-build-from-within-the-ide).  
