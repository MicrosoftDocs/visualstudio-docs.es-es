...
|Title|Descripción|  
|-----------|-----------------|  
|[BscMake (tarea)](../msbuild/bscmake-task.md)|Ajusta la herramienta Utilidad de mantenimiento de información de examen de Microsoft (bscmake.exe).|  
|[CL (tarea)](../msbuild/cl-task.md)|Incluye la herramienta compilador de Visual C++, cl.exe.|  
...
|[LIB (tarea)](../msbuild/lib-task.md)|Incluye la herramienta Administrador de bibliotecas de 32 bits de Microsoft (lib.exe).|  
...
|[SetEnv (tarea)](../msbuild/setenv-task.md)|Establece o elimina el valor de una variable de entorno especificada.|  
...
|[Escritura de tareas](../msbuild/task-writing.md)|Describe cómo se crea una tarea.|
