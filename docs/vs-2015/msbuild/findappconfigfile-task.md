...
ms.locfileid: "47567725"
---
# <a name="findappconfigfile-task"></a>FindAppConfigFile (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [FindAppConfigFile (tarea)](https://docs.microsoft.com/visualstudio/msbuild/findappconfigfile-task).  
