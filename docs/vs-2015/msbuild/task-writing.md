...
ms.locfileid: "47567247"
---
# <a name="task-writing"></a>Escribir tareas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [escribir tareas](https://docs.microsoft.com/visualstudio/msbuild/task-writing).  
