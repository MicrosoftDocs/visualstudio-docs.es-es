...
ms.locfileid: "47578838"
---
# <a name="task-element-msbuild"></a>Elemento de tarea (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [elemento Task (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/task-element-msbuild).  
