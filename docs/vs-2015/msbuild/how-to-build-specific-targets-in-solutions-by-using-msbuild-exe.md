...
La versión más reciente de este tema puede encontrarse en [Cómo: Compilar destinos específicos en soluciones mediante MSBuild.exe utilizando](https://docs.microsoft.com/visualstudio/msbuild/how-to-build-specific-targets-in-solutions-by-using-msbuild-exe).  
