...
ms.locfileid: "47578204"
---
# <a name="resolvemanifestfiles-task"></a>ResolveManifestFiles (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ResolveManifestFiles (tarea)](https://docs.microsoft.com/visualstudio/msbuild/resolvemanifestfiles-task).  
