...
ms.locfileid: "47566872"
---
# <a name="xdcmake-task"></a>XDCMake (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [XDCMake (tarea)](https://docs.microsoft.com/visualstudio/msbuild/xdcmake-task).  
