...
ms.locfileid: "47580017"
---
# <a name="formatversion-task"></a>FormatVersion (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [tarea FormatVersion](https://docs.microsoft.com/visualstudio/msbuild/formatversion-task).  
