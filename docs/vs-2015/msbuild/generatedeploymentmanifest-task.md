...
ms.locfileid: "47579096"
---
# <a name="generatedeploymentmanifest-task"></a>GenerateDeploymentManifest (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [GenerateDeploymentManifest (tarea)](https://docs.microsoft.com/visualstudio/msbuild/generatedeploymentmanifest-task).  
