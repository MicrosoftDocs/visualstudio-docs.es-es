...
ms.locfileid: "47578293"
---
# <a name="xmlpeek-task"></a>XmlPeek (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [tarea XmlPeek](https://docs.microsoft.com/visualstudio/msbuild/xmlpeek-task).  
