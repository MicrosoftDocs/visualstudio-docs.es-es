...
ms.locfileid: "47566467"
---
# <a name="item-functions"></a>Funciones de elementos
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [funciones de elementos](https://docs.microsoft.com/visualstudio/msbuild/item-functions).  
