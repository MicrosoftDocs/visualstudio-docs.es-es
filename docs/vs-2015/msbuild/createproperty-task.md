...
ms.locfileid: "47581166"
---
# <a name="createproperty-task"></a>CreateProperty (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CreateProperty (tarea)](https://docs.microsoft.com/visualstudio/msbuild/createproperty-task).  
