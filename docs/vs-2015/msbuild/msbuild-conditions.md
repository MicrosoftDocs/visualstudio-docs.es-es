...
ms.locfileid: "47580072"
---
# <a name="msbuild-conditions"></a>Condiciones de MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [condiciones de MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-conditions).  
