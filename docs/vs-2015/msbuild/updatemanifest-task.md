...
ms.locfileid: "47574972"
---
# <a name="updatemanifest-task"></a>UpdateManifest (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [UpdateManifest (tarea)](https://docs.microsoft.com/visualstudio/msbuild/updatemanifest-task).  
