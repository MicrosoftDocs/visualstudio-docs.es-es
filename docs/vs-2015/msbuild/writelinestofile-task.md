...
ms.locfileid: "47580684"
---
# <a name="writelinestofile-task"></a>WriteLinesToFile (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [WriteLinesToFile (tarea)](https://docs.microsoft.com/visualstudio/msbuild/writelinestofile-task).  
