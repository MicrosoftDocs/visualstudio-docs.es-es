...
ms.locfileid: "47578841"
---
# <a name="tooltaskextension-base-class"></a>ToolTaskExtension (Clase base)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ToolTaskExtension Base clase](https://docs.microsoft.com/visualstudio/msbuild/tooltaskextension-base-class).  
