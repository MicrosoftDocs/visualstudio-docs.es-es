...
ms.locfileid: "47582834"
---
# <a name="unregisterassembly-task"></a>UnregisterAssembly (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [UnregisterAssembly (tarea)](https://docs.microsoft.com/visualstudio/msbuild/unregisterassembly-task).  
