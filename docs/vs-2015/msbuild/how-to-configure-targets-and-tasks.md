...
ms.locfileid: "47580795"
---
# <a name="how-to-configure-targets-and-tasks"></a>Cómo: Configurar destinos y tareas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: configurar destinos y tareas](https://docs.microsoft.com/visualstudio/msbuild/how-to-configure-targets-and-tasks).  
