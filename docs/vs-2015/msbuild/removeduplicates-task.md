...
ms.locfileid: "47578205"
---
# <a name="removeduplicates-task"></a>RemoveDuplicates (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [RemoveDuplicates (tarea)](https://docs.microsoft.com/visualstudio/msbuild/removeduplicates-task).  
