...
ms.locfileid: "47566962"
---
# <a name="generatetrustinfo-task"></a>GenerateTrustInfo (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [GenerateTrustInfo (tarea)](https://docs.microsoft.com/visualstudio/msbuild/generatetrustinfo-task).  
