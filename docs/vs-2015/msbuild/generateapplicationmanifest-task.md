...
|`ErrorReportUrl`|Parámetro [String](<!-- TODO: review code entity reference <xref:assetId:///String?qualifyHint=False&amp;autoUpgrade=True>  -->) opcional.<br /><br /> Especifica la dirección URL de la página web que se muestra en los cuadros de diálogo durante los informes de errores de las instalaciones ClickOnce.|  
...
|`TargetFrameworkMoniker`|Parámetro <!-- TODO: review code entity reference <xref:assetId:///String?qualifyHint=False&amp;autoUpgrade=True>  --> opcional.<br /><br /> Especifica el moniker de la plataforma de destino.|  
|`TargetFrameworkProfile`|Parámetro <!-- TODO: review code entity reference <xref:assetId:///String?qualifyHint=False&amp;autoUpgrade=True>  --> opcional.<br /><br /> Especifica el perfil de la plataforma de destino.|  
|`TargetFrameworkSubset`|Parámetro <!-- TODO: review code entity reference <xref:assetId:///String?qualifyHint=False&amp;autoUpgrade=True>  --> opcional.<br /><br /> Especifica el nombre del subconjunto de .NET Framework de destino.|  
|`TargetFrameworkVersion`|Parámetro <!-- TODO: review code entity reference <xref:assetId:///String?qualifyHint=False&amp;autoUpgrade=True>  --> opcional.<br /><br /> Especifica la versión de .NET Framework de destino del proyecto.|  
...
|`UseApplicationTrust`|Parámetro <!-- TODO: review code entity reference <xref:assetId:///Boolean?qualifyHint=False&amp;autoUpgrade=True>  --> opcional.<br /><br /> Si es true, las propiedades `Product`, `Publisher` y `SupportUrl` se escriben en el manifiesto de aplicación.|  
...
## <a name="example"></a>Ejemplo  
 En este ejemplo se utiliza la tarea `GenerateApplicationManifest` para generar un manifiesto de aplicación de [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] y la tarea `GenerateDeploymentManifest` para generar un manifiesto de implementación para una aplicación con un único ensamblado. A continuación, utiliza la tarea `SignFile` para firmar los manifiestos.  
  
 Esto ilustra el escenario de generación de manifiestos más sencillo posible donde los manifiestos de [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] se generan para un único programa. Un nombre e identidad predeterminados se deducen del ensamblado para el manifiesto.  
...
## <a name="example"></a>Ejemplo  
 En este ejemplo se usan las tareas `GenerateApplicationManifest` y `GenerateDeploymentManifest` para generar los manifiestos de aplicación e implementación de [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] para una aplicación con un único ensamblado, especificando el nombre y la identidad de los manifiestos.  
...
## <a name="example"></a>Ejemplo  
 En este ejemplo se usan las tareas `GenerateApplicationManifest` y `GenerateDeploymentManifest` para generar los manifiestos de aplicación e implementación de [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] para una aplicación con varios archivos y ensamblados.  
...
## <a name="example"></a>Ejemplo  
 En este ejemplo se usa la tarea `GenerateApplicationManifest` para generar un manifiesto nativo para la aplicación Test.exe, haciendo referencia al componente Alpha.dll nativo y a un componente COM aislado Bravo.dll.  
  
 En este ejemplo se genera el manifiesto Test.exe., consiguiendo que la aplicación XCOPY se pueda implementar aprovechando el COM sin registro.  
