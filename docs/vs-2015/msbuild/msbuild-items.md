...
ms.locfileid: "47582326"
---
# <a name="msbuild-items"></a>Elementos de MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [elementos de MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-items).  
