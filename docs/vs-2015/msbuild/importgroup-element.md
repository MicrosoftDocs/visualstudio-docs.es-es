...
ms.locfileid: "47566791"
---
# <a name="importgroup-element"></a>Elemento ImportGroup
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [elemento ImportGroup](https://docs.microsoft.com/visualstudio/msbuild/importgroup-element).  
