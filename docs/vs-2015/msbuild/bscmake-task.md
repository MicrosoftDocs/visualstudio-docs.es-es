...
ms.locfileid: "47581413"
---
# <a name="bscmake-task"></a>BscMake (Tarea)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [tarea BscMake](https://docs.microsoft.com/visualstudio/msbuild/bscmake-task).  
