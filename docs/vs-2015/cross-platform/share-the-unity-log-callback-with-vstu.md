...
La versión más reciente de este tema puede encontrarse en [compartir la devolución de llamada de registro de Unity con VSTU](https://docs.microsoft.com/visualstudio/cross-platform/share-the-unity-log-callback-with-vstu).  
