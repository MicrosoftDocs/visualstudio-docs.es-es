...
- [Visual Studio 2015](https://visualstudio.microsoft.com/downloads/). Asegúrese de que las Herramientas de desarrollo de aplicaciones de Windows universales estén seleccionadas en la lista de características opcionales. Sin estas herramientas no podrá crear aplicaciones universales.

  Después de instalar este software, debe [Habilitar el dispositivo Windows 10 para el](https://msdn.microsoft.com/library/windows/apps/xaml/dn706236.aspx) desarrollo. (Ya no necesita una licencia de desarrollador para cada dispositivo Windows 10).
...
## <a name="universal-windows-apps"></a>Aplicaciones universales de Windows
 ...
 Después de crear la aplicación de Windows universal, debe [empaquetar la aplicación](https://msdn.microsoft.com/library/windows/apps/hh454036.aspx) para instalarla en un dispositivo de Windows 10 o enviarla a la tienda Windows.
