...
ms.locfileid: "47580606"
---
# <a name="change-log-visual-studio-tools-for-unity"></a>Registro de cambios (Visual Studio Tools para Unity)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [el registro de cambios (Visual Studio Tools para Unity)](https://docs.microsoft.com/visualstudio/cross-platform/change-log-visual-studio-tools-for-unity).  
