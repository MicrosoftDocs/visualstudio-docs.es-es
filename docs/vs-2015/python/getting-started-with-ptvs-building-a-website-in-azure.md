---
title: 'Introducción a PTVS: Creación de un sitio Web en Azure | Microsoft Docs'
ms.date: 11/15/2016
...
---
# <a name="getting-started-with-ptvs-building-a-website-in-azure"></a>Introducción a PTVS: Creación de un sitio Web en Azure
