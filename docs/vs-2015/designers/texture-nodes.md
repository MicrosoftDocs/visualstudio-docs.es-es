...
ms.locfileid: "47580458"
---
# <a name="texture-nodes"></a>Nodos de textura
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [nodos de textura](https://docs.microsoft.com/visualstudio/designers/texture-nodes).  
