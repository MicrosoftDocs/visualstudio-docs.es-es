...
## <a name="see-also"></a>Consulte también
 [Cómo: crear un diseñador de sombras de sombreador de color básico](../designers/how-to-create-a-basic-color-shader.md) [Shader Designer](../designers/shader-designer.md)
