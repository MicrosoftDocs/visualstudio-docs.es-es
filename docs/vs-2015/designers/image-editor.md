...
### <a name="configuring-the-image"></a>Configuración de una imagen
...
##### <a name="resizing-selections"></a>Cambio del tamaño de las selecciones
 ...
 Ctrl copia el contenido de la región seleccionada antes de cambiar su tamaño. La imagen original queda intacta, mientras que el tamaño de la copia se cambia.

 Shift cambia el tamaño de la región seleccionada en proporción a su tamaño original.

 Alt cambia el tamaño de la región de selección. Esto deja la imagen sin modificar.
