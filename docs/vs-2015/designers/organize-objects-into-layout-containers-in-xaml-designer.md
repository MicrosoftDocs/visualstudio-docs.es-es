...
La versión más reciente de este tema puede encontrarse en [organizar objetos en contenedores de diseño en el Diseñador XAML](https://docs.microsoft.com/visualstudio/designers/organize-objects-into-layout-containers-in-xaml-designer).  
