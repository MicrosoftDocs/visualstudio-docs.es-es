...
ms.locfileid: "47575934"
---
# <a name="how-to-create-a-basic-lambert-shader"></a>Cómo: Crear un sombreador Lambert básico
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: crear un sombreador Lambert básico](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-basic-lambert-shader).  
