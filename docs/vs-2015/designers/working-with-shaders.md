...
ms.locfileid: "47582933"
---
# <a name="working-with-shaders"></a>Trabajar con sombreadores
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [trabajar con sombreadores](https://docs.microsoft.com/visualstudio/designers/working-with-shaders).  
