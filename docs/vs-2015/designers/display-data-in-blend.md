...
ms.locfileid: "47581281"
---
# <a name="display-data-in-blend"></a>Mostrar datos en Blend
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [mostrar datos en Blend](https://docs.microsoft.com/visualstudio/designers/display-data-in-blend).  
