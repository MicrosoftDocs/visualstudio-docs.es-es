...
ms.locfileid: "47582831"
---
# <a name="value-xelement-dynamic-property"></a>Value (Propiedad dinámica de XElement)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Value (propiedad dinámica de XElement)](https://docs.microsoft.com/visualstudio/designers/value-xelement-dynamic-property).  
