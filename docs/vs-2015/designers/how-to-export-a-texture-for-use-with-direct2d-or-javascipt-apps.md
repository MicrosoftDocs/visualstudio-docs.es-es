...
La versión más reciente de este tema puede encontrarse en [Cómo: exportar una textura para usarla con Direct2D o Javascipt aplicaciones](https://docs.microsoft.com/visualstudio/designers/how-to-export-a-texture-for-use-with-direct2d-or-javascipt-apps).  
