...
ms.locfileid: "47574057"
---
# <a name="working-with-3-d-models"></a>Trabajar con modelos 3D
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [trabajar con modelos 3D](https://docs.microsoft.com/visualstudio/designers/working-with-3-d-models).  
