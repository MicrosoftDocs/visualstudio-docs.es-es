...
ms.locfileid: "47579760"
---
# <a name="how-to-create-and-modify-mip-levels"></a>Cómo: Crear y modificar niveles de MIP
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: crear y modificar niveles de MIP](https://docs.microsoft.com/visualstudio/designers/how-to-create-and-modify-mip-levels).  
