...
ms.locfileid: "47582206"
---
# <a name="getting-project-properties"></a>Obtención de las propiedades del proyecto
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [obtener las propiedades del proyecto](https://docs.microsoft.com/visualstudio/extensibility/getting-project-properties).  
