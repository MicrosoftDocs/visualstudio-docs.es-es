...
La versión más reciente de este tema puede encontrarse en [elemento ProjectTemplateLink (plantillas de Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/projecttemplatelink-element-visual-studio-templates).  
