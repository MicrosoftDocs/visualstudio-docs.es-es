...
ms.locfileid: "47575781"
---
# <a name="sccremove-function"></a>SccRemove (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccRemove (función)](https://docs.microsoft.com/visualstudio/extensibility/sccremove-function).  
