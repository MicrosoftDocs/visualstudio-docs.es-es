...
ms.locfileid: "47579131"
---
# <a name="single-and-multi-tab-views"></a>Vistas de una sola pestaña y varias pestañas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [único y las vistas de varias pestañas](https://docs.microsoft.com/visualstudio/extensibility/single-and-multi-tab-views).  
