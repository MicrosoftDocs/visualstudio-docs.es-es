...
ms.locfileid: "47582825"
---
# <a name="adding-a-submenu-to-a-menu"></a>Adición de un submenú a un menú
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [agregar un submenú a un menú](https://docs.microsoft.com/visualstudio/extensibility/adding-a-submenu-to-a-menu).  
