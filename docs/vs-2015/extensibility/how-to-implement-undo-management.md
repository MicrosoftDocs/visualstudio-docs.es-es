...
ms.locfileid: "47566025"
---
# <a name="how-to-implement-undo-management"></a>Cómo: implementar la administración de deshacer
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: implementar la administración de deshacer](https://docs.microsoft.com/visualstudio/extensibility/how-to-implement-undo-management).  
