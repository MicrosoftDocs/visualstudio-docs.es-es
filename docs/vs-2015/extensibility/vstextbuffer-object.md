...
ms.locfileid: "47565633"
---
# <a name="vstextbuffer-object"></a>VSTextBuffer (Objeto)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [VSTextBuffer (objeto)](https://docs.microsoft.com/visualstudio/extensibility/vstextbuffer-object).  
