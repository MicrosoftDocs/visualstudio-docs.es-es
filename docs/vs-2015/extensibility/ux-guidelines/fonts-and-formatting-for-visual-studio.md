 ...
 **Código de procedimientos:** Donde "textBlock" es un bloque de texto y "label" definido anteriormente es una etiqueta definida previamente.
...
|||
|-|-|
|**Uso:** Todo el texto<br /><br /> **Hacer:** Caso de uso de oración<br /><br /> **No:** Cursiva en negrita o cursiva|**Aparece como:** 9 pt Segoe UI<br /><br /> **Ejemplo Visual:**<br /><br /> ![Ejemplo de fuente del entorno](../../extensibility/ux-guidelines/media/0202-g-ef.png "0202 g_EF")|
...
## <a name="see-also"></a>Vea también
 [MSDN: Fuentes (Windows)](https://msdn.microsoft.com/library/windows/desktop/dn742483\(v=vs.85\).aspx) [MSDN: Texto de la interfaz de usuario (Windows)](https://msdn.microsoft.com/library/windows/desktop/dn742478\(v=vs.85\).aspx)
