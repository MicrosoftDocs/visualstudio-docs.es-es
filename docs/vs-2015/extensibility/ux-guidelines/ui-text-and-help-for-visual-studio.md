...
- Siga las instrucciones de Microsoft existentes para el texto y el [estilo y el tono](https://msdn.microsoft.com/library/windows/desktop/dn742477\(v=vs.85\).aspx)de la [interfaz de usuario](https://msdn.microsoft.com/library/windows/desktop/dn742478\(v=vs.85\).aspx) .
...
#### <a name="control-labels"></a>Etiquetas de control
 Las etiquetas de control deben ser cortas, concisas y seguir las [instrucciones del escritorio de Windows para los controles](https://msdn.microsoft.com/library/windows/desktop/dn742399\(v=vs.85\).aspx).
...
- No usar nunca *hacer clic..* . al texto del vínculo.
...
- Para obtener más información sobre el estilo de escritura correcto para los vínculos de ayuda, consulte la [Guía de escritorio de Windows para obtener ayuda](https://msdn.microsoft.com/library/windows/desktop/dn742494\(v=vs.85\).aspx).
...
#### <a name="use-the-shell-dialog-service-for-error-messages"></a>Use el servicio de diálogo Shell para los mensajes de error.
 El uso del servicio de cuadro de diálogo Shell le permite controlar el aspecto del mensaje (fuentes en particular) sin cambios importantes en elementos individuales. Use los mecanismos **IErrorInfo** y notifique mediante **IVsUIShell:: SetErrorInfo/ReportErrorInfo**.
...
## <a name="see-also"></a>Consulte también
 [Fuentes y formato del](../../extensibility/ux-guidelines/fonts-and-formatting-for-visual-studio.md) [diseño](../../extensibility/ux-guidelines/layout-for-visual-studio.md) de Visual Studio para las [notificaciones y el progreso](../../extensibility/ux-guidelines/notifications-and-progress-for-visual-studio.md) de Visual Studio para Visual Studio
