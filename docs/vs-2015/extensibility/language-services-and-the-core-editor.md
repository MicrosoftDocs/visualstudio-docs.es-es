...
ms.locfileid: "47577648"
---
# <a name="language-services-and-the-core-editor"></a>Servicios de lenguaje y el Editor básico
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [servicios de lenguaje y el Editor básico](https://docs.microsoft.com/visualstudio/extensibility/language-services-and-the-core-editor).  
