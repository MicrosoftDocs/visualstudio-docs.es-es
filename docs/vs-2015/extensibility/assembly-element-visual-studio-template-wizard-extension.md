...
La versión más reciente de este tema puede encontrarse en [elemento Assembly (extensión de Asistente de Visual Studio plantilla)](https://docs.microsoft.com/visualstudio/extensibility/assembly-element-visual-studio-template-wizard-extension).  
