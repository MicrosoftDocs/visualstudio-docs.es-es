...
ms.locfileid: "47578672"
---
# <a name="extending-the-isolated-shell"></a>Ampliación del Shell aislado
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ampliación del Shell aislado](https://docs.microsoft.com/visualstudio/extensibility/extending-the-isolated-shell).  
