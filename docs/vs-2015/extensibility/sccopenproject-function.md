...
ms.locfileid: "47578344"
---
# <a name="sccopenproject-function"></a>SccOpenProject (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccOpenProject (función)](https://docs.microsoft.com/visualstudio/extensibility/sccopenproject-function).  
