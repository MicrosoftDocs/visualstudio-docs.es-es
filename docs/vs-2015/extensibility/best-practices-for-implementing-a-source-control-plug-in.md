...
La versión más reciente de este tema puede encontrarse en [procedimientos recomendados para implementar un complemento de Control de código fuente](https://docs.microsoft.com/visualstudio/extensibility/best-practices-for-implementing-a-source-control-plug-in).  
