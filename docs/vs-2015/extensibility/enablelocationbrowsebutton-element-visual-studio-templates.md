...
La versión más reciente de este tema puede encontrarse en [EnableLocationBrowseButton Element (Visual Studio Templates)](https://docs.microsoft.com/visualstudio/extensibility/enablelocationbrowsebutton-element-visual-studio-templates).  
