...
### <a name="exporting-and-importing-component-parts"></a>Exportar e importar partes de componentes  
...
### <a name="importing-a-mef-export"></a>Importar una exportación de MEF  
...
## <a name="getting-editor-functionality-from-a-mef-component-part"></a>Obtener la funcionalidad del editor de una parte del componente MEF  
...
2. Agregue las instrucciones Using pertinentes.  
