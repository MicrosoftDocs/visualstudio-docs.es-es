...
ms.locfileid: "47580868"
---
# <a name="scchistory-function"></a>SccHistory (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccHistory (función)](https://docs.microsoft.com/visualstudio/extensibility/scchistory-function).  
