...
ms.locfileid: "47579496"
---
# <a name="registering-a-tool-window"></a>Registro de una ventana de herramientas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [registrando una ventana de herramientas](https://docs.microsoft.com/visualstudio/extensibility/registering-a-tool-window).  
