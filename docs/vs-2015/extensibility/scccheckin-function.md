...
ms.locfileid: "47574121"
---
# <a name="scccheckin-function"></a>SccCheckin (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccCheckin (función)](https://docs.microsoft.com/visualstudio/extensibility/scccheckin-function).  
