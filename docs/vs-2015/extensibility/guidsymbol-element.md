...
ms.locfileid: "47577280"
---
# <a name="guidsymbol-element"></a>GuidSymbol (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [GuidSymbol (elemento)](https://docs.microsoft.com/visualstudio/extensibility/guidsymbol-element).  
