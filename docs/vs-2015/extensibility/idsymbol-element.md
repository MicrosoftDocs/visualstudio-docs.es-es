...
ms.locfileid: "47567494"
---
# <a name="idsymbol-element"></a>IDSymbol (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [IDSymbol (elemento)](https://docs.microsoft.com/visualstudio/extensibility/idsymbol-element).  
