...
ms.locfileid: "47567120"
---
# <a name="commandplacements-element"></a>CommandPlacements (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CommandPlacements (elemento)](https://docs.microsoft.com/visualstudio/extensibility/commandplacements-element).  
