...
ms.locfileid: "47575309"
---
# <a name="localizing-menu-commands"></a>Adaptación de comandos de menú
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [localizar los comandos de menú](https://docs.microsoft.com/visualstudio/extensibility/localizing-menu-commands).  
