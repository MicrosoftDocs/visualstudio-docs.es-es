...
ms.locfileid: "47577782"
---
# <a name="sccdirqueryinfo-function"></a>SccDirQueryInfo (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccDirQueryInfo (función)](https://docs.microsoft.com/visualstudio/extensibility/sccdirqueryinfo-function).  
