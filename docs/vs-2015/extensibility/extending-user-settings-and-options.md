...
ms.locfileid: "47576119"
---
# <a name="extending-user-settings-and-options"></a>Ampliación de configuración y opciones de usuario
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Extending User Settings y opciones](https://docs.microsoft.com/visualstudio/extensibility/extending-user-settings-and-options).  
