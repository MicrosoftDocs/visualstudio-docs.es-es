...
ms.locfileid: "47577991"
---
# <a name="sccdirdiff-function"></a>SccDirDiff (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccDirDiff (función)](https://docs.microsoft.com/visualstudio/extensibility/sccdirdiff-function).  
