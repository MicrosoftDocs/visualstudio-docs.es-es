...
ms.locfileid: "47579521"
---
# <a name="keybindings-element"></a>KeyBindings (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [KeyBindings (elemento)](https://docs.microsoft.com/visualstudio/extensibility/keybindings-element).  
