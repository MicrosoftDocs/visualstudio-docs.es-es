...
ms.locfileid: "47576563"
---
# <a name="how-to-create-custom-text-markers"></a>Cómo: crear marcadores de texto personalizado
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: crear marcadores de texto personalizado](https://docs.microsoft.com/visualstudio/extensibility/how-to-create-custom-text-markers).  
