...
ms.locfileid: "47577637"
---
# <a name="adding-a-tool-window"></a>Adición de una ventana de herramientas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [adición de una ventana de herramientas](https://docs.microsoft.com/visualstudio/extensibility/adding-a-tool-window).  
