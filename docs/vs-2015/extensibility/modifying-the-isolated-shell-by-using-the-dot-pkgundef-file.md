...
La versión más reciente de este tema puede encontrarse en [modificando el aislado Shell por mediante el. Archivo Pkgundef](https://docs.microsoft.com/visualstudio/extensibility/modifying-the-isolated-shell-by-using-the-dot-pkgundef-file).  
