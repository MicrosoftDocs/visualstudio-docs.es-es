...
La versión más reciente de este tema puede encontrarse en [Cómo: crear una fuente Atom para una galería privada](https://docs.microsoft.com/visualstudio/extensibility/how-to-create-an-atom-feed-for-a-private-gallery).  
