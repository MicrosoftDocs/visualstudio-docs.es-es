...
ms.locfileid: "47575154"
---
# <a name="menus-element"></a>Menus (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Menus (elemento)](https://docs.microsoft.com/visualstudio/extensibility/menus-element).  
