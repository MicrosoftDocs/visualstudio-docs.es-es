...
ms.locfileid: "47581239"
---
# <a name="how-to-use-the-activity-log"></a>Cómo: usar el registro de actividad
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: usar el registro de actividad](https://docs.microsoft.com/visualstudio/extensibility/how-to-use-the-activity-log).  
