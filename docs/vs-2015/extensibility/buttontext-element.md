...
ms.locfileid: "47566747"
---
# <a name="buttontext-element"></a>ButtonText (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ButtonText (elemento)](https://docs.microsoft.com/visualstudio/extensibility/buttontext-element).  
