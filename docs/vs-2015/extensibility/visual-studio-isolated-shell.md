...
- Algunos aspectos del shell también se pueden especificar cuando se inicia la aplicación. Para ello, actualice los parámetros en la llamada al punto de entrada inicial del appenvstub.dll.  
