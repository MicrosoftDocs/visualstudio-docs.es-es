...
La versión más reciente de este tema puede encontrarse en [ProvideDefaultName Element (Visual Studio Templates)](https://docs.microsoft.com/visualstudio/extensibility/providedefaultname-element-visual-studio-templates).  
