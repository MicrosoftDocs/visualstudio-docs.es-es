...
ms.locfileid: "47568052"
---
# <a name="walkthrough-creating-an-sdk-using-javascript"></a>Tutorial: Creación de un SDK con JavaScript
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Tutorial: crear un SDK usando JavaScript](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-creating-an-sdk-using-javascript).  
