...
ms.locfileid: "47580787"
---
# <a name="description-element-visual-studio-templates"></a>Description (Elemento, Plantillas de Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [elemento Description (plantillas de Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/description-element-visual-studio-templates).  
