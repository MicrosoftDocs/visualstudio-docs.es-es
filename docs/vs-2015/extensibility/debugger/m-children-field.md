...
ms.locfileid: "47580309"
---
# <a name="mchildren-field"></a>m_children (Campo)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [m_children (campo)](https://docs.microsoft.com/visualstudio/extensibility/debugger/m-children-field).  
