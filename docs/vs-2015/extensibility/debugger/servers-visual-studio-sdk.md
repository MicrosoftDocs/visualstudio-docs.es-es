...
ms.locfileid: "68199395"
---
# <a name="servers-visual-studio-sdk"></a>Servidores (Visual Studio SDK)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

En cuanto a la arquitectura del depurador, un **servidor**:  
  
- Es un contenedor de puertos y proveedores de puertos y se usa para comunicar puertos y proveedores de puertos al administrador de depuración de sesión (SDM) y a los motores de depuración.  
