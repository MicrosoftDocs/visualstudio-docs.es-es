...
ms.locfileid: "68179213"
---
# <a name="core-interfaces"></a>Interfaces básicas
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Las siguientes interfaces son las interfaces principales para extender el depurador mediante [!INCLUDE[vsipsdk](../../../includes/vsipsdk-md.md)] .  
...
## <a name="core-server"></a><a name="CoreServer"></a> Servidor principal  
 Estas interfaces representan el equipo en el que se depura un programa. Los implementa, [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] pero pueden ser llamados por los motores de depuración.  
...
|[IDebugNoSymbolsEvent2](../../../extensibility/debugger/reference/idebugnosymbolsevent2.md)|DE|Indica [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] a la interfaz de usuario del depurador que avise al usuario de que no se pudieron encontrar símbolos para el ejecutable iniciado.|  
...
|[IDebugProgramDestroyEventFlags2](../../../extensibility/debugger/reference/idebugprogramdestroyeventflags2.md)|DE|Permite que un motor de depuración invalide el comportamiento predeterminado de la [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] interfaz de usuario al finalizar una sesión de depuración.|  
...
|[IDebugPortSupplierDescription2](../../../extensibility/debugger/reference/idebugportsupplierdescription2.md)|PS|Permite [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] que la interfaz de usuario muestre texto dentro de la sección **información de transporte** del cuadro de diálogo **asociar al proceso** .|  
