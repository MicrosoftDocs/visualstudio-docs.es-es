...
#### <a name="parameters"></a>Parámetros  
 ...
 `ppField`  
 enuncia Devuelve el tipo de matriz tal como se representa mediante una interfaz [IDebugClassField](../../../extensibility/debugger/reference/idebugclassfield.md) .  
