...
ms.locfileid: "47575801"
---
# <a name="evaluating-locals"></a>Evaluación de variables locales
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [evaluar variables locales](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-locals).  
