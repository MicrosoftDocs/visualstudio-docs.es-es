...
ms.locfileid: "47567129"
---
# <a name="getting-local-properties"></a>Obtención de propiedades locales
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [obtención de propiedades Local](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-local-properties).  
