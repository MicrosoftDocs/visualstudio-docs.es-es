...
ms.locfileid: "47580419"
---
# <a name="implementing-and-registering-a-port-supplier"></a>Implementación y registro de un proveedor de puertos
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [implementar y registrar un proveedor de puerto](https://docs.microsoft.com/visualstudio/extensibility/debugger/implementing-and-registering-a-port-supplier).  
