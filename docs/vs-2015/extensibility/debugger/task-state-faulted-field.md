---
title: TASK_STATE_FAULTED (campo) | Documentos de Microsoft
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47582650"
---
# <a name="taskstatefaulted-field"></a>TASK_STATE_FAULTED (Campo)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [TASK_STATE_FAULTED (campo)](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-faulted-field).  
