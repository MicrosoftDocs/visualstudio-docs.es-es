...
ms.locfileid: "47575525"
---
# <a name="evaluating-a-watch-window-expression"></a>Evaluación de una expresión de la ventana Inspección
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [evaluar una expresión de la ventana Inspección](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-a-watch-window-expression).  
