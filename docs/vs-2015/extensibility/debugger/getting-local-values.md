...
ms.author: gregvanl
manager: ghogen
ms.openlocfilehash: cedf41d5f34ff44d9d002678638b2d9295c43e31
ms.sourcegitcommit: 55f7ce2d5d2e458e35c45787f1935b237ee5c9f8
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 08/22/2018
ms.locfileid: "47565579"
---
# <a name="getting-local-values"></a>Obtención de valores locales
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [obtener los valores locales](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-local-values).  
