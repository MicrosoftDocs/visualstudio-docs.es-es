...
ms.locfileid: "47574687"
---
# <a name="task-class---internal-members"></a>Clase de tarea: miembros internos
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [tarea Class: miembros internos](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-class-internal-members).  
