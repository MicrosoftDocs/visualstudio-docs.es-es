...
ms.locfileid: "47567126"
---
# <a name="binding-breakpoints"></a>Enlace de puntos de interrupción
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [enlace puntos de interrupción](https://docs.microsoft.com/visualstudio/extensibility/debugger/binding-breakpoints).  
