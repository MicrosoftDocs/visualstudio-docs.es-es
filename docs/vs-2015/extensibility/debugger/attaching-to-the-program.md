...
ms.locfileid: "47580044"
---
# <a name="attaching-to-the-program"></a>Asociación al programa
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [asociar al programa](https://docs.microsoft.com/visualstudio/extensibility/debugger/attaching-to-the-program).  
