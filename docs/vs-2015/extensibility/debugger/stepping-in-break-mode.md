...
ms.locfileid: "47577056"
---
# <a name="stepping-in-break-mode"></a>Escalonado en modo de interrupción
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [entrar en modo de interrupción](https://docs.microsoft.com/visualstudio/extensibility/debugger/stepping-in-break-mode).  
