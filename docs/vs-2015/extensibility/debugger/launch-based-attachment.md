...
ms.locfileid: "47574970"
---
# <a name="launch-based-attachment"></a>Adjunto basado en el inicio
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [adjunto basado en Inicio](https://docs.microsoft.com/visualstudio/extensibility/debugger/launch-based-attachment).  
