...
ms.locfileid: "47580674"
---
# <a name="visualizing-and-viewing-data"></a>Visualización de datos
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [visualización y ver datos](https://docs.microsoft.com/visualstudio/extensibility/debugger/visualizing-and-viewing-data).  
