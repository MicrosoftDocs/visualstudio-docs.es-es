...
ms.locfileid: "47578292"
---
# <a name="evaluating-expressions"></a>Evaluación de expresiones
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [evaluar expresiones](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-expressions).  
