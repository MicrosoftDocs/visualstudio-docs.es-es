...
ms.locfileid: "47577243"
---
# <a name="commandtable-element"></a>CommandTable (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CommandTable (elemento)](https://docs.microsoft.com/visualstudio/extensibility/commandtable-element).  
