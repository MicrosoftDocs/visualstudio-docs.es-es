...
La versión más reciente de este tema puede encontrarse en [crear instancias del Editor por Core con la API heredada](https://docs.microsoft.com/visualstudio/extensibility/instantiating-the-core-editor-by-using-the-legacy-api).  
