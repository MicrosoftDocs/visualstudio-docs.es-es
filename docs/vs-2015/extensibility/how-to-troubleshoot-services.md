...
ms.locfileid: "47568148"
---
# <a name="how-to-troubleshoot-services"></a>Cómo: solucionar problemas de servicios
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: solucionar problemas de servicios](https://docs.microsoft.com/visualstudio/extensibility/how-to-troubleshoot-services).  
