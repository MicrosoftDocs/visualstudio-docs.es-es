...
ms.locfileid: "47574531"
---
# <a name="ide-guids"></a>GUID de IDE
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [GUID de IDE](https://docs.microsoft.com/visualstudio/extensibility/ide-guids).  
...
## <a name="command-sets-and-properties"></a>Conjuntos de comandos y las propiedades  
...
## <a name="component-selector-page-guids"></a>GUID de páginas del Selector de componentes  
