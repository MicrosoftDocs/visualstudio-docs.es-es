...
## <a name="installation-location"></a>Ubicación de instalación  
 ...
 De forma predeterminada, la instalación solo se aplica al usuario actual, ya que% LocalAppData% es un directorio específico del usuario. Sin embargo, si establece el elemento [AllUsers](https://msdn.microsoft.com/ac817f50-3276-4ddb-b467-8bbb1432455b) del manifiesto en `True` , la extensión se instalará en. \\ *VisualStudioInstallationFolder*\Common7\IDE\Extensions y estará disponible para todos los usuarios del equipo.  
