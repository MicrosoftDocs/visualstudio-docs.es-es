...
5. También debe agregar un `TagsChanged` eventos que se llamará el método update.  
...
## <a name="creating-a-tagger-provider"></a>Creación de un proveedor del etiquetador  
