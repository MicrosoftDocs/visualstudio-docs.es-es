...
ms.locfileid: "47580425"
---
# <a name="elements-of-the-isolated-shell"></a>Elementos del Shell aislado
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [elementos del Shell aislado](https://docs.microsoft.com/visualstudio/extensibility/elements-of-the-isolated-shell).  
