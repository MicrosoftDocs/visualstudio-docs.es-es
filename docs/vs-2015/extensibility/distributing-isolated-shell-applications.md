...
ms.locfileid: "47581483"
---
# <a name="distributing-isolated-shell-applications"></a>Distribuir aplicaciones de Shell aislado
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [distribuir aplicaciones de Shell aislado](https://docs.microsoft.com/visualstudio/extensibility/distributing-isolated-shell-applications).  
