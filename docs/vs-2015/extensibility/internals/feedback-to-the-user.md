...
ms.locfileid: "47582167"
---
# <a name="feedback-to-the-user"></a>Comentarios para el usuario
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [comentarios al usuario](https://docs.microsoft.com/visualstudio/extensibility/internals/feedback-to-the-user).  
