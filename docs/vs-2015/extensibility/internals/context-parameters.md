...
ms.locfileid: "47566276"
---
# <a name="context-parameters"></a>Parámetros de contexto
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [parámetros de contexto](https://docs.microsoft.com/visualstudio/extensibility/internals/context-parameters).  
