...
## <a name="general-msbuild-considerations"></a>General MSBuild Considerations  
 ...
 MSBuild does not have native support for configuration objects, but does provide conditional attributes for specifying configuration-specific data. Por ejemplo:  
