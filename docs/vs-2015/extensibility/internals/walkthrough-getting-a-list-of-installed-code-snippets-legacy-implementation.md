---
title: 'Tutorial: obtener una lista de fragmentos de código instalados (implementación heredada) | Microsoft Docs'
ms.date: 11/15/2016
...
> [!NOTE]
> La `expansionsList` lista de matrices se almacena en caché por motivos de rendimiento. Los cambios en los fragmentos de código no se reflejan en la lista hasta que el servicio de lenguaje se detenga y se vuelva a cargar (por ejemplo, al detenerse y reiniciarse [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] ).  
