...
ms.locfileid: "47566416"
---
# <a name="commenting-code-in-a-legacy-language-service"></a>Comentario de código en un servicio de lenguaje heredado
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [comentar el código en un servicio de lenguaje heredado](https://docs.microsoft.com/visualstudio/extensibility/internals/commenting-code-in-a-legacy-language-service).  
