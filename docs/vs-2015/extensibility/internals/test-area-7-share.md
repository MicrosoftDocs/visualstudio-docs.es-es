...
ms.locfileid: "47582085"
---
# <a name="test-area-7-share"></a>Área de prueba 7: compartir
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [7 del área de prueba: recurso compartido](https://docs.microsoft.com/visualstudio/extensibility/internals/test-area-7-share).  
