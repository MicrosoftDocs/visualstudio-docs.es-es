...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe la secuencia de inicialización de subtipo de proyecto mediante programación por [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] entorno.  
...
## <a name="related-sections"></a>Secciones relacionadas  
 ...
 Proporciona vínculos a temas en los que se detallan los [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] proyectos.
