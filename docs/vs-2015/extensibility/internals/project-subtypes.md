...
ms.locfileid: "47574039"
---
# <a name="project-subtypes"></a>Subtipos de proyecto
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [subtipos de proyecto](https://docs.microsoft.com/visualstudio/extensibility/internals/project-subtypes).  
