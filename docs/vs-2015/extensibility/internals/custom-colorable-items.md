...
ms.locfileid: "47580562"
---
# <a name="custom-colorable-items"></a>Elementos coloreables personalizados
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [elementos coloreables personalizados](https://docs.microsoft.com/visualstudio/extensibility/internals/custom-colorable-items).  
