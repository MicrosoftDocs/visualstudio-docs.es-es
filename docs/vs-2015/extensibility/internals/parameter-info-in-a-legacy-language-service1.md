...
La versión más reciente de este tema puede encontrarse en [información de parámetros en un archivo de lenguaje heredado1](https://docs.microsoft.com/visualstudio/extensibility/internals/parameter-info-in-a-legacy-language-service1).  
