...
ms.locfileid: "68205991"
---
# <a name="vspackages"></a>VSPackages
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Los VSPackages son módulos de software que amplían el [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] el entorno de desarrollo integrado (IDE) proporcionando a los elementos de interfaz de usuario, servicios, proyectos, editores y diseñadores.  
