...
La versión más reciente de este tema puede encontrarse en [agregar elementos a los cuadros de diálogo Agregar nuevo elemento](https://docs.microsoft.com/visualstudio/extensibility/internals/adding-items-to-the-add-new-item-dialog-boxes).  
