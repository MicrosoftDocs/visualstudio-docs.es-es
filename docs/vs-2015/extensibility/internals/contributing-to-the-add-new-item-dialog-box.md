...
ms.locfileid: "47565613"
---
# <a name="contributing-to-the-add-new-item-dialog-box"></a>Contribución al cuadro de diálogo Agregar nuevo elemento
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [que contribuyen a que el cuadro de diálogo Agregar nuevo elemento](https://docs.microsoft.com/visualstudio/extensibility/internals/contributing-to-the-add-new-item-dialog-box).  
