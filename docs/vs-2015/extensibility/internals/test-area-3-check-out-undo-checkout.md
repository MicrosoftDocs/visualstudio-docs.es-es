...
ms.locfileid: "47579090"
---
# <a name="test-area-3-check-outundo-checkout"></a>Área de prueba 3: Extraer / Deshacer desprotección
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [prueba área 3: comprobar Out-Undo desprotección](https://docs.microsoft.com/visualstudio/extensibility/internals/test-area-3-check-out-undo-checkout).  
