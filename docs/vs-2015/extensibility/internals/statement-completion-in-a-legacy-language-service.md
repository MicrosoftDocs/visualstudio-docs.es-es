...
La versión más reciente de este tema puede encontrarse en [finalización de instrucciones en un servicio de lenguaje heredado](https://docs.microsoft.com/visualstudio/extensibility/internals/statement-completion-in-a-legacy-language-service).  
