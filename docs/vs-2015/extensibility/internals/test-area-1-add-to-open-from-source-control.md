...
- En [!INCLUDE[vsvss](../../includes/vsvss-md.md)] , abra desde el control de código fuente: **archivo**, **abrir**, **Project** / **solución**de proyecto; busque en la [!INCLUDE[vsvss](../../includes/vsvss-md.md)] ubicación.  
...
- Para [!INCLUDE[vsvss](../../includes/vsvss-md.md)] , agregar desde el control de código fuente también está disponible desde **archivo**, **Agregar**, **proyecto existente**; buscar en la [!INCLUDE[vsvss](../../includes/vsvss-md.md)] ubicación.  
