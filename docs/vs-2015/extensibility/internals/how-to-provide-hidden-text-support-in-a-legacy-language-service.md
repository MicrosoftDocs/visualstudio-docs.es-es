...
La versión más reciente de este tema puede encontrarse en [Cómo: proporcionar soporte de texto oculto en un servicio de lenguaje heredado](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-provide-hidden-text-support-in-a-legacy-language-service).  
