...
- Después de obtener un servicio, utilice [QueryInterface](https://msdn.microsoft.com/library/62fce95e-aafa-4187-b50b-e6611b74c3b3) (código no administrado) o conversión (código administrado) para obtener la interfaz deseada, por ejemplo:  
...
## <a name="see-also"></a>Vea también  
 ...
 [Casting and Type Conversions](https://msdn.microsoft.com/library/568df58a-d292-4b55-93ba-601578722878)  (Conversiones de tipos [Guía de programación de C#])  
