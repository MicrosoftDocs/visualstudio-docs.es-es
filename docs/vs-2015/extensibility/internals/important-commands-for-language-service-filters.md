...
La versión más reciente de este tema puede encontrarse en [comandos importantes para los filtros de servicio de lenguaje](https://docs.microsoft.com/visualstudio/extensibility/internals/important-commands-for-language-service-filters).  
