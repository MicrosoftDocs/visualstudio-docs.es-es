...
ms.locfileid: "47567753"
---
# <a name="making-commands-available"></a>Puesta a disposición de comandos
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [realizar comandos disponibles](https://docs.microsoft.com/visualstudio/extensibility/internals/making-commands-available).  
