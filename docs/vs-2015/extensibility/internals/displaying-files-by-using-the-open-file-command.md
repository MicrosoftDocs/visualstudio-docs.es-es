...
La versión más reciente de este tema puede encontrarse en [mostrar archivos mediante el uso del comando archivo abrir](https://docs.microsoft.com/visualstudio/extensibility/internals/displaying-files-by-using-the-open-file-command).  
