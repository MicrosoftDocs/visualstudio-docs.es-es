...
La versión más reciente de este tema puede encontrarse en [Guía de prueba para los complementos de Control de código fuente](https://docs.microsoft.com/visualstudio/extensibility/internals/test-guide-for-source-control-plug-ins).  
