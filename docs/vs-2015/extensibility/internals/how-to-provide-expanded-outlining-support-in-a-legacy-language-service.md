---
title: 'Cómo: proporcionar compatibilidad de esquematización ampliada en un servicio de lenguaje heredado | Microsoft Docs'
ms.date: 11/15/2016
...
ms.locfileid: "90843351"
---
# <a name="how-to-provide-expanded-outlining-support-in-a-legacy-language-service"></a>Provisión de compatibilidad con esquematización ampliada en un servicio de lenguaje heredado
...
## <a name="adding-client-controlled-outline-regions"></a>Agregar regiones de esquema controladas por el cliente  
 Utilice este enfoque para implementar la esquematización controlada por el cliente (o inteligente) como la utilizada por los [!INCLUDE[csprcs](../../includes/csprcs-md.md)] servicios de lenguaje de y [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] . Un servicio de lenguaje que administra su propia esquematización supervisa el contenido del búfer de texto para destruir las regiones de esquema antiguas cuando deja de ser válida y crea nuevas regiones de esquema según sea necesario.  
