...
ms.locfileid: "47575830"
---
# <a name="resources-in-vspackages"></a>Recursos de VSPackages
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [recursos de VSPackages](https://docs.microsoft.com/visualstudio/extensibility/internals/resources-in-vspackages).  
