...
ms.locfileid: "47582652"
---
# <a name="sccrunscc-function"></a>SccRunScc (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccRunScc (función)](https://docs.microsoft.com/visualstudio/extensibility/sccrunscc-function).  
