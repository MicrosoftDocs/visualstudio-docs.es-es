...
ms.locfileid: "47582058"
---
# <a name="creating-an-extension-with-a-vspackage"></a>Creación de una extensión con un VSPackage
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [crear una extensión con un VSPackage](https://docs.microsoft.com/visualstudio/extensibility/creating-an-extension-with-a-vspackage).  
