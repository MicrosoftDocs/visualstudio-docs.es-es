...
La versión más reciente de este tema puede encontrarse en [ProjectItem (elemento) (plantillas de elemento de Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/projectitem-element-visual-studio-item-templates).  
