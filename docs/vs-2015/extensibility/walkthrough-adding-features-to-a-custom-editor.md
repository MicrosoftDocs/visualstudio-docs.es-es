...
La versión más reciente de este tema puede encontrarse en [Tutorial: agregar características a un Editor personalizado](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-adding-features-to-a-custom-editor).  
