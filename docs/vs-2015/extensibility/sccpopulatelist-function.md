...
ms.locfileid: "47567429"
---
# <a name="sccpopulatelist-function"></a>SccPopulateList (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccPopulateList (función)](https://docs.microsoft.com/visualstudio/extensibility/sccpopulatelist-function).  
