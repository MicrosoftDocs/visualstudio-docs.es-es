...
ms.locfileid: "47573736"
---
# <a name="sccgetcommandoptions-function"></a>SccGetCommandOptions (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccGetCommandOptions (función)](https://docs.microsoft.com/visualstudio/extensibility/sccgetcommandoptions-function).  
