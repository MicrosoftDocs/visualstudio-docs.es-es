...
ms.locfileid: "47580809"
---
# <a name="sccadd-function"></a>SccAdd (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccAdd (función)](https://docs.microsoft.com/visualstudio/extensibility/sccadd-function).  
