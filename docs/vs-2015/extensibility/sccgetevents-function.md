...
ms.locfileid: "47575312"
---
# <a name="sccgetevents-function"></a>SccGetEvents (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccGetEvents (función)](https://docs.microsoft.com/visualstudio/extensibility/sccgetevents-function).  
