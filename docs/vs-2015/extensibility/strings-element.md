...
ms.locfileid: "47578467"
---
# <a name="strings-element"></a>Strings (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Strings (elemento)](https://docs.microsoft.com/visualstudio/extensibility/strings-element).  
