...
ms.locfileid: "47577041"
---
# <a name="combos-element"></a>Combos (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Combos (elemento)](https://docs.microsoft.com/visualstudio/extensibility/combos-element).  
