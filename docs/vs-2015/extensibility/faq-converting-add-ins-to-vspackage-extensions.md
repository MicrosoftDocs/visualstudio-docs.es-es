...
La versión más reciente de este tema puede encontrarse en [preguntas más frecuentes: convertir complementos en extensiones de VSPackage](https://docs.microsoft.com/visualstudio/extensibility/faq-converting-add-ins-to-vspackage-extensions).  
