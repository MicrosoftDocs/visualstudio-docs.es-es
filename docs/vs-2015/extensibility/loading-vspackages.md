...
ms.locfileid: "47579134"
---
# <a name="loading-vspackages"></a>Carga de VSPackages
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [cargar VSPackages](https://docs.microsoft.com/visualstudio/extensibility/loading-vspackages).  
