...
ms.locfileid: "47575655"
---
# <a name="scccreatesubproject-function"></a>SccCreateSubProject (Función)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [SccCreateSubProject (función)](https://docs.microsoft.com/visualstudio/extensibility/scccreatesubproject-function).  
