...
La versión más reciente de este tema puede encontrarse en [exponer propiedades a la ventana propiedades](https://docs.microsoft.com/visualstudio/extensibility/exposing-properties-to-the-properties-window).  
