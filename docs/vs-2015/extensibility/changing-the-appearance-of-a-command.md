...
ms.locfileid: "47582016"
---
# <a name="changing-the-appearance-of-a-command"></a>Cambio de la apariencia de un comando
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [cambiar la apariencia de un comando](https://docs.microsoft.com/visualstudio/extensibility/changing-the-appearance-of-a-command).  
