...
ms.locfileid: "48880258"
---
# <a name="creating-an-options-page"></a>Creación de una página de opciones
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [creación de una página de opciones](https://docs.microsoft.com/visualstudio/extensibility/creating-an-options-page).  
