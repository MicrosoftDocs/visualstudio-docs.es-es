...
ms.locfileid: "47581145"
---
# <a name="createinplace-visual-studio-templates"></a>CreateInPlace (Plantillas de Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CreateInPlace (plantillas de Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/createinplace-visual-studio-templates).  
