...
La versión más reciente de este tema puede encontrarse en [activar desactivar advertencias de compatibilidad para complementos de Control de código fuente](https://docs.microsoft.com/visualstudio/extensibility/how-to-turn-off-compatibility-warnings-for-source-control-plug-ins).  
