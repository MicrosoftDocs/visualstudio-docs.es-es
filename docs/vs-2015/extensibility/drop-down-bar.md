...
ms.locfileid: "47574674"
---
# <a name="drop-down-bar"></a>Barra desplegable
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [barra desplegable](https://docs.microsoft.com/visualstudio/extensibility/drop-down-bar).  
