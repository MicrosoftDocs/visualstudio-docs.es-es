...
|`SCC_CAP_SCCFILE`|0x80000000L|Es compatible con MSSCCPRJ. Archivo SCC (sujeto a invalidación de usuario/administrador) y [SccWillCreateSccFile](../extensibility/sccwillcreatesccfile-function.md).|  
