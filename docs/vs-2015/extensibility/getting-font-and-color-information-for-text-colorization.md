...
La versión más reciente de este tema puede encontrarse en [obteniendo información de fuente y Color para la coloración de texto](https://docs.microsoft.com/visualstudio/extensibility/getting-font-and-color-information-for-text-colorization).  
