...
ms.locfileid: "47575294"
---
# <a name="addressing-dpi-issues"></a>Solución de problemas de PPP
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [direccionamiento PPP problemas2](https://docs.microsoft.com/visualstudio/extensibility/addressing-dpi-issues2).  
