...
ms.locfileid: "47580048"
---
# <a name="adapting-legacy-code-to-the-editor"></a>Adaptar código heredado en el Editor
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [adaptar código heredado en el Editor de](https://docs.microsoft.com/visualstudio/extensibility/adapting-legacy-code-to-the-editor).  
