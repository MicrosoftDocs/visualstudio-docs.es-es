...
## <a name="getting-started"></a>Introducción  
 ...
 [Agregando correcciones de código Tutorial: Proporcionar correcciones de los usuarios para problemas de analizador](https://msdn.microsoft.com/magazine/dn904670.aspx)  
