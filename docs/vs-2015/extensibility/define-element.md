...
ms.locfileid: "47575529"
---
# <a name="define-element"></a>Define (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [definir elemento](https://docs.microsoft.com/visualstudio/extensibility/define-element).  
