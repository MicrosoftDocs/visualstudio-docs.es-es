...
ms.locfileid: "47575808"
---
# <a name="buttons-element"></a>Buttons (Elemento)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Buttons (elemento)](https://docs.microsoft.com/visualstudio/extensibility/buttons-element).  
