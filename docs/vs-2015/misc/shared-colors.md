...
|---------------|-------------|--------------------------------|  
|![Título de menú predeterminado](../extensibility/ux-guidelines/media/0303-002-menutitledefault.png "0303-002_MenuTitleDefault")<br /><br /> **Título de menú**|Información previa|None|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Título de menú al mantener el mouse](../extensibility/ux-guidelines/media/0303-004-menutitlehover.png "0303-004_MenuTitleHover")<br /><br /> **Título de menú**|Información previa|`Environment.CommandBarMouseOverBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Título de menú presionado](../extensibility/ux-guidelines/media/0303-006-menutitlepressed.png "0303-006_MenuTitlePressed")<br /><br /> **Título de menú**|Información previa|`Environment.CommandBarMenuBackgroundGradientBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Título de menú con glifo deshabilitado](../extensibility/ux-guidelines/media/0303-008-menutitlewithglyphdisabled.png "0303-008_MenuTitleWithGlyphDisabled")<br /><br /> **Título de menú con glifo**|Información previa|None|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Menú predeterminado](../extensibility/ux-guidelines/media/0303-010-menudefault.png "0303-010_MenuDefault")<br /><br /> **Menú**|Información previa|`Environment.CommandBarMenuBackgroundGradientBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|![Menú activado](../extensibility/ux-guidelines/media/0303-011-menuchecked.png "0303-011_MenuChecked")<br /><br /> **Comprobado**|Marca de verificación|`Environment.CommandBarCheckBox`|  
|![Menú activado](../extensibility/ux-guidelines/media/0303-011-menuchecked.png "0303-011_MenuChecked")<br /><br /> **Comprobado**|Fondo de marca de verificación|`Environment.CommandBarSelectedIcon`|  
...
|![Menú activado al mantener el mouse](../extensibility/ux-guidelines/media/0303-014-menuhoverchecked.png "0303-014_MenuHoverChecked")<br /><br /> **Comprobado**|Marca de verificación|`Environment.CommandBarCheckBoxMouseOver`|  
|![Menú activado al mantener el mouse](../extensibility/ux-guidelines/media/0303-014-menuhoverchecked.png "0303-014_MenuHoverChecked")<br /><br /> **Comprobado**|Fondo de marca de verificación|`Environment.CommandBarHoverOverSelectedIcon`|  
|![Menú seleccionado al mantener el mouse](../extensibility/ux-guidelines/media/0303-015-menuhoverselected.png "0303-015_MenuHoverSelected")<br /><br /> **Seleccionado**|Fondo de icono|`Environment.CommandBarHoverOverSelected`|  
|![Menú seleccionado al mantener el mouse](../extensibility/ux-guidelines/media/0303-015-menuhoverselected.png "0303-015_MenuHoverSelected")<br /><br /> **Seleccionado**|Borde de icono|`Environment.CommandBarHoverOverSelectedIconBorder`|  
...
- para los componentes de barra de comandos distintos de aquellos para los que se especifican nombres de los token.  
  ...
  **Predeterminado** (sin otros estados)  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Icono de comando predeterminado](../extensibility/ux-guidelines/media/0303-023-commandicondefault.png "0303-023_CommandIconDefault")<br /><br /> **Predeterminado**|Información previa|N/D (se hereda del fondo de la barra de comandos)|  
|![Icono de comando predeterminado](../extensibility/ux-guidelines/media/0303-023-commandicondefault.png "0303-023_CommandIconDefault")<br /><br /> **Predeterminado**|Primer plano (texto)|`Environment.CommandBarTextActive`|  
|![Icono de comando predeterminado](../extensibility/ux-guidelines/media/0303-023-commandicondefault.png "0303-023_CommandIconDefault")<br /><br /> **Predeterminado**|Borde|N/D|  
|![Icono de comando predeterminado seleccionado](../extensibility/ux-guidelines/media/0303-024-commandicondefaultselected.png "0303-024_CommandIconDefaultSelected")<br /><br /> **Seleccionado**|Información previa|`Environment.CommandBarSelected`|  
...
|![Icono de comando predeterminado seleccionado](../extensibility/ux-guidelines/media/0303-024-commandicondefaultselected.png "0303-024_CommandIconDefaultSelected")<br /><br /> **Seleccionado**|Borde|`Environment.CommandBarSelectedBorder`|  
  
 **Al mantener el puntero y teclado con foco**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Icono de comandos al mantener el mouse](../extensibility/ux-guidelines/media/0303-025-commandiconhover.png "0303-025_CommandIconHover")<br /><br /> **Estándar al mantener el puntero**|Información previa|`Environment.CommandBarMouseOverBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|![Icono de comandos al mantener el mouse seleccionado](../extensibility/ux-guidelines/media/0303-026-commandiconhoverselected.png "0303-026_CommandIconHoverSelected")<br /><br /> **Seleccionado al mantener el puntero**|Información previa|`Environment.CommandBarHoverOverSelected`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Icono de comando presionado](../extensibility/ux-guidelines/media/0303-027-commandiconpressed.png "0303-027_CommandIconPressed")<br /><br /> **Icono de comando presionado**|Información previa|`Environment.CommandBarMouseDownBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Icono de comando deshabilitado](../extensibility/ux-guidelines/media/0303-028-commandicondisabled.png "0303-028_CommandIconDisabled")<br /><br /> **Icono de comando deshabilitado**|Información previa|N/D (se hereda del fondo de la barra de comandos)|  
...
##### <a name="combo-box"></a><a name="BKMK_CommandComboBox"></a>Caja combinada  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Campo de entrada de cuadro combinado](../extensibility/ux-guidelines/media/0303-030-comboboxinputfield.png "0303-030_ComboBoxInputField")<br /><br /> **Campo de entrada**|Información previa|`Environment.ComboBoxBackground`|  
...
|![Cuadro combinado&#45;botón desplegable](../extensibility/ux-guidelines/media/0303-031-comboboxdropdownbutton.png "0303-031_ComboBoxDropdownButton")<br /><br /> **Botón desplegable**|Información previa|N/D (se hereda)|  
|![Cuadro combinado&#45;botón desplegable](../extensibility/ux-guidelines/media/0303-031-comboboxdropdownbutton.png "0303-031_ComboBoxDropdownButton")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`Environment.ComboBoxGlyph`|  
|![Cuadro combinado&#47;lista&#45;abajo](../extensibility/ux-guidelines/media/0303-032-comboboxdropdownlist.png "0303-032_ComboBoxDropdownList")<br /><br /> **Lista desplegable**|Información previa|`Environment.ComboBoxPopupBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
|![Cuadro combinado&#47;lista&#45;abajo](../extensibility/ux-guidelines/media/0303-032-comboboxdropdownlist.png "0303-032_ComboBoxDropdownList")<br /><br /> **Lista desplegable**|Primer plano (texto)|`Environment.ComboBoxItemText`|  
|![Cuadro combinado&#47;lista&#45;abajo](../extensibility/ux-guidelines/media/0303-032-comboboxdropdownlist.png "0303-032_ComboBoxDropdownList")<br /><br /> **Lista desplegable**|Borde|`Environment.ComboBoxPopupBorder`|  
  
 **Al mantener el puntero**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Campo de entrada de cuadro combinado al mantener el mouse](../extensibility/ux-guidelines/media/0303-033-comboboxinputfieldhover.png "0303-033_ComboBoxInputFieldHover")<br /><br /> **Campo de entrada**|Información previa|`Environment.ComboBoxMouseOverBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|![Cuadro combinado&#47;botón de bajar&#45;hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-034-comboboxdropdownbuttonhover.png "0303-034_ComboBoxDropdownButtonHover")<br /><br /> **Botón desplegable**|Información previa|`Environment.ComboBoxButtonMouseOverBackground`|  
|![Cuadro combinado&#47;botón de bajar&#45;hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-034-comboboxdropdownbuttonhover.png "0303-034_ComboBoxDropdownButtonHover")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`Environment.ComboBoxMouseOverGlyph`|  
|![Cuadro combinado&#47;lista desplegable&#45;lista hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-035-comboboxdropdownlisthover.png "0303-035_ComboBoxDropdownListHover")<br /><br /> **Lista desplegable**|Fondo (elemento de menú)|`Environment.ComboBoxItemMouseOverBackground`|  
|![Cuadro combinado&#47;lista desplegable&#45;lista hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-035-comboboxdropdownlisthover.png "0303-035_ComboBoxDropdownListHover")<br /><br /> **Lista desplegable**|Primer plano (texto)|`Environment.ComboBoxItemMouseOverText`|  
|![Cuadro combinado&#47;lista desplegable&#45;lista hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-035-comboboxdropdownlisthover.png "0303-035_ComboBoxDropdownListHover")<br /><br /> **Lista desplegable**|Borde (elemento de menú)|`Environment.ComboBoxItemMouseOverBorder`|  
  
 **Con foco**  
  
|Componente|Elemento|Nombre del token: Color.category|  
|---------------|-------------|--------------------------------|  
|![Campo de entrada de cuadro combinado enfocado](../extensibility/ux-guidelines/media/0303-036-comboboxinputfieldfocused.png "0303-036_ComboBoxInputFieldFocused")<br /><br /> **Campo de entrada**|Información previa|`Environment.ComboBoxFocusedBackground`|  
...
|![Cuadro combinado&#47;botón desplegable&#45;botón enfocado](../extensibility/ux-guidelines/media/0303-037-comboboxdropdownbuttonfocused.png "0303-037_ComboBoxDropdownButtonFocused")<br /><br /> **Botón desplegable**|Información previa|`Environment.ComboBoxFocusedButtonBackground`|  
|![Cuadro combinado&#47;botón desplegable&#45;botón enfocado](../extensibility/ux-guidelines/media/0303-037-comboboxdropdownbuttonfocused.png "0303-037_ComboBoxDropdownButtonFocused")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`Environment.ComboBoxFocusedGlyph`|  
  
 **Presionado**  
  
|Componente|Elemento|Nombre del token: Color.category|  
|---------------|-------------|--------------------------------|  
|![Campo entrada de cuadro combinado presionado](../extensibility/ux-guidelines/media/0303-038-comboboxinputfieldpressed.png "0303-038_ComboBoxInputFieldPressed")<br /><br /> **Campo de entrada**|Información previa|`Environment.ComboBoxMouseDownBackground`|  
...
|![Cuadro combinado&#47;botón desplegable&#45;pulsado el botón](../extensibility/ux-guidelines/media/0303-039-comboboxdropdownbuttonpressed.png "0303-039_ComboBoxDropdownButtonPressed")<br /><br /> **Botón desplegable**|Información previa|`Environment.ComboBoxButtonMouseDownBackground`|  
|![Cuadro combinado&#47;botón desplegable&#45;pulsado el botón](../extensibility/ux-guidelines/media/0303-039-comboboxdropdownbuttonpressed.png "0303-039_ComboBoxDropdownButtonPressed")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`Environment.ComboBoxMouseDownGlyph`|  
  
 **Deshabilitado**  
  
|Componente|Elemento|Nombre del token: Color.category|  
|---------------|-------------|--------------------------------|  
|![Campo entrada de cuadro combinado deshabilitado](../extensibility/ux-guidelines/media/0303-041-comboboxinputfielddisabled.png "0303-041_ComboBoxInputFieldDisabled")<br /><br /> **Campo de entrada**|Información previa|`Environment.ComboBoxDisabledBackground`|  
...
|![Cuadro combinado&#47;botón desplegable&#45;botón desactivado](../extensibility/ux-guidelines/media/0303-040-comboboxdropdownbuttondisabled.png "0303-040_ComboBoxDropdownButtonDisabled")<br /><br /> **Botón desplegable**|Información previa|None|  
|![Cuadro combinado&#47;botón desplegable&#45;botón desactivado](../extensibility/ux-guidelines/media/0303-040-comboboxdropdownbuttondisabled.png "0303-040_ComboBoxDropdownButtonDisabled")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`Environment.ComboBoxDisabledGlyph`|  
...
> Las listas desplegables son similares a los cuadros combinados, pero carecen de áreas de texto editable. Si la lista desplegable incluye un área de texto editable, use los tokens de color que se encuentran en [Combo box](../misc/shared-colors.md#BKMK_CommandComboBox).  
 ...
 ![Suelta&#45;línea roja](../extensibility/ux-guidelines/media/0303-042-dropdownredline.png "0303-042_DropdownRedline")  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Menú&#45;campo de selección hacia abajo](../extensibility/ux-guidelines/media/0303-043-dropdownselectionfield.png "0303-043_DropdownSelectionField")<br /><br /> **Campo de selección**|Información previa|`Environment.DropDownBackground`|  
|![Menú&#45;campo de selección hacia abajo](../extensibility/ux-guidelines/media/0303-043-dropdownselectionfield.png "0303-043_DropdownSelectionField")<br /><br /> **Campo de selección**|Primer plano (texto)|`DropDownText`|  
|![Menú&#45;campo de selección hacia abajo](../extensibility/ux-guidelines/media/0303-043-dropdownselectionfield.png "0303-043_DropdownSelectionField")<br /><br /> **Campo de selección**|Borde|`DropDownBorder`|  
|![Menú&#45;campo de selección hacia abajo](../extensibility/ux-guidelines/media/0303-043-dropdownselectionfield.png "0303-043_DropdownSelectionField")<br /><br /> **Campo de selección**|Separador|Sin separador|  
|![Botón&#45;hacia abajo](../extensibility/ux-guidelines/media/0303-044-dropdownbutton.png "0303-044_DropdownButton")<br /><br /> **Botón desplegable**|Información previa|None|  
|![Botón&#45;hacia abajo](../extensibility/ux-guidelines/media/0303-044-dropdownbutton.png "0303-044_DropdownButton")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`Environment.DropDownGlyph`|  
|![Lista desplegable&#45;abajo](../extensibility/ux-guidelines/media/0303-045-dropdownlist.png "0303-045_DropdownList")<br /><br /> **Lista desplegable**|Información previa|`Environment.DropDownPopupBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
|![Lista desplegable&#45;abajo](../extensibility/ux-guidelines/media/0303-045-dropdownlist.png "0303-045_DropdownList")<br /><br /> **Lista desplegable**|Primer plano (texto)|`Environment.ComboBoxItemText`|  
|![Lista desplegable&#45;abajo](../extensibility/ux-guidelines/media/0303-045-dropdownlist.png "0303-045_DropdownList")<br /><br /> **Lista desplegable**|Borde|`Environment.DropDownPopupBorder`|  
|![Lista desplegable&#45;abajo](../extensibility/ux-guidelines/media/0303-045-dropdownlist.png "0303-045_DropdownList")<br /><br /> **Lista desplegable**|Shadow|`Environment.DropShadowBackground`|  
  
 **Al mantener el puntero**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Suelte&#45;campo de selección hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-046-dropdownselectionfieldhover.png "0303-046_DropdownSelectionFieldHover")<br /><br /> **Campo de selección**|Información previa|`Environment.DropDownMouseOverBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
|![Suelte&#45;campo de selección hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-046-dropdownselectionfieldhover.png "0303-046_DropdownSelectionFieldHover")<br /><br /> **Campo de selección**|Primer plano (texto)|`Environment.DropDownMouseOverText`|  
|![Suelte&#45;campo de selección hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-046-dropdownselectionfieldhover.png "0303-046_DropdownSelectionFieldHover")<br /><br /> **Campo de selección**|Borde|`Environment.DropDownMouseOverBorder`|  
|![Suelte&#45;campo de selección hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-046-dropdownselectionfieldhover.png "0303-046_DropdownSelectionFieldHover")<br /><br /> **Campo de selección**|Separador|`Environment.DropDownButtonMouseOverSeparator`|  
|![Suelta&#45;botón hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-047-dropdownbuttonhover.png "0303-047_DropdownButtonHover")<br /><br /> **Botón desplegable**|Información previa|`Environment.DropDownButtonMouseOverBackground`|  
|![Suelta&#45;botón hacia abajo al pasar el ratón](../extensibility/ux-guidelines/media/0303-047-dropdownbuttonhover.png "0303-047_DropdownButtonHover")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`Environment.DropDownMouseOverGlyph`|  
|![Desplegable&#45;lista desplegable al pasar el ratón](../extensibility/ux-guidelines/media/0303-048-dropdownlisthover.png "0303-048_DropdownListHover")<br /><br /> **Lista desplegable**|Fondo (elemento de menú)|`Environment.ComboBoxItemMouseOverBackground`|  
|![Desplegable&#45;lista desplegable al pasar el ratón](../extensibility/ux-guidelines/media/0303-048-dropdownlisthover.png "0303-048_DropdownListHover")<br /><br /> **Lista desplegable**|Primer plano (texto)|`Environment.ComboBoxItemMouseOverText`|  
|![Desplegable&#45;lista desplegable al pasar el ratón](../extensibility/ux-guidelines/media/0303-048-dropdownlisthover.png "0303-048_DropdownListHover")<br /><br /> **Lista desplegable**|Borde (elemento de menú)|`Environment.ComboBoxItemMouseOverBorder`|  
  
 **Presionado**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Suelte&#45;campo de selección presionado](../extensibility/ux-guidelines/media/0303-049-dropdownselectionfieldpressed.png "0303-049_DropdownSelectionFieldPressed")<br /><br /> **Campo de selección**|Información previa|`Environment.DropDownMouseDownBackground`|  
|![Suelte&#45;campo de selección presionado](../extensibility/ux-guidelines/media/0303-049-dropdownselectionfieldpressed.png "0303-049_DropdownSelectionFieldPressed")<br /><br /> **Campo de selección**|Primer plano (texto)|`Environment.DropDownMouseDownText`|  
|![Suelte&#45;campo de selección presionado](../extensibility/ux-guidelines/media/0303-049-dropdownselectionfieldpressed.png "0303-049_DropdownSelectionFieldPressed")<br /><br /> **Campo de selección**|Borde|`Environment.DropDownMouseDownBorder`|  
|![Suelte&#45;campo de selección presionado](../extensibility/ux-guidelines/media/0303-049-dropdownselectionfieldpressed.png "0303-049_DropdownSelectionFieldPressed")<br /><br /> **Campo de selección**|Separador|`Environment.DropDownButtonMouseDownSeparator`|  
|![Botón de&#45;pulsado](../extensibility/ux-guidelines/media/0303-050-dropdownbuttonpressed.png "0303-050_DropdownButtonPressed")<br /><br /> **Botón desplegable**|Información previa|`Environment.DropDownButtonMouseDownBackground`|  
|![Botón de&#45;pulsado](../extensibility/ux-guidelines/media/0303-050-dropdownbuttonpressed.png "0303-050_DropdownButtonPressed")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`Environment.DropDownMouseDownGlyph`|  
  
 **Deshabilitado**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Menú&#45;campo de selección desactivado](../extensibility/ux-guidelines/media/0303-051-dropdownselectionfielddisabled.png "0303-051_DropdownSelectionFieldDisabled")|Información previa|`Environment.DropDownDisabledBackground`|  
|![Menú&#45;campo de selección desactivado](../extensibility/ux-guidelines/media/0303-051-dropdownselectionfielddisabled.png "0303-051_DropdownSelectionFieldDisabled")|Primer plano (texto)|`Environment.DropDownDisabledText`|  
|![Menú&#45;campo de selección desactivado](../extensibility/ux-guidelines/media/0303-051-dropdownselectionfielddisabled.png "0303-051_DropdownSelectionFieldDisabled")|Borde|`Environment.DropDownDisabledBorder`|  
|![Menú&#45;campo de selección desactivado](../extensibility/ux-guidelines/media/0303-051-dropdownselectionfielddisabled.png "0303-051_DropdownSelectionFieldDisabled")|Separador|Sin separador|  
|![Botón desplegable&#45;botón desplegable desactivado](../extensibility/ux-guidelines/media/0303-052-dropdownbuttondisabled.png "0303-052_DropdownButtonDisabled")|Información previa|N/D|  
|![Botón desplegable&#45;botón desplegable desactivado](../extensibility/ux-guidelines/media/0303-052-dropdownbuttondisabled.png "0303-052_DropdownButtonDisabled")|Primer plano (glifo)|`Environment.DropDownDisabledGlyph`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Botón de expansión](../extensibility/ux-guidelines/media/0303-054-splitbutton.png "0303-054_SplitButton")<br /><br /> **Botón de expansión (predeterminado)**|Información previa|None|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Botón Dividir al pasar el ratón](../extensibility/ux-guidelines/media/0303-055-splitbuttonhover.png "0303-055_SplitButtonHover")<br /><br /> **Botón de expansión (al mantener el puntero)**|Información previa|`Environment.CommandBarMouseOverBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
|![Botón Dividir al pasar el ratón](../extensibility/ux-guidelines/media/0303-055-splitbuttonhover.png "0303-055_SplitButtonHover")<br /><br /> **Botón de expansión (al mantener el puntero)**|Primer plano (texto)|`Environment.CommandBarTextHover`|  
|![Botón Dividir al pasar el ratón](../extensibility/ux-guidelines/media/0303-055-splitbuttonhover.png "0303-055_SplitButtonHover")<br /><br /> **Botón de expansión (al mantener el puntero)**|Primer plano (glifo)|`Environment.CommandBarSplitButtonMouseOverGlyph`|  
|![Botón Dividir al pasar el ratón](../extensibility/ux-guidelines/media/0303-055-splitbuttonhover.png "0303-055_SplitButtonHover")<br /><br /> **Botón de expansión (al mantener el puntero)**|Borde|`Environment.CommandBarBorder`|  
|![Botón Dividir al pasar el ratón](../extensibility/ux-guidelines/media/0303-055-splitbuttonhover.png "0303-055_SplitButtonHover")<br /><br /> **Botón de expansión (al mantener el puntero)**|Separador|`Environment.CommandBarSplitButtonSeparator`|  
  
 **Presionado**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Botón dividido pulsado](../extensibility/ux-guidelines/media/0303-056-splitbuttonpressed.png "0303-056_SplitButtonPressed")<br /><br /> **Botón de expansión (presionado)**|Información previa|`Environment.CommandBarMouseDownBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
|![Botón dividido pulsado](../extensibility/ux-guidelines/media/0303-056-splitbuttonpressed.png "0303-056_SplitButtonPressed")<br /><br /> **Botón de expansión (presionado)**|Primer plano (texto)|`Environment.CommandBarTextMouseDown`|  
|![Botón dividido pulsado](../extensibility/ux-guidelines/media/0303-056-splitbuttonpressed.png "0303-056_SplitButtonPressed")<br /><br /> **Botón de expansión (presionado)**|Primer plano (glifo)|`Environment.CommandBarSplitButtonMouseDownGlyph`|  
|![Botón dividido pulsado](../extensibility/ux-guidelines/media/0303-056-splitbuttonpressed.png "0303-056_SplitButtonPressed")<br /><br /> **Botón de expansión (presionado)**|Borde|`Environment.CommandBarBorder`|  
|![Botón dividido pulsado](../extensibility/ux-guidelines/media/0303-056-splitbuttonpressed.png "0303-056_SplitButtonPressed")<br /><br /> **Botón de expansión (presionado)**|Separador|N/D|  
  
 **Deshabilitado**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Botón Dividir desactivado](../extensibility/ux-guidelines/media/0303-057-splitbuttondisabled.png "0303-057_SplitButtonDisabled")<br /><br /> **Botón de expansión (deshabilitado)**|Información previa|N/D|  
|![Botón Dividir desactivado](../extensibility/ux-guidelines/media/0303-057-splitbuttondisabled.png "0303-057_SplitButtonDisabled")<br /><br /> **Botón de expansión (deshabilitado)**|Primer plano (texto)|`Environment.ComboBoxItemTextInactive`|  
|![Botón Dividir desactivado](../extensibility/ux-guidelines/media/0303-057-splitbuttondisabled.png "0303-057_SplitButtonDisabled")<br /><br /> **Botón de expansión (deshabilitado)**|Primer plano (glifo)|`Environment.CommandBarTextInactive`|  
|![Botón Dividir desactivado](../extensibility/ux-guidelines/media/0303-057-splitbuttondisabled.png "0303-057_SplitButtonDisabled")<br /><br /> **Botón de expansión (deshabilitado)**|Borde|N/D|  
|![Botón Dividir desactivado](../extensibility/ux-guidelines/media/0303-057-splitbuttondisabled.png "0303-057_SplitButtonDisabled")<br /><br /> **Botón de expansión (deshabilitado)**|Separador|N/D|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|Documento: acoplado o flotante|Información previa|Depende del tipo de documento|  
...
|![Marco enfocado](../extensibility/ux-guidelines/media/0303-067-framefocused.png "0303-067_FrameFocused")<br /><br /> **Marco: flotante, con foco**|Información previa|`Environment.ToolWindowFloatingFrame`|  
...
|![Marco no enfocado](../extensibility/ux-guidelines/media/0303-068-frameunfocused.png "0303-068_FrameUnfocused")<br /><br /> **Marco: flotante, sin foco**|Información previa|`Environment.ToolWindowFloatingFrameInactive`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Pestaña seleccionada enfocada](../extensibility/ux-guidelines/media/0303-074-selectedtabfocused.png "0303-074_SelectedTabFocused")<br /><br /> **Pestaña de documento seleccionada, con foco**|Información previa|`Environment.FileTabSelectedGradientTop`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Pestaña seleccionada no enfocada](../extensibility/ux-guidelines/media/0303-075-selectedtabunfocused.png "0303-075_SelectedTabUnfocused")<br /><br /> **Pestaña de documento seleccionada, sin foco**|Información previa|`Environment.FileTabInactiveGradientTop`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|Componente|Elemento|Nombre del token: Color.category|  
|---------------|-------------|--------------------------------|  
|![Pestaña en segundo plano](../extensibility/ux-guidelines/media/0303-076-backgroundtab.png "0303-076_BackgroundTab")<br /><br /> **Valor predeterminado de pestaña en segundo plano**|Información previa|`Environment.FileTabBackground`|  
...
|Componente|Elemento|Nombre del token: Color.category|  
|---------------|-------------|--------------------------------|  
|![Pestaña en segundo plano al mantener el puntero](../extensibility/ux-guidelines/media/0303-077-backgroundtabhover.png "0303-077_BackgroundTabHover")<br /><br /> **Pestaña en segundo plano al mantener el puntero**|Información previa|`Environment.FileTabHotGradientTop`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Pestaña de vista previa enfocada](../extensibility/ux-guidelines/media/0303-079-previewtabfocused.png "0303-079_PreviewTabFocused")<br /><br /> **Pestaña de vista previa con foco**|Información previa|`Environment.FileTabProvisionalSelectedActive`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Pestaña de vista previa no enfocada](../extensibility/ux-guidelines/media/0303-080-previewtabunfocused.png "0303-080_PreviewTabUnfocused")<br /><br /> **Pestaña de vista previa sin foco**|Información previa|`Environment.FileTabProvisionalSelectedInactive`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Pestaña de vista previa en segundo plano](../extensibility/ux-guidelines/media/0303-081-previewbackgroundtab.png "0303-081_PreviewBackgroundTab")<br /><br /> **Pestaña en segundo plano de la pestaña de vista previa**|Información previa|`Environment.FileTabProvisionalInactive`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Barra de título enfocada](../extensibility/ux-guidelines/media/0303-093-titlebarfocused.png "0303-093_TitleBarFocused")<br /><br /> **Barra de título con foco**|Información previa|`Environment.TitleBarActiveGradientBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Barra de título no enfocada](../extensibility/ux-guidelines/media/0303-094-titlebarunfocused.png "0303-094_TitleBarUnfocused")<br /><br /> **Barra de título sin foco**|Información previa|`Environment.TitleBarInactiveGradientBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Botón de la barra de título enfocado](../extensibility/ux-guidelines/media/0303-096-titlebarbuttonfocused.png "0303-096_TitleBarButtonFocused")<br /><br /> **Con foco**|Información previa|N/D|  
|![Botón de la barra de título enfocado](../extensibility/ux-guidelines/media/0303-096-titlebarbuttonfocused.png "0303-096_TitleBarButtonFocused")<br /><br /> **Con foco**|Primer plano (glifo)|`Environment.ToolWindowButtonActiveGlyph`|  
|![Botón de la barra de título enfocado](../extensibility/ux-guidelines/media/0303-096-titlebarbuttonfocused.png "0303-096_TitleBarButtonFocused")<br /><br /> **Con foco**|Borde|N/D|  
|![Botón de la barra de título no enfocado](../extensibility/ux-guidelines/media/0303-097-titlebarbuttonunfocused.png "0303-097_TitleBarButtonUnfocused")<br /><br /> **Sin foco**|Información previa|N/D|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Botón de la barra de título enfocado al mantener el mouse](../extensibility/ux-guidelines/media/0303-098-titlebarbuttonfocusedhover.png "0303-098_TitleBarButtonFocusedHover")<br /><br /> **Con foco**|Información previa|`Environment.ToolWindowButtonHoverActive`|  
|![Botón de la barra de título enfocado al mantener el mouse](../extensibility/ux-guidelines/media/0303-098-titlebarbuttonfocusedhover.png "0303-098_TitleBarButtonFocusedHover")<br /><br /> **Con foco**|Primer plano (glifo)|`Environment.ToolWindowButtonHoverActiveGlyph`|  
|![Botón de la barra de título enfocado al mantener el mouse](../extensibility/ux-guidelines/media/0303-098-titlebarbuttonfocusedhover.png "0303-098_TitleBarButtonFocusedHover")<br /><br /> **Con foco**|Borde|`Environment.ToolWindowButtonHoverActiveBorder`|  
|![Botón de la barra de título no enfocado al mantener el mouse](../extensibility/ux-guidelines/media/0303-099-titlebarbuttonunfocusedhover.png "0303-099_TitleBarButtonUnfocusedHover")<br /><br /> **Sin foco**|Información previa|`Environment.ToolWindowButtonHoverInactive`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Botón de la barra de título enfocado y presionado](../extensibility/ux-guidelines/media/0303-100-titlebarbuttonfocusedpressed.png "0303-100_TitleBarButtonFocusedPressed")<br /><br /> **Con foco**|Información previa|`Environment.ToolWindowButtonDown`|  
|![Botón de la barra de título enfocado y presionado](../extensibility/ux-guidelines/media/0303-100-titlebarbuttonfocusedpressed.png "0303-100_TitleBarButtonFocusedPressed")<br /><br /> **Con foco**|Primer plano (glifo)|`Environment.ToolWindowButtonDownActiveGlyph`|  
|![Botón de la barra de título enfocado y presionado](../extensibility/ux-guidelines/media/0303-100-titlebarbuttonfocusedpressed.png "0303-100_TitleBarButtonFocusedPressed")<br /><br /> **Con foco**|Borde|`Environment.ToolWindowButtonDownBorder`|  
|![Botón de la barra de título no enfocado y presionado](../extensibility/ux-guidelines/media/0303-101-titlebarbuttonunfocusedpressed.png "0303-101_TitleBarButtonUnfocusedPressed")<br /><br /> **Sin foco**|Información previa|`Environment.ToolWindowButtonDown`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Pestaña de ventana de herramientas enfocada](../extensibility/ux-guidelines/media/0303-103-toolwindowtabfocused.png "0303-103_ToolWindowTabFocused")<br /><br /> **Pestaña de ventana de herramienta seleccionada, con foco**|Información previa|`Environment.ToolWindowTabSelectedTab`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Pestaña de ventana de herramientas no enfocada](../extensibility/ux-guidelines/media/0303-104-toolwindowtabunfocused.png "0303-104_ToolWindowTabUnfocused")<br /><br /> **Pestaña de ventana de herramienta seleccionada, sin foco**|Información previa|`Environment.ToolWindowTabSelectedTab`|  
...
#### <a name="auto-hide-tabs"></a>Pestaña de ocultación automática  
 ![Auto&#45;ocultar la línea roja](../extensibility/ux-guidelines/media/0303-107-autohideredline.png "0303-107_AutoHideRedline")  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Ficha de ocultación de&#45;automática](../extensibility/ux-guidelines/media/0303-108-autohidetab.png "0303-108_AutoHideTab")<br /><br /> **Pestaña de ocultación automática predeterminada**|Información previa|`Environment.AutoHideTabBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
|![Ficha de ocultación de&#45;automática](../extensibility/ux-guidelines/media/0303-108-autohidetab.png "0303-108_AutoHideTab")<br /><br /> **Pestaña de ocultación automática predeterminada**|Primer plano (texto)|`Environment.AutoHideTabText`|  
|![Ficha de ocultación de&#45;automática](../extensibility/ux-guidelines/media/0303-108-autohidetab.png "0303-108_AutoHideTab")<br /><br /> **Pestaña de ocultación automática predeterminada**|Borde|`Environment.AutoHideTabBorder`|  
  
 **Al mantener el puntero**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Auto&#45;ocultar pestaña al pasar el ratón](../extensibility/ux-guidelines/media/0303-109-autohidetabhover.png "0303-109_AutoHideTabHover")<br /><br /> **Pestaña de ocultación automática al mantener el puntero**|Información previa|`Environment.AutoHideTabMouseOverBackgroundBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
|![Auto&#45;ocultar pestaña al pasar el ratón](../extensibility/ux-guidelines/media/0303-109-autohidetabhover.png "0303-109_AutoHideTabHover")<br /><br /> **Pestaña de ocultación automática al mantener el puntero**|Primer plano (texto)|`Environment.AutoHideTabMouseOverText`|  
|![Auto&#45;ocultar pestaña al pasar el ratón](../extensibility/ux-guidelines/media/0303-109-autohidetabhover.png "0303-109_AutoHideTabHover")<br /><br /> **Pestaña de ocultación automática al mantener el puntero**|Borde|`Environment.AutoHideTabMouseOverBorder`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Campo de entrada de búsqueda enfocado](../extensibility/ux-guidelines/media/0303-111-searchinputfieldfocused.png "0303-111_SearchInputFieldFocused")<br /><br /> **Campo de entrada**|Información previa|`SearchControl.FocusedBackground`|  
...
|![Botón de acción de búsqueda enfocado](../extensibility/ux-guidelines/media/0303-112-searchactionbuttonfocused.png "0303-112_SearchActionButtonFocused")<br /><br /> **Botón de acción**|Información previa|None|  
...
|![Botón de búsqueda&#45;hacia abajo enfocado](../extensibility/ux-guidelines/media/0303-113-searchdropdownbuttonfocused.png "0303-113_SearchDropdownButtonFocused")<br /><br /> **Botón desplegable**|Información previa|`SearchControl.FocusedDropDownButton`|  
|![Botón de búsqueda&#45;hacia abajo enfocado](../extensibility/ux-guidelines/media/0303-113-searchdropdownbuttonfocused.png "0303-113_SearchDropdownButtonFocused")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`SearchControl.FocusedDropDownButtonGlyph`|  
|![Botón de búsqueda&#45;hacia abajo enfocado](../extensibility/ux-guidelines/media/0303-113-searchdropdownbuttonfocused.png "0303-113_SearchDropdownButtonFocused")<br /><br /> **Botón desplegable**|Borde|`SearchControl.FocusedDropDownButtonBorder`|  
  
 **Sin foco**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Campo de entrada de búsqueda no enfocado](../extensibility/ux-guidelines/media/0303-114-searchinputfieldunfocused.png "0303-114_SearchInputFieldUnfocused")<br /><br /> **Campo de entrada activo**|Información previa|`SearchControl.SearchActiveBackground`|  
...
|![Campo de entrada de búsqueda no enfocado e inactivo](../extensibility/ux-guidelines/media/0303-114-1-searchinputfieldunfocusedinactive.png "0303-114-1_SearchInputFieldUnfocusedInactive")<br /><br /> **Campo de entrada inactivo**|Información previa|`SearchControl.Unfocused`|  
...
|![Botón de acción de búsqueda no enfocado](../extensibility/ux-guidelines/media/0303-115-searchactionbuttonunfocused.png "0303-115_SearchActionButtonUnfocused")<br /><br /> **Botón de acción**|Información previa|N/D|  
...
|![Botón desplegable de búsqueda&#45;desenfocado](../extensibility/ux-guidelines/media/0303-116-searchdropdownbuttonunfocused.png "0303-116_SearchDropdownButtonUnfocused")<br /><br /> **Botón desplegable**|Información previa|`SearchControl.UnfocusedDropDownButton`|  
|![Botón desplegable de búsqueda&#45;desenfocado](../extensibility/ux-guidelines/media/0303-116-searchdropdownbuttonunfocused.png "0303-116_SearchDropdownButtonUnfocused")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`SearchControl.UnfocusedDropDownButtonGlyph`|  
|![Botón desplegable de búsqueda&#45;desenfocado](../extensibility/ux-guidelines/media/0303-116-searchdropdownbuttonunfocused.png "0303-116_SearchDropdownButtonUnfocused")<br /><br /> **Botón desplegable**|Borde|`SearchControl.UnfocusedDropDownButtonBorder`|  
  
 **Presionado**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Botón de acción de búsqueda presionado](../extensibility/ux-guidelines/media/0303-116-1-searchactionbuttonpressed.png "0303-116-1_SearchActionButtonPressed")<br /><br /> **Botón de acción**|Información previa|`SearchControl.ActionButtonMouseDown`|  
...
|![Botón de búsqueda&#45;pulsado el botón desplegable](../extensibility/ux-guidelines/media/0303-116-2-searchdropdownbuttonpressed.png "0303-116-2_SearchDropdownButtonPressed")<br /><br /> **Botón desplegable**|Información previa|`SearchControl.MouseDownDropDownButton`|  
|![Botón de búsqueda&#45;pulsado el botón desplegable](../extensibility/ux-guidelines/media/0303-116-2-searchdropdownbuttonpressed.png "0303-116-2_SearchDropdownButtonPressed")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`SearchControl.MouseDownDropDownButtonGlyph`|  
|![Botón de búsqueda&#45;pulsado el botón desplegable](../extensibility/ux-guidelines/media/0303-116-2-searchdropdownbuttonpressed.png "0303-116-2_SearchDropdownButtonPressed")<br /><br /> **Botón desplegable**|Borde|`SearchControl.MouseDownDropDownButtonBorder`|  
  
 **Resaltado (solo texto)**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Campo de entrada de búsqueda resaltado](../extensibility/ux-guidelines/media/0303-120-searchinputfieldhighlight.png "0303-120_SearchInputFieldHighlight")<br /><br /> **Campo de entrada con texto resaltado**|Información previa|`SearchControl.Selection`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Campo de entrada de búsqueda deshabilitado](../extensibility/ux-guidelines/media/0303-121-searchinputfielddisabled.png "0303-121_SearchInputFieldDisabled")<br /><br /> **Campo de entrada**|Información previa|`SearchControl.Disabled`|  
...
|![Botón de acción de búsqueda deshabilitado](../extensibility/ux-guidelines/media/0303-122-searchactionbuttondisabled.png "0303-122_SearchActionButtonDisabled")<br /><br /> **Botón de acción**|Información previa|None|  
...
|![Botón desplegable de búsqueda&#45;botón desplegable desactivado](../extensibility/ux-guidelines/media/0303-123-searchdropdownbuttondisabled.png "0303-123_SearchDropdownButtonDisabled")<br /><br /> **Botón desplegable**|Información previa|None|  
|![Botón desplegable de búsqueda&#45;botón desplegable desactivado](../extensibility/ux-guidelines/media/0303-123-searchdropdownbuttondisabled.png "0303-123_SearchDropdownButtonDisabled")<br /><br /> **Botón desplegable**|Primer plano (glifo)|`SearchControl.DisabledDownButtonGlyph`|  
|![Botón desplegable de búsqueda&#45;botón desplegable desactivado](../extensibility/ux-guidelines/media/0303-123-searchdropdownbuttondisabled.png "0303-123_SearchDropdownButtonDisabled")<br /><br /> **Botón desplegable**|Borde|None|  
...
##### <a name="search-drop-down-lists"></a>Listas desplegables de búsqueda  
 ...
 ![Buscar&#45;línea roja hacia abajo](../extensibility/ux-guidelines/media/0303-124-searchdropdownredline.png "0303-124_SearchDropdownRedline")  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Búsqueda sugerida](../extensibility/ux-guidelines/media/0303-125-searchsuggested.png "0303-125_SearchSuggested")<br /><br /> **Búsquedas sugeridas**|Información previa|`SearchControl.PopupItemsListBackgroundGradientBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|![Casilla de verificación de búsqueda](../extensibility/ux-guidelines/media/0303-126-searchcheckbox.png "0303-126_SearchCheckbox")<br /><br /> **Opciones de búsqueda (casilla)**|Información previa|`SearchControl.PopupSectionBackgroundGradientBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
|![Opciones de búsqueda](../extensibility/ux-guidelines/media/0303-127-searchoptions.png "0303-127_SearchOptions")<br /><br /> **Opciones de búsqueda (vínculo)**|Información previa|`SearchControl.PopupSectionBackgroundGradientBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Búsqueda sugerida al mantener el mouse](../extensibility/ux-guidelines/media/0303-128-searchsuggestedhover.png "0303-128_SearchSuggestedHover")<br /><br /> **Búsquedas sugeridas**|Información previa|`SearchControl.PopupControlMouseOverBackgroundGradientBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|![Casilla de verificación de búsqueda al mantener el mouse](../extensibility/ux-guidelines/media/0303-129-searchcheckboxhover.png "0303-129_SearchCheckboxHover")<br /><br /> **Búsquedas sugeridas (casilla)**|Información previa|`SearchControl.PopupControlMouseOverBackgroundGradientBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
|![Opciones de búsqueda al mantener el mouse](../extensibility/ux-guidelines/media/0303-130-searchoptionshover.png "0303-130_SearchOptionsHover")<br /><br /> **Opciones de búsqueda**|Información previa|`SearchControl.PopupControlMouseOverBackgroundGradientBegin`<br /><br /> Aunque no se usan en la interfaz de usuario moderna con temas, hay delimitadores de degradado y valores para este fondo.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Barra de información](../extensibility/ux-guidelines/media/0303-139-infobar.png "0303-139_Infobar")<br /><br /> **Barra de información**|Información previa|`Environment.InfoBackground`|  
...
#### <a name="scroll-bar"></a>Barra de desplazamiento  
 Las barras de desplazamiento reciben el estilo del entorno de Visual Studio y no es necesario aplicarles un tema. Sin embargo, puede decidir que desea aprovechar los colores utilizados en las barras de desplazamiento para que la interfaz de usuario siempre parezca coherente con esta parte del entorno de Visual Studio.  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Barra de desplazamiento](../extensibility/ux-guidelines/media/0303-141-scrollbar.png "0303-141_Scrollbar")<br /><br /> **Scrollbar**|Barra de desplazamiento|`Environment.ScrollBarBackground`|  
|![Barra de desplazamiento](../extensibility/ux-guidelines/media/0303-141-scrollbar.png "0303-141_Scrollbar")<br /><br /> **Scrollbar**|Primer plano (control)|`Environment.ScrollBarThumbBackground`|  
|![Flecha de barra de desplazamiento](../extensibility/ux-guidelines/media/0303-142-scrollbararrow.png "0303-142_ScrollbarArrow")<br /><br /> **Flecha de desplazamiento**|Información previa|`Environment.ScrollBarArrowBackground`<br /><br /> Se establece en el mismo color que la barra de desplazamiento.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Barra de desplazamiento al mantener el mouse](../extensibility/ux-guidelines/media/0303-143-scrollbarhover.png "0303-143_ScrollbarHover")<br /><br /> **Scrollbar**|Barra de desplazamiento|`Environment.ScrollBarBackground`|  
|![Barra de desplazamiento al mantener el mouse](../extensibility/ux-guidelines/media/0303-143-scrollbarhover.png "0303-143_ScrollbarHover")<br /><br /> **Scrollbar**|Primer plano (control)|`Environment.ScrollBarThumbMouseOverBackground`|  
|![Flecha de barra de desplazamiento al mantener el mouse](../extensibility/ux-guidelines/media/0303-144-scrollbararrowhover.png "0303-144_ScrollbarArrowHover")<br /><br /> **Flecha de desplazamiento**|Información previa|`Environment.ScrollBarArrowMouseOverBackground`<br /><br /> Se establece en el mismo color que la barra de desplazamiento.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Barra de desplazamiento presionada](../extensibility/ux-guidelines/media/0303-145-scrollbarpressed.png "0303-145_ScrollbarPressed")<br /><br /> **Scrollbar**|Barra de desplazamiento|`Environment.ScrollBarBackground`|  
|![Barra de desplazamiento presionada](../extensibility/ux-guidelines/media/0303-145-scrollbarpressed.png "0303-145_ScrollbarPressed")<br /><br /> **Scrollbar**|Primer plano (control)|`Environment.ScrollBarThumbPressedBackground`|  
|![Flecha de la barra de desplazamiento presionada](../extensibility/ux-guidelines/media/0303-146-scrollbararrowpressed.png "0303-146_ScrollbarArrowPressed")<br /><br /> **Flecha de desplazamiento**|Información previa|`Environment.ScrollBarArrowPressedBackground`<br /><br /> Se establece en el mismo color que la barra de desplazamiento.|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Vista de árbol](../extensibility/ux-guidelines/media/0303-148-treeview.png "0303-148_TreeView")|Información previa|`TreeView.Background`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Vista de árbol al mantener el mouse](../extensibility/ux-guidelines/media/0303-149-treeviewhover.png "0303-149_TreeViewHover")|Información previa|`TreeView.Background`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Vista de árbol al arrastrar](../extensibility/ux-guidelines/media/0303-150-treeviewdragover.png "0303-150_TreeViewDragOver")|Información previa|`TreeView.DragOverItem`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Vista de árbol enfocada](../extensibility/ux-guidelines/media/0303-151-treeviewfocused.png "0303-151_TreeViewFocused")<br /><br /> **Con foco**|Información previa|`TreeView.SelectedItemActive`|  
|![Vista de árbol enfocada](../extensibility/ux-guidelines/media/0303-151-treeviewfocused.png "0303-151_TreeViewFocused")<br /><br /> **Con foco**|Primer plano (texto)|`TreeView.SelectedItemActive`|  
|![Vista de árbol enfocada](../extensibility/ux-guidelines/media/0303-151-treeviewfocused.png "0303-151_TreeViewFocused")<br /><br /> **Con foco**|Primer plano (glifo)|`TreeView.SelectedItemActiveGlyph`|  
|![Vista de árbol enfocada](../extensibility/ux-guidelines/media/0303-151-treeviewfocused.png "0303-151_TreeViewFocused")<br /><br /> **Con foco**|Borde|`TreeView.FocusVisualBorder`|  
|![Vista de árbol no enfocada](../extensibility/ux-guidelines/media/0303-152-treeviewunfocused.png "0303-152_TreeViewUnfocused")<br /><br /> **Sin foco**|Información previa|`TreeView.SelectedItemInactive`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Vista de árbol enfocada al mantener el mouse](../extensibility/ux-guidelines/media/0303-153-treeviewfocusedhover.png "0303-153_TreeViewFocusedHover")<br /><br /> **Con foco**|Información previa|`TreeView.SelectedItemActive`|  
|![Vista de árbol enfocada al mantener el mouse](../extensibility/ux-guidelines/media/0303-153-treeviewfocusedhover.png "0303-153_TreeViewFocusedHover")<br /><br /> **Con foco**|Primer plano (texto)|`TreeView.SelectedItemActive`|  
|![Vista de árbol enfocada al mantener el mouse](../extensibility/ux-guidelines/media/0303-153-treeviewfocusedhover.png "0303-153_TreeViewFocusedHover")<br /><br /> **Con foco**|Primer plano (glifo)|`TreeView.SelectedItemActiveGlyphMouseOver`|  
|![Vista de árbol enfocada al mantener el mouse](../extensibility/ux-guidelines/media/0303-153-treeviewfocusedhover.png "0303-153_TreeViewFocusedHover")<br /><br /> **Con foco**|Borde|Ninguno`TreeView.FocusVisualBorder`|  
|![Vista de árbol no enfocada al mantener el mouse](../extensibility/ux-guidelines/media/0303-154-treeviewunfocusedhover.png "0303-154_TreeViewUnfocusedHover")<br /><br /> **Sin foco**|Información previa|`TreeView.SelectedItemInactive`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![casilla](../extensibility/ux-guidelines/media/0303-162-checkbox.png "0303-162_Checkbox")|Información previa|`CommonControls.CheckBoxBackground`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Casilla de verificación deshabilitada](../extensibility/ux-guidelines/media/0303-163-checkboxdisabled.png "0303-163_CheckboxDisabled")|Información previa|`CommonControls.CheckBoxBackgroundDisabled`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Casilla de verificación al mantener el mouse](../extensibility/ux-guidelines/media/0303-164-checkboxhover.png "0303-164_CheckboxHover")|Información previa|`CommonControls.CheckBoxBackgroundHover`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Casilla de verificación presionada](../extensibility/ux-guidelines/media/0303-165-checkboxpressed.png "0303-165_CheckboxPressed")|Información previa|`CommonControls.CheckBoxBackgroundPressed`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Casilla de verificación enfocada](../extensibility/ux-guidelines/media/0303-166-checkboxfocused.png "0303-166_CheckboxFocused")|Información previa|`CommonControls.CheckBoxBackgroundFocused`|  
...
|![Casilla de verificación enfocada](../extensibility/ux-guidelines/media/0303-166-checkboxfocused.png "0303-166_CheckboxFocused")|Texto|`CommonControls.CheckBoxTextFocused`|  
...
#### <a name="drop-boxcombo-box-controls"></a>Controles de cuadro combinado o lista desplegable  
 ![Suelta&#45;&#47;caja roja del cuadro combinado](../extensibility/ux-guidelines/media/0303-167-dropdowncomboboxredline.png "0303-167_DropDownComboBoxRedline")  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Suelta&#45;&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-168-dropdowncombobox.png "0303-168_DropDownComboBox")|Información previa|`CommonControls.ComboBoxBackground`|  
|![Suelta&#45;&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-168-dropdowncombobox.png "0303-168_DropDownComboBox")|Borde|`CommonControls.ComboBoxBorder`|  
|![Suelta&#45;&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-168-dropdowncombobox.png "0303-168_DropDownComboBox")|Texto|`CommonControls.ComboBoxText`|  
|![Suelta&#45;&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-168-dropdowncombobox.png "0303-168_DropDownComboBox")|Separador|`CommonControls.ComboBoxSeparator`|  
|![Suelta&#45;&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-168-dropdowncombobox.png "0303-168_DropDownComboBox")|Glifo|`CommonControls.ComboBoxGlyph`|  
|![Suelta&#45;&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-168-dropdowncombobox.png "0303-168_DropDownComboBox")|Fondo de glifo|`CommonControls.ComboBoxGlyphBackground`|  
  
 **Deshabilitado**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Suelta&#45;cuadro combinado desactivado&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-169-dropdowncomboboxdisabled.png "0303-169_DropDownComboBoxDisabled")|Información previa|`CommonControls.ComboBoxBackgroundDisabled`|  
|![Suelta&#45;cuadro combinado desactivado&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-169-dropdowncomboboxdisabled.png "0303-169_DropDownComboBoxDisabled")|Borde|`CommonControls.ComboBoxBorderDisabled`|  
|![Suelta&#45;cuadro combinado desactivado&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-169-dropdowncomboboxdisabled.png "0303-169_DropDownComboBoxDisabled")|Texto|`CommonControls.ComboBoxTextDisabled`|  
|![Suelta&#45;cuadro combinado desactivado&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-169-dropdowncomboboxdisabled.png "0303-169_DropDownComboBoxDisabled")|Separador|`CommonControls.ComboBoxSeparatorDisabled`|  
|![Suelta&#45;cuadro combinado desactivado&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-169-dropdowncomboboxdisabled.png "0303-169_DropDownComboBoxDisabled")|Glifo|`CommonControls.ComboBoxGlyphDisabled`|  
|![Suelta&#45;cuadro combinado desactivado&#47;cuadro combinado](../extensibility/ux-guidelines/media/0303-169-dropdowncomboboxdisabled.png "0303-169_DropDownComboBoxDisabled")|Fondo de glifo|`CommonControls.ComboBoxGlyphBackgroundDisabled`|  
  
 **Al mantener el puntero**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Suelta&#45;cuadro combinado de&#47;al pasar el ratón](../extensibility/ux-guidelines/media/0303-170-dropdowncomboboxhover.png "0303-170_DropDownComboBoxHover")|Información previa|`CommonControls.ComboBoxBackgroundHover`|  
|![Suelta&#45;cuadro combinado de&#47;al pasar el ratón](../extensibility/ux-guidelines/media/0303-170-dropdowncomboboxhover.png "0303-170_DropDownComboBoxHover")|Borde|`CommonControls.ComboBoxBorderHover`|  
|![Suelta&#45;cuadro combinado de&#47;al pasar el ratón](../extensibility/ux-guidelines/media/0303-170-dropdowncomboboxhover.png "0303-170_DropDownComboBoxHover")|Texto|`CommonControls.ComboBoxTextHover`|  
|![Suelta&#45;cuadro combinado de&#47;al pasar el ratón](../extensibility/ux-guidelines/media/0303-170-dropdowncomboboxhover.png "0303-170_DropDownComboBoxHover")|Separador|`CommonControls.ComboBoxSeparatorHover`|  
|![Suelta&#45;cuadro combinado de&#47;al pasar el ratón](../extensibility/ux-guidelines/media/0303-170-dropdowncomboboxhover.png "0303-170_DropDownComboBoxHover")|Glifo|`CommonControls.ComboBoxGlyphHover`|  
|![Suelta&#45;cuadro combinado de&#47;al pasar el ratón](../extensibility/ux-guidelines/media/0303-170-dropdowncomboboxhover.png "0303-170_DropDownComboBoxHover")|Fondo de glifo|`CommonControls.ComboBoxGlyphBackgroundHover`|  
  
 **Presionado**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Suelta&#45;&#47;cuadro combinado presionado](../extensibility/ux-guidelines/media/0303-171-dropdowncomboboxpressed.png "0303-171_DropDownComboBoxPressed")|Información previa|`CommonControls.ComboBoxBackgroundPressed`|  
|![Suelta&#45;&#47;cuadro combinado presionado](../extensibility/ux-guidelines/media/0303-171-dropdowncomboboxpressed.png "0303-171_DropDownComboBoxPressed")|Borde|`CommonControls.ComboBoxBorderPressed`|  
|![Suelta&#45;&#47;cuadro combinado presionado](../extensibility/ux-guidelines/media/0303-171-dropdowncomboboxpressed.png "0303-171_DropDownComboBoxPressed")|Texto|`CommonControls.ComboBoxTextPressed`|  
|![Suelta&#45;&#47;cuadro combinado presionado](../extensibility/ux-guidelines/media/0303-171-dropdowncomboboxpressed.png "0303-171_DropDownComboBoxPressed")|Separador|`CommonControls.ComboBoxSeparatorPressed`|  
|![Suelta&#45;&#47;cuadro combinado presionado](../extensibility/ux-guidelines/media/0303-171-dropdowncomboboxpressed.png "0303-171_DropDownComboBoxPressed")|Glifo|`CommonControls.ComboBoxGlyphPressed`|  
|![Suelta&#45;&#47;cuadro combinado presionado](../extensibility/ux-guidelines/media/0303-171-dropdowncomboboxpressed.png "0303-171_DropDownComboBoxPressed")|Fondo de glifo|`CommonControls.ComboBoxGlyphBackgroundPressed`|  
  
 **Con foco**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Suelta&#45;&#47;cuadro combinado enfocado](../extensibility/ux-guidelines/media/0303-172-dropdowncomboboxfocused.png "0303-172_DropDownComboBoxFocused")|Información previa|`CommonControls.ComboBoxBackgroundFocused`|  
|![Suelta&#45;&#47;cuadro combinado enfocado](../extensibility/ux-guidelines/media/0303-172-dropdowncomboboxfocused.png "0303-172_DropDownComboBoxFocused")|Borde|`CommonControls.ComboBoxBorderFocused`|  
|![Suelta&#45;&#47;cuadro combinado enfocado](../extensibility/ux-guidelines/media/0303-172-dropdowncomboboxfocused.png "0303-172_DropDownComboBoxFocused")|Texto|`CommonControls.ComboBoxTextFocused`|  
|![Suelta&#45;&#47;cuadro combinado enfocado](../extensibility/ux-guidelines/media/0303-172-dropdowncomboboxfocused.png "0303-172_DropDownComboBoxFocused")|Separador|`CommonControls.ComboBoxSeparatorFocused`|  
|![Suelta&#45;&#47;cuadro combinado enfocado](../extensibility/ux-guidelines/media/0303-172-dropdowncomboboxfocused.png "0303-172_DropDownComboBoxFocused")|Glifo|`CommonControls.ComboBoxGlyphFocused`|  
|![Suelta&#45;&#47;cuadro combinado enfocado](../extensibility/ux-guidelines/media/0303-172-dropdowncomboboxfocused.png "0303-172_DropDownComboBoxFocused")|Fondo de glifo|`CommonControls.ComboBoxGlyphBackgroundFocused`|  
  
 **Selección de entrada de texto**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Suelte&#45;entrada de texto de cuadro combinado hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-173-dropdowncomboboxtextinput.png "0303-173_DropDownComboBoxTextInput")|Resaltar|`CommonControls.ComboBoxTextInputSelection`|  
  
 **Presionado: vista de elementos de lista**  
  
|Componente|Elemento|Nombre del token: Color.category|  
|---------------|-------------|--------------------------------|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Información previa|`CommonControls.ComboBoxListBackground`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Información previa|`CommonControls.ComboBoxListBackgroundHover`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Información previa|`CommonControls.ComboBoxListItemBackgroundPressed`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Información previa|`CommonControls.ComboBoxListItemBackgroundFocused`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Borde|`CommonControls.ComboBoxListBorder`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Borde|`CommonControls.ComboBoxListBorderHover`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Borde|`CommonControls.ComboBoxListBorderPressed`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Borde|`CommonControls.ComboBoxListBorderFocused`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Texto del elemento|`CommonControls.ComboBoxListItemText`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Texto del elemento|`CommonControls.ComboBoxListItemTextHover`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Texto del elemento|`CommonControls.ComboBoxListItemTextPressed`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Texto del elemento|`CommonControls.ComboBoxListItemTextFocused`|  
|![Suelte&#45;vista de lista de cuadros combinados hacia abajo&#47;](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")|Sombra de fondo|`CommonControls.ComboBoxListBackgroundShadow`|  
...
#### <a name="tabular-data-grid-controls"></a>Controles de datos tabulares (cuadrícula)  
 ...
 ![Datos tabulares &#40;control de cuadrícula&#41; línea roja](../extensibility/ux-guidelines/media/0303-197-tabulardatagridcontrolredline.png "0303-197_TabularDataGridControlRedline")  
...
|-----------|-------------|--------------------------------|  
|Valor predeterminado|Información previa|`Header.Default`|  
|Valor predeterminado|Primer plano (texto)|`Environment.CommandBarTextActive`|  
|Valor predeterminado|Primer plano (glifo)|`Header.Glyph`|  
|Valor predeterminado|Borde|`Header.SeparatorLine`|  
|Al mantener el puntero|Información previa|`Header.MouseOver`|  
...
|Presionado|Información previa|`CommonControls.CheckBoxBackgroundPressed`|  
...
|State|Elemento|Nombre del token: Category.color|  
|-----------|-------------|--------------------------------|  
|Valor predeterminado|Información previa|Transparente|  
|Valor predeterminado|Primer plano (texto)|`Environment.CommandBarTextActive`|  
|Valor predeterminado|Borde|None|  
|Seleccionado (activo)|Información previa|`TreeView.SelectedItemActive`|  
|Seleccionado (activo)|Primer plano (texto)|`TreeView.SelectedItemActiveText`|  
|Seleccionado (activo)|Borde|None|  
|Seleccionado (inactivo)|Información previa|`TreeView.SelectedItemInactive`|  
...
|-----------|---------------|-------------|--------------------------------|  
|Predeterminado (seleccionado)|Pestaña|Información previa|`ManifestDesigner.TabActive`|  
|Predeterminado (seleccionado)|Pestaña|Borde|None|  
|Predeterminado (seleccionado)|Panel de descripción|Información previa|`ManifestDesigner.DescriptionPane`|  
|Predeterminado (seleccionado)|Página de contenido|Información previa|`ManifestDesigner.Background`|  
...
|Sin seleccionar|Pestaña|Información previa|`ManifestDesigner.Tab.Inactive`|  
|Al mantener el puntero|Pestaña|Información previa|`ManifestDesigner.Tab.Mouseover`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![etiqueta](../extensibility/ux-guidelines/media/0303-177-tag.png "0303-177_Tag")<br /><br /> **Predeterminado**|Información previa|`Tag.Background`|  
|![etiqueta](../extensibility/ux-guidelines/media/0303-177-tag.png "0303-177_Tag")<br /><br /> **Predeterminado**|Primer plano (texto)|`Tag.Background`|  
|![Etiqueta al mantener el mouse](../extensibility/ux-guidelines/media/0303-178-taghover.png "0303-178_TagHover")<br /><br /> **Al mantener el puntero**|Información previa|`Tag.HoverBackground`|  
...
|![Etiqueta presionada](../extensibility/ux-guidelines/media/0303-179-tagpressed.png "0303-179_TagPressed")<br /><br /> **Presionado**|Información previa|`Tag.PressedBackground`|  
...
|![Etiqueta seleccionada](../extensibility/ux-guidelines/media/0303-180-tagselected.png "0303-180_TagSelected")<br /><br /> **Seleccionado**|Información previa|`Tag.SelectedBackground`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![&#41;de glifo de &#40;de etiquetas](../extensibility/ux-guidelines/media/0303-181-tagglyph.png "0303-181_TagGlyph")<br /><br /> **Predeterminado (valor predeterminado de etiqueta)**|Información previa|N/D|  
|![&#41;de glifo de &#40;de etiquetas](../extensibility/ux-guidelines/media/0303-181-tagglyph.png "0303-181_TagGlyph")<br /><br /> **Predeterminado (valor predeterminado de etiqueta)**|Primer plano (glifo)|`Tag.TagHoverGlyph`|  
  
 **Al mantener el puntero**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Etiquetar &#40;&#41; de glifo al mantener el mouse](../extensibility/ux-guidelines/media/0303-182-tagglyphhover.png "0303-182_TagGlyphHover")<br /><br /> **Al mantener el puntero (valor predeterminado de etiqueta)**|Información previa|`Tag.TagHoverGlyphHoverBackground`|  
|![Etiquetar &#40;&#41; de glifo al mantener el mouse](../extensibility/ux-guidelines/media/0303-182-tagglyphhover.png "0303-182_TagGlyphHover")<br /><br /> **Al mantener el puntero (valor predeterminado de etiqueta)**|Primer plano (glifo)|`Tag.TagHoverGlyphHover`|  
|![Etiquetar &#40;&#41; de glifo al mantener el mouse](../extensibility/ux-guidelines/media/0303-182-tagglyphhover.png "0303-182_TagGlyphHover")<br /><br /> **Al mantener el puntero (valor predeterminado de etiqueta)**|Borde|`Tag.TagHoverGlyphHoverBorder`|  
  
 **Presionado**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![&#41; presionar el glifo de &#40;de etiquetas](../extensibility/ux-guidelines/media/0303-183-tagglyphpressed.png "0303-183_TagGlyphPressed")<br /><br /> **Presionado (valor predeterminado de etiqueta)**|Información previa|`Tag.TagHoverGlyphPressedBackground`|  
|![&#41; presionar el glifo de &#40;de etiquetas](../extensibility/ux-guidelines/media/0303-183-tagglyphpressed.png "0303-183_TagGlyphPressed")<br /><br /> **Presionado (valor predeterminado de etiqueta)**|Primer plano (glifo)|`Tag.TagHoverGlyphPressed`|  
|![&#41; presionar el glifo de &#40;de etiquetas](../extensibility/ux-guidelines/media/0303-183-tagglyphpressed.png "0303-183_TagGlyphPressed")<br /><br /> **Presionado (valor predeterminado de etiqueta)**|Borde|`Tag.TagHoverGlyphPressedBorder`|  
  
 **Etiqueta seleccionada o valor predeterminado de glifo**  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Etiqueta seleccionada](../extensibility/ux-guidelines/media/0303-184-tagselected.png "0303-184_TagSelected")<br /><br /> **Predeterminado (etiqueta seleccionada)**|Información previa|N/D|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Etiqueta seleccionada al mantener el mouse](../extensibility/ux-guidelines/media/0303-185-tagselectedhover.png "0303-185_TagSelectedHover")<br /><br /> **Al mantener el puntero (etiqueta seleccionada)**|Información previa|`Tag.TagSelectedGlyphHoverBackground`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Etiqueta seleccionada presionada](../extensibility/ux-guidelines/media/0303-186-tagselectedpressed.png "0303-186_TagSelectedPressed")<br /><br /> **Presionado (etiqueta seleccionada)**|Información previa|`Tag.TagSelectedGlyphPressedBackground`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|Nivel inferior|Información previa|`Environment.EnvironmentBackground`|  
  
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|Nivel superior|Información previa<br /><br /> *Los delimitadores de degradado se establecen en el mismo valor de color en los temas claro y oscuro de Visual Studio 2013.*|`Environment.EnvironmentBackgroundGradientBegin`|  
|Nivel superior|Información previa<br /><br /> *Los delimitadores de degradado se establecen en el mismo valor de color en los temas claro y oscuro de Visual Studio 2013.*|`Environment.EnvironmentBackgroundGradientEnd`|  
|Nivel superior|Información previa<br /><br /> *Los delimitadores de degradado se establecen en el mismo valor de color en los temas claro y oscuro de Visual Studio 2013.*|`Environment.EnvironmentBackgroundGradientMiddle1`|  
|Nivel superior|Información previa<br /><br /> *Los delimitadores de degradado se establecen en el mismo valor de color en los temas claro y oscuro de Visual Studio 2013.*|`Environment.EnvironmentBackgroundGradientMiddle2`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|Barra de menús|Información previa<br /><br /> *Los delimitadores de degradado se establecen en el mismo valor de color en los temas claro y oscuro de Visual Studio 2013.*|`Environment.CommandShelfHighlightGradientBegin`|  
|Barra de menús|Información previa<br /><br /> *Los delimitadores de degradado se establecen en el mismo valor de color en los temas claro y oscuro de Visual Studio 2013.*|`Environment.CommandShelfHighlightGradientMiddle`|  
|Barra de menús|Información previa<br /><br /> *Los delimitadores de degradado se establecen en el mismo valor de color en los temas claro y oscuro de Visual Studio 2013.*|`Environment.CommandShelfHighlightGradientEnd`|  
|Barra de comandos|Información previa<br /><br /> *Los delimitadores de degradado se establecen en el mismo valor de color en los temas claro y oscuro de Visual Studio 2013.*|`Environment.CommandShelfBackgroundGradientBegin`|  
|Barra de comandos|Información previa<br /><br /> *Los delimitadores de degradado se establecen en el mismo valor de color en los temas claro y oscuro de Visual Studio 2013.*|`Environment.CommandShelfBackgroundGradientMiddle`|  
|Barra de comandos|Información previa<br /><br /> *Los delimitadores de degradado se establecen en el mismo valor de color en los temas claro y oscuro de Visual Studio 2013.*|`Environment.CommandShelfBackgroundGradientEnd`|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Nodo primario de cuadro de herramientas](../extensibility/ux-guidelines/media/0303-190-toolboxparentnode.png "0303-190_ToolboxParentNode")<br /><br /> **Nodo primario**|Información previa|`Environment.ToolboxContent`<br /><br /> Encabezados<br /><br /> `Environment.ToolWindowBackground`<br /><br /> Elementos individuales o ventana completa si no hay controles disponibles|  
|![Nodo secundario de cuadro de herramientas](../extensibility/ux-guidelines/media/0303-191-toolboxchildnode.png "0303-191_ToolboxChildNode")<br /><br /> **Nodo secundario**|Información previa|`Environment.ToolboxContent`<br /><br /> Encabezados<br /><br /> `Environment.ToolWindowBackground`<br /><br /> Elementos individuales o ventana completa si no hay controles disponibles|  
...
|Componente|Elemento|Nombre del token: Category.color|  
|---------------|-------------|--------------------------------|  
|![Nodo primario de cuadro de herramientas enfocado](../extensibility/ux-guidelines/media/0303-193-toolboxparentnodefocused.png "0303-193_ToolboxParentNodeFocused")<br /><br /> **Nodo primario con foco**|Información previa|`TreeView.SelectedItemActive`<br /><br /> De categoría [Tree view](../misc/shared-colors.md#BKMK_TreeView)|  
|![Nodo secundario de cuadro de herramientas enfocado](../extensibility/ux-guidelines/media/0303-194-toolboxchildnodefocused.png "0303-194_ToolboxChildNodeFocused")<br /><br /> **Nodo secundario con foco**|Información previa|`TreeView.SelectedItemActive`<br /><br /> De categoría [Tree view](../misc/shared-colors.md#BKMK_TreeView)|  
...
|![Nodo primario de cuadro de herramientas no enfocado](../extensibility/ux-guidelines/media/0303-195-toolboxparentnodeunfocused.png "0303-195_ToolboxParentNodeUnfocused")<br /><br /> **Nodo primario sin foco**|Información previa|`TreeView.SelectedItemInactive`<br /><br /> De categoría [Tree view](../misc/shared-colors.md#BKMK_TreeView)|  
|![Nodo secundario de cuadro de herramientas no enfocado](../extensibility/ux-guidelines/media/0303-196-toolboxchildnodeunfocused.png "0303-196_ToolboxChildNodeUnfocused")<br /><br /> **Nodo secundario sin foco**|Información previa|`TreeView.SelectedItemInactive`<br /><br /> De categoría [Tree view](../misc/shared-colors.md#BKMK_TreeView)|  
...
|||||||||  
|-|-|-|-|-|-|-|-|  
|Componente|Parte|Elemento|State|Ligero|Oscuro|Azul|Contraste alto|  
|Líneas divisorias|||Valor predeterminado|FFEEEEF2|FF2D2D30|FFEEEEF2|ControlDark|  
|Glifo de expansión||Primer plano|Valor predeterminado|||||  
|Glifo de expansión||Primer plano|Al mantener el puntero|||||  
|Glifo de expansión||Información previa|Valor predeterminado|||||  
|Glifo de expansión||Información previa|Al mantener el puntero|||||  
|Glifo de expansión||Borde|Valor predeterminado|||||  
