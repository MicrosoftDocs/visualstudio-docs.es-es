...
La versión más reciente de este tema puede encontrarse en [advertencias de análisis de código para código administrado por CheckId](https://docs.microsoft.com/visualstudio/code-quality/code-analysis-warnings-for-managed-code-by-checkid).  
