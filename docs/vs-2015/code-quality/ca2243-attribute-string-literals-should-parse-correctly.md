...
La versión más reciente de este tema puede encontrarse en [CA2243: los literales de cadena de atributo se deben analizar correctamente](https://docs.microsoft.com/visualstudio/code-quality/ca2243-attribute-string-literals-should-parse-correctly).
