...
ms.locfileid: "47574806"
---
# <a name="maintainability-warnings"></a>advertencias de mantenimiento
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [advertencias de mantenimiento](https://docs.microsoft.com/visualstudio/code-quality/maintainability-warnings).  
