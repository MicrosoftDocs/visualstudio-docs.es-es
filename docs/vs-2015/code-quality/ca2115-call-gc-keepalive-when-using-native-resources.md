...
La versión más reciente de este tema puede encontrarse en [CA2115: llamar a GC. KeepAlive cuando se utilicen recursos nativos](https://docs.microsoft.com/visualstudio/code-quality/ca2115-call-gc-keepalive-when-using-native-resources).
