...
ms.locfileid: "47591278"
---
# <a name="ca1502-avoid-excessive-complexity"></a>CA1502: Evite la excesiva complejidad
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CA1502: Evite la excesiva complejidad](https://docs.microsoft.com/visualstudio/code-quality/ca1502-avoid-excessive-complexity).
