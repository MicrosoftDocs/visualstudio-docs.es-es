...
```  
 ...
 `c` sería la extensión de signo a con signo `int` con un valor 37, que está fuera del intervalo válido para [isspace](https://msdn.microsoft.com/library/3ac254c4-92aa-4238-882a-3a3fb576cdf5).  
