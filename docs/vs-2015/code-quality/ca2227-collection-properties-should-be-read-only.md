---
title: 'CA2227: Las propiedades de colección deben ser de solo lectura | Microsoft Docs'
ms.custom: ''
ms.date: 2018-06-30
...
La versión más reciente de este tema puede encontrarse en [CA2227: las propiedades de colección deben ser de solo lectura](https://docs.microsoft.com/visualstudio/code-quality/ca2227-collection-properties-should-be-read-only).
