...
Advertencia C6279: \<variable > se asigna nuevo escalar, eliminará con la eliminación de matriz]  
 ...
 Esta advertencia solo aparece en C++ código e indica que la función de llamada ha asignado memoria con el valor escalar de manera inconsistente **nueva** operador, pero lo ha liberado con la matriz **delete []** operador. Si la memoria se asigna con valor escalar **nueva**, lo normal es liberarla con valor escalar **eliminar**.  
