...
La versión más reciente de este tema puede encontrarse en [CA1711: los identificadores no deberían tener el sufijo incorrecto](https://docs.microsoft.com/visualstudio/code-quality/ca1711-identifiers-should-not-have-incorrect-suffix).
