...
La versión más reciente de este tema puede encontrarse en [CA1033: los métodos de interfaz deben ser tipos secundarios](https://docs.microsoft.com/visualstudio/code-quality/ca1033-interface-methods-should-be-callable-by-child-types).
