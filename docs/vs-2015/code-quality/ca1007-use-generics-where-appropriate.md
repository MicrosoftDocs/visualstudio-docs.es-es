---
title: 'CA1007: Utilizar valores genéricos cuando sea apropiado | Microsoft Docs'
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47583266"
---
# <a name="ca1007-use-generics-where-appropriate"></a>CA1007: Utilizar valores genéricos cuando sea posible
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CA1007: utilizar valores genéricos](https://docs.microsoft.com/visualstudio/code-quality/ca1007-use-generics-where-appropriate).
