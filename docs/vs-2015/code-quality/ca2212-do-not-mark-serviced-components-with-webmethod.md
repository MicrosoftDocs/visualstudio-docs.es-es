...
La versión más reciente de este tema puede encontrarse en [CA2212: no marcar los componentes con servicio como WebMethod](https://docs.microsoft.com/visualstudio/code-quality/ca2212-do-not-mark-serviced-components-with-webmethod).
