...
La versión más reciente de este tema puede encontrarse en [CA2220: los finalizadores deben llamar al finalizador de la clase base](https://docs.microsoft.com/visualstudio/code-quality/ca2220-finalizers-should-call-base-class-finalizer).
