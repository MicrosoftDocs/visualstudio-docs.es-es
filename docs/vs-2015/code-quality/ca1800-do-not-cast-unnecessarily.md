...
ms.locfileid: "47591548"
---
# <a name="ca1800-do-not-cast-unnecessarily"></a>CA1800: No convertir innecesariamente
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CA1800: no convertir innecesariamente](https://docs.microsoft.com/visualstudio/code-quality/ca1800-do-not-cast-unnecessarily).
