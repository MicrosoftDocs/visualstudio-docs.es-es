...
La versión más reciente de este tema puede encontrarse en [CA1019: definir descriptores de acceso para los argumentos de atributo](https://docs.microsoft.com/visualstudio/code-quality/ca1019-define-accessors-for-attribute-arguments).
