...
La versión más reciente de este tema puede encontrarse en [CA1065: no producir excepciones en ubicaciones inesperadas](https://docs.microsoft.com/visualstudio/code-quality/ca1065-do-not-raise-exceptions-in-unexpected-locations).
