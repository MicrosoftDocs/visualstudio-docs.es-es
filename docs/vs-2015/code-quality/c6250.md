...
ms.locfileid: "47576224"
---
# <a name="c6250"></a>C6250
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [C6250](https://docs.microsoft.com/visualstudio/code-quality/c6250).  
  
Advertencia C6250: llamar a \<función > VirtualFree sin la marca MEM_RELEASE se podrá liberar memoria pero no descriptores de dirección (VAD); da como resultado pérdidas de espacio de dirección  
