...
ms.locfileid: "77272796"
---
# <a name="c6331"></a>C6331
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

ADVERTENCIA C6331: parámetro no válido: no se permite pasar MEM_RELEASE y MEM_DECOMMIT junto a \<function> . Esto provocará un error en la llamada  
