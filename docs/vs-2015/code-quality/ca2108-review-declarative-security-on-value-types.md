...
La versión más reciente de este tema puede encontrarse en [CA2108: revisar la seguridad declarativa en los tipos de valor](https://docs.microsoft.com/visualstudio/code-quality/ca2108-review-declarative-security-on-value-types).
