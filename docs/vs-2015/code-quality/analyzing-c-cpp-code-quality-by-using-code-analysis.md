---
title: Analizar la calidad de código de C/C++ mediante el análisis de código | Microsoft Docs
ms.date: 11/15/2016
...
|Title|Descripción|  
|-|-|  
|[Información general de análisis de código para C/C++](../code-quality/code-analysis-for-c-cpp-overview.md)|Proporciona información sobre las características de la herramienta de análisis de código.|  
...
|[Usar los comprobadores de C++ Core Guidelines](../code-quality/using-the-cpp-core-guidelines-checkers.md)|Agregue los comprobadores de C++ Core Guidelines al proyecto.|  
