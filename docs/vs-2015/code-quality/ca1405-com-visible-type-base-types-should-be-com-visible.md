...
La versión más reciente de este tema puede encontrarse en [CA1405: los tipos de base de tipos visibles COM deben ser visibles para COM](https://docs.microsoft.com/visualstudio/code-quality/ca1405-com-visible-type-base-types-should-be-com-visible).
