...
ADVERTENCIA C6277: nombre de la aplicación NULL con una ruta de acceso sin comillas en la llamada a \<function> : se produce una vulnerabilidad de seguridad si la ruta contiene espacios  
