...
La versión más reciente de este tema puede encontrarse en [CA2225: las sobrecargas del operador tienen alternativas con nombre](https://docs.microsoft.com/visualstudio/code-quality/ca2225-operator-overloads-have-named-alternates).
