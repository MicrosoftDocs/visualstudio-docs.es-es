...
ms.locfileid: "47580770"
---
# <a name="mixed-minimum-rules-rule-set"></a>Conjunto de reglas Reglas mínimas mixtas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [conjunto de reglas reglas mínimas mixtas](https://docs.microsoft.com/visualstudio/code-quality/mixed-minimum-rules-rule-set).  
