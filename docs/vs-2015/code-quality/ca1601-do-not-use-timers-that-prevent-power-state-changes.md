...
La versión más reciente de este tema puede encontrarse en [CA1601: no utilizar temporizadores que impidan los cambios de estado de energía](https://docs.microsoft.com/visualstudio/code-quality/ca1601-do-not-use-timers-that-prevent-power-state-changes).
