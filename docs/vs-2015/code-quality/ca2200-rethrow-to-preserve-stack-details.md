...
La versión más reciente de este tema puede encontrarse en [CA2200: Rethrow para conservar los detalles de la pila](https://docs.microsoft.com/visualstudio/code-quality/ca2200-rethrow-to-preserve-stack-details).
