...
```  
 ...
 Para ver un ejemplo completo de cómo crear un descriptor de seguridad, consulte [crear un descriptor de C++seguridad para un nuevo objeto en ](https://msdn.microsoft.com/library/aa446595.aspx). Para obtener más información, vea [crear una DACL](https://msdn.microsoft.com/library/ms717798.aspx).
