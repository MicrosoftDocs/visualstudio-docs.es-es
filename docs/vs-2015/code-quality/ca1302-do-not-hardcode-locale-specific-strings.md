...
La versión más reciente de este tema puede encontrarse en [CA1302: no codificar las cadenas específicas de configuración regional](https://docs.microsoft.com/visualstudio/code-quality/ca1302-do-not-hardcode-locale-specific-strings).
