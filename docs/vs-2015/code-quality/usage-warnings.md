...
ms.locfileid: "47567816"
---
# <a name="usage-warnings"></a>advertencias de uso
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [advertencias de uso](https://docs.microsoft.com/visualstudio/code-quality/usage-warnings).  
