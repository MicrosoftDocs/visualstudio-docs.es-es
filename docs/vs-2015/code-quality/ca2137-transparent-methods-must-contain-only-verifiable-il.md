...
La versión más reciente de este tema puede encontrarse en [CA2137: los métodos transparentes deben contener solo comprobable IL](https://docs.microsoft.com/visualstudio/code-quality/ca2137-transparent-methods-must-contain-only-verifiable-il).
