...
La versión más reciente de este tema puede encontrarse en [CA1814: preferir las matrices escalonadas antes que multidimensionales](https://docs.microsoft.com/visualstudio/code-quality/ca1814-prefer-jagged-arrays-over-multidimensional).
