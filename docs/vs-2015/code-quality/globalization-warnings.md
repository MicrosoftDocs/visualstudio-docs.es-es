...
ms.locfileid: "47582310"
---
# <a name="globalization-warnings"></a>Advertencias de globalización
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [advertencias de globalización](https://docs.microsoft.com/visualstudio/code-quality/globalization-warnings).  
