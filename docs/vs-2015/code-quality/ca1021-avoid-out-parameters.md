...
ms.locfileid: "47591284"
---
# <a name="ca1021-avoid-out-parameters"></a>CA1021: Evitar parámetros out
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [CA1021: evitar parámetros out](https://docs.microsoft.com/visualstudio/code-quality/ca1021-avoid-out-parameters).
