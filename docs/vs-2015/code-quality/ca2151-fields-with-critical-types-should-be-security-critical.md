...
La versión más reciente de este tema puede encontrarse en [CA2151: los campos con tipos críticos deben ser crítico para la seguridad](https://docs.microsoft.com/visualstudio/code-quality/ca2151-fields-with-critical-types-should-be-security-critical).
