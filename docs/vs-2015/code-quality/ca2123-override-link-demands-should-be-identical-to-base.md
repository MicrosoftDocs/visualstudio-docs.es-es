...
La versión más reciente de este tema puede encontrarse en [CA2123: las peticiones de vínculo deben ser idénticas al basar](https://docs.microsoft.com/visualstudio/code-quality/ca2123-override-link-demands-should-be-identical-to-base).
