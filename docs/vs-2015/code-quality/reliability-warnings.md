...
ms.locfileid: "47576520"
---
# <a name="reliability-warnings"></a>advertencias de confiabilidad
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [advertencias de confiabilidad](https://docs.microsoft.com/visualstudio/code-quality/reliability-warnings).  
