...
La versión más reciente de este tema puede encontrarse en [CA2104: no declarar tipos de referencias mutables de solo lectura](https://docs.microsoft.com/visualstudio/code-quality/ca2104-do-not-declare-read-only-mutable-reference-types).
