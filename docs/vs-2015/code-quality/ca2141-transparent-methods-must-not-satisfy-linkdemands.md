...
La versión más reciente de este tema puede encontrarse en [CA2141: los métodos transparentes no deben satisfacer LinkDemands](https://docs.microsoft.com/visualstudio/code-quality/ca2141-transparent-methods-must-not-satisfy-linkdemands).
