...
ms.locfileid: "47574654"
---
# <a name="how-to-create-a-custom-rule-set"></a>Cómo: Crear un conjunto de reglas personalizadas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: crear un conjunto de reglas personalizado](https://docs.microsoft.com/visualstudio/code-quality/how-to-create-a-custom-rule-set).  
