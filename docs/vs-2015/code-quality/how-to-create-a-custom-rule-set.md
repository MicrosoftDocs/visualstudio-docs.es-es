...
1. En el menú **archivo** de [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] , elija **nuevo** y, a continuación, haga clic en **archivo**.
...
- Para cambiar el campo por el que se agrupan las reglas, seleccione el campo en la lista **Agrupar por** . Para mostrar las reglas desagrupadas, seleccione **\<None>** .
