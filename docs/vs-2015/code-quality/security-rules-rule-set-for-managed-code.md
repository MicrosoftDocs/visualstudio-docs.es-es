...
La versión más reciente de este tema puede encontrarse en [establecen reglas de seguridad para código administrado](https://docs.microsoft.com/visualstudio/code-quality/security-rules-rule-set-for-managed-code).  
