...
La versión más reciente de este tema puede encontrarse en [análisis de código para información general del código administrado](https://docs.microsoft.com/visualstudio/code-quality/code-analysis-for-managed-code-overview).  
