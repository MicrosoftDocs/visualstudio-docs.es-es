...
ms.locfileid: "47578846"
---
# <a name="all-rules-rule-set"></a>Conjunto de reglas Todas las reglas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [todas las reglas de conjunto de reglas](https://docs.microsoft.com/visualstudio/code-quality/all-rules-rule-set).  
