...
La versión más reciente de este tema puede encontrarse en [CA1712: no utilizar prefijos en valores de enumeración con el nombre de tipo](https://docs.microsoft.com/visualstudio/code-quality/ca1712-do-not-prefix-enum-values-with-type-name).
