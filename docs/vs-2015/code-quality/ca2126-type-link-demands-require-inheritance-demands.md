...
La versión más reciente de este tema puede encontrarse en [CA2126: las peticiones de vínculo de tipos requieren peticiones de herencias](https://docs.microsoft.com/visualstudio/code-quality/ca2126-type-link-demands-require-inheritance-demands).
