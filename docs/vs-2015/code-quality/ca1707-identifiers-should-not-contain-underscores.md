...
Para obtener la documentación más reciente de Visual Studio, consulte [CA1707: Los identificadores no deberían contener subrayado](https://docs.microsoft.com/visualstudio/code-quality/ca1707-identifiers-should-not-contain-underscores) en docs.microsoft.com.  
