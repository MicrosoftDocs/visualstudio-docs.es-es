...
La versión más reciente de este tema puede encontrarse en [establecen reglas de corrección básicas para código administrado](https://docs.microsoft.com/visualstudio/code-quality/basic-correctness-rules-rule-set-for-managed-code).  
