...
La versión más reciente de este tema puede encontrarse en [CA2208: crear instancias de las excepciones del argumento correctamente](https://docs.microsoft.com/visualstudio/code-quality/ca2208-instantiate-argument-exceptions-correctly).
