...
La versión más reciente de este tema puede encontrarse en [CA2100: consultas SQL de revisión de las vulnerabilidades de seguridad](https://docs.microsoft.com/visualstudio/code-quality/ca2100-review-sql-queries-for-security-vulnerabilities).
