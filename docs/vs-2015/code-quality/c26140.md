...
ms.locfileid: "47578156"
---
# <a name="c26140"></a>C26140
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [C26140](https://docs.microsoft.com/visualstudio/code-quality/c26140).  
  
Advertencia C26140: tipo de bloqueo indefinido \<bloqueo > en la anotación \<anotación > en bloqueo \<bloqueo >.  
