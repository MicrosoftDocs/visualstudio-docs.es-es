...
ms.locfileid: "47583114"
---
# <a name="c26167"></a>C26167
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [C26167](https://docs.microsoft.com/visualstudio/code-quality/c26167).  
  
Advertencia C26167: posiblemente liberar el bloqueo no retenido \<bloqueo > en la función \<func >.  
