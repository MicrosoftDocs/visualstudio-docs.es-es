...
La versión más reciente de este tema puede encontrarse en [CA1059: los miembros no deben exponer algunos tipos concretos](https://docs.microsoft.com/visualstudio/code-quality/ca1059-members-should-not-expose-certain-concrete-types).
