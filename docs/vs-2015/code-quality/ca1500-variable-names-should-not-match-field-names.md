...
Para obtener la documentación más reciente de Visual Studio, consulte [CA1500: Los nombres de variable no deben coincidir con los nombres de campo](https://docs.microsoft.com/visualstudio/code-quality/ca1500-variable-names-should-not-match-field-names) en docs.microsoft.com.  
