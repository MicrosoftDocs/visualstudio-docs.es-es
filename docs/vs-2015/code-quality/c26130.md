...
ADVERTENCIA C26130: falta la anotación \_Requires_lock_held\_(\<> Lock) o \_No_competing_thread\_ \<Func >. De lo contrario, podría ser una condición de carrera. La variable \<var > debe protegerse mediante Lock \<Lock >.  
