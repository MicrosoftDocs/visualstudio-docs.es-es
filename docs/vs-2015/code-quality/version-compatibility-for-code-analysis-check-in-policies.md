...
La versión más reciente de este tema puede encontrarse en [compatibilidad de versiones de directivas de protección de análisis de código](https://docs.microsoft.com/visualstudio/code-quality/version-compatibility-for-code-analysis-check-in-policies).  
