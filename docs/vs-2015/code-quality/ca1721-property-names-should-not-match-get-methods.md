...
La versión más reciente de este tema puede encontrarse en [CA1721: los nombres de propiedades no deberían coincidir con los métodos get](https://docs.microsoft.com/visualstudio/code-quality/ca1721-property-names-should-not-match-get-methods).
