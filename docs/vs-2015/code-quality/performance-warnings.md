...
ms.locfileid: "47566593"
---
# <a name="performance-warnings"></a>advertencias de rendimiento
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [las advertencias de rendimiento](https://docs.microsoft.com/visualstudio/code-quality/performance-warnings).  
