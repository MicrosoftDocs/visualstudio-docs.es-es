...
|[CA1802: Utilizar letras cuando sea apropiado](../code-quality/ca1802-use-literals-where-appropriate.md)|Un campo se declara estático y de solo lectura (Shared y ReadOnly en [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]) y se inicializa con un valor que se calcula en tiempo de compilación. Dado que el valor asignado al campo de destino es calculable en tiempo de compilación, cambie la declaración a un campo const (const en [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]) para que el valor se calcule en tiempo de compilación en lugar de en tiempo de ejecución.|
