...
## <a name="how-to-fix-violations"></a>Cómo corregir infracciones
 Para corregir una infracción de esta regla, marque el tipo como `sealed` . Si tiene como destino [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] 2,0 o anterior, un enfoque mejor es marcar el tipo como `static` . De esta manera, se evita tener que declarar un constructor privado para evitar que se cree la clase.

## <a name="when-to-suppress-warnings"></a>Cuándo suprimir advertencias
 Suprima una advertencia de esta regla solo si el tipo está diseñado para ser heredado. La ausencia del `sealed` modificador sugiere que el tipo es útil como un tipo base.
