...
La versión más reciente de este tema puede encontrarse en [CA1000: no declarar miembros estáticos en tipos genéricos](https://docs.microsoft.com/visualstudio/code-quality/ca1000-do-not-declare-static-members-on-generic-types).
