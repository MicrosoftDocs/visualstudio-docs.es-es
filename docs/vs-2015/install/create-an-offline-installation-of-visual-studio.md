...
3. Después de ejecutar este comando, aparecerá un cuadro de diálogo que le permite cambiar la carpeta donde desea que resida el diseño de instalación sin conexión.   A continuación, haga clic en el botón **Descargar.**
     ...
     Cuando la descarga del paquete es correcta, debería ver un mensaje que dice **Configuración correcta! Todos los componentes especificados se han adquirido correctamente.**

4. Busque la carpeta que especificó anteriormente. (Por ejemplo, busque D:-VisualStudio2015.) Esta carpeta contiene todo lo que necesita para copiar en una ubicación compartida o instalar medios.
