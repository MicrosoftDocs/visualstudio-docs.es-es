...
## <a name="installing-by-creating-an-offline-installation"></a><a name="BKMK_Offline"></a> Instalación mediante la creación de una instalación sin conexión
...
2. Después de descargar el instalador en una ubicación del sistema de archivos, ejecute " \<executable name> /layout".
...
3. Después de ejecutar este comando, aparecerá un cuadro de diálogo que le permite cambiar la carpeta donde desea que resida el diseño de instalación sin conexión.   A continuación, haga clic en el botón **Descargar** .

     Cuando la descarga del paquete se realice correctamente, debería ver un mensaje que indica que el programa de instalación se ha **realizado correctamente. Todos los componentes especificados se han adquirido correctamente.**

4. Busque la carpeta que especificó anteriormente. (Por ejemplo, busque D:\VisualStudio2015.) Esta carpeta contiene todo lo que necesita copiar en una ubicación compartida o instalar los medios.
...
## <a name="troubleshooting-an-offline-installation"></a><a name="BKMK_tshoot"></a> Solución de problemas de una instalación sin conexión
...
- [Instalación de Visual Studio](install-visual-studio-2015.md)