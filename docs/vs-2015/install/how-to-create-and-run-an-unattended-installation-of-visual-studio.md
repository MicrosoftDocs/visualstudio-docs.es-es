...
- Abra el **iniciar** menú, elija **ejecutar**y, a continuación, escriba \\ \\ *ServerName*\IDEinstall\vs_*producto*.exe /adminfile *PathOfTheAdmindeployment.xmlFile*<em>AdditionalParametersAsNeeded</em>  
