...
ms.locfileid: "47578461"
---
# <a name="ltcommandsgt-element-bootstrapper"></a>&lt;Comandos&gt; (elemento, arranque)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ &lt;comandos&gt; (elemento, arranque)](https://docs.microsoft.com/visualstudio/deployment/commands-element-bootstrapper).  
