...
ms.locfileid: "47573840"
---
# <a name="ltpackagefilesgt-element-bootstrapper"></a>&lt;PackageFiles&gt; (elemento, arranque)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ &lt;PackageFiles&gt; (elemento, arranque)](https://docs.microsoft.com/visualstudio/deployment/packagefiles-element-bootstrapper).  
