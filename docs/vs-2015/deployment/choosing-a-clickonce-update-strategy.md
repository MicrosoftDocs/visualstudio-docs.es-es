...
ms.locfileid: "47567876"
---
# <a name="choosing-a-clickonce-update-strategy"></a>Elegir una estrategia de actualización de ClickOnce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [elegir una estrategia de actualización de ClickOnce](https://docs.microsoft.com/visualstudio/deployment/choosing-a-clickonce-update-strategy).  
