...
La versión más reciente de este tema puede encontrarse en [Cómo: especificar una ubicación alternativa para las actualizaciones de implementación](https://docs.microsoft.com/visualstudio/deployment/how-to-specify-an-alternate-location-for-deployment-updates).  
...
3.  Guarde el archivo.  
    ...
    > [!NOTE]
    >  Deberá volver a firmar el archivo con Mage.exe. Para obtener más información, consulte [Tutorial: implementar manualmente una aplicación ClickOnce](../deployment/walkthrough-manually-deploying-a-clickonce-application.md).  
