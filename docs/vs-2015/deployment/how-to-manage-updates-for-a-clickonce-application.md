...
[!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] las aplicaciones pueden buscar actualizaciones automáticamente o mediante programación. Como desarrollador, tiene mucha flexibilidad a la hora de especificar Cuándo y cómo se realizan las comprobaciones de actualización, si las actualizaciones son obligatorias y dónde debe buscar actualizaciones la aplicación.  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Cuadro de diálogo actualizaciones de la aplicación](https://msdn.microsoft.com/8eca8743-8e68-4d04-bfd5-4dc0a9b2934f)   
