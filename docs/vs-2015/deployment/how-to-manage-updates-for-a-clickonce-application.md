...
La versión más reciente de este tema puede encontrarse en [Cómo: administrar actualizaciones para una aplicación ClickOnce](https://docs.microsoft.com/visualstudio/deployment/how-to-manage-updates-for-a-clickonce-application).  
