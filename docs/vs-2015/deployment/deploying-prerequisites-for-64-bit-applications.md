...
La versión más reciente de este tema puede encontrarse en [requisitos previos de implementación para aplicaciones de 64 bits](https://docs.microsoft.com/visualstudio/deployment/deploying-prerequisites-for-64-bit-applications).  
