...
> Antes de tomar la decisión de habilitar esta característica, consulte la sección "Seguridad" más adelante en este tema.  
 ...
 Para obtener información sobre cómo crear una [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] implementación con Mage.exe o MageUI.exe, vea [Tutorial: implementar manualmente una aplicación ClickOnce](../deployment/walkthrough-manually-deploying-a-clickonce-application.md).  
