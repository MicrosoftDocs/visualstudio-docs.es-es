...
La versión más reciente de este tema puede encontrarse en [ejecución Windows Store apps en el equipo local](https://docs.microsoft.com/visualstudio/debugger/run-windows-store-apps-on-the-local-machine).  
