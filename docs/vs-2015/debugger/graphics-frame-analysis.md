...
ms.locfileid: "47580440"
---
# <a name="graphics-frame-analysis"></a>Análisis de fotograma de gráficos
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [análisis de fotogramas de gráficos](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-frame-analysis).  
