...
- Puede que el marco nativo inmediatamente encima del código administrado no esté en la ventana **Pila de llamadas**. Para obtener más información, consulte [Cómo Salida del código administrado cuando los marcos nativos no aparecen en la ventana Pila de llamadas](../debugger/how-to-step-out-of-managed-code-when-native-frames-are-missing-from-the-call-stack-window.md).  
...
## <a name="see-also"></a>Vea también  
 [Procedimientos: usar la ventana Pila de llamadas](../debugger/how-to-use-the-call-stack-window.md)
