...
ms.locfileid: "47578939"
---
# <a name="error-site-uses-ip-address"></a>Error: El sitio utiliza una dirección IP
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Error: dirección IP del sitio utiliza](https://docs.microsoft.com/visualstudio/debugger/error-site-uses-ip-address).  
