...
ms.locfileid: "47581004"
---
# <a name="using-the-debuggerdisplay-attribute"></a>Usar el atributo DebuggerDisplay
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [utilizando el atributo DebuggerDisplay](https://docs.microsoft.com/visualstudio/debugger/using-the-debuggerdisplay-attribute).  
