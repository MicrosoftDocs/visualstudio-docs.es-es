...
La versión más reciente de este tema puede encontrarse en [Error: no se puede obtener acceso a la interfaz de depuración de SQL Server](https://docs.microsoft.com/visualstudio/debugger/error-unable-to-access-the-sql-server-debugging-interface).  
