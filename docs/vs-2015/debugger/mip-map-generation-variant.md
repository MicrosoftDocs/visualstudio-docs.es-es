...
ms.locfileid: "47574347"
---
# <a name="mip-map-generation-variant"></a>Mip-map (Variante de generación)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [variante de generación Mip-map](https://docs.microsoft.com/visualstudio/debugger/graphics/mip-map-generation-variant).  
