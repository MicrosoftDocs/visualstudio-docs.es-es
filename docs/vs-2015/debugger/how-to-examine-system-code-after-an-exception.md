...
La versión más reciente de este tema puede encontrarse en [Cómo: Examinar código después de una excepción del sistema](https://docs.microsoft.com/visualstudio/debugger/how-to-examine-system-code-after-an-exception).  
