...
ms.locfileid: "47577913"
---
# <a name="visualizer-architecture"></a>Arquitectura de un visualizador
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [arquitectura del visualizador](https://docs.microsoft.com/visualstudio/debugger/visualizer-architecture).  
