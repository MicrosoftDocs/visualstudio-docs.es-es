...
ms.locfileid: "47577055"
---
# <a name="pseudovariables"></a>Pseudovariables
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Pseudovariables](https://docs.microsoft.com/visualstudio/debugger/pseudovariables).  
