...
ms.locfileid: "47581184"
---
# <a name="how-to-display-thread-properties"></a>Cómo: Mostrar las propiedades del subproceso
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: mostrar propiedades del subproceso](https://docs.microsoft.com/visualstudio/debugger/how-to-display-thread-properties).  
