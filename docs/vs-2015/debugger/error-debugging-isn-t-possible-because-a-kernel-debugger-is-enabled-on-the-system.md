...
La versión más reciente de este tema puede encontrarse en [Error: no depuración&#39;t posible porque un depurador del Kernel está habilitado en el sistema](https://docs.microsoft.com/visualstudio/debugger/error-debugging-isn-t-possible-because-a-kernel-debugger-is-enabled-on-the-system).  
