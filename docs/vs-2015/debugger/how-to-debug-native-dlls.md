...
ms.locfileid: "47592912"
---
# <a name="how-to-debug-native-dlls"></a>Cómo: Depurar DLL nativas
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: depurar DLL nativas](https://docs.microsoft.com/visualstudio/debugger/how-to-debug-native-dlls).  
