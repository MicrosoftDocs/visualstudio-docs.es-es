...
ms.locfileid: "47580585"
---
# <a name="how-to-use-the-disassembly-window"></a>Cómo: Utilizar la ventana Desensamblado
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [ver el código de desensamblado en el depurador de Visual Studio](https://docs.microsoft.com/visualstudio/debugger/how-to-use-the-disassembly-window).  
