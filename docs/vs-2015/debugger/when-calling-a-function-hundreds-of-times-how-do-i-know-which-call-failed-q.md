...
La versión más reciente de este tema puede encontrarse en [al llamar a una función varias veces, ¿cómo sé que llamada genera el error?](https://docs.microsoft.com/visualstudio/debugger/when-calling-a-function-hundreds-of-times-how-do-i-know-which-call-failed-q).  
