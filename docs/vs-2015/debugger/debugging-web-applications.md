...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe cómo depurar un [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] proyecto que aún está en desarrollo.  
 ...
 [Procedimiento Depuración de excepciones de ASP.NET](../debugger/how-to-debug-aspnet-exceptions.md)  
