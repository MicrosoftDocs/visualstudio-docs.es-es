...
ms.locfileid: "47565889"
---
# <a name="stop-statements-in-visual-basic"></a>Instrucciones Stop en Visual Basic
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [instrucciones Stop en Visual Basic](https://docs.microsoft.com/visualstudio/debugger/stop-statements-in-visual-basic).  
