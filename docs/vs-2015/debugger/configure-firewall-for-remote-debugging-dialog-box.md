...
La versión más reciente de este tema puede encontrarse en [configurar Firewall para el cuadro de diálogo de depuración remota](https://docs.microsoft.com/visualstudio/debugger/configure-firewall-for-remote-debugging-dialog-box).  
