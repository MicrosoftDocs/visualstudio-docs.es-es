...
ms.locfileid: "47566418"
---
# <a name="create-custom-views-of-managed-objects"></a>Crear vistas personalizadas de objetos administrados
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [crear vistas personalizadas de objetos administrados](https://docs.microsoft.com/visualstudio/debugger/create-custom-views-of-dot-managed-objects).  
