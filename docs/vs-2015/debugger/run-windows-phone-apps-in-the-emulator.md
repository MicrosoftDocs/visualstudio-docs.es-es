---
title: Ejecutar Windows Phone aplicaciones en el emulador | Microsoft Docs
ms.date: 11/15/2016
...
El emulador de Windows Phone proporciona un entorno virtual en el que puede depurar y probar aplicaciones de Windows Phone en el equipo sin un dispositivo físico. Puede simular eventos táctiles y rotaciones, y elegir el tamaño y la resolución de la pantalla física que desee emular. También puede probar muchas características usadas habitualmente como, por ejemplo, la ubicación, las redes, las notificaciones, los sensores, el acelerómetro y la tarjeta SD opcional.  
 ...
 Para obtener más información sobre las características que puede probar en el emulador, consulte características de las [aplicaciones de prueba en el emulador de Windows Phone](https://msdn.microsoft.com/c1b2b0ec-b8cc-4a98-84c1-701428e45cb1).  
...
## <a name="run-a-windows-phone-app-in-the-emulator"></a><a name="BKMK_run"></a> Ejecutar una aplicación Windows Phone en el emulador  
...
### <a name="run-an-app-from-visual-studio"></a><a name="BKMK_vs"></a> Ejecutar una aplicación desde Visual Studio  
...
3. Para implementar y ejecutar la aplicación con depuración, en el menú **depurar** , haga clic en **iniciar depuración**o presione F5.  
  
     Para implementar y ejecutar la aplicación sin depuración, en el menú **depurar** , haga clic en **iniciar sin depurar**o presione Ctrl + F5.  
...
- Para detener una aplicación en ejecución, realice una de las siguientes operaciones:  
  ...
  - En el emulador, presione el botón **atrás** para salir de la aplicación. Si la página activa de la aplicación no era la página de inicio de la aplicación, es posible que tenga que presionar el botón **atrás** más de una vez.  
...
1. Antes de ejecutar la aplicación, en Visual Studio, haga clic con el botón derecho en el proyecto en Explorador de soluciones y, a continuación, seleccione **propiedades** para abrir el **Diseñador de proyectos**.  
  
2. En el **Diseñador de proyectos**, en la página **depurar** , deje desactivada la casilla marcadores de exclusión al **desactivarse durante la depuración** si desea que la aplicación pase a un estado inactivo cuando esté desactivada. Active la casilla si quiere que se asigne a la aplicación un marcador de exclusión al desactivarla.  
  
3. En el menú **depurar** , haga clic en **iniciar depuración**o presione F5 para ejecutar la aplicación.  
  
4. En el emulador, presione el botón **iniciar** . Aparece la pantalla Inicio y se desactiva la aplicación. La aplicación entra en un estado inactivo o está extinguida, en función de la configuración de la casilla de verificación de **desecho tras la desactivación durante la depuración** .  
  
##### <a name="to-reactivate-a-dormant-or-tombstoned-app"></a>Para reactivar una aplicación inactiva o con marcador de exclusión  
  
- En el emulador, presione el botón **atrás** para volver a la aplicación. Si ha navegado a otras páginas o ha abierto otra aplicación, es posible que tenga que presionar el botón **atrás** más de una vez para reactivar la aplicación.  
...
### <a name="run-an-app-with-the-application-deployment-tool"></a><a name="BKMK_depltool"></a> Ejecutar una aplicación con la herramienta de implementación de aplicaciones  
 También puede usar la herramienta de implementación de aplicaciones Windows Phone (**AppDeploy.exe**) para ejecutar la aplicación en el emulador. Esta herramienta es una aplicación independiente que se instala al instalar las herramientas de desarrollo de Windows Phone.  
  
 Para obtener más información, vea [implementación de aplicaciones Windows Phone 8,1 con la herramienta de implementación de aplicaciones](https://msdn.microsoft.com/library/23700f82-1399-44d9-bc0c-714be4a48ee6).  
  
## <a name="configure-the-windows-phone-emulator-with-the-emulator-toolbar"></a><a name="BKMK_toolbar"></a> Configurar el emulador de Windows Phone con la barra de herramientas del emulador  
...
|---------------------|---------------------------|  
|![Opciones de entrada en la barra de herramientas del Emulador de Windows Phone](../debugger/media/wp-emulator.png "WP_Emulator_")|**Configurar entrada de único punto o multipunto**<br /><br /> Al habilitar una entrada de multipunto, puede hacer clic con el botón derecho para mover los puntos táctiles sin tocar la pantalla. A continuación, puedeshacer clic con el botón izquierdo para mover ambos puntos táctiles simultáneamente.|  
|![Orientación en la barra de herramientas del Emulador de Windows Phone](../debugger/media/wp-emulator-rotation.png "WP_Emulator_rotation")|**Configurar la orientación del emulador**<br /><br /> Puede cambiar la orientación en Windows Phone Emulator por una de las tres orientaciones posibles: vertical, horizontal a la izquierda u horizontal a la derecha. El tamaño del emulador no cambia al cambiar la orientación.<br /><br /> Para cambiar la orientación, haga clic en el botón girar a la **izquierda** o en el botón girar a la **derecha** .|  
|![Opciones de tamaño en la barra de herramientas del Emulador de Windows Phone](../debugger/media/wp-emulator-size.png "WP_Emulator_size")|**Configurar el tamaño del emulador**<br /><br /> Puede cambiar el tamaño del emulador en la pantalla del equipo host. Los puntos por pulgada (PPP) del emulador se basan en los PPP del monitor host, independientemente del valor del zoom.<br /><br /> -Para ajustar el emulador a la pantalla, haga clic en el botón **ajustar a la pantalla** .<br />-Para cambiar la configuración del zoom, haga clic en el botón **zoom** . Se abre el cuadro de diálogo **zoom** . En el cuadro de diálogo **zoom** , escriba un valor de Zoom entre 33 y 100.|  
  
## <a name="use-the-simulated-hardware-buttons-on-the-emulator"></a><a name="BKMK_buttons"></a> Usar los botones de hardware simulados en el emulador  
...
- Haga clic en el botón de **encendido** para simular la activación y desactivación de la pantalla. Haga clic y mantenga presionado para simular la activación y desactivación del teléfono.  
...
- El botón **cámara** inicia la aplicación de cámara. Puede simular cómo hacer una foto o grabar un vídeo mediante los controles de la aplicación de la cámara.  
...
2. La imagen central muestra el emulador después de pulsar el botón de **encendido** para desactivar la pantalla.  
  
3. La imagen de la derecha muestra la pantalla del emulador tras pulsar el botón **subir volumen** para aumentar el volumen.  
  
   ![Botones del Emulador de Windows Phone](../debugger/media/wp-emulator-buttons.png "WP_Emulator_buttons")  
  
## <a name="use-the-computer-keyboard-with-the-emulator"></a><a name="BKMK_tasks_kbd"></a> Usar el teclado del equipo con el emulador  
...
|F2|START|Las pulsaciones prolongadas funcionan según lo previsto.|  
|F3|SEARCH||  
...
|F10|BAJAR VOLUMEN||  
|F11|No aplicable.||  
|F12|POWER|Presione la tecla F12 dos veces para habilitar la pantalla de bloqueo.<br /><br /> Las pulsaciones prolongadas funcionan según lo previsto.|  
...
## <a name="save-and-load-custom-checkpoints"></a><a name="BKMK_checkpoints"></a> Guardar y cargar puntos de control personalizados  
...
- Haga clic en **nuevo punto de control** para capturar una nueva instantánea del estado del emulador con los datos y la configuración necesarios para volver a probar la aplicación más adelante. El nuevo punto de control se agrega a la lista de **puntos de control** .  
  
   Puede capturar un punto de control mientras el depurador esté asociado al emulador.  
  
- Seleccione un punto de control en la lista **puntos** de control para ver información sobre el punto de control.  
  
- Seleccione el botón de radio de la columna **predeterminado** para convertir un punto de control guardado en el punto de control predeterminado para el emulador activo.  
  
- Haga clic en **restaurar** para reiniciar el sistema operativo Windows Phone en el emulador y cargar la instantánea seleccionada.  
  
- Haga clic en **eliminar** para eliminar una instantánea que ya no necesite.  
  
  La imagen del emulador original aparece siempre como el primer elemento en la lista **puntos de control** y no se puede cambiar ni eliminar. Sin embargo, puede seleccionar una instantánea diferente como imagen del emulador predeterminada.  
  
  ![Pestaña de puntos de comprobación del Emulador de Windows Phone](../debugger/media/wp-emulator-checkpoints.png "WP_Emulator_checkpoints")  
  
## <a name="capture-screenshots-in-the-emulator"></a><a name="BKMK_tasks_shot"></a> Capturar capturas de pantallas en el emulador  
 ...
 ![Capturas de pantalla desde el Emulador de Windows Phone](../debugger/media/wp-emulator-screenshots.png "WP_Emulator_screenshots")  
...
3. En la barra de herramientas del emulador, haga clic en el botón expandir para abrir la ventana **herramientas adicionales** .  
...
7. Elija la ubicación y el **nombre de archivo** que desee y, a continuación, haga clic en **Guardar**.  
...
- Especifique una compilación de versión en Visual Studio. Después de especificar una compilación de versión, inicie la aplicación seleccionando el vínculo **implementar _[nombre de la aplicación]_ ** en el menú **compilar** .  
