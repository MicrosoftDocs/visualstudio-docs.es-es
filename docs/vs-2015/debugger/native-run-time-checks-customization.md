...
La versión más reciente de este tema puede encontrarse en [nativo personalización en tiempo de ejecución comprueba](https://docs.microsoft.com/visualstudio/debugger/native-run-time-checks-customization).  
