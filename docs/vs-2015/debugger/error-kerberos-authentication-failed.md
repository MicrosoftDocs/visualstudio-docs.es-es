...
ms.locfileid: "47576573"
---
# <a name="error-kerberos-authentication-failed"></a>Error: Error de autenticación Kerberos
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Error: error de autenticación de Kerberos](https://docs.microsoft.com/visualstudio/debugger/error-kerberos-authentication-failed).  
