...
ms.locfileid: "47567485"
---
# <a name="preparing-to-debug-aspnet"></a>Preparar la depuración en ASP.NET
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [preparar la depuración ASP.NET](https://docs.microsoft.com/visualstudio/debugger/preparing-to-debug-aspnet).  
