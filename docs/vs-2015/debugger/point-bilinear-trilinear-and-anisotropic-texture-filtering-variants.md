...
La versión más reciente de este tema puede encontrarse en [punto, bilineal, trilineal y anisotrópico variantes de filtrado de textura](https://docs.microsoft.com/visualstudio/debugger/graphics/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants).  
