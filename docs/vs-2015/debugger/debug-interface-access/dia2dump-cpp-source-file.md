---
title: Origen Dia2dump.cpp | Documentos de Microsoft
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47577451"
---
# <a name="dia2dumpcpp-source-file"></a>Archivo de origen Dia2dump.cpp
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [origen Dia2dump.cpp](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/dia2dump-cpp-source-file).  
  
El código de origen Dia2dump.cpp siguiente muestra el contenido de un archivo. pdb. Este código de origen usa [ejemplo Dia2dump](../../debugger/debug-interface-access/dia2dump-sample.md).  
