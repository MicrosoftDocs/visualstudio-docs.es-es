...
ms.locfileid: "68197609"
---
# <a name="dia2dumpcpp-source-file"></a>Archivo de origen Dia2dump.cpp
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

El siguiente código fuente de Dia2dump. cpp muestra el contenido de un archivo. pdb. Este código fuente lo usa el [ejemplo Dia2dump](../../debugger/debug-interface-access/dia2dump-sample.md).  
