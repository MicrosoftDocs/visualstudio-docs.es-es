---
title: Get_scoped | Documentos de Microsoft
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47575510"
---
# <a name="idiasymbolgetscoped"></a>IDiaSymbol::get_scoped
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Get_scoped](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-scoped).  
