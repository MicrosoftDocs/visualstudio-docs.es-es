...
## <a name="remarks"></a>Notas  
 Si la [enumeración LocationType (](../../debugger/debug-interface-access/locationtype.md) del símbolo es `LocIsBitField` , la longitud devuelta por este método está en bits; de lo contrario, la longitud es en bytes para todos los demás tipos de ubicación.  
