...
#### <a name="parameters"></a>Parámetros  
 `pRetVal`  
 enuncia Devuelve `TRUE` si el compilador generó el símbolo; de lo contrario, devuelve `FALSE` si el símbolo se generó a partir del origen escrito por el usuario.  
