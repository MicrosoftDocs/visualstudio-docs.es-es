...
Recupera una marca que especifica si la función contiene un uso del comando [setjmp](https://msdn.microsoft.com/library/684a8b27-e8eb-455b-b4a8-733ca1cbd7d2) (emparejado con el comando [longjmp](https://msdn.microsoft.com/library/0e13670a-5130-45c1-ad69-6862505b7a2f) , estos forman el método de estilo C de control de excepciones).  
...
#### <a name="parameters"></a>Parámetros  
 `pFlag`  
 enuncia Devuelve `TRUE` si la función contiene un `setjmp` comando; de lo contrario, devuelve `FALSE` .  
