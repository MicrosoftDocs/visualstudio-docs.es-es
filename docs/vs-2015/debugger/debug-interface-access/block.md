...
ms.locfileid: "62580484"
---
# <a name="block"></a>Bloquear
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Cada bloque de código se identifica mediante un `SymTagBlock` símbolo. Los símbolos de bloque se utilizan para identificar ámbitos anidados dentro de las funciones.  
