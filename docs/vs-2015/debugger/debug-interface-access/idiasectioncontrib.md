...
## <a name="notes-for-callers"></a>Notas para llamadores  
 Esta interfaz se obtiene llamando a los métodos [IDiaEnumSectionContribs:: Item](../../debugger/debug-interface-access/idiaenumsectioncontribs-item.md) y [IDiaEnumSectionContribs:: Next](../../debugger/debug-interface-access/idiaenumsectioncontribs-next.md) . Vea la interfaz [IDiaEnumSectionContribs](../../debugger/debug-interface-access/idiaenumsectioncontribs.md) para obtener un ejemplo de cómo obtener la `IDiaSectionContrib` interfaz.  
  
## <a name="example"></a>Ejemplo  
 Esta función muestra la dirección de cada sección junto con los símbolos asociados. Vea la interfaz [IDiaEnumSectionContribs](../../debugger/debug-interface-access/idiaenumsectioncontribs.md) para ver cómo `IDiaSectionContrib` se obtiene la interfaz.  
