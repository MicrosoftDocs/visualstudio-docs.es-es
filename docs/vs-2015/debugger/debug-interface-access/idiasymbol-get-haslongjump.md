...
Recupera una marca que especifica si la función contiene un uso de la [longjmp](https://msdn.microsoft.com/library/0e13670a-5130-45c1-ad69-6862505b7a2f) comando (emparejado con un [setjmp](https://msdn.microsoft.com/library/684a8b27-e8eb-455b-b4a8-733ca1cbd7d2) comando, forman el método de estilo C de control de excepciones).  
