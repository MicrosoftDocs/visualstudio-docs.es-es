---
title: Get_hascastoperator | Documentos de Microsoft
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47579144"
---
# <a name="idiasymbolgethascastoperator"></a>IDiaSymbol::get_hasCastOperator
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Get_hascastoperator](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-hascastoperator).  
