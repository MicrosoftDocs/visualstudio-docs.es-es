...
ms.locfileid: "47582146"
---
# <a name="annotation"></a>Anotación
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [anotación](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/annotation).  
