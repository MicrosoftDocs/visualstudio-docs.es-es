...
|Método|Descripción|  
|------------|-----------------|  
|[IDiaEnumLineNumbers::get__NewEnum](../../debugger/debug-interface-access/idiaenumlinenumbers-get-newenum.md)|Recupera la versión de la [interfaz IEnumVARIANT](https://msdn.microsoft.com/139e3c93-faef-4003-9079-e0e94494db3e) de este enumerador.|  
...
## <a name="notes-for-callers"></a>Notas para llamadores  
 Esta interfaz se obtiene llamando a uno de los métodos siguientes en la interfaz [IDiaSession](../../debugger/debug-interface-access/idiasession.md) :  
...
## <a name="example"></a>Ejemplo  
 En este ejemplo se muestra cómo obtener la `IDiaEnumLineNumbers` interfaz de una sesión. En este caso, en el ejemplo se muestra cómo obtener la enumeración del número de línea para una función (representada por `pSymbol` ). Para obtener un ejemplo más completo del uso de números de línea, vea la interfaz [IDiaLineNumber](../../debugger/debug-interface-access/idialinenumber.md) .  
