...
## [Introducción](getting-started-debug-interface-access-sdk.md)
### [Información general](overview-debug-interface-access-sdk.md)
### [Consultar el archivo .pdb](querying-the-dot-pdb-file.md)
## [Símbolos y etiquetas de símbolo](symbols-and-symbol-tags.md)
### [Ubicaciones de símbolos](symbol-locations.md)
### [Jerarquía léxica de tipos de símbolos](lexical-hierarchy-of-symbol-types.md)
#### [Anotación](annotation.md)
#### [Bloque](block.md)
#### [Compiland](compiland.md)
#### [CompilandDetails](compilanddetails.md)
#### [CompilandEnv](compilandenv.md)
#### [Personalizado (Debug Interface Access SDK)](custom-debug-interface-access-sdk.md)
#### [Datos (Debug Interface Access SDK)](data-debug-interface-access-sdk.md)
#### [Exe](exe.md)
#### [Función (Debug Interface Access SDK)](function-debug-interface-access-sdk.md)
#### [FuncDebugEnd](funcdebugend.md)
#### [FuncDebugStart](funcdebugstart.md)
#### [Etiqueta (Debug Interface Access SDK)](label-debug-interface-access-sdk.md)
#### [PublicSymbol](publicsymbol.md)
#### [Thunk](thunk.md)
#### [UsingNameSpace](usingnamespace.md)
### [Jerarquía de clases de tipos de símbolos](class-hierarchy-of-symbol-types.md)
...
## [Referencia](debug-interface-access-sdk-reference.md)
...
### [Enumeraciones y estructuras](enumerations-and-structures.md)
#### [Enumeración BasicType](basictype.md)
#### [Enumeración CV_access_e](cv-access-e.md)
#### [Enumeración CV_call_e](cv-call-e.md)
#### [Enumeración CV_CFL_LANG](cv-cfl-lang.md)
#### [Enumeración CV_CPU_TYPE_e](cv-cpu-type-e.md)
#### [Enumeración CV_HREG_e](cv-hreg-e.md)
#### [Enumeración DataKind](datakind.md)
#### [Estructura DiaAddressMapEntry](diaaddressmapentry.md)
#### [Enumeración LocationType](locationtype.md)
#### [Enumeración MemoryTypeEnum](memorytypeenum.md)
#### [Enumeración NameSearchOptions](namesearchoptions.md)
#### [Enumeración StackFrameTypeEnum](stackframetypeenum.md)
#### [Enumeración SymTagEnum](symtagenum.md)
#### [Enumeración THUNK_ORDINAL](thunk-ordinal.md)
#### [Enumeración UdtKind](udtkind.md)
### [Constantes (Debug Interface Access SDK)](constants-debug-interface-access-sdk.md)
## [Ejemplo Dia2dump](dia2dump-sample.md)
## [Archivo de origen Dia2dump.cpp](dia2dump-cpp-source-file.md)
