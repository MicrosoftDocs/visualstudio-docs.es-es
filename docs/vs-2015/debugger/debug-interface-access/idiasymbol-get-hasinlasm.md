---
title: Get_hasinlasm | Documentos de Microsoft
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47582159"
---
# <a name="idiasymbolgethasinlasm"></a>IDiaSymbol::get_hasInlAsm
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Get_hasinlasm](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-hasinlasm).  
