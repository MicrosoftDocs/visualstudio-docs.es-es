...
ms.locfileid: "47576236"
---
# <a name="limitations-on-wcf-debugging"></a>Limitaciones de la depuración de WCF
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [limitaciones sobre la depuración de WCF](https://docs.microsoft.com/visualstudio/debugger/limitations-on-wcf-debugging).  
