...
10. Presiona Ctrl+Mayús+B para compilar el proyecto.  
    ...
    ![Depuración de XAML en Blend para Visual Studio](../debugger/media/blend-debugxaml-xaml.png "blend_debugXAML_XAML")  
...
## <a name="debugging-in-visual-studio"></a>Depurar en Visual Studio  
 ...
 Para obtener más información sobre cómo depurar la aplicación, vea [depurar aplicaciones de la tienda Windows en Visual Studio](https://msdn.microsoft.com/library/windows/apps/hh441472.aspx).  
  
## <a name="getting-help"></a>Ayuda  
 Si necesita más ayuda para depurar la [!INCLUDE[blend_subs](../includes/blend-subs-md.md)] aplicación, puede buscar entradas relacionadas con su problema o publicar una pregunta en los foros de la comunidad de aplicaciones de la [tienda Windows](https://social.msdn.microsoft.com/Forums/windowsapps/home?category=windowsapps) .
