...
ms.locfileid: "47583148"
---
# <a name="0x2x4x-msaa-variants"></a>0x/2x/4x MSAA (Variantes)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [0 variantes de MSAA x-2 x x-4](https://docs.microsoft.com/visualstudio/debugger/graphics/0x-2x-4x-msaa-variants).  
