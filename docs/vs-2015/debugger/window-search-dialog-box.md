...
ms.locfileid: "47579469"
---
# <a name="window-search-dialog-box"></a>Cuadro de diálogo Buscar ventana
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [cuadro de diálogo Buscar ventana](https://docs.microsoft.com/visualstudio/debugger/window-search-dialog-box).  
