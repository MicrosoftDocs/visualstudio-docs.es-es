...
ms.locfileid: "47577749"
---
# <a name="16bpp-render-target-format-variant"></a>16bpp (Representar variante de formato de destino)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [formato de destino de 16 BPP representar variante](https://docs.microsoft.com/visualstudio/debugger/graphics/16bpp-render-target-format-variant).  
