...
ms.locfileid: "47576171"
---
# <a name="using-spy"></a>Usar Spy++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [usar Spy ++](https://docs.microsoft.com/visualstudio/debugger/using-spy-increment).  
