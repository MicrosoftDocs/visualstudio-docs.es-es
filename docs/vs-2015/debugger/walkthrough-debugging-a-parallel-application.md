...
1. Para reanudar la ejecución hasta llegar al cuarto punto de interrupción, haga clic en **Continuar** en el menú **Depurar**.  
     ...
     La **Vista aérea** también permite ver diagramas grandes en la ventana **Pilas paralelas**. Puede ver el **vista aérea** haciendo clic en el botón situado entre las barras de desplazamiento en la esquina inferior derecha de la ventana, tal como se muestra en la siguiente ilustración.  
...
1. Para reanudar la ejecución hasta llegar al tercer punto de interrupción, haga clic en **Continuar**, en el menú **Depurar**.  
     ...
     Observe que la tarea 4 y 5 se están ejecutando en el mismo subproceso. Esta información no se muestra en el **subprocesos** ventana; poder verlo aquí es otra ventaja de la **tareas paralelas** ventana. Para confirmar esto, vea la ventana **Pilas paralelas**. Asegúrese de que está viendo **Tareas**. Busque las tareas 4 y 5 haciendo doble clic en ellos en el **tareas paralelas** ventana. Al hacerlo, se actualiza el resaltado azul de la ventana **Pilas paralelas**. También puede buscar las tareas 4 y 5 examinando la información sobre herramientas en la ventana **Pilas paralelas**.  
