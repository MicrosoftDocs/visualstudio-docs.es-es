...
ms.locfileid: "47573951"
---
# <a name="message-search-dialog-box"></a>Cuadro de diálogo Buscar mensaje
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [cuadro de diálogo Buscar mensaje](https://docs.microsoft.com/visualstudio/debugger/message-search-dialog-box).  
