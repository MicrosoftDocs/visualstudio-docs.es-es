...
La versión más reciente de este tema puede encontrarse en [preparar la depuración: tipos de proyecto de Visual C++](https://docs.microsoft.com/visualstudio/debugger/debugging-preparation-visual-cpp-project-types).  
