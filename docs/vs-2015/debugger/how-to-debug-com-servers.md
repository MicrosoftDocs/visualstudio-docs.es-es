...
ms.locfileid: "47574080"
---
# <a name="how-to-debug-com-servers"></a>Cómo: Depurar servidores COM
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: depurar servidores COM](https://docs.microsoft.com/visualstudio/debugger/how-to-debug-com-servers).  
