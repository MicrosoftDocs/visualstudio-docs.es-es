...
ms.locfileid: "47579967"
---
# <a name="how-to-attach-to-script"></a>Cómo: Adjuntar a script
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: adjuntar a Script](https://docs.microsoft.com/visualstudio/debugger/how-to-attach-to-script).  
