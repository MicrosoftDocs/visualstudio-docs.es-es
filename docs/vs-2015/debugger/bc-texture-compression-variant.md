...
ms.locfileid: "47577994"
---
# <a name="bc-texture-compression-variant"></a>BC (Variante de compresión de textura)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [variante BC Texture Compression](https://docs.microsoft.com/visualstudio/debugger/graphics/bc-texture-compression-variant).  
