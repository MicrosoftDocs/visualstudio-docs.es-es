...
ms.locfileid: "47574185"
---
# <a name="capturing-graphics-information"></a>Capturar información de gráficos
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [capturar información de gráficos](https://docs.microsoft.com/visualstudio/debugger/graphics/capturing-graphics-information).  
