...
ms.locfileid: "47582521"
---
# <a name="allocation-hook-functions"></a>Funciones de enlace de asignación
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [funciones de enlace de asignación](https://docs.microsoft.com/visualstudio/debugger/allocation-hook-functions).  
