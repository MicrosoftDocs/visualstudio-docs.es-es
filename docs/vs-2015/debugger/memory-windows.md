...
ms.locfileid: "47574280"
---
# <a name="memory-windows"></a>Memoria (Ventana)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [vista memoria para Variables en el depurador](https://docs.microsoft.com/visualstudio/debugger/memory-windows).  
