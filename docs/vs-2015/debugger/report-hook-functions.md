...
ms.locfileid: "47578010"
---
# <a name="report-hook-functions"></a>Funciones de enlace de informe
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [funciones de enlace de informe](https://docs.microsoft.com/visualstudio/debugger/report-hook-functions).  
