...
## <a name="BKMK_Contents"></a> Contents  
 ...
 [Iniciar varios procesos en una solución de VS, asociar a un proceso, iniciar automáticamente un proceso en el depurador](#BKMK_Start_multiple_processes_in_a_VS_solution__attach_to_a_process__automatically_start_a_process_in_the_debugger)  
...
## <a name="BKMK_Start_multiple_processes_in_a_VS_solution__attach_to_a_process__automatically_start_a_process_in_the_debugger"></a>Iniciar varios procesos en una solución de VS, asociar a un proceso, iniciar automáticamente un proceso en el depurador  
...
### <a name="BKMK_Start_debugging_multiple_processes_in_a_Visual_Studio_solution"></a>Iniciar la depuración de varios procesos en una solución de Visual Studio  
 ...
 ![Cambiar el tipo de inicio de un proyecto](../debugger/media/dbg-execution-startmultipleprojects.png "DBG_Execution_StartMultipleProjects")  
...
#### <a name="BKMK_Start_multiple_projects_in_a_solution"></a>Iniciar varios proyectos en una solución  
...
7. En el cuadro de diálogo Editar cadena, escriba `vsjitdebugger.exe` en el cuadro **datos del valor** .  
    ...
    ![Editar cadena (cuadro de diálogo)](../debugger/media/dbg-execution-automaticstart-editstringdlg.png "DBG_Execution_AutomaticStart_EditStringDlg")  
  
   ![Entrada de inicio del depurador automático en regedit. exe](../debugger/media/dbg-execution-automaticstart-result.png "DBG_Execution_AutomaticStart_Result")  
...
|Menú **depurar** :<br /><br /> -   **entrar en el proceso actual**<br />-   **recorrer el proceso actual**<br />-   **paso a paso para salir del proceso actual**|N/D|El proceso actual se ejecuta paso a paso.<br /><br /> Otros procesos mantienen su estado existente (suspendido o en ejecución).|  
...
|Menú contextual de la ventana **procesos** :<br /><br /> **proceso de interrupción** de -   |N/D|Se interrumpe el proceso seleccionado.<br /><br /> Otros procesos mantienen su estado existente (suspendido o en ejecución).|  
 ...
 **Para cambiar el modo en que detener la depuración afecta a un proceso individual**  
