...
ms.locfileid: "47565724"
---
# <a name="vsgdbg-class"></a>VsgDbg (Clase)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Case Vsgdbg](https://docs.microsoft.com/visualstudio/debugger/graphics/vsgdbg-class).  
