...
La versión más reciente de este tema puede encontrarse en [crear tablas de búsqueda en aplicaciones de Windows Forms](https://docs.microsoft.com/visualstudio/data-tools/create-lookup-tables-in-windows-forms-applications).  
