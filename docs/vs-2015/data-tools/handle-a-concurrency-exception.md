...
ms.locfileid: "47573986"
---
# <a name="handle-a-concurrency-exception"></a>Tratar las excepciones de simultaneidad
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [controlar una excepción de simultaneidad](https://docs.microsoft.com/visualstudio/data-tools/handle-a-concurrency-exception).  
