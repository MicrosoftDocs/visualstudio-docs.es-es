...
> [!NOTE]
> El diseñador de DataSet proporciona funcionalidad para <xref:System.Data.DataTable.ColumnChanging> generar <xref:System.Data.DataTable.RowChanging> controladores de eventos y cuando se necesita validación. Para obtener más información, vea [agregar validación a un conjunto de datos de n niveles](../data-tools/add-validation-to-an-n-tier-dataset.md).
...
3. Haga clic con el botón secundario en el al `TableAdapter` que desea agregar el código y, a continuación, seleccione**Ver código**.
