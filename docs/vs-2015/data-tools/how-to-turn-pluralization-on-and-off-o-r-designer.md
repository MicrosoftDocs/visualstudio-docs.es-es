...
2. Establezca la **pluralización de nombres** en **habilitado**como  =  **falso** para establecer el valor de [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] modo que no cambie los nombres de clase.

3. Establezca la **pluralización de nombres** en **habilitada**  =  **true** para aplicar las reglas de pluralización a los nombres de clase de los objetos agregados a [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] .
