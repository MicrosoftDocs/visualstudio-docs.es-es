---
title: 'Cómo: crear una asociación (relación) entre LINQ to SQL clases (Object Relational Designer) | Microsoft Docs'
ms.date: 11/15/2016
...
4. Seleccione las **Propiedades de la asociación** que relacionan las clases. Por lo general, se asigna a la relación entre claves externas definida en la base de datos. Por ejemplo, en la Asociación Customers y Orders, las propiedades de la **Asociación** son el CustomerID de cada clase.
