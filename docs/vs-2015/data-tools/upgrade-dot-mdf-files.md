---
title: Actualizar archivos. MDF | Microsoft Docs
ms.date: 11/15/2016
...
En este tema se describen las opciones para actualizar el archivo de base de datos (. MDF) después de instalar una versión más reciente de Visual Studio. Incluye instrucciones para las siguientes tareas:
...
> [!WARNING]
> Si actualiza un archivo. MDF creado en LocalDB 2014 (V12) 32 bit a LocalDB 2016 (v13), no podrá volver a abrir el archivo en la versión de 32 bits de LocalDB.  En Update 2, LocalDB v13 es solo de 64 bits.
