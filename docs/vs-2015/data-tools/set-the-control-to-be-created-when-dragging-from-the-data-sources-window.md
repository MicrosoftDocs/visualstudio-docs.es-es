...
La versión más reciente de este tema puede encontrarse en [establecer el control que se creará al arrastrar desde la ventana Orígenes de datos](https://docs.microsoft.com/visualstudio/data-tools/set-the-control-to-be-created-when-dragging-from-the-data-sources-window).  
