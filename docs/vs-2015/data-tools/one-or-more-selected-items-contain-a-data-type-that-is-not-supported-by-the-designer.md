...
La versión más reciente de este tema puede encontrarse en [uno o más elementos seleccionados contienen un tipo de datos que no es compatible con el diseñador](https://docs.microsoft.com/visualstudio/data-tools/one-or-more-selected-items-contain-a-data-type-that-is-not-supported-by-the-designer).  
