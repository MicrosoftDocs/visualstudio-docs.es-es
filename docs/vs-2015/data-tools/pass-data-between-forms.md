---
title: Pasar datos entre formularios | Microsoft Docs
ms.date: 11/15/2016
...
3. Seleccione **Windows Forms aplicación**y haga clic en **Aceptar**. Para obtener más información, vea [aplicaciones cliente](https://msdn.microsoft.com/library/2dfb50b7-5af2-4e12-9bbb-c5ade0e39a68).
...
## <a name="add-a-tableadapter-query-to-form2-to-load-orders-for-the-selected-customer-on-form1"></a>Agregue una consulta de TableAdapter a Form2 para cargar los pedidos del cliente seleccionado en Form1.
