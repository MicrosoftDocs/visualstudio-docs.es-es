...
ms.locfileid: "47566038"
---
# <a name="create-a-sql-database-by-using-a-script"></a>Crear una base de datos SQL mediante una secuencia de comandos
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [crear una base de datos SQL mediante una secuencia de comandos](https://docs.microsoft.com/visualstudio/data-tools/create-a-sql-database-by-using-a-script).  
