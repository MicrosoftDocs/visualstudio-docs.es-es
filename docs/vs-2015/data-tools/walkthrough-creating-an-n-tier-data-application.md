...
- Escribir código para rellenar las tablas de datos.
  ...
  ![vínculo a vídeo](../data-tools/media/playvideo.gif "PlayVideo") Para obtener una versión en vídeo de este tema, vea [el vídeo cómo: crear una aplicación de datos de N niveles](http://go.microsoft.com/fwlink/?LinkId=115188).
