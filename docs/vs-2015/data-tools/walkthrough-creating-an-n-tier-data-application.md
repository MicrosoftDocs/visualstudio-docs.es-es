...
1. En el menú **archivo** , cree un nuevo proyecto.
    ...
    > [!NOTE]
    > El **Diseñador de DataSet** se admite en los [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] proyectos de C# y. Cree el nuevo proyecto en uno de estos lenguajes.
