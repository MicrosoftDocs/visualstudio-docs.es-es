...
ms.locfileid: "47577047"
---
# <a name="query-datasets"></a>Consultar conjuntos de datos
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [consultar conjuntos de datos](https://docs.microsoft.com/visualstudio/data-tools/query-datasets).  
