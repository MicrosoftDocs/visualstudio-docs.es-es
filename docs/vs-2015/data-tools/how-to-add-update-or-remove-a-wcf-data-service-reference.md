...
## <a name="updating-a-service-reference"></a>Actualizar una referencia de servicio
 A veces, el Entity Data Model para un [!INCLUDE[ssAstoria](../includes/ssastoria-md.md)] cambiará. Cuando esto sucede, se debe actualizar la referencia de servicio.
