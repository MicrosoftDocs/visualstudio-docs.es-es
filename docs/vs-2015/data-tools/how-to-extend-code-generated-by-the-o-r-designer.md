...
2. En la [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] , haga clic con el botón secundario en la clase para la que desea agregar la validación y, a continuación, haga clic en **Ver código**.
...
2. En la [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] , haga clic con el botón secundario en un área vacía del diseñador y, a continuación, haga clic en **Ver código**.
