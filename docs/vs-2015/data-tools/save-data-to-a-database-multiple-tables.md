...
ms.locfileid: "47574319"
---
# <a name="save-data-to-a-database-multiple-tables"></a>Guardar datos en una base de datos (varias tablas)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [guardar datos en una base de datos (varias tablas)](https://docs.microsoft.com/visualstudio/data-tools/save-data-to-a-database-multiple-tables).  
