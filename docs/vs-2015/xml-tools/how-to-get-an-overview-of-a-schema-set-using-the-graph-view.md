...
La versión más reciente de este tema puede encontrarse en [Cómo: obtener una visión general de un esquema establecido mediante la vista gráfico](https://docs.microsoft.com/visualstudio/xml-tools/how-to-get-an-overview-of-a-schema-set-using-the-graph-view).  
