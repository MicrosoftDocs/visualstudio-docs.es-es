...
ms.locfileid: "47575276"
---
# <a name="editing-xslt-style-sheets"></a>Editar hojas de estilos XSLT
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [editar hojas de estilos XSLT](https://docs.microsoft.com/visualstudio/xml-tools/editing-xslt-style-sheets).  
