...
ms.locfileid: "47582685"
---
# <a name="how-to-create-xml-snippets"></a>Crear fragmentos de código XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Cómo: crear fragmentos XML](https://docs.microsoft.com/visualstudio/xml-tools/how-to-create-xml-snippets).  
