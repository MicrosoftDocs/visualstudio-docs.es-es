---
title: 'Archivo XSD de ejemplo: Esquema Simple | Microsoft Docs'
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47575492"
---
# <a name="sample-xsd-file-simple-schema"></a>Ejemplo de archivo XSD: esquema simple
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Sample XSD File: esquema Simple](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-simple-schema).  
