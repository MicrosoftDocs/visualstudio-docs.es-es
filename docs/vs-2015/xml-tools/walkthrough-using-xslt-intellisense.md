---
title: 'Tutorial: Usar XSLT IntelliSense | Microsoft Docs'
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47567193"
---
# <a name="walkthrough-using-xslt-intellisense"></a>Tutorial: Usar XSLT de IntelliSense
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [Tutorial: usar XSLT IntelliSense](https://docs.microsoft.com/visualstudio/xml-tools/walkthrough-using-xslt-intellisense).  
