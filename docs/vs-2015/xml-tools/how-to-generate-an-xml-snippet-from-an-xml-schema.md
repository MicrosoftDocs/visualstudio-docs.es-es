...
La versión más reciente de este tema puede encontrarse en [Cómo: generar un XML desde un esquema XML del fragmento](https://docs.microsoft.com/visualstudio/xml-tools/how-to-generate-an-xml-snippet-from-an-xml-schema).  
