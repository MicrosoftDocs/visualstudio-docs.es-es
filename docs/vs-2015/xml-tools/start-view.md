...
ms.locfileid: "47574787"
---
# <a name="start-view"></a>Vista Inicio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [vista inicio](https://docs.microsoft.com/visualstudio/xml-tools/start-view).  
