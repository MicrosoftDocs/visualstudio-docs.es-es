...
ms.locfileid: "47580698"
---
# <a name="content-model-view"></a>Vista Modelo de contenido
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versión más reciente de este tema puede encontrarse en [vista modelo de contenido](https://docs.microsoft.com/visualstudio/xml-tools/content-model-view).  
