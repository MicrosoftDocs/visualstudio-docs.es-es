...
- [Planeación de la migración a Git](https://www.visualstudio.com/learn/centralized-to-git/)  
- [Migración de TFVC a Git](https://www.visualstudio.com/learn/migrate-from-tfvc-to-git/)  
