...
## <a name="write-great-web-apps-with-aspnet"></a>Escribir excelentes aplicaciones web con ASP.NET  
 [ASP.NET Core](http://www.asp.net/core/overview) es una actualización principal para MVC, WebAPI y SignalR, y se ejecuta en Windows, Mac y Linux.  ASP.NET Core se diseñó desde la base para ofrecer una pila de .NET eficiente y que admite composición, con el fin de compilar servicios y aplicaciones web modernos basados en la nube.  
...
|[Novedades de Visual C#](/dotnet/csharp/csharp-7)|
