...
## Comentarios  
 Para obtener un ejemplo de código, vea [geometric\_distribution \(Clase\)](/visual-cpp/standard-library/geometric-distribution-class).  
...
## Vea también  
 ...
 [geometric\_distribution \(Clase\)](/visual-cpp/standard-library/geometric-distribution-class)