---
title: "Reglas y limitaciones para TLS | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
El contenido se movió a [Almacenamiento local de subprocesos \(TLS\)](/visual-cpp/parallel/multithreading/thread-local-storage-tls)