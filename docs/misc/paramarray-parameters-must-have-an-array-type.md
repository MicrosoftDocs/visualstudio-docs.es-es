...
2.  Si el error se repite, guarde el trabajo y reinicie [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
  
3.  Si el error persiste, reinstale [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
