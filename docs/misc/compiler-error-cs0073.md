...
Un descriptor de acceso add o remove debe tener un cuerpo  
 ...
 Una palabra clave **add** o **remove** en una definición [evento](/dotnet/csharp/language-reference/keywords/event) debe tener un cuerpo. Para obtener más información, consulte [Eventos](/dotnet/csharp/programming-guide/events/index).  
