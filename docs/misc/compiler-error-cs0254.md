---
title: "Error del compilador CS0254 | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
El lado derecho de una asignación de instrucción fixed puede no ser una expresión de conversión  
 ...
 Es posible que el lado derecho de una expresión [fixed](/dotnet/csharp/language-reference/keywords/fixed-statement) no pueda usar una conversión. Para obtener más información, consulta [Código no seguro y punteros](/dotnet/csharp/programming-guide/unsafe-code-pointers/index).  
