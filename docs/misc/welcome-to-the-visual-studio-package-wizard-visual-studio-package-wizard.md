...
La plantilla de paquete [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] crea una implementación básica de un paquete de VS que se puede expandir más adelante. También puede usar la plantilla de paquete [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] para agregar componentes opcionales a un paquete de VS.  
