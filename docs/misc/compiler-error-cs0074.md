...
'evento': un evento abstracto no puede tener inicializador.  
 ...
 Si un [evento](/dotnet/csharp/language-reference/keywords/event) está marcado como **abstract**, no se puede inicializar. Para obtener más información, consulta [Eventos](/dotnet/csharp/programming-guide/events/index).  
