...
Se especificó la opción del compilador con el valor `+` o `-`; estos valores no se admiten.  
 ...
 Para más información sobre las opciones del compilador y los valores que admiten, consulte [Opciones del compilador de Visual Basic, por orden alfabético](/dotnet/visual-basic/reference/command-line-compiler/compiler-options-listed-alphabetically).  
...
## Vea también  
 [Opciones del compilador de Visual Basic, por orden alfabético](/dotnet/visual-basic/reference/command-line-compiler/compiler-options-listed-alphabetically)