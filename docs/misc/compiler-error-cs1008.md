...
Se esperaba el tipo byte, sbyte, short, ushort, int, uint, long o ulong  
 ...
 Determinados tipos de datos, como [enums](/dotnet/csharp/language-reference/keywords/enum), solo se pueden declarar para almacenar datos de tipos especificados.  
