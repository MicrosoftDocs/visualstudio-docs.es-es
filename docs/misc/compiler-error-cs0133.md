...
La expresión que se asigna a 'variable' debe ser constante.  
 ...
 Una variable [const](/dotnet/csharp/language-reference/keywords/const) no puede tomar como valor una expresión que no es constante. Para obtener más información, consulta [Constantes](/dotnet/csharp/programming-guide/classes-and-structs/constants).  
