...
---
# VSPackages administrado
Los temas siguientes explican cómo crear un paquete VSPackage.  Un Paquete es un módulo de programación que extiende el entorno de desarrollo integrado de \(IDE\) [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] proporcionando elementos \(UI\), a servicios, a proyectos, editores, y diseñadores de la interfaz de usuario.  Para obtener más información, vea [VSPackages](../extensibility/internals/vspackages.md).  
...
## En esta sección  
 ...
 Describe la función y la ubicación de los ensamblados de interoperabilidad de [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] y de los espacios de nombres que proporcionan.  
 ...
 Explica los problemas de interoperabilidad entre los ensamblados de interoperabilidad de [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] y las interfaces COM.  
