---
title: "Error de MSBuild MSB2001 | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
manager: "douge"
---
# Error de MSBuild MSB2001
**El elemento \<{0}\> no contiene el atributo "{1}" necesario.**  
  
 El proyecto que se está convirtiendo ha sufrido modificaciones o daños, o bien, no se ha creado en [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
