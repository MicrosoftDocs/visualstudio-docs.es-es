...
Se ha hecho referencia a un literal XML o una propiedad de eje XML en las ventanas **Inspección** o **Inmediato** durante una sesión de depuración en la que el código XML de las características de [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] no está disponibles. Este es el caso de un ensamblado que o bien no usa el código XML de las características de [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] o bien es una compilación de versión.  
...
## Vea también  
 [Depurar la aplicación de Visual Basic](/dotnet/visual-basic/developing-apps/debugging)   
 [Literales XML](/dotnet/visual-basic/language-reference/xml-literals/index)   
 [Propiedades de eje XML](/dotnet/visual-basic/language-reference/xml-axis/xml-axis-properties)   
