...
El evento 'event' solo puede aparecer a la izquierda de \+\= o \-\= \(excepto cuando se usa desde el tipo 'type'\)  
 ...
 Fuera de la clase en la que está definido, un [evento](/dotnet/csharp/language-reference/keywords/event) solo puede agregar o restar referencias. Para obtener más información, consulta [Eventos](/dotnet/csharp/programming-guide/events/index).  
