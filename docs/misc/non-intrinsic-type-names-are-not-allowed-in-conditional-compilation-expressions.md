...
La expresión de compilación condicional hace referencia a un tipo no intrínseco, pero se permiten solo tipos intrínsecos.  
 ...
 Para más información sobre el tipo intrínseco en [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)], vea [Resumen de tipos de datos](/dotnet/visual-basic/language-reference/keywords/data-types-summary).  
