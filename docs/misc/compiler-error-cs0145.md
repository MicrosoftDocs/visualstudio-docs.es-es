...
El campo const requiere que se proporcione un valor  
 ...
 Debe inicializar una variable [const](/dotnet/csharp/language-reference/keywords/const). Para obtener más información, consulta [Constantes](/dotnet/csharp/programming-guide/classes-and-structs/constants).  
