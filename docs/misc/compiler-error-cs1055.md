...
Se esperaba un descriptor de acceso add o remove  
 ...
 Si su [evento](/dotnet/csharp/language-reference/keywords/event) no se ha declarado como campo, debe definir las funciones de descriptor de acceso **add** y **remove**.  
