...
El parámetro params no se puede declarar como ref ni out  
 ...
 Las palabras clave [ref](/dotnet/csharp/language-reference/keywords/ref) o [out](/dotnet/csharp/language-reference/keywords/out) no se puede usar con la palabra clave [params](/dotnet/csharp/language-reference/keywords/params).  
