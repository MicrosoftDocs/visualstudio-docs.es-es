...
ms.topic: "article"
f1_keywords: 
  - "vs.tasklisterror.fail_starting_compiler"
...
Se encontró un error desconocido al emitir la solicitud **Iniciar compilación** para el compilador de [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] o de [!INCLUDE[csprcs](../data-tools/includes/csprcs_md.md)].  
