...
Debe proporcionar un inicializador en una declaración de instrucción fixed o using  
 ...
 Se debe declarar e inicializar la variable en una [instrucción fixed](/dotnet/csharp/language-reference/keywords/fixed-statement). Para obtener más información, consulta [Código no seguro y punteros](/dotnet/csharp/programming-guide/unsafe-code-pointers/index).  
...
```  
 ...
 En el ejemplo siguiente también genera el error CS0210 porque la [instrucción using](/dotnet/csharp/language-reference/keywords/using-statement) no tiene inicializador.  
