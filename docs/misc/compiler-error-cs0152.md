...
La etiqueta 'label' ya se da en esta instrucción switch  
 ...
 Se repitió una etiqueta en una instrucción [switch](/dotnet/csharp/language-reference/keywords/switch). Para obtener más información, consulta [switch](/dotnet/csharp/language-reference/keywords/switch).  
