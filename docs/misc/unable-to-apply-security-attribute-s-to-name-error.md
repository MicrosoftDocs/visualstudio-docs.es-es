...
3.  Si el error continúa, guarde el trabajo y reinicie [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
  
4.  Si el error se vuelve a producir, reinstale [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
