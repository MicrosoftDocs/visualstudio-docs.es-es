...
El evento 'event' solo puede aparecer a la izquierda de \+\= o \-\=  
 ...
 Se llamó a [event](/dotnet/csharp/language-reference/keywords/event) de manera incorrecta. Para obtener más información, consulte [Eventos](/dotnet/csharp/programming-guide/events/index) y [Delegados](/dotnet/csharp/programming-guide/delegates/index).  
