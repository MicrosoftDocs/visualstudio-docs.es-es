...
No se pueden definir métodos sobrecargados que difieran solo en ref y out.  
 ...
 Los métodos que únicamente se diferencian en el uso de [ref](/dotnet/csharp/language-reference/keywords/ref) y [out](/dotnet/csharp/language-reference/keywords/out) en un parámetro no se permiten.  
