...
![Ventana de ayuda en Visual Studio](~/docs/rtvs/media/help-window.png)
...
![Resultados de búsqueda de ayuda](~/docs/rtvs/media/help-search1.png)
...
![Resultados de búsqueda de ayuda mediante el campo de entrada](~/docs/rtvs/media/help-search2.png)
...
- Haga clic con el botón derecho en un término de búsqueda (por ejemplo, una función) y seleccione el comando **Ayuda sobre** o simplemente presione F1 para abrir ayuda sobre esa función. También puede invocar **Ayuda sobre** para cualquier selección.
    ...
    ![Invocación de ayuda a través del menú contextual](~/docs/rtvs/media/help-right-click.png)
...
![Resultados de búsqueda en web en Visual Studio](~/docs/rtvs/media/help-web-search-results.png)
...
![Cambio a la opción Cadena de búsqueda en la Web mediante F1](~/docs/rtvs/media/options-dialog.png)
