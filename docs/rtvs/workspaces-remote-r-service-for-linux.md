---
title: "Configuración de Servicio R remoto en Linux | Microsoft Docs"
ms.custom: 
ms.date: 12/04/2017
ms.reviewer: 
ms.suite: 
...
El servicio R remoto para Linux actualmente se empaqueta como rtvs-daemon. El demonio es compatible y se ha probado en Ubuntu 16.04, 16.10 LTS para escritorio, servidor y el subsistema de Windows para Linux con Ubuntu. En la mayor parte de este tema se proporcionan instrucciones sobre cómo configurar el Servicio R remoto en estos sistemas diferentes.
