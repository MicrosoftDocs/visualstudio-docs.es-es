...
A. GitHub mantiene un repositorio principal de los archivos de *.gitignore* recomendados. Puede verlo aquí: [R .gitignore](https://github.com/github/gitignore/blob/master/R.gitignore)
