...
![Ventana Herramientas de diagnóstico](~/docs/profiling/media/prof-tour-diagnostic-tools.png "Herramientas de diagnóstico")
...
![Vista de Resumen de Herramientas de diagnóstico](~/docs/profiling/media/prof-tour-cpu-and-memory-graph.gif "Resumen de Herramientas de diagnóstico")
...
![Habilitar el uso de CPU en las Herramientas de diagnóstico](~/docs/profiling/media/prof-tour-enable-cpu-profiling.png "Habilitar uso de CPU en Herramientas de diagnóstico")
...
![Vista de Uso de CPU de Herramientas de diagnóstico](~/docs/profiling/media/prof-tour-cpu-usage.png "Uso de CPU de Herramientas de diagnóstico")
...
![Vista de "mariposa" de llamador y destinatario de Herramientas de diagnóstico](~/docs/profiling/media/prof-tour-cpu-usage-caller-callee.png "Vista de llamador y destinatario de Herramientas de diagnóstico")
...
![Ver eventos de Herramientas de diagnóstico](~/docs/profiling/media/prof-tour-events.png "Ver eventos de Herramientas de diagnóstico")
...
![Sugerencias de rendimiento en la guía de generación de perfiles](~/docs/profiling/media/prof-tour-perf-tips.png "Sugerencias de rendimiento en la guía de generación de perfiles")
...
![Ver eventos del Análisis de UI en las Herramientas de diagnóstico](~/docs/profiling/media/prof-tour-ui-analysis.png "Ver eventos del Análisis de UI de Herramientas de diagnóstico")
...
![Generador de perfiles de rendimiento](~/docs/profiling/media/prof-tour-performance-profiler.png "Generador de perfiles de rendimiento")
...
![Herramienta de generación de perfiles en la Escala de tiempo de la aplicación](~/docs/profiling/media/prof-tour-application-timeline.gif "Escala de tiempo de la aplicación en la guía de generación de perfiles")
...
![Herramienta de generación de perfiles de uso de GPU](~/docs/profiling/media/prof-tour-gpu-usage.png "Diagnóstico de uso de GPU")
...
![Herramienta de generación de perfiles de Uso de red](~/docs/profiling/media/prof-tour-network-usage.png "Diagnóstico de Uso de red")

Seleccione una operación en la vista de resumen para ver más detalles.

![Información detallada en la herramienta de Uso de red](~/docs/profiling/media/prof-tour-network-usage-details.png "Detalles del diagnóstico de Uso de red")
...
![Herramienta de Explorador de rendimiento](~/docs/profiling/media/prof-tour-performance-explorer.png "Explorador de rendimiento")
