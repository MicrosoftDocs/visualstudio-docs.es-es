...
Las herramientas de generación de perfiles a las que se tiene acceso durante una sesión de depuración están disponibles en la ventana Herramientas de diagnóstico. La ventana Herramientas de diagnóstico aparece automáticamente a menos que la desactive. Para mostrar la ventana, haga clic en **Depurar / Windows / Mostrar herramientas de diagnóstico**. Con la ventana abierta, puede seleccionar las herramientas para las que se van a recopilar datos.

![Herramientas de diagnóstico](../profiling/media/prof-tour-diagnostic-tools.png "Herramientas de diagnóstico")
...
![Resumen de Herramientas de diagnóstico](../profiling/media/prof-tour-cpu-and-memory-graph.gif "Resumen de Herramientas de diagnóstico")
...
![Habilitar generación de perfiles de CPU de Herramientas de diagnóstico](../profiling/media/prof-tour-enable-cpu-profiling.png "Habilitar generación de perfiles de CPU de Herramientas de diagnóstico")
...
![Uso de CPU de Herramientas de diagnóstico](../profiling/media/prof-tour-cpu-usage.png "Uso de CPU de Herramientas de diagnóstico")

Si hace doble clic en una función que le interese, verá una vista de tres paneles más detallada, con la función seleccionada en el centro de la ventana, la función de llamada a la izquierda y las funciones llamadas a la derecha. En la sección **Cuerpo de la función** se muestra la cantidad total de tiempo (y el porcentaje de tiempo) empleado en el cuerpo de la función, excluido el tiempo invertido en las funciones de llamada y las funciones llamadas. Estos datos pueden ayudarle a evaluar si la función en sí es un cuello de botella de rendimiento.

![Vista de llamador y destinatario de Herramientas de diagnóstico](../profiling/media/prof-tour-cpu-usage-caller-callee.png "Vista de llamador y destinatario de Herramientas de diagnóstico")

## <a name="analyze-memory-usage"></a>Analizar el uso de memoria

La ventana Herramientas de diagnóstico permite evaluar el uso de memoria en la aplicación. Por ejemplo, puede buscar el número y el tamaño de los objetos del montón. Para obtener instrucciones más detalladas sobre el análisis de la memoria, vea [Memory Usage](../profiling/memory-usage.md) (Uso de memoria).
...
![Tomar instantáneas en Herramientas de diagnóstico](../profiling/media/prof-tour-take-snapshots.gif "Tomar instantáneas en Herramientas de diagnóstico")
...
![Vista de diferencias del montón de Herramientas de diagnóstico](../profiling/media/prof-tour-mem-usage-diff-heap.png "Vista de diferencias del montón de Herramientas de diagnóstico")
...
![Vista Eventos de Herramientas de diagnóstico](../profiling/media/prof-tour-events.png "Vista Eventos de Herramientas de diagnóstico")
...
![Análisis de interfaz de usuario en la vista Eventos de Herramientas de diagnóstico](../profiling/media/prof-tour-ui-analysis.png "Análisis de interfaz de usuario en la vista Eventos de Herramientas de diagnóstico")
...
![Escala de tiempo de la aplicación en la guía de generación de perfiles](../profiling/media/prof-tour-application-timeline.gif "Escala de tiempo de la aplicación en la guía de generación de perfiles")
...
![Cuadro de diálogo Uso de GPU](../profiling/media/prof-tour-gpu-usage.png "Cuadro de diálogo Uso de GPU")
...
![Cuadro de diálogo Memoria de JavaScript](../profiling/media/diagjsmemory.png "Cuadro de diálogo Memoria de JavaScript")
...
![Cuadro de diálogo Capacidad de respuesta de IU HTML](../profiling/media/diaghtmlresp.png "Cuadro de diálogo Capacidad de respuesta de IU HTML")
...
![Cuadro de diálogo Uso de red](../profiling/media/prof-tour-network-usage.png "Cuadro de diálogo Uso de red")

Seleccione una operación en la vista de resumen para ver más detalles.

![Cuadro de diálogo de detalles de Uso de red](../profiling/media/prof-tour-network-usage-details.png "Cuadro de diálogo de detalles de Uso de red")
...
![Explorador de rendimiento](../profiling/media/prof-tour-performance-explorer.png "Explorador de rendimiento")
