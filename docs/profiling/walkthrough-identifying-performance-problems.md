---
title: "Tutorial: Generar perfiles de aplicaciones | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
helpviewer_keywords: 
  ...
  - "aplicaciones de generación de perfiles, tutoriales"
...
manager: "ghogen"
---
# Tutorial: Generar perfiles de aplicaciones
...
6.  En **¿Para qué aplicación desea generar perfiles?**, seleccione PeopleTrax y, a continuación, haga clic en **Siguiente**.  
...
9. Cierre el Bloc de notas y, a continuación, cierre la aplicación **PeopleTrax**.  
...
4.  Con el código de la aplicación de ejemplo se suministra una versión alternativa de GetPeople. Puede llamar a la función optimizada agregando un símbolo de compilación adicional a las propiedades de compilación.  En la ventana del Explorador de soluciones, haga clic con el botón secundario en el proyecto People y, a continuación, haga clic en **Propiedades**.  En el menú de la página de propiedades, haga clic en **General** y escriba **OPTIMIZED\_GETPEOPLE** en el cuadro de texto del símbolo de compilación condicional.  La versión optimizada de GetPeople reemplazará al método original en la compilación siguiente.  
  
5.  Vuelva a ejecutar la sesión de rendimiento.  En la barra de herramientas del Explorador de rendimiento, haga clic en **Iniciar con generación de perfiles**.  Haga clic en **Get People** y, a continuación, haga clic en **Exportar datos**.  Cierre la ventana del Bloc de notas que aparece y, a continuación, cierre la aplicación People Trax.  
...
6.  Para comparar las dos generaciones de perfiles, seleccione los dos archivos de datos en el Explorador de rendimiento, haga clic con el botón secundario en los archivos y, a continuación, haga clic en **Comparar informes de rendimiento**.  Se abre una ventana de Informe de comparación en la ventana principal de [!INCLUDE[vs_current_short](../code-quality/includes/vs_current_short_md.md)].  En la columna **Delta** se muestra el cambio en el valor de rendimiento de las funciones entre el valor de **Línea base** anterior y el valor de **Comparación** posterior.  Puede seleccionar los valores que se van comparar en la lista desplegable **Columna**.  Seleccione **Muestras inclusivas %**.  
...
3.  Puede ver que PeopleTrax.Form1.ExportData es el único método que llama a Concat.  En la lista **Funciones que llaman**, haga clic en **PeopleTrax.Form1.ExportData** para seleccionar el método que actúa como destino de la vista Detalles de la función.  
...
5.  Para reemplazar esta área de problema con código optimizado, agregue OPTIMIZED\_EXPORTDATA como símbolo de compilación condicional al proyecto PeopleTrax.  
  
6.  En el Explorador de soluciones, haga clic con el botón secundario del mouse en el proyecto PeopleTrax y, a continuación, haga clic en **Propiedades**.  
  
     Aparece el formulario de propiedades del proyecto PeopleTrax.  
  
7.  Haga clic en la pestaña **Compilar**.  
  
8.  En el cuadro de texto **Símbolos de compilación condicional**, escriba OPTIMIZED\_EXPORTDATA.  
