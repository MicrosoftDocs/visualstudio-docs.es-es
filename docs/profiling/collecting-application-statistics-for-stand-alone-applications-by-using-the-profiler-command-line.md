...
helpviewer_keywords: 
  ...
  - "herramientas de generación de perfiles, método de muestreo"
...
manager: "ghogen"
---
# Recopilar estad&#237;sticas de aplicaci&#243;n para aplicaciones independientes utilizando la l&#237;nea de comandos del generador de perfiles
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

En esta sección se describen los procedimientos y opciones para recopilar las estadísticas de rendimiento para una aplicación cliente \(independiente\) utilizando el método de muestreo de la línea de comandos.  
...
|**Adjuntar el generador de perfiles a una aplicación C\/C\+\+ en ejecución**|-   [Cómo: Adjuntar el generador de perfiles a una aplicación nativa y recopilar estadísticas de la aplicación](../Topic/How%20to:%20Attach%20the%20Profiler%20to%20a%20Native%20Stand-Alone%20Application%20and%20Collect%20Application%20Statistics%20by%20Using%20the%20Command%20Line.md)|  
...
|**Recopilar datos de recolección de elementos no utilizados y de asignación de memoria .NET**|-   [Recopilar datos de memoria de .NET Framework](../profiling/collecting-dotnet-framework-memory-data-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
...
|**Generar perfiles de servicios**|-   [Recopilar estadísticas de aplicación mediante muestreo](../profiling/collecting-application-statistics-for-services-by-using-the-profiler-sampling-method.md).  Describe cómo recopilar estadísticas de rendimiento de los servicios de Windows utilizando el método de muestreo.|  
  
### Analizar vistas e informes de datos de muestreo  
