...
description: Obtenga información sobre la función StopProfile y cómo establece el contador en 0 (desactivado) para el nivel de generación de perfiles especificado.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- StopProfile
