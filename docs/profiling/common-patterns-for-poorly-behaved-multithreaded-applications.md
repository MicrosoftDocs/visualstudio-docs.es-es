...
description: El Visualizador de simultaneidad proporciona grafos para aplicaciones de varios niveles, además de una galería de patrones habituales sobre aquellas que tienen un comportamiento deficiente.
