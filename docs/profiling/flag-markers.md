...
## <a name="flag-category"></a>Categoría de la marca
 ...
 ![Cinco colores de marcadores de categoría](../profiling/media/cvmarkercategory.png "CVMarkerCategory") Marcadores que muestran categorías
...
## <a name="alerts"></a>Alertas
 ...
 ![Marcador de alerta del visualizador de simultaneidad](../profiling/media/cvmarkeralert.png "CVMarkerAlert") Marcador de alerta
