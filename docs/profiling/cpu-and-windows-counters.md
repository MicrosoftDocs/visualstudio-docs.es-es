...
description: Los contadores de CPU (hardware) y Windows (software) proporcionan datos de rendimiento. Obtenga más información sobre cómo verlos y cómo recopilar datos de estos.
