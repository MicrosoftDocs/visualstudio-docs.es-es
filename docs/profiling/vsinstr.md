...
description: Obtenga información sobre cómo se usa la herramienta VSInstr para instrumentar archivos binarios y otras de sus opciones.
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
