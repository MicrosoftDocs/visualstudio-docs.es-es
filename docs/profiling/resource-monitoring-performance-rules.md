...
description: Obtenga más información sobre cómo los mensajes de rendimiento proporcionan datos adicionales sobre el rendimiento de la aplicación en la categoría de supervisión de recursos.
ms.date: 11/04/2016
ms.topic: conceptual
