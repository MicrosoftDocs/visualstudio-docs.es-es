...
3.  Elija **Uso de CPU** y luego elija **Iniciar**.  
     ...
     ![Elegir el uso de CPU](~/docs/profiling/media/cpuuse_lib_choosecpuusage.png "CPUUSE_LIB_ChooseCpuUsage")  
