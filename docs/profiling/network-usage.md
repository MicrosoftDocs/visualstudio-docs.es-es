...
description: Obtenga información sobre cómo la herramienta Diagnóstico de red de Visual Studio recopila datos sobre las operaciones de red realizadas mediante la API Windows.Web.Http.
ms.custom: seodec18
ms.date: 11/04/2016
ms.topic: conceptual
...
- [Visual Studio blog: Introducing Visual Studio's network inspector](https://devblogs.microsoft.com/visualstudio/) (Blog de Visual Studio: Introducción al inspector de red de Visual Studio)
