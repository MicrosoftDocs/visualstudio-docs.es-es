...
Las herramientas de generación de perfiles [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] admiten la recopilación de datos de duración de objetos y de asignación de memoria de .NET, lo cual lo ayuda a detectar problemas de rendimiento relacionados con la memoria de la aplicación.  
...
-   En el **Explorador de rendimiento**, haga clic con el botón secundario del mouse en el nombre de la sesión y, a continuación, haga clic en **Propiedades**.  
 ...
 Las tareas de la tabla siguiente describen las opciones que puede especificar en el cuadro de diálogo *Páginas de propiedades de***sesión de rendimiento** cuando recopile datos de memoria de .NET.  
