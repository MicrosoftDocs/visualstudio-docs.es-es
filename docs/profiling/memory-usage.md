...
4.  Elija **Uso de memoria** con la opción **Seleccionar herramientas** en la barra de herramientas.
     ...
     ![Mostrar herramientas de diagnóstico](~/docs/profiling/media/DiagToolsSelectTool.png "DiagToolsSelectTool")
...
5.  Haga clic en **Depurar / Iniciar depuración** (o **Inicio** en la barra de herramientas o **F5**).
     ...
     ![Pestaña Resumen de herramientas de diagnóstico de](~/docs/profiling/media/DiagToolsSummaryTab.png "DiagToolsSummaryTab")
     ...
     >   
     >  ![Habilitar las instantáneas](~/docs/profiling/media/dbgdiag_mem_mixedtoolbar_enablesnapshot.png "DBGDIAG_MEM_MixedToolbar_EnableSnapshot")  
     >   
...
6.  Para tomar una instantánea al comienzo de la sesión de depuración, elija **Instantánea** en la barra de herramientas reducida **Uso de memoria**. (Puede ser útil para establecer un punto de interrupción aquí también.)
    ...
    ![Tomar instantánea](~/docs/profiling/media/dbgdiag_mem_mixedtoolbar_takesnapshot.png "DBGDIAG_MEM_MixedToolbar_TakeSnapshot") 
...
![Tabla de resumen de memoria](~/docs/profiling/media/dbgdiag_mem_summarytable.png "DBGDIAG_MEM_SummaryTable")
...
### <a name="managed-types-reports"></a>Informes de tipos administrados  
 ...
 Para mostrar las instancias de un tipo seleccionado en el panel superior, seleccione el icono ![Icono de instancia](~/docs/profiling/media/dbgdiag_mem_instanceicon.png "DBGDIAG_MEM_InstanceIcon").  
...
-   Elija el icono de instancias (![icono de instancia en la columna Tipo de objeto](~/docs/profiling/media/dbg_mma_instancesicon.png "DBG_MMA_InstancesIcon")) de un tipo seleccionado para mostrar información sobre los objetos del tipo seleccionado en la instantánea.  
...
-   Elija una instantánea de la lista **Comparar con** en un informe administrado o nativo.  
     ...
     ![Elegir una instantánea en la lista Comparar con](~/docs/profiling/media/dbgdiag_mem_choosecompareto.png "DBGDIAG_MEM_ChooseCompareTo")  
