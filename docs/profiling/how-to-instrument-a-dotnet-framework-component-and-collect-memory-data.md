---
title: 'Línea de comandos del generador de perfiles: instrumentación del componente de .NET independiente y obtención de datos de memoria'
description: Aprenda a usar las herramientas de línea de comandos de las Herramientas de generación de perfiles de Visual Studio para recopilar datos sobre la memoria para un componente de .NET Framework de una aplicación independiente.
