...
description: Obtenga más información sobre la función StartProfile y de cómo establece el contador en 1 (activado) para el nivel de generación de perfiles especificado.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- StartProfile
