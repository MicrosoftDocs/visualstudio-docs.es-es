...
description: Este mensaje indica la cantidad media de memoria física que el proceso está utilizando actualmente en bytes (el espacio de trabajo).
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- vs.performance.503
