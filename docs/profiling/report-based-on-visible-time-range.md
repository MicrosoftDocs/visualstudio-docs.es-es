...
helpviewer_keywords: 
  - "Visualizador de simultaneidad, Informe basado en el intervalo de tiempo visible"
...
---
# Informe basado en el intervalo de tiempo visible
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

La vista Perfil muestra informes que están basados en el intervalo de tiempo y los canales actualmente visibles.  Para ver detalles sobre diferentes subconjuntos de datos, haga clic en los elementos de la leyenda.  
  
 Aquí puede encontrar más información sobre los datos de las tablas.  
