...
El método de generación de perfiles *Instrumentación* del [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] registra información de tiempos detallada de llamadas a funciones, líneas y las instrucciones de la aplicación perfilada  
