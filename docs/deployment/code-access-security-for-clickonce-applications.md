...
dev_langs: 
  ...
  - "C++"
helpviewer_keywords: 
  - "implementar aplicaciones [ClickOnce], seguridad"
  - "aplicaciones ClickOnce, caspol"
  - "seguridad [ClickOnce], aplicaciones de WPF hospedadas en explorador"
  - "seguridad [ClickOnce], aplicaciones ClickOnce"
  - "aplicaciones ClickOnce, directivas de seguridad de acceso del código"
  - "seguridad, ClickOnce"
...
## Seguridad de acceso del código de ClickOnce predeterminada  
...
## Depurar una aplicación que tiene permisos restringidos  
...
## Permisos de seguridad para las aplicaciones hospedadas en explorador  
