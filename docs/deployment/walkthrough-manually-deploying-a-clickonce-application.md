...
6.  Inicie sesión en el manifiesto de aplicación con el certificado Authenticode. Reemplace *mycert.pfx* con la ruta de acceso al archivo de certificado. Reemplace *passwd* con la contraseña para el archivo de certificado.  
    ...
    Comenzando con el SDK de .NET Framework 4.6.2, que se distribuye con Visual Studio y con el SDK de Windows, mage.exe signos manifiestos con CNG así como con los certificados de Authenticode. Utilice los mismos parámetros de línea de comandos al igual que con los certificados de Authenticode.
