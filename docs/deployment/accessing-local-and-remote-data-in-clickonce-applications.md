---
title: "Obtener acceso local o remoto a los datos en aplicaciones ClickOnce | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
dev_langs: 
  ...
  - "C++"
helpviewer_keywords: 
  - "Implementación de ClickOnce, datos"
  - "acceso a los datos, aplicaciones de ClickOnce"
...
### Almacenamiento aislado  
 ...
 Para obtener más información, consulta [Almacenamiento aislado](../Topic/Isolated%20Storage.md).  
...
|Instalación de CD\-ROM|Puede acceder a servidores web|  
 ...
 Si su aplicación [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] no puede acceder a un servidor web debido a restricciones de seguridad, la aplicación debe imponer <xref:System.Net.WebPermission> para ese sitio web. Para obtener más información sobre cómo aumentar los permisos de seguridad para una aplicación [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)], consulte [Proteger las aplicaciones ClickOnce](../deployment/securing-clickonce-applications.md).  
  
### Acceder a los datos a través de un servicio web XML  
