---
title: 'Cómo: especificar un vínculo para obtener soporte técnico | Documentos de Microsoft'
ms.custom: ''
ms.date: 11/04/2016
...
5.  En el **dirección URL de soporte** , a continuación, escriba una ruta de acceso completa a un recurso compartido UNC, página Web o sitio Web.  
