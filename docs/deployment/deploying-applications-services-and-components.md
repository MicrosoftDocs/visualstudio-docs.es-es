...
- **ASP.NET**, **ASP.NET Core**, **Node.js** y **Python**: puede usar la opción Publicar para implementar en un sitio web mediante FTP o Web Deploy. Para obtener más información, vea [Implementar en un sitio web](quickstart-deploy-to-a-web-site.md).
    ...
    ![Elección de IIS](../deployment/media/quickstart-publish-iis.png)
...
| **LightSwitch** | LightSwitch ya no se admite a partir de Visual Studio 2017, pero todavía se puede implementar desde Visual Studio 2015 y versiones anteriores. | [Implementar aplicaciones LightSwitch](/previous-versions/ff872288(v=vs.140)) |
