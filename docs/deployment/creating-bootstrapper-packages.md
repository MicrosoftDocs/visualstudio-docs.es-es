---
title: "Crear paquetes de arranque | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
dev_langs: 
  ...
  - "C++"
helpviewer_keywords: 
  - "requisitos previos personalizados"
  - "implementar aplicaciones [Visual Studio], requisitos previos personalizados"
  - "implementar aplicaciones [Visual Studio], requisitos previos"
  - "requisitos previos, personalizados"
  - "RedistList (archivo)"
  - "lista redistribuible"
...
## Crear paquetes personalizados  
 Puede generar los manifiestos con el editor XML de Visual Studio. Para obtener más información, vea [Cómo: Crear un manifiesto de paquete](../deployment/how-to-create-a-package-manifest.md) y [Cómo: Crear un manifiesto de producto](../deployment/how-to-create-a-product-manifest.md). Para obtener un ejemplo de cómo crear un paquete de programa previo, vea [Tutorial: Crear un arranque personalizado para mostrar un aviso de privacidad](../deployment/walkthrough-creating-a-custom-bootstrapper-to-show-a-privacy-prompt.md).  
...
-   El manifiesto del paquete, package.xml, que contiene los metadatos específicos del idioma; normalmente, contiene mensajes de error localizados. Un componente debe tener al menos un manifiesto del paquete por cada versión localizada de ese componente.  
 ...
 Por último, copie los archivos redistribuibles en la ubicación de la carpeta del programa previo. Para obtener más información, consulta [Cómo: Crear un paquete de arranque localizado](../deployment/how-to-create-a-localized-bootstrapper-package.md).  
...
|[VersionNT](https://msdn.microsoft.com/en-us/library/aa372495\(v=vs.140\).xaspx)|Número de versión de los sistemas operativos Windows NT, Windows 2000, Windows XP, Windows Vista, Windows Server 2008 o Windows 7. La sintaxis de la versión es Principal.Secundaria.ServicePack.|  
...
## Separar los redistribuibles de las instalaciones de las aplicaciones  
