...
1. Elija **MVC** (.NET Framework) o **Aplicación web (controlador de vista de modelos)** (para .NET Core), asegúrese de que la opción **Sin autenticación** está seleccionada y haga clic en **Aceptar**.
