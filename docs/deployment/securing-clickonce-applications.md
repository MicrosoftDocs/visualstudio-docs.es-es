...
## <a name="deploying-obfuscated-assemblies"></a>Implementar ensamblados protegidos  
 Visual Studio incluye gratuitamente [protección preferente - Dotfuscator Community Edition](../ide/dotfuscator/index.md), que puede utilizar para proteger las aplicaciones ClickOnce a través de ocultación de código y las medidas de protección activa.  Para obtener más información, vea [la sección de ClickOnce de la Guía de usuario de Dotfuscator Community Edition](https://www.preemptive.com/dotfuscator/ce/docs/help/5.27/advanced_clickonce.html).
