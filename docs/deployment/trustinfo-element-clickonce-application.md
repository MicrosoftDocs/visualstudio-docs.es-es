...
dev_langs: 
  ...
  - "C++"
helpviewer_keywords: 
  - "manifiestos [ClickOnce], trustInfo (elemento)"
  - "<trustInfo> (elemento) [manifiesto de aplicación ClickOnce]"
...
## Comentarios  
 ...
 Para obtener más información sobre la elevación de permisos, consulte [Proteger las aplicaciones ClickOnce](../deployment/securing-clickonce-applications.md). Para obtener más información sobre la implementación de directivas, vea [Información general sobre la implementación de aplicaciones de confianza](../deployment/trusted-application-deployment-overview.md).  
