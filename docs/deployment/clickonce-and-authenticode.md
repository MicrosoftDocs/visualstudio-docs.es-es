...
- Genere su propio certificado con el cmdlet New-SelfSignedCertificate de PowerShell o mediante *MakeCert.exe*, que se incluye con [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)] .
