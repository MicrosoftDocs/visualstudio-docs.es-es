...
- Genere su propio certificado con el cmdlet New-SelfSignedCertificate de PowerShell o con *Makecert. exe*, que se incluye con el [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)].
...
- Cree un ensamblado de línea de comandos que actualice el certificado. En el [artículo de soporte técnico de Microsoft 925521](https://support.microsoft.com/help/925521)encontrará información detallada sobre este proceso.
