...
## <a name="ftp-protocol-nt-supported-for-installing-applications"></a>Nt admitido para la instalación de aplicaciones de protocolo FTP  
...
-   Si crea un tipo MIME con extensión "*" y el tipo MIME "application/octet-stream", permitirá que los archivos de tipo de archivo desbloqueado para descargarse. (Sin embargo, los archivos bloqueados como *.aspx* y *.asmx* no se puede descargar.)  
...
## <a name="content-type-mappings"></a>Asignaciones de tipo de contenido  
 ...
 Si implementa mediante un servidor IIS, ejecute *inetmgr.* exe y agregue un nuevo tipo de contenido de "application/x-ms-application" para el *.application* extensión.  
