...
description: Obtenga información sobre los requisitos previos de implementación de las aplicaciones, incluido el uso del cuadro de diálogo requisitos previos y los paquetes de arranque.
