...
1. Si previamente ha configurado ningún perfil de publicación, el **publicar** aparecerá el panel. Haga clic en **crear nuevo perfil**.
...
1. En el **importar archivo de configuración de publicación** cuadro de diálogo, vaya a y seleccione el perfil que creó en la sección anterior y haga clic en **abierto**.

    Visual Studio comienza el proceso de implementación y la ventana de salida muestra el progreso y los resultados.
