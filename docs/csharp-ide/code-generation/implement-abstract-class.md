---
title: "Implementar una clase abstracta: generación de código (C#) | Documentos de Microsoft"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="implement-an-abstract-class-in-c"></a>Implementar una clase abstracta en C# #
