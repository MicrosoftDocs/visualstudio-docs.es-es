---
title: "Introducir una variable local - generación de código (C#) | Documentos de Microsoft"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="introduce-a-local-variable-in-c"></a>Introducir una variable local en C# #
