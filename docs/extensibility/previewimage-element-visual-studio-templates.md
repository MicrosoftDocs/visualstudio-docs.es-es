---
title: Elemento PreviewImage (Plantillas de Visual Studio) Microsoft Docs
ms.date: 11/04/2016
...
---
# <a name="previewimage-element-visual-studio-templates"></a>Elemento PreviewImage (plantillas de Visual Studio)
