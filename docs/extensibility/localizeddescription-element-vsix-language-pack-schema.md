...
manager: "ghogen"
---
# Elemento LocalizedDescription (esquema del paquete de idioma VSIX)
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

Obligatorio. Proporciona una descripción traducida de la extensión.  
...
## Valor de texto  
 Obligatorio. Descripción de la extensión en el lenguaje de destino.  
