...
|Método|Descripción|  
|------------|-----------------|  
|[IOleCommandTarget](http://msdn.microsoft.com/library/windows/desktop/ms683797)|Interfaz OLE estándar. Se utiliza para controlar en el búfer de deshacer/rehacer.|  
