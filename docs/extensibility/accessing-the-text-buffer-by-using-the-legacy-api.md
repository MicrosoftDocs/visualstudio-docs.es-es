...
## <a name="one--and-two-dimension-coordinate-systems"></a>Dimensión de uno y dos sistemas de coordenadas
 ...
 ![Objeto de búfer de texto](../extensibility/media/vstextbuffer.gif "objeto vsTextBuffer") objeto de búfer de texto
...
- [Cambiar la configuración de la vista mediante el uso de la API heredada](../extensibility/changing-view-settings-by-using-the-legacy-api.md) se explica cómo cambiar la configuración de vista mediante la API heredada.

- [Use el Administrador de texto para supervisar la configuración global](../extensibility/using-the-text-manager-to-monitor-global-settings.md) explica cómo usar el Administrador de texto para supervisar la configuración global.
