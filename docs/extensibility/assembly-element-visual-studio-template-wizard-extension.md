...
titleSuffix: ''
description: Obtenga información sobre el elemento Assembly y cómo especifica el nombre o el nombre seguro del ensamblado que implementa la interfaz IWizard.
