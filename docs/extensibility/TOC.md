...
# [Crear la primera extensión: Hola a todos](extensibility-hello-world.md)
...
# [Cómo: extensiones de ida y vuelta para Visual Studio](how-to-roundtrip-VSIXs.md)
...
## [Ubicación de Visual Studio](locating-visual-studio.md)
