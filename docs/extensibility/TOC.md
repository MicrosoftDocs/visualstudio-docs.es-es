...
#[Abrir carpeta](open-folder.md)
##[Áreas de trabajo](workspaces.md)
##[Contextos de archivo](workspace-file-contexts.md)
##[Indexación](workspace-indexing.md)
##[Servicios de lenguaje](workspace-language-services.md)
##[Compilación](workspace-build.md)
