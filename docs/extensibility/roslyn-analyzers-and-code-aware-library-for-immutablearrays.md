...
## <a name="initalize-the-analyzer"></a>Inicializar el analizador
...
### <a name="launch-visual-studio-with-your-analyzer-the-first-time"></a>Inicie Visual Studio con el analizador de la primera vez
