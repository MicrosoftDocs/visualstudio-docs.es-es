...
```  
 ...
 Para más obtener ejemplo estas personalizaciones, consulte [Tutorial: crear una aplicación de Shell aislado básica](../extensibility/walkthrough-creating-a-basic-isolated-shell-application.md).  
...
|VsDbgCmdUsed.vsct|Tabla de comandos para el depurador.|  
 ...
 Para obtener más información, vea [diseñar la tabla de comandos de XML (. Archivos Vsct)](../extensibility/internals/designing-xml-command-table-dot-vsct-files.md) y [referencia del esquema XML de VSCT](../extensibility/vsct-xml-schema-reference.md).  
