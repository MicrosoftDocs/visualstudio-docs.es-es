...
|AppIcon|string|La ruta de acceso completa del icono del programa. Este icono aparece en la barra de título a la izquierda del nombre de aplicación.<br /><br /> El valor predeterminado es "$RootFolder$\\*nombresolución*.ico", donde *solutionName* es el nombre del archivo de solución de aplicación.|  
...
|AppName|string|El nombre de la aplicación. El nombre aparece en la barra de título de la ventana de la aplicación.<br /><br /> El valor predeterminado es el nombre del archivo de solución de aplicación.|  
...
|UserOptsFileExt|string|La extensión para los archivos de opciones de usuario de solución para la aplicación.<br /><br /> El valor predeterminado es el nombre del archivo de solución de aplicación.|  
...
|Name|Tipo|Valor|  
|----------|----------|-----------|  
|Nombre dll|string|El nombre de archivo del archivo DLL.<br /><br /> El valor predeterminado es "*nombresolución*ui.dll", donde *solutionName* es el nombre del archivo de solución de aplicación.|  
