...
description: Obtenga información sobre el elemento ProjectSubType y cómo clasifica la plantilla en una subcategoría del valor especificado en el elemento ProjectType.
