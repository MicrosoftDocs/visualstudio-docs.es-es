...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Cómo: registrar los eventos de búfer de texto con la API heredada](../extensibility/how-to-register-for-text-buffer-events-with-the-legacy-api.md)  
