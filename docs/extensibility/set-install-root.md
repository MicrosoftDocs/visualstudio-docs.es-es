...
![propiedades de la raíz de instalación](~/docs/extensibility/media/install-root-properties.png)
...
![subruta de conjunto](~/docs/extensibility/media/set-subpath.png)
