...
description: Obtenga información sobre el <element> elemento y cómo especifica la ruta de acceso al archivo. vstemplate de un proyecto en una plantilla de varios proyectos.
