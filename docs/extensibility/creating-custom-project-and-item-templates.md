...
1. Cree un proyecto de plantilla de proyecto. Para encontrar la plantilla de proyecto en el cuadro de diálogo **nuevo proyecto** , busque "plantilla de proyecto" y seleccione la versión de C# o Visual Basic.

     La plantilla genera un archivo de clase, un icono, un archivo *. vstemplate* , un archivo de proyecto editable llamado *ProjectTemplate. vbproj* o *ProjectTemplate. csproj*, y algunos archivos generados normalmente por otros tipos de proyectos, como un archivo *Resources. resx* , un archivo *AssemblyInfo* y un archivo *. Settings* . Cada archivo de código contiene sustituciones de parámetros comunes cuando sea necesario.
