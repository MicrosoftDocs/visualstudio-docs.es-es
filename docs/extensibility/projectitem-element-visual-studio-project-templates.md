...
description: Obtenga información sobre el elemento ProjectItem para plantillas de proyecto y cómo acepta distintos atributos dependiendo de si la plantilla es para un proyecto o un elemento.
