...
ms.locfileid: "48863925"
---
# <a name="add-a-submenu-to-a-menu"></a>Agregar un submenú a un menú
En este tutorial se basa en la demostración en [agregar un menú en la barra de menús de Visual Studio](../extensibility/adding-a-menu-to-the-visual-studio-menu-bar.md) mostrándole cómo agregar un submenú a la **TestMenu** menú.
...
1.  Siga los pasos de [agregar un menú en la barra de menús de Visual Studio](../extensibility/adding-a-menu-to-the-visual-studio-menu-bar.md) para crear el elemento de menú y el proyecto. Los pasos descritos en este tutorial se suponen que es el nombre del proyecto VSIX `TopLevelMenu`.
...
3.  Agregar submenú recién creado para el `<Menus>` sección.
    ...
    ```
     ...
     El par GUID/ID del elemento primario especifica el grupo de menús que se generó en [agregar un menú en la barra de menús de Visual Studio](../extensibility/adding-a-menu-to-the-visual-studio-menu-bar.md), y es un elemento secundario en el menú de nivel superior.
...
## <a name="see-also"></a>Vea también
 [Agregar un menú en la barra de menús de Visual Studio](../extensibility/adding-a-menu-to-the-visual-studio-menu-bar.md) [comandos, menús y barras de herramientas](../extensibility/internals/commands-menus-and-toolbars.md)
