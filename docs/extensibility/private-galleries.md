...
## Agregar una galería privada a extensiones y actualizaciones de Visual Studio  
 ...
 ![Cuadro de diálogo para agregar del Administrador de extensiones](~/docs/extensibility/media/em_adddialog.png "EM\_AddDialog")  
...
## Instalar extensiones desde una galería privada  
 ...
 ![Administrador de extensiones instalando una galería privada](~/docs/extensibility/media/em_.png "EM\_")  
...
## Actualizar extensiones desde una galería privada  
 ...
 ![Actualización de la galería privada del Administrador de extensiones](~/docs/extensibility/media/em_update.png "EM\_Update")  
