...
La herramienta editor de colores de extensión de Visual Studio puede crear y editar colores personalizados para Visual Studio. La herramienta también puede generar claves de recursos de tema para que los colores se puedan usar en el código. Esta herramienta es útil para crear colores para una extensión de Visual Studio que admita la realización de la conversión. Esta herramienta puede abrir archivos. pkgdef y. Xml. Los temas de Visual Studio (archivos. vstheme) se pueden usar con el editor de colores de extensión de Visual Studio cambiando la extensión de archivo a. Xml. Además, los archivos. vstheme se pueden importar en un archivo. XML actual.
 ...
 ![Héroe del editor de colores de VSIX](../../extensibility/internals/media/vsix-color-editor-hero.png "Héroe del editor de colores de VSIX")
...
5. Pruebe los cambios en Visual Studio.
   ...
   **Paso 1: Determine los nombres de categoría y token para los nuevos tokens de color.**
...
- ListItemDisabledBorder
  ...
  **Paso 3: Utilice el editor de colores para crear nuevos tokens de color.**
  ...
  ![Nuevo color del editor de colores de VSIX](../../extensibility/internals/media/vsix-color-editor-new-color.png "Nuevo color del editor de colores de VSIX")
  ...
  ![Nueva categoría del editor de colores de VSIX](../../extensibility/internals/media/vsix-color-editor-new-category.png "Nueva categoría del editor de colores de VSIX")
  ...
  ![Color del editor de colores de VSIX nuevo relleno](../../extensibility/internals/media/vsix-color-editor-new-color-filled.png "Color del editor de colores de VSIX nuevo relleno")
  ...
  ![Fondo del editor de colores de VSIX](../../extensibility/internals/media/vsix-color-editor-background.png "Fondo del editor de colores de VSIX")
  ...
  Al especificar valores para contraste alto, escriba los nombres de colores del sistema Windows válidos. No escriba valores ARGB codificados. Para ver una lista de nombres de colores del sistema válidos, seleccione "background: "O" Foreground: Sistema "de los menús desplegables de valores de color. Al crear elementos que tienen componentes de texto, use el par de colores de fondo y de texto del sistema de texto correctos, o bien el texto podría ser ilegible.
  ...
  **Paso 4: Use los colores en una extensión de Visual Studio.**
  ...
  ![Editor de colores de VSIX pkgdef](../../extensibility/internals/media/vsix-color-editor-pkgdef.png "Editor de colores de VSIX pkgdef")
  ...
  ![Visor de código de recursos del editor de colores de VSIX](../../extensibility/internals/media/vsix-color-editor-resource-code-viewer.png "Visor de código de recursos del editor de colores de VSIX")

  Incluya este código en una clase estática del proyecto. Referencia a **Microsoft. VisualStudio.\< Shell. VSVersion >,0. dll** debe agregarse al proyecto para que use el tipo **ThemeResourceKey** .
 ...
 **Paso 5: Pruebe los cambios en Visual Studio.**
 ...
 Se ![aplica el editor de colores de VSIX] Se (../../extensibility/internals/media/vsix-color-editor-apply.png "aplica el editor de colores de VSIX")
