...
>  Enlace distingue mayúsculas de minúsculas.  
 ...
 ![Varias configuraciones](~/docs/extensibility/internals/media/vsmultiplecfgs.gif "vsMultipleCfgs")  
Varias configuraciones  
 ...
 ![Dependencias del proyecto](~/docs/extensibility/internals/media/vsprojdependencies.gif "vsProjDependencies")  
