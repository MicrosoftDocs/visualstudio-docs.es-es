...
> [!NOTE]
> Las barras de herramientas `guidSHLMainMenu`y los grupos usan el GUID , excepto cuando se especifique lo contrario mediante la sintaxis GUID:ID . Cuando se especifica un GUID para una barra de herramientas, también se aplica a los grupos que descienden de esa barra de herramientas.
...
- [Añadir una barra de herramientas a una ventana de herramientas](../../extensibility/adding-a-toolbar-to-a-tool-window.md)
- [GUID e iDs de los menús de Visual Studio](../../extensibility/internals/guids-and-ids-of-visual-studio-menus.md)
