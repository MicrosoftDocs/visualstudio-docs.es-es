...
## <a name="command-menu-access"></a>Acceso al menú de comandos
 En los casos de prueba se usa la siguiente ruta de acceso del menú del entorno de desarrollo integrado de [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)].
