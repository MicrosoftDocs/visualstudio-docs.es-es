...
description: Obtenga información sobre el registro de un servicio de lenguaje heredado de un VSPackage con Visual Studio mediante la adición de entradas y claves del registro.
