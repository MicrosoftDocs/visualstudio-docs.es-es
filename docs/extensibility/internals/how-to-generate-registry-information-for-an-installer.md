...
description: Aprenda a usar la utilidad de RegPkg.exe en Visual Studio para generar información del registro de VSPackage para la incorporación en un paquete de instalación de Windows Installer.
