---
title: "Incluye&amp;2; del servicio de lenguaje heredado | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
ms.topic: "article"
helpviewer_keywords: 
  - "editores [Visual Studio SDK], ayudas de desarrollo de código"
...
## En esta sección  
 ...
 [Formato de un servicio de lenguaje heredado automático](../../extensibility/internals/automatic-formatting-in-a-legacy-language-service.md)  
 ...
 [Esquematización y ocultado el texto de un servicio de lenguaje heredado](../../extensibility/internals/outlining-and-hidden-text-in-a-legacy-language-service.md)  
 Explica cómo implementar el texto oculto o esquema.  
