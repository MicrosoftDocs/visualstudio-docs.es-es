...
**Botón cerrar de la barra de &times; Estado (): estado predeterminado**
...
**Botón cerrar de la barra de &times; Estado (): estado de desplazamiento**

![Botón cerrar de la barra &times; de desplazamiento () al mantener el mouse](../../extensibility/ux-guidelines/media/0303_InfobarCloseHover.png "0303_InfobarCloseHover.png")<br />Botón cerrar de la barra &times; de desplazamiento () al mantener el mouse
...
**Botón cerrar de la barra de &times; Estado (): estado presionado**

![Botón cerrar de la barra de la barra de despresionar ( &times; )](../../extensibility/ux-guidelines/media/0303_InfobarClosePressed.png "0303_InfobarClosePressed.png")<br />Botón cerrar de la barra de la barra de despresionar ( &times; )
...
![Botón de acción de búsqueda enfocado](../../extensibility/ux-guidelines/media/0303-112_searchactionbuttonfocused.png "0303-112_SearchActionButtonFocused")<br />Botón de acción de búsqueda enfocada
...
![Menú al mantener el mouse](../../extensibility/ux-guidelines/media/0303-013_menuhover.png "0303-013_MenuHover")<br />Elemento de menú al mantener el mouse

![Menú activado al mantener el mouse](../../extensibility/ux-guidelines/media/0303-014_menuhoverchecked.png "0303-014_MenuHoverChecked")<br />Elemento de menú activado al mantener el mouse

![Menú seleccionado al mantener el mouse](../../extensibility/ux-guidelines/media/0303-015_menuhoverselected.png "0303-015_MenuHoverSelected")<br />Elemento de menú seleccionado al mantener el mouse
...
![Límite de barra de comandos](../../extensibility/ux-guidelines/media/0303-018_commandbarredline.png "0303-018_CommandBarRedline")<br />Barra de comandos (barra de comandos)

![Límite de botón de desbordamiento](../../extensibility/ux-guidelines/media/0303-019_overflowbuttonredline.png "0303-019_OverflowButtonRedline")<br />Botón de desbordamiento (roja)
...
![Límite de grupo de la barra de comandos](../../extensibility/ux-guidelines/media/0303-020_commandbargroupredline.png "0303-020_CommandBarGroupRedline")<br />Grupo de la barra de comandos (barra roja)
...
![Límite de icono de comando](../../extensibility/ux-guidelines/media/0303-021_commandiconredline1.png "0303-021_CommandIconRedline1")<br />Icono de comando (fotomando)
...
![Botón desplegable de&#45;de cuadro combinado](../../extensibility/ux-guidelines/media/0303-031_comboboxdropdownbutton.png "0303-031_ComboBoxDropdownButton")<br />Botón desplegable de la barra de comandos
...
#### <a name="command-bar-drop-downs"></a><a name="BKMK_CommandDropDown"></a> Desplegables de la barra de comandos
...
![Quitar&#45;campo de selección hacia abajo presionado](../../extensibility/ux-guidelines/media/0303-049_dropdownselectionfieldpressed.png "0303-049_DropdownSelectionFieldPressed")<br />Campo de selección desplegable de la barra de comandos presionado
...
![Límite de botón de expansión](../../extensibility/ux-guidelines/media/0303-053_splitbuttonredline.png "0303-053_SplitButtonRedline")<br />Botón de expansión de la barra de comandos (barra roja)
...
#### <a name="close-times-tag-glyph"></a>Glifo de &times; etiqueta Close ()
...
**Glifo de &times; etiqueta Close (): estado de desplazamiento**

![Cerrar el &times; glifo de etiqueta al mantener el mouse](../../extensibility/ux-guidelines/media/0303-182_tagglyphhover.png "0303-182_TagGlyphHover")<br />Cerrar el &times; glifo de etiqueta al mantener el mouse
...
**Glifo de &times; etiqueta Close (): estado presionado**

![Se presionó el glifo de etiqueta Close ( &times; )](../../extensibility/ux-guidelines/media/0303-183_tagglyphpressed.png "0303-183_TagGlyphPressed")<br />Se presionó el glifo de etiqueta Close ( &times; )
...
**Etiqueta seleccionada con el glifo de Close ( &times; ): estado predeterminado**
...
**Etiqueta seleccionada con el glifo Close ( &times; ): estado de desplazamiento**

![Etiqueta seleccionada con el &times; glifo de cierre () al mantener el mouse](../../extensibility/ux-guidelines/media/0303-185_tagselectedhover.png "0303-185_TagSelectedHover")<br />Etiqueta seleccionada con el &times; glifo de cierre () al mantener el mouse
...
**Etiqueta seleccionada con el glifo cerrar ( &times; ): estado presionado**
