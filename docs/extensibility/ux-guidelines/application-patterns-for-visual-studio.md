...
- Use las ventanas de herramientas existentes apropiadas para tareas y no cree nuevas con una funcionalidad similar. Las nuevas ventanas de herramientas solo deben crearse si ofrecen una "herramienta" o una funcionalidad que no se pueden integrar en una ventana similar, o si se convierte una ventana existente en un centro de dinamización.
...
![Concepto de vestíbulo para exponer una interfaz de usuario adicional en Outlook](../../extensibility/ux-guidelines/media/0704-08_hallway.png "0704-08_Hallway")<br />Concepto de vestíbulo para exponer una interfaz de usuario adicional en Outlook
