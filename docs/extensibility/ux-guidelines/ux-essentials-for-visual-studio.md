...
- La resolución mínima para Visual Studio 2015 es **1280 x 720**. Esto significa que es *posible* a usar Visual Studio con esta resolución, aunque quizás no sea una experiencia de usuario óptima. No hay ninguna garantía de que todos los aspectos podrá utilizarse con resoluciones inferiores a 1280 x 720.
...
Es una mejor solución a este problema:
...
El diseño correcto para esta situación es seguir el patrón común para Internet Explorer, Office y Visual Studio: al mantener el mouse, el usuario puede ver la descripción de la información sobre herramientas y un solo clic oculta la interfaz de usuario.
...
**La mejor solución:** Suponer la pregunta al usuario haría que se esté preguntando si hace clic en el vínculo. Por ejemplo:
