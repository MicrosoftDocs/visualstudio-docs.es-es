...
> [!NOTE]
>  Yoou puede encontrar el código de registro de ejemplo de código MyCEE en el archivo *dllentry.cpp*, que se encuentra en la instalación de VSIP bajo EnVSDK\MyCPkgs\MyCEE.  
