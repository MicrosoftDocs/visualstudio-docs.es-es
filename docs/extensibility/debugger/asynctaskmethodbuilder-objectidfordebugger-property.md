---
title: Propiedad AsyncTaskMethodBuilder.ObjectIdForDebugger | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: ObjectForDebugger property, AsyncTaskMethodBuilder structure [.NET Framework debug engines]
...
manager: ghogen
ms.workload: vssdk
ms.openlocfilehash: 91d08d66850c684f3601dd6694f803474dc0e1cf
...
Obtiene un objeto que puede utilizarse para identificar de forma exclusiva este generador para el depurador.  
