...
`dwPassCount` El número de veces que se sitúe sobre el punto de interrupción antes de activar.

`stylePassCount` Un valor de la [BP_PASSCOUNT_STYLE](../../../extensibility/debugger/reference/bp-passcount-style.md) recuento de pasos de la enumeración que especifica el estilo del punto de interrupción.
