---
title: IEnumDebugPrograms2::Next | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>Parámetros  
 ...
 `rgelt`  
 [entrada, salida] Matriz de [IDebugProgram2](../../../extensibility/debugger/reference/idebugprogram2.md) elementos que deben rellenarse.  
