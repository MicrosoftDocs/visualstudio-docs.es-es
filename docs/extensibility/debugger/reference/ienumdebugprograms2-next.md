---
description: Devuelve el siguiente conjunto de elementos de la enumeración programs.
...
`rgelt`\
[in, out] Matriz de elementos [IDebugProgram2](../../../extensibility/debugger/reference/idebugprogram2.md) que se va a rellenar.
