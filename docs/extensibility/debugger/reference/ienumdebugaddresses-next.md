---
title: IEnumDebugAddresses::Siguiente ? Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[adentro, fuera] Matriz de [IDebugAddress](../../../extensibility/debugger/reference/idebugaddress.md) elementos que se van a rellenar.
