---
title: IEnumDebugAddresses::Next | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
#### <a name="parameters"></a>Parámetros  
 ...
 `rgelt`  
 [entrada, salida] Matriz de [IDebugAddress](../../../extensibility/debugger/reference/idebugaddress.md) elementos que deben rellenarse.  
