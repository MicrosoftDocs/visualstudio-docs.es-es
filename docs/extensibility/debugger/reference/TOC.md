# [Referencia (API de depuración de Visual Studio)](reference-visual-studio-debugging-apis.md)
## [Referencia de API (depuración de Visual Studio)](api-reference-visual-studio-debugging.md)
### [Interfaces (depuración de Visual Studio)](interfaces-visual-studio-debugging.md)
...
###### [IDebugSymbolProviderDirect::GetMetaDataImport](idebugsymbolproviderdirect-getmethodfromaddress.md)
...
### [Enumeraciones (depuración de Visual Studio)](enumerations-visual-studio-debugging.md)
