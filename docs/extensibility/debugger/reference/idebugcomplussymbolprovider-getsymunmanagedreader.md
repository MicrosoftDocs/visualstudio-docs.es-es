---
description: Recupera el lector de símbolos que va a usar el código no administrado.
...
enuncia Devuelve el objeto que representa el lector de símbolos.
