...
## <a name="remarks"></a>Observaciones
 Las matrices (contenedores para variables), las clases (contenedores para métodos y variables) y los métodos (contenedores para parámetros y variables locales) son todos ejemplos de contenedores.
