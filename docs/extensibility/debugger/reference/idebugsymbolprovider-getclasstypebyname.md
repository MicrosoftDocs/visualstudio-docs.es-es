...
#### <a name="parameters"></a>Parámetros  
 ...
 `ppField`  
 [out] Devuelve el tipo de clase, tal como está representado por la [IDebugClassField](../../../extensibility/debugger/reference/idebugclassfield.md) interfaz.  
