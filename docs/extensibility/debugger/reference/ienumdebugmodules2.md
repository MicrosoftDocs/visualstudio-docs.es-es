...
## <a name="methods-in-vtable-order"></a>Métodos en orden de Vtable
 En la tabla siguiente `IEnumDebugModules2`se muestran los métodos de .
...
## <a name="remarks"></a>Observaciones
 ...
 Para fines de depuración en Visual Studio, un programa es una secuencia lógica de instrucciones de código que pueden cruzar los límites del módulo, por lo tanto, la necesidad de una lista de módulos para una sola interfaz [IDebugProgram2.](../../../extensibility/debugger/reference/idebugprogram2.md) El primer módulo de la lista normalmente contiene el punto de entrada inicial para el programa asociado.
