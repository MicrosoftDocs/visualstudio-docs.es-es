---
title: IEnumDebugThreads2::Siguiente Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[adentro, fuera] Matriz de [IDebugThread2](../../../extensibility/debugger/reference/idebugthread2.md) elementos que se rellenarán.
