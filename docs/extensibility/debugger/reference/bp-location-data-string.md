...
`bstrDataExpr` La cadena de datos que escribe el usuario para el punto de interrupción.

`dwNumElements` El número de elementos en la cadena de datos en el que se produce el punto de interrupción.
