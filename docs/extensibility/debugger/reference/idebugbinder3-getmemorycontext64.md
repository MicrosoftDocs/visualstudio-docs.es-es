...
`uConstant`\
[en] Una dirección de memoria de 64 bits, como 0x50000000.
...
En los ejemplos siguientes se crea un objeto que implementa el [IDebugBinder3](../../../extensibility/debugger/reference/idebugbinder3.md) interfaz y utiliza este método para recuperar el contexto de memoria.
