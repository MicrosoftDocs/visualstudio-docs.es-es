---
title: IEnumDebugCustomAttributes::Siguiente ? Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[fuera] Matriz de [IDebugCustomAttribute](../../../extensibility/debugger/reference/idebugcustomattribute.md) objetos que se van a rellenar.
