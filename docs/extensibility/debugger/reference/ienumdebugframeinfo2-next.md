---
title: IEnumDebugFrameInfo2::Next | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
#### <a name="parameters"></a>Parámetros  
 ...
 `rgelt`  
 [entrada, salida] Matriz de [FRAMEINFO](../../../extensibility/debugger/reference/frameinfo.md) elementos que deben rellenarse.  
