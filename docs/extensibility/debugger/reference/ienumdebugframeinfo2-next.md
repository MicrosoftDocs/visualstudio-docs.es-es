---
title: IEnumDebugFrameInfo2::Siguiente Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
[adentro, fuera] Matriz de elementos [FRAMEINFO](../../../extensibility/debugger/reference/frameinfo.md) que se van a rellenar.
