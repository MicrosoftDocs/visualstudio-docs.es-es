---
title: BP_STATE de la casa de la casa de Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- BP_STATE
...
Se devuelve desde el [GetState](../../../extensibility/debugger/reference/idebugboundbreakpoint2-getstate.md) método.
