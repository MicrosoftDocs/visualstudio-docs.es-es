...
## <a name="notes-for-callers"></a>Notas para las personas que llaman
 Esta interfaz es una especialización de la [IDebugObject](../../../extensibility/debugger/reference/idebugobject.md) `IDebugObject` interfaz y se obtiene mediante [QueryInterface](/cpp/atl/queryinterface) en la interfaz.
...
## <a name="remarks"></a>Observaciones
 Esta interfaz permite al evaluador de expresiones representar funciones en un árbol de análisis. Los `Create` métodos de esta interfaz se utilizan para construir objetos que representan los parámetros de entrada para el método. A continuación, la función se puede ejecutar llamando al método [Evaluate,](../../../extensibility/debugger/reference/idebugfunctionobject-evaluate.md) que devuelve un objeto que representa el valor devuelto de la función.
