---
title: IEnumDebugFields::Next | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>Parámetros  
 ...
 `rgelt`  
 [entrada, salida] Matriz de [IDebugField](../../../extensibility/debugger/reference/idebugfield.md) elementos que deben rellenarse.  
