---
description: Habilita o deshabilita el punto de interrupción.
...
`fEnable`\
de Se establece en un valor distinto de cero ( `TRUE` ) para habilitar o en cero ( `FALSE` ) para deshabilitar el punto de interrupción.
