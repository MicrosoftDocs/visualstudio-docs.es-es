---
description: Recupera las clases con el atributo especificado que se implementan en el lenguaje de programación especificado.
...
`guidLanguage`\
de Identificador único para el lenguaje.

`pstrAttribute`\
de Cadena de atributo.

`ppEnum`\
enuncia Devuelve una enumeración de las clases de atributos.
