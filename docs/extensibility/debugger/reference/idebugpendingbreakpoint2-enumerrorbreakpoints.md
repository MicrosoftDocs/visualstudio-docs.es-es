...
ms.author: gregvanl
manager: ghogen
ms.openlocfilehash: 7d82cd464cbd3d325fc688a7add0f501223fd3eb
...
#### <a name="parameters"></a>Parámetros  
 `bpErrorType`  
 [in] Una combinación de valores de la [BP_ERROR_TYPE](../../../extensibility/debugger/reference/bp-error-type.md) enumeración que selecciona el tipo de errores para enumerar.  
