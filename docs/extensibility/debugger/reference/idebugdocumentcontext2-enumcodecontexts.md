...
## <a name="remarks"></a>Comentarios  
 Un contexto de único documento puede generar varios contextos de código cuando el documento utiliza plantillas o archivos de inclusión.  
