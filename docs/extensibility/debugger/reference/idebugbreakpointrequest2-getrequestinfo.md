...
Obtiene la información de la solicitud de punto de interrupción que describe la solicitud de punto de interrupción.  
...
#### Parámetros  
 `dwFields`  
 \[in\]  Una combinación de marcadores de enumeración de [BPREQI\_FIELDS](../../../extensibility/debugger/reference/bpreqi-fields.md) que determina qué campos en el parámetro de `pBPRequestInfo` se deben completar.  
  
 `pBPRequestInfo`  
 \[out\]  Especifica la estructura de [BP\_REQUEST\_INFO](../../../extensibility/debugger/reference/bp-request-info.md) que se completará con la descripción de la solicitud de punto de interrupción.  
