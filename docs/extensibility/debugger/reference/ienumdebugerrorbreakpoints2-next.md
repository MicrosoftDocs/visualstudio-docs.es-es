...
#### <a name="parameters"></a>Parámetros  
 ...
 `rgelt`  
 [entrada, salida] Matriz de [IDebugErrorBreakpoint2](../../../extensibility/debugger/reference/idebugerrorbreakpoint2.md) elementos que deben rellenarse.  
