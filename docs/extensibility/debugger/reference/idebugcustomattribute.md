...
## <a name="methods-in-vtable-order"></a>Métodos en orden de Vtable
 En la tabla siguiente `IDebugCustomAttribute`se muestran los métodos de .
...
## <a name="remarks"></a>Observaciones
 Un atributo personalizado es una estructura para C- que proporciona metadatos personalizados asociados a una clase o método determinado.
