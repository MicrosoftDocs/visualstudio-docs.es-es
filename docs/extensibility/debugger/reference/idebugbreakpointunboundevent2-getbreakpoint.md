...
Obtiene el punto de interrupción que se desató.
...
`ppBP`\
[fuera] Devuelve un [IDebugBoundBreakpoint2](../../../extensibility/debugger/reference/idebugboundbreakpoint2.md) objeto que representa el punto de interrupción que se convirtió en unbound.
