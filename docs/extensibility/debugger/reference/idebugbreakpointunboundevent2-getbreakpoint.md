...
ms.locfileid: "31106924"
---
# <a name="idebugbreakpointunboundevent2getbreakpoint"></a>IDebugBreakpointUnboundEvent2::GetBreakpoint
Obtiene el punto de interrupción que se desvinculó.  
...
#### <a name="parameters"></a>Parámetros  
 `ppBP`  
 [out] Devuelve un [IDebugBoundBreakpoint2](../../../extensibility/debugger/reference/idebugboundbreakpoint2.md) objeto que representa el punto de interrupción que se desvinculó.  
