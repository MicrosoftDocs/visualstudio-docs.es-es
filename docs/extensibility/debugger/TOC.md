...
# [Ejemplos de depuración de Visual Studio](visual-studio-debugging-samples.md)
...
### [Evaluación de expresiones (SDK de depuración de Visual Studio)](expression-evaluation-visual-studio-debugging-sdk.md)
### [Eventos de control](control-events.md)
## [Envío de eventos](sending-events.md)
### [Orígenes de eventos (Visual Studio SDK)](event-sources-visual-studio-sdk.md)
...
### [Control de excepciones (Visual Studio SDK)](exception-handling-visual-studio-sdk.md)
## [Depuración de un motor de depuración personalizado](how-to-debug-a-custom-debug-engine.md)
# [Introducción a la extensibilidad del depurador](getting-started-with-debugger-extensibility.md)
...
### [Servidores (Visual Studio SDK)](servers-visual-studio-sdk.md)
...
### [Módulos](modules.md)
### [Puntos de interrupción (Visual Studio SDK)](breakpoints-visual-studio-sdk.md)
...
# [Escritura de un evaluador de expresiones de Common Language Runtime](writing-a-common-language-runtime-expression-evaluator.md)
...
## [Clase de tarea: miembros internos](task-class-internal-members.md)
...
## [TaskScheduler Class: miembros internos](taskscheduler-class-internal-members.md)
...
## [ContingentProperties Class: miembros internos](contingentproperties-class-internal-members.md)
### [m_children (Campo)](m-children-field.md)
## [AsyncTaskMethodBuilder Structure: miembros internos](asynctaskmethodbuilder-structure-internal-members.md)
### [AsyncTaskMethodBuilder.ObjectIdForDebugger (Propiedad)](asynctaskmethodbuilder-objectidfordebugger-property.md)
### [AsyncTaskMethodBuilder.m_builder (Campo)](asynctaskmethodbuilder-m-builder-field.md)
## Estructura [AsyncTaskMethodBuilder<TResult>: miembros internos](asynctaskmethodbuilder-tresult-structure-internal-members.md)
### [AsyncTaskMethodBuilder<TResult>.ObjectIdForDebugger (Propiedad)](asynctaskmethodbuilder-tresult-objectidfordebugger-property.md)
### [AsyncTaskMethodBuilder<TResult>.m_task (Campo)](asynctaskmethodbuilder-tresult-m-task-field.md)
## [AsyncVoidMethodBuilder Structure: miembros internos](asyncvoidmethodbuilder-structure-internal-members.md)
### [AsyncVoidMethodBuilder.ObjectIdForDebugger (Propiedad)](asyncvoidmethodbuilder-objectidfordebugger-property.md)
### [AsyncVoidMethodBuilder.m_objectIdForDebugger (Campo)](asyncvoidmethodbuilder-m-objectidfordebugger-field.md)
