---
title: "Paquete de GUID de características de Visual Studio | Documentos de Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Puede utilizar el siguientes GUID en el archivo .pkgundef de la aplicación de shell aislado para excluir los paquetes específicos de la aplicación.  
  
## <a name="package-guids"></a>GUID del paquete  
  
|Área de características|Nombre del paquete sin procesar|GUID del paquete|  
|------------------|----------------------|------------------|  
|Núcleo IDE|Paquete de deshacer|{1D76B2E0-F11B-11D2-AFC3-00105A9991EF}|  
...
||Paquete común de IDE de Visual Studio|{6E87CFAD-6C05-4ADF-9CD7-3B7943875B7C}|  
...
|Ayuda|Visual Studio Help Package|{4A791146-19E4-11D3-B86B-00C04F79F802}|  
|Lista de tareas, lista de errores|ErrorListPackage|{4A9B7E50-AA16-11D0-A8C5-00A0C921A4D2}|  
|Esquema de clases|Class Outline Package|{21AF45B0-FFA5 -&11;D&0;-G63F-00A0C922E851}|  
...
|Editor de HTML|Visual Studio HTM Editor Package|{1B437D20-F8FE-11D2-A6AE-00104BCC7269}|  
||Visual Web Developer HTML Source Editor Package|{BFCC0C3C-6F87-4285-A6C8-BB616061800D}|  
|Editor CSS|Visual Studio CSS Editing Package|{A764E895-518D-11d2-9A89-00C04F79EFC3}|  
|Editor XML|Visual Studio XML Editor Package|{87569308-4813-40A0-9CD0-D7A30838CA3F}|  
|Explorador web|Visual Studio Web Browser Package|{E8B06F41-6D01-11D2-AA7D-00C04F990343}|  
||Generador de proyecto aplicación Web, para ver en la funcionalidad de explorador|{349C5851-65DF-11DA-9384-00065B846F21}|  
|Editor binario|Visual Studio Binary Editor Package|{5B98C2C0-CD7B-11D0-92DF-00A0C9138C45}|  
|Diseñador de Windows Forms|Paquete de alojamiento Diseñador de Windows Forms|{68939055-38E0-4D17-92CB-8909710D8178}|  
...
|Herramientas para bases de datos|Visual Database Tools Package|{220A4C17-7E7C-4663-BBCC-5E607C6543CD}|  
...
|Soporte de SourceSafe|Visual SourceSafe Provider Package|{AA8EB8CD-7A51-11D0-92C3-00A0C9138C45}|  
...
|Fragmentos de código|Visual Studio Code Snippets Package|{0B680757-2C29-4531-80FA-535A5178AA98}|  
|Compatibilidad con proyecto de lenguaje administrado|Enumerador de componente de Visual Studio|{588205E0-66e0-11D3-8600-00C04F6123B3}|  
||Visual Studio Settings and Project Designers Package|{67909B06-91E9-4F3E-AB50-495046BE9A9A}|  
|Exportar plantilla...|Export Template Package|{F1E4CFCA-4573-4345-8718-7BDE2b1F0BE8}|  
  
 Algunos paquetes nunca deben quitarse porque muchas otras características tienen dependencias en ellos. Por ejemplo, nunca se deben quitar los que aparecen bajo "IDE principal".  
  
 Algunas características no se puede quitar completamente. Por ejemplo, no hay ningún paquete que puede eliminarse para quitar **la vista de clases** y sus menús asociados, opciones y los servicios. El **la vista de clases** ventana proporciona el paquete de entorno de Visual Studio, que también proporciona otras características claves del IDE. Si desea quitar **la vista de clases**, también tendrá que quitar **buscar y reemplazar**, el entorno de **opciones** páginas, el **ventana de comandos**y el **salida** ventana.
