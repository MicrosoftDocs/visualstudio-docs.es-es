...
## <a name="prerequisites"></a>Requisitos previos  
 ...
 También debe descargar el código fuente para el [Managed Package Framework para proyectos](http://mpfproj12.codeplex.com/). Extraiga el archivo en una ubicación que sea accesible a la solución que se va a crear.  
...
2.  Copia el *AssemblyInfo.cs* de archivos desde el *propiedades* carpeta a la *Projects\SimpleProject* carpeta.  
...
4.  Reemplace el contenido existente con las siguientes líneas.  
...
6.  En el **propiedades** ventana, establezca el **acción de compilación** de *AssemblyInfo.cs*, *Program.cs*, *SimpleProject.ico* , y *SimpleProject.myproj* a **contenido**y establezca sus **incluir en VSIX** propiedades a **True**.  
...
5.  Agregue un atributo GUID a la `SimpleProjectFactory` clase. El valor del atributo es el generador de proyectos nuevos GUID.  
