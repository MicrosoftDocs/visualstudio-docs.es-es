...
4. Agregue un atributo GUID a la clase `SimpleProjectFactory`. El valor del atributo es el nuevo GUID del generador de proyectos.
...
1. En el archivo *SimpleProjectPackage.CS* , agregue la siguiente directiva de `using`.
...
5. En *SimpleProjectFactory.CS*, agregue la siguiente directiva de `using` después de las directivas de `using` existentes.
...
1. En el archivo *SimpleProjectFactory.CS* , agregue la siguiente directiva de `using`:
...
4. En *SimpleProjectNode.CS*, agregue las siguientes directivas de `using`:
...
1. En el archivo *SimpleProjectNode.CS* , agregue la siguiente directiva de `using`.
