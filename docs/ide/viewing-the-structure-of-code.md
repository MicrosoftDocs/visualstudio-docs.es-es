...
Puede examinar los objetos y miembros de proyectos de Visual Studio, componentes de .NET Framework, componentes de COM, bibliotecas de vínculos dinámicos (DLL) y bibliotecas de tipo (TLB).
