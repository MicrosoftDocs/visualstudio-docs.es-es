...
manager: "ghogen"
---
# Sugerencias y trucos de Visual Studio
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

Puede navegar en [!INCLUDE[vs_dev12](../data-tools/includes/vs_dev12_md.md)] más fácilmente con los accesos directos que se muestran en este tema.  Para obtener más información general, vea [Métodos abreviados de teclado de Visual Studio](http://msdn.microsoft.com/es-es/2e15e27f-296b-4e9c-91e6-d91ea0110a67).  Para obtener información sobre cómo optimizar Visual Studio para la accesibilidad, vea [Sugerencias y trucos de accesibilidad](../ide/reference/accessibility-tips-and-tricks.md).  
...
|Detener la depuración|Mayús\+F5|  
...
##  <a name="BKMK_ALM"></a> Administración del ciclo de vida de las aplicaciones  
 Vea [Métodos abreviados de teclado: Visual Studio Online, portal web de TFS y Team Explorer](http://msdn.microsoft.com/es-es/35ea128b-7565-4ee3-8266-b9f0d32aecf4).  
  
## Vea también  
 [Blog de Visual Studio](http://blogs.msdn.com/b/visualstudio)   
 [Blog de sugerencias y trucos de Visual Studio](http://blogs.msdn.com/b/zainnab)   
 [Cuadro de herramientas de Visual Studio en Channel 9](http://channel9.msdn.com/Shows/Visual-Studio-Toolbox)   
 [Visual Studio UserVoice](http://visualstudio.uservoice.com/forums/121579-visual-studio)   
 [Errores de Visual Studio en Connect](http://connect.microsoft.com/VisualStudio)