...
Gravedad | Efecto
------------ | -------------
none/silent | Cuando no se sigue este estilo, no se muestra nada al usuario, pero las características de generación de código se generan en este estilo. 
...
- **[Configuración del estilo de código CSharp](#csharp_codestyle)**
    ...
    - [Preferencias del bloque de código](#code_block)
        - [Preferir llaves](#prefer_braces)

## <a name="this_and_me">Cualificación "This." y "Me."</a>
### <a name="this_and_me_fields">Campos (IDE0003/IDE0009)</a>
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
...
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
|`dotnet_style_predefined_type_for_locals_parameters_members`| C# y Visual Basic | true:none | Visual Studio 2017 RTW |
...
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
|`dotnet_style_predefined_type_for_member_access`| C# y Visual Basic | true:none | Visual Studio 2017 RTW |
...
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
|`dotnet_style_object_initializer`| C# y Visual Basic | true:suggestion | Visual Studio 2017 RTW |
...
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
|`dotnet_style_collection_initializer`| C# y Visual Basic | true:suggestion | Visual Studio 2017 RTW |
...
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
|`dotnet_style_explicit_tuple_names`| C# 7.0+ y Visual Basic 15+ | true:suggestion | Visual Studio 2017 RTW |
...
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
|`dotnet_style_coalesce_expression`| C# y Visual Basic | true:suggestion | Visual Studio 2017 RTW |
...
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
|`dotnet_style_null_propagation`| C# 6.0+ y Visual Basic 14+ | true:suggestion | Visual Studio 2017 RTW |
...
| Valor | Descripción | Aplicado 
| ------------- |:-------------|:-------------|
| True | Se prefiere el uso de expresiones `throw` en lugar de instrucciones `throw`. | **C#:** <br>`this.s = ss ?? throw new ArgumentNullException(nameof(s));`
| False | Se prefiere el uso de instrucciones `throw` en lugar de expresiones `throw`.| **C#:** <br>`if (s==null) {throw new ArgumentNullException(nameof(s));} this.s = s;`
...
| False | Se prefiere realizar una comprobación de NULL antes de invocar a Lambda en lugar de usar el operador de fusión condicional (`?.`).| **C#:** <br>`if (func!=null) { func(args); }`
...
## <a name="code_block">Preferencias del bloque de código</a>
### <a name="prefer_braces">Preferir llaves (IDE0011)</a>
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
...
| Valor | Descripción | Aplicado 
| ------------- |:-------------|:-------------|
| True | Preferir llaves | **C#:** <br>`if (test) { this.Display(); }`
| False | Preferir no usar llaves cuando sea posible | **C#:** <br>`if (test) this.Display();`
...
En las opciones de formato debe especificar **true** (opción preferida) o **false** (opción no preferida), excepto en un par de los casos en los que debe especificar las condiciones que quiera aplicar a la regla.
...
- **[Configuración de formato de C#](#newline)**
    - [Opciones de nueva línea](#newline)
        ...
        - [Nueva línea antes de los miembros en inicializadores de objetos](#newline_before_object)
    ...
    - [Opciones de sangría](#indent)
        ...
        - [Aplicar sangría a etiquetas `switch`](#indent_switch_labels)
...
### <a name="newline_before_object">Nueva línea antes de los miembros en inicializadores de objetos</a>
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
...
### <a name="indent_switch_labels">Aplicar sangría a etiquetas `switch`</a>
| **Nombre de la opción** | **Lenguajes aplicables** | **Valor predeterminado de Visual Studio** | **Versión compatible** |
| ----------- | -------------------- | ----------------------| ----------------  |
...
| Valor | Descripción 
| ------------- |:-------------|
| True | Aplicar sangría a etiquetas `switch`  |
...
Para las convenciones de nomenclatura, debe especificar **símbolos**, un **estilo** y una **gravedad**. Las convenciones de nomenclatura deben ordenarse de la más específica a la menos específica. La primera regla encontrada que se puede aplicar es la única que se aplica. 
...
Las siguientes son opciones válidas para la gravedad de una regla de estilo de nomenclatura `none`, `silent`, `suggestion`, `warning`, `error`.
 ...
 `suggestion` significa que el usuario ve lo siguiente en la lista de errores, y lo siguiente en el IDE. La gravedad `suggestion` permite ejecutar la regla de nomenclatura, pero no hace que la compilación se interrumpa.
...
Identifique _qué_ símbolos, _con qué_ modificadores y _a qué_ nivel de accesibilidad debe aplicarse la regla de nomenclatura.
