...
El **Diseñador de clases** no sólo permite ver clases y tipos, sino también diseñarlos.  En los siguientes temas se explica cómo hacerlo:  
  
> [!NOTE]
>  Cuando trabaje con el Diseñador de clases, deberá inspeccionar el código que emite antes de ejecutarlo para comprobar que sea apropiado para el contexto de seguridad.  
  
## En esta sección  
 [How to: Create Types by using Class Designer](../ide/how-to-create-types-by-using-class-designer.md)  
  
 Describe cómo utilizar el Diagrama de clases para crear un tipo.  
 ...
 Describe cómo definir las asociaciones en el diagrama de clases.  
 ...
 Proporciona información y vínculos a temas sobre la creación y configuración de miembros de tipo con el Diseñador de clases.  
