...
ms.locfileid: "103622574"
---
# <a name="history-of-whats-new-in-visual-studio-docs"></a>Historial de novedades en la documentación de Visual Studio

Le damos la bienvenida al historial de novedades de la documentación de Visual Studio. Este artículo contiene los cambios más importantes en la documentación anteriores a febrero de 2021 (a partir de julio de 2020). Para ver las últimas novedades, vea [Documentación de Visual Studio: Novedades de la documentación](whats-new-visual-studio-docs.md).
