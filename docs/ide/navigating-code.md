---
title: "Navegar por el código | Microsoft Docs"
ms.custom: 
ms.date: 09/26/2017
ms.reviewer: 
ms.suite: 
...
Ir a definición le lleva a la definición del elemento seleccionado. Para obtener más información, vea [Go To Definition and Peek Definition](../ide/go-to-and-peek-definition.md) (Ir a definición y Ver la definición).  
...
La jerarquía de llamadas muestra las llamadas a un método en la ventana Jerarquía de llamadas:  
