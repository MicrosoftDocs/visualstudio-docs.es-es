...
### <a name="access-your-azure-account-in-server-explorer"></a>Obtener acceso a su cuenta de Azure en el Explorador de servidores  
 ...
 ![El Explorador de servidores mostrando el nodo de Azure Tools expandido](~/docs/ide/media/vs2015_serverexplorer.png "VS2015_ServerExplorer")  
 ...
 ![Administrar el cuadro de diálogo Suscripciones de Azure](~/docs/ide/media/vs2015_manage_subs.png "vs2015_manage_subs")  
...
###  <a name="a-nameaccessazurea-access-azure-active-directory-in-a-web-project"></a><a name="access_azure"></a> Obtener acceso a Azure Active Directory en un proyecto web  
 ...
 ![Cuadro de diálogo Cambiar autenticación para ASP.NET](~/docs/ide/media/vs2015_change_authentication.png "VS2015_change_authentication")  
...
## <a name="add-a-second-user-account-to-visual-studio"></a>Agregar una segunda cuenta de usuario a Visual Studio  
 ...
 ![Selector de cuentas de Visual Studio](~/docs/ide/media/vs2015_acct_picker.png "VS2015_acct_picker")  
