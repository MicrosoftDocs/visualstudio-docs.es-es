...
Aparte de lograr un mejor rendimiento de instalación, Visual Studio 2017 tarda menos en iniciar el IDE y en cargar las soluciones. Por ejemplo, la selección de la nueva característica Carga de solución ligera, ubicada en el menú principal bajo **Herramientas**, **Opciones**, **Proyectos y soluciones**, permite la carga más rápida de soluciones más grandes.  
...
Para ofrecerle una amplia información gráfica de Visual Studio, la siguiente imagen muestra Visual Studio con un proyecto abierto junto con varias ventanas de herramientas clave que probablemente usará:  
 ...
 - [Team Explorer](https://www.visualstudio.com/docs/connect/work-team-explorer) le permite realizar el seguimiento de elementos de trabajo y compartir código con otros usuarios a través de tecnologías de control de versiones como [Git](https://git-scm.com/) y Control de versiones de Team Foundation (TFVC) (https://www.visualstudio.com/docs/tfvc/overview).  
