...
## <a name="navigate-in-the-code-window"></a>Navegar por la ventana de código  
 ...
 ![Botones de navegación hacia adelante y atrás](../ide/media/vs2015_nav_buttons.png "VS2015_Nav_buttons")  
...
![Ventana Navegar a - buscar por mayúsculas](../ide/media/vside_capitalsearch.png "Ventana Navegar a - buscar por mayúsculas")
...
-   [Configuración de Visual Basic](/dotnet/visual-basic/developing-apps/using-ide/settings)  
