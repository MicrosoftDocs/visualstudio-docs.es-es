...
#### <a name="create-the-wpf-project"></a>Crear el proyecto de WPF
...
#### <a name="clean-the-solution-files-and-build-a-release-version"></a>Limpiar los archivos de solución y crear una versión de lanzamiento
