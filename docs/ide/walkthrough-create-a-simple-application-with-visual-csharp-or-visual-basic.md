...
2.  Cambie el **tema de color** a **Oscuro** y, a continuación, haga clic en **Aceptar**.  
 ...
 El tema de color usado para las imágenes en el resto de este tutorial es el tema claro. Para obtener más información sobre cómo personalizar el IDE, consulte [Personalizar la configuración de desarrollo de Visual Studio](http://msdn.microsoft.com/es-es/22c4debb-4e31-47a8-8f19-16f328d7dcd3).  
...
1.  Cree un nuevo proyecto. En la barra de menús, elija **Archivo**, **Nuevo**, **Proyecto...**.  
     ...
     ![En el cuadro de inicio rápido, especifique un proyecto nuevo](../ide/media/exploreide-quicklaunchnewprojectsmall.png "ExploreIDE\-QuickLaunchNewProjectsmall")  
...
3.  Guarde los cambios presionando Ctrl\-s o usando el elemento de menú **Archivo**.  
 ...
 A continuación, agregará dos controles [RadioButton](../Topic/RadioButton.md) al formulario.  
...
2.  Agregue dos controles RadioButton a la superficie de diseño eligiendo el elemento RadioButton y arrastrándolo a la ventana de la superficie de diseño dos veces. Además, mueva los botones \(seleccionándolos y usando las teclas de dirección\) para que los botones aparezcan uno junto al otro bajo el control TextBlock.  
     ...
     ![Formulario Greetings con bloque de texto y dos botones de opción](../ide/media/exploreide-greetingswithradiobuttons.png "ExploreIDE\-Greetingswithradiobuttons")  
...
2.  Abra el menú contextual de RadioButton2 presionando el botón secundario del mouse mientras selecciona RadioButton2, elija **Editar texto** y, luego, escriba `Goodbye`.  
 ...
 El último elemento de la interfaz de usuario que agregará es un control [Button](../Topic/Button.md).  
...
##  <a name="BKMK_DebugTest"></a> Depurar y probar la aplicación  
 A continuación, depurará la aplicación para buscar errores y probar que los dos cuadros de mensaje aparecen correctamente. Las siguientes instrucciones indican cómo compilar e iniciar el depurador, pero más adelante podría leer [Compilar una aplicación de WPF \(WPF\)](../Topic/Building%20a%20WPF%20Application%20\(WPF\).md) y [Depurar WPF](../debugger/debugging-wpf.md) para obtener más información.  
...
3.  Compile la solución con **Compilar**, **Compilar solución** o presione la tecla F6.  
 ...
 ¡Enhorabuena por completar este tutorial\! Puede encontrar el .exe creado en el directorio de soluciones y proyectos \(... \\HelloWPFApp\\HelloWPFApp\\bin\\Release\\\). Si desea explorar más ejemplos, vea [Ejemplos de Visual Studio](../ide/visual-studio-samples.md).  
  
## Vea también  
 [Novedades de Visual Studio 2015](../ide/what-s-new-in-visual-studio-2015.md)   
 [Introducción](../ide/get-started-developing-with-visual-studio.md)   
