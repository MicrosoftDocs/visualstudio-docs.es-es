...
- **Deshabilite las herramientas de diagnóstico**
    ...
    Para más información, vea [Herramientas de generación de perfiles](https://docs.microsoft.com/en-us/visualstudio/profiling/profiling-tools).
