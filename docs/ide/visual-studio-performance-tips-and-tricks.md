...
Si deshabilita la restauración automática de archivos, puede acceder a archivos rápidamente con la función [Ir a](../ide/go-to.md). Seleccione **Editar** > **Ir a** > **Ir a todo**, o presione **Ctrl**+**T**.
