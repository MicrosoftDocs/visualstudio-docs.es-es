...
## Expresiones regulares en Visual Studio  
...
|Coincidir con el texto de una clase de caracteres Unicode, donde “X” es el número de Unicode.  Para obtener más información sobre clases de caracteres Unicode, consulte el documento sobre<br /><br /> [propiedades de caracteres Unicode estándar 5.2](http://www.unicode.org/versions/Unicode5.2.0/ch04.pdf).|\\p{X}|`\p{Lu}` coincide con “T” y “D” en “Thomas Doe”.|  
|Coincidir con un límite de palabras|`\b` \(fuera de una clase de caracteres \\b especifica un límite de palabras y dentro de una clase de caracteres un retroceso\).|`\bin` coincide con “in” en “inside”, pero no con “pinto”.|  
...
|Coincidir con un carácter Unicode|\\uXXXX donde XXXX especifica el valor del carácter Unicode.|`\u0065` coincide con “e”.|  
