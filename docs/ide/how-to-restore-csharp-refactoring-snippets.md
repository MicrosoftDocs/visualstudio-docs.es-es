...
---
title: "Cómo: Restaurar fragmentos de código de refactorización de C# | Microsoft Docs" ms.custom: "" ms.date: "11/04/2016" ms.reviewer: "" ms.suite: "" ms.technology: 
  - "vs-ide-general" ms.tgt_pltfrm: "" ms.topic: "article" helpviewer_keywords: 
  - "expansión no segura"
  - "expansiones, no seguras" ms.assetid: 12114273-7f2f-43d0-abcb-2d4711a3a68d caps.latest.revision: 20 author: "gewarren" ms.author: "gewarren" manager: ghogen
---
 ...
 *Directorio de instalación*\Microsoft Visual Studio 15.0\VC#\Snippets\\*language ID*\Refactoring  
...
5.  Busque la carpeta **Refactorización**, cuya ruta de acceso del directorio es la siguiente:  
     ...
     *Directorio de instalación*\Microsoft Visual Studio 15.0\VC#\Snippets\\*language ID*\Refactoring  
     ...
     C:\Archivos de programa\Microsoft Visual Studio 15.0\VC#\Snippets\1033\Refactoring.  
