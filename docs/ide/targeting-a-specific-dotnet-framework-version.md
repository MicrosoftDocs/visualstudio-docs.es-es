...
<a id="related-sections" class="xliff"></a>  
 ...
 Describe el control **Plataforma de destino** del Diseñador de proyectos para proyectos de [!INCLUDE[csprcs](../data-tools/includes/csprcs_md.md)].  
  
 [Página de aplicación, Diseñador de proyectos (Visual Basic)](../ide/reference/application-page-project-designer-visual-basic.md)  
 Describe el control **Plataforma de destino** del Diseñador de proyectos para proyectos de [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
