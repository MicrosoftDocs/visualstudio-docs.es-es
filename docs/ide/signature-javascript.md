...
ms.topic: "article"
helpviewer_keywords: 
  - "etiqueta XML de JavaScript <signature>"
  - "signature (etiqueta XML) [JavaScript]"
...
## Comentarios  
 ...
 El elemento `<signature>` debe colocarse en el cuerpo de la función antes de cualquier instrucción.  Cuando utilice elementos [\<summary\>](../ide/summary-javascript.md), [\<param\>](../ide/param-javascript.md) o [\<returns\>](../ide/returns-javascript.md) con el elemento `<signature>`, coloque los demás elementos dentro del bloque `<signature>`.  
