...
description: Aprenda a usar Visual Studio para despejar un registro de compilación mediante el filtrado de uno o varios tipos de advertencias del compilador.
