...
helpviewer_keywords: 
  ...
  - "elementos de la solución, la carpeta en el Explorador de soluciones"
  - "elementos de solución, compartidos"
  - "soluciones [Visual Studio]"
  - "elementos de proyecto [Visual Studio], acerca de los elementos de proyecto"
  - "áreas de trabajo"
  - "diseño de soluciones [Visual Studio]"
  - "proyectos [Visual Studio]"
  - "soluciones [Visual Studio], proyectos y"
  - "vs.solutionpropertypages.projectdependencies"
  - "aplicaciones [Visual Studio]"
  - "proyectos [Visual Studio], configurar"
  - "archivos varios"
...
>  No tiene que usar soluciones o proyectos si no quiere. Simplemente, puede abrir los archivos en Visual Studio y comenzar a editar el código. Vea [Open Any Folder with Visual Studio](https://blogs.msdn.microsoft.com/visualstudio/2016/04/12/open-any-folder-with-visual-studio-15-preview/) (Abrir cualquier carpeta con Visual Studio) para obtener más información.
 ...
 ![Soluciones y proyectos de Visual Studio](../ide/media/vs2015_project_diagram.png "vs2015_project_diagram")  
