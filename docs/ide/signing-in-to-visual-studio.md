...
-   **Desbloquea permanentemente Visual Studio Express Edition**: puede usar cualquier edición de Visual Studio Express todo el tiempo que quiera, en lugar de tener un período de prueba limitado de 30 días.  
...
-   **Desbloquea Visual Studio si usa una cuenta asociada con una suscripción de MSDN o Visual Studio Team Services**. Vea [Cómo desbloquear Visual Studio](../ide/how-to-unlock-visual-studio.md).  
...
1.  En el explorador, seleccione el nombre de su cuenta en la parte superior y el **perfil de Visual Studio**.  

1.  Seleccione **Editar perfil** y cambie los valores de configuración que quiera.  

1.  Cuando haya terminado, seleccione **Guardar cambios**.
