...
|Área|Descripción|  
|----------|-----------------|  
|[Ejemplos de aplicaciones de la Tienda Windows](http://go.microsoft.com/fwlink/?LinkID=255278)|Muestra cómo desarrollar aplicaciones de la [!INCLUDE[win8_appname_long](../debugger/includes/win8_appname_long_md.md)].|  
|[Ejemplos de .NET Framework](http://msdn.microsoft.com/es-es/177055f8-4a1f-43e7-aee6-995c196079b1)|Muestra varios aspectos de [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] en C\# y Visual Basic.|  
