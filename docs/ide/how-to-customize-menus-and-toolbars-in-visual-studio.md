...
## <a name="adding-removing-or-moving-a-menu-on-the-menu-bar"></a>Agregar, quitar o mover un menú de la barra de menús  
...
## <a name="adding-removing-or-moving-a-toolbar"></a>Agregar, quitar o mover una barra de herramientas  
...
## <a name="resetting-a-menu-or-a-toolbar"></a>Restaurar un menú o una barra de herramientas  
