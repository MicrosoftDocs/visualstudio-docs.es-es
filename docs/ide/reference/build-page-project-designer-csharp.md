...
description: Aprenda a usar la página Compilar del Diseñador de proyectos de Visual Studio para especificar las propiedades de configuración de compilación de un proyecto.
