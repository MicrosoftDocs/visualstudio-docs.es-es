---
title: "Extracción de un método en C# | Microsoft Docs"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="extract-a-method-in-c"></a>Extracción de un método en C# #
...
1. Resalte el código que se va a extraer:
   ...
   ![Código resaltado](media/extractmethod-highlight-cs.png)
...
1. A continuación, realice alguno de los siguientes procedimientos:
   ...
   * **Mouse**
   ...
   ![Cambio de nombre del método](media/extractmethod-rename-cs.png)
