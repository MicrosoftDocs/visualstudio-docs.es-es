---
title: "Acercamiento de la declaración de variable a la referencia en C# | Microsoft Docs"
ms.custom: 
ms.date: 11/27/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="move-declaration-near-reference-in-c"></a>Acercamiento de la declaración a la referencia en C# #
