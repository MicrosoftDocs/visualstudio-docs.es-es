...
helpviewer_keywords: 
  ...
  - "extensiones de archivo, Visual Studio"
  - "tipos de archivos"
  - "tipos de archivos, Visual Studio"
  - "sln (archivos)"
  - "archivos de solución"
  - "soluciones, archivos de solución"
  - "suo (archivos)"
  - "Visual Studio, tipos de archivo y extensiones de archivo"
...
---
# Tipos de archivos de proyecto y soluci&#243;n
...
## Archivos de proyecto  
 ...
 [Tipos de archivos creados para proyectos de Visual C\+\+](/visual-cpp/ide/file-types-created-for-visual-cpp-projects)  
