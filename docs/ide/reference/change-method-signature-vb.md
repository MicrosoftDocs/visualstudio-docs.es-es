---
title: "Refactorización de una firma de método en Visual Basic | Microsoft Docs"
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="change-a-method-signature-in-visual-basic"></a>Cambio de firma del método en Visual Basic
...
1. Resalte o coloque el cursor de texto en el nombre del método para modificar uno de sus usos:
   ...
   ![Código resaltado](media/changesignature-highlight-vb.png)
...
1. En el cuadro de diálogo **Cambiar firma** que aparece, puede usar los botones a la derecha para cambiar la firma del método:
   ...
   ![Cuadro de diálogo para cambiar firma](media/changesignature-dialog-vb.png)
...
1. Cuando haya terminado, presione el botón **Aceptar** para realizar los cambios.
   ...
   ![Resultado del cambio de firma](media/changesignature-result-vb.png)
