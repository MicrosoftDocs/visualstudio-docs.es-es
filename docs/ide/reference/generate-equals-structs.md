...
**Qué:** permite generar operadores **Equals** e **IEquatable** para [structs](https://docs.microsoft.com/dotnet/csharp/language-reference/builtin-types/struct).
