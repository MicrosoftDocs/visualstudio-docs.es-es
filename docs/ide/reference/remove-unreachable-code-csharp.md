---
title: "Retirada de la refactorización de código no accesible para C# en Visual Studio | Microsoft Docs"
ms.custom: 
ms.date: 11/27/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="remove-unreachable-code-in-c"></a>Retirada de código inaccesible en C# #
