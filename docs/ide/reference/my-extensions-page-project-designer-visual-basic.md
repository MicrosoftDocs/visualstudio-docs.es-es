...
## <a name="see-also"></a>Vea también  
 ...
 [Empaquetar e implementar extensiones My personalizadas](/dotnet/visual-basic/developing-apps/customizing-extending-my/packaging-and-deploying-custom-my-extensions)   
 [Extender el modelo de aplicaciones de Visual Basic](/dotnet/visual-basic/developing-apps/customizing-extending-my/extending-the-visual-basic-application-model)   
