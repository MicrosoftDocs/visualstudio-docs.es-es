...
description: Obtenga información sobre el cuadro de diálogo Opciones, su diseño y cómo Visual Studio aplica las opciones que se seleccionan a sus proyectos y soluciones.
...
> [!NOTE]
> Algunas colecciones de configuraciones definen el número de páginas que aparecen en el panel de navegación del cuadro de diálogo Opciones.
...
- [Configuración y preferencias de Git](../../version-control/git-settings.md)
