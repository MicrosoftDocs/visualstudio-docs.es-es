...
### Aplicaciones Windows universales para cualquier dispositivo con Windows 10  
 ...
 ![Plataforma universal de Windows](~/docs/cross-platform/media/uwp_coreextensions.png "UWP\_CoreExtensions")  
...
## Barra de menús de la Vista previa del dispositivo  
 ...
 ![Menú de vista previa del dispositivo](~/docs/ide/media/vs2015_device_preview.png "vs2015\_device\_preview")  
...
4.  Salesforce  
 ...
 ![Cuadro de diálogo Agregar servicios conectados](~/docs/ide/media/vs2015_addconnectedservicedialog.png "VS2015\_AddConnectedServiceDialog")  
...
### Imágenes de alta resolución y compatibilidad táctil  
 ...
 ![Compatibilidad táctil en el editor](~/docs/ide/media/vs2015_touchsupport.png "VS2015\_TouchSupport")  
