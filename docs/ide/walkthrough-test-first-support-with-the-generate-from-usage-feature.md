---
title: "Tutorial: Desarrollo basado en pruebas previas con la característica de generación a partir del uso | Microsoft Docs"
ms.custom: 
ms.date: 10/09/2017
ms.reviewer: 
ms.suite: 
...
### <a name="to-add-a-reference-to-the-class-library-project"></a>Para agregar una referencia al proyecto de biblioteca de clases
...
Suponga que la especificación indica que un nuevo `Automobile` se puede poner en estado en ejecución si sus propiedades `Model` y `TopSpeed` se establecen en un valor distinto de los valores predeterminados.  
