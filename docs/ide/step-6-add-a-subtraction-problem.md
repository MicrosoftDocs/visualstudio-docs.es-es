...
2.  Agregue el código siguiente después del comentario "Fill in the subtraction problem" (Rellenar el problema de resta).  
     ...
     ![Información sobre herramientas de la ventana IntelliSense](../ide/media/express_overloads.png "Express_Overloads")  
Información sobre herramientas de la ventana IntelliSense  
     ...
     ![Sobrecarga del método Next&#40;&#41; en IntelliSense](../ide/media/express_nextoverload.png "Express_NextOverload")  
