...
description: Aprenda a diseñar, editar y refactorizar las clases y otros tipos, y a agregar un diagrama de clases al proyecto de C#, Visual Basic o C++.
