...
## <a name="using-the-mouse-in-class-designer"></a>Usar el mouse en el Diseñador de clases  
...
## <a name="using-the-mouse-in-the-class-details-window"></a>Usar el mouse en la ventana Detalles de clase  
...
## <a name="using-the-keyboard-in-class-designer"></a>Usar el teclado en el Diseñador de clases  
...
## <a name="using-the-keyboard-in-the-class-details-window"></a>Usar el teclado en la ventana Detalles de clase  
