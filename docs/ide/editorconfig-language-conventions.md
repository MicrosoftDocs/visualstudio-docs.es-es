...
1. Mantenga el mouse sobre la línea ondulada en el editor y abra el menú de bombilla que aparece. Elija **Configurar o suprimir incidencias** > **Configurar estilo de código \<rule ID>** .
