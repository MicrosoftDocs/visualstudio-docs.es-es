---
title: 'Documentación de Visual Studio: Novedades de marzo de 2021'
titleSuffix: ''
description: Novedades de la documentación de Visual Studio de marzo de 2021.
ms.date: 04/02/2021
helpviewer_keywords:
...
Le damos la bienvenida a las novedades de la documentación de Visual Studio de marzo de 2021. En este artículo se enumeran algunos de los cambios más importantes de documentación que se han producido durante este período. Para obtener información sobre las novedades de los meses anteriores, vea el artículo del [historial de novedades](whats-new-visual-studio-docs-history.md).

## <a name="code-quality"></a>Calidad del código

**Artículos actualizados**

- [Procedimiento para ejecutar el análisis de código heredado manualmente para código administrado](../code-quality/how-to-run-legacy-code-analysis-manually-for-managed-code.md): confirmación de la combinación desde la rama de trabajo
...
- [Elemento VisibilityItem:](../extensibility/visibilityitem-element.md) confirmación de la combinación desde la rama de trabajo
...
- [Tutorial: Introducción a C# y ASP.NET Core en Visual Studio](../get-started/csharp/tutorial-aspnet-core.md)
  - Confirmación de la combinación desde la rama de trabajo
  - Actualización de tutorial-aspnet-core.md
...
- [Solución de problemas y creación de registros para MSBuild](./msbuild-logs.md): confirmación de la combinación desde la rama de trabajo
