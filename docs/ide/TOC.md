...
## [Primer vistazo al IDE de Visual Studio](quickstart-ide-orientation.md)
## [Personalización del tema y de los colores de texto](quickstart-personalize-the-ide.md)
## [Codificación en el Editor](quickstart-editor.md)
...
#### [Preferencias de estilo del código](code-styles-and-quick-actions.md)
...
### [IntelliSense de Visual Basic](visual-basic-specific-intellisense.md)
