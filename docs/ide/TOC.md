# [Información general sobre IDE de Visual Studio](visual-studio-ide.md)
...
## [Optimización del rendimiento de Visual Studio](optimize-visual-studio-startup-time.md)
## [Optimizar la carga de la solución](optimize-solution-loading-in-visual-studio.md)
...
## [Desbloqueo de Visual Studio](how-to-unlock-visual-studio.md)
## [Notificaciones de Visual Studio](visual-studio-notifications.md)
## [Creación de listas blancas con las direcciones URL en una red privada](whitelisting-urls-in-a-private-network.md)
...
#### [Configuración de estilo de código .NET para EditorConfig](editorconfig-code-style-settings-reference.md)
