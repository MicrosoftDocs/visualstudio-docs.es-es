...
2. Pulse **Ctrl + .** en cualquier sitio de una línea para invocar a la bombilla e ir directamente a la lista de posibles correcciones.  
   ...
   ![Bombilla con el desplazamiento del mouse](~/docs/ide/media/vs2015_lightbulb_hover.png "VS2017_LightBulb_Hover")  
...
![Refactorización: resolver conflictos de combinación](~/docs/ide/media/vside-refactoring-merge-conflicts.png)
...
![Refactorización: agregar comprobación de valores nulos](~/docs/ide/media/vside-refactoring-nullcheck.png)
...
![Refactorización: generar constructores](~/docs/ide/media/vside-refactoring-constructors.png)
...
![Refactorización variables no usadas](~/docs/ide/media/vside-refactoring-unusedvars.png)
...
![Refactorización: invalidaciones](~/docs/ide/media/vside-refactoring-overrides.png)

![Cuadro de diálogo Refactorización: invalidaciones](~/docs/ide/media/vside-refactoring-overrides-dialog.png)
...
![Refactorización: cambiar base](~/docs/ide/media/vside-refactoring-changebase1.png)

![Refactorización: cambiar base](~/docs/ide/media/vside-refactoring-changebase2.png)
...
![Refactorización: cambiar separadores de dígitos](~/docs/ide/media/vside-refactoring-separators.png)
