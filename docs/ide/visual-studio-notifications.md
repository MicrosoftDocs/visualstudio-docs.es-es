...
Visual Studio tiene un sistema de notificación que le avisa de diversos eventos, como los siguientes:
...
- Se ha producido un evento de entorno que podría interesarle.  
 ...
 ![Icono de notificación de Visual Studio](~/docs/ide/media/vs2015_notificationicon.png "vs2015_NotificationIcon")  
