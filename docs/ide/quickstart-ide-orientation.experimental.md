...
![Página de inicio en Visual Studio](media/start-page-dark.png)

Si cierra la **página de inicio** y quiere verla de nuevo, puede volver a abrirla desde el menú **Archivo**.

![Menú Archivo en Visual Studio](media/file-menu-start-page-dark.png)
...
1. En la **página de inicio**, en el cuadro de búsqueda de **Nuevo proyecto**, escriba **console** para filtrar la lista de tipos de proyecto a los que contengan "console" en su nombre.
   ...
   ![Búsqueda de plantillas de proyecto en la página de inicio de Visual Studio](media/start-page-search-templates-dark.png)
...
1. En el cuadro de diálogo **Nuevo proyecto** que aparece, acepte el nombre de proyecto predeterminado y haga clic en **Aceptar**.
   ...
   ![Editor en Visual Studio](media/editor-dark.png)
...
![Explorador de soluciones en Visual Studio](media/solution-explorer-console-app-dark.png)
...
![Barra de menús en Visual Studio](media/menu-bar-dark.png)
...
![Lista de errores en Visual Studio](media/error-list-dark.png)
...
![Ventana Resultados en Visual Studio](media/output-window-dark.png)
...
1. Escriba **verbosity** en el cuadro **Inicio rápido**. En los resultados que aparecen, elija **Proyectos y soluciones --> Compilar y ejecutar** en la categoría **Opciones**.
   ...
   ![Cuadro Inicio rápido en Visual Studio](media/quick-launch-verbosity-dark.png)
...
1. Vuelva a compilar el proyecto al hacer clic con el botón derecho en el proyecto **ConsoleApp1** del **Explorador de soluciones** y elija **Recompilar** en el menú contextual.
   ...
   ![Resultados de compilación detallados en Visual Studio](media/build-output-verbose-dark.png)
...
![Menú Enviar comentarios en Visual Studio](media/send-feedback-dark.png)
...
- Adéntrese aún más en Visual Studio e incluso profundice en la depuración en la [introducción al IDE de Visual Studio](../ide/visual-studio-ide.md)

- Examine la sección **Elementos generales de la interfaz de usuario** de la documentación de VS, donde se profundiza en ventanas como [Lista de errores](../ide/reference/error-list-window.md), [Resultados](../ide/reference/output-window.md), [Propiedades](../ide/reference/properties-window.md) y en el cuadro de diálogo [Opciones](../ide/reference/options-dialog-box-visual-studio.md)
