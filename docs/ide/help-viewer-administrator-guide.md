...
2.  Escriba lo siguiente:  
     ...
     C:\Archivos de programa (x86)\Visor de Ayuda de Microsoft\v2.3\hlpctntmgr.exe /operation install /catalogname VisualStudio15 /locale es-es  
...
4.  Escriba lo siguiente:  
     ...
     Xcopy %ProgramData%\Microsoft\HelpLibrary2 \<*nombreDeCarpeta*>\ /y /e /k /o  
