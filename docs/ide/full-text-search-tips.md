...
---
title: "Sugerencias para la búsqueda de texto completo | Microsoft Docs" ms.custom: "" ms.date: "11/04/2016" ms.reviewer: "" ms.suite: "" ms.technology: 
  - "vs-help-viewer" ms.tgt_pltfrm: "" ms.topic: "article" f1_keywords: 
  - "hv_search" helpviewer_keywords: 
  - "Visor de Ayuda, sugerencias para la búsqueda de texto completo"
  - "sugerencias de búsqueda de texto completo [Visor de Ayuda]" ms.assetid: bcaad23d-2ca7-4bec-8b54-b884bc34e70b caps.latest.revision: 13 author: "gewarren" ms.author: "gewarren" manager: ghogen
---
# <a name="full-text-search-tips"></a>Sugerencias para la búsqueda de texto completo
Uno de los métodos más útiles de buscar información en la Ayuda consiste en realizar una búsqueda de texto completo. Puede crear búsquedas más selectivas que devuelvan solo los temas que le interesan si entiende cómo la sintaxis afecta a la consulta. La sintaxis incluye caracteres especiales, palabras reservadas y filtros. En este tema se proporcionan sugerencias, procedimientos e información detallada de la sintaxis para ayudarle a crear mejor sus consultas.
