---
title: "Administración de los recursos de aplicación (.NET) | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
- Aplicaciones de Windows 8.x, vea [Definición de recursos de una aplicación (HTML)](https://msdn.microsoft.com/en-us/library/windows/apps/hh465228.aspx)
