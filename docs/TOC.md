...
#### [Uso del IDE para VB...](vb-ide/refactoring-vb.md)
#### [Refactorización, generación de código y acciones rápidas](ide/refactoring-code-generation-quick-actions.md)
...
##### [Lenguaje .NET y convenciones de formato para EditorConfig](ide/editorconfig-code-style-settings-reference.md)
...
##### [Diseñar y ver clases y tipos](ide/class-designer/TOC.md)
