---
title: "Prestación LinkedIn Learning"
Author: evanwindom
Ms.author: jaunger
Manager: evelynp
Ms.date: 11/7/2017
...
---
# <a name="activating-the-linkedin-learning-benefit-in-your-visual-studio-subscription"></a>Activación de la prestación LinkedIn Learning en su suscripción de Visual Studio
...
Su suscripción de Visual Studio incluye una suscripción a LinkedIn Premium, que incluye LinkedIn Learning.  La duración de la suscripción Premium dependerá del tipo de suscripción de Visual Studio que tenga:

| Suscripción                                                     | Prestación                      |
|------------------------------------------------------------------|------------------------------|
| Suscripciones estándar y anual en la nube de Visual Studio Enterprise   | Suscripción Premium de 6 meses |
| Suscripciones estándar y anual en la nube de Visual Studio Professional | Suscripción Premium de 3 meses |
| Visual Studio Test Professional                                  | Suscripción Premium de 3 meses |
| Plataformas de MSDN                                                   | Suscripción Premium de 3 meses |
| Visual Studio Dev Essentials                                     | Suscripción Premium de 3 meses | 
...
Para activar la suscripción Premium y la prestación LinkedIn Learning:
1. Inicie sesión en [https://my.visualstudio.com](https://my.visualstudio.com/benefits).
...
9.  Cuando proporcione la dirección de correo electrónico, recibirá un mensaje que contiene un código de confirmación.  El mensaje es de "Mensajes de LinkedIn".  Si no lo encuentra en la bandeja de entrada, compruebe las carpetas de correo no deseado.  Escriba el código del mensaje y haga clic en **Verificar**.  El código de comprobación expira transcurridos unos minutos, así que si expira antes de que pueda usarlo, haga clic en el botón "Reenviar" para obtener uno nuevo.
