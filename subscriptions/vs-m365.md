...
<sup>1</sup> *Incluye No para reventa (NFR), el programa Visual Studio Industry Partner (VSIP), Empleado a tiempo completo (FTE), BizSpark y MCT Software & Services Developer. Excluye MCT Software & Services, Microsoft Partner Network (MPN), Imagine, Profesional mejor valorado (MVP), Director regional (RD) y NFR básico.*
