...
#### [Participación en Visual Studio Dev Essentials](join-dev-essentials.md)
#### [Anulación de la participación en Visual Studio Dev Essentials](leave-vsde.md)
### [Ventajas para suscriptores](subscriber-benefits.md)
...
#### [Centro de aplicaciones de Visual Studio](vs-visual-studio-app-center.md)
...
#### [Chat de asesoramiento de Azure](vs-azure-advisory-chat.md)
...
###### [Búsqueda de PCN](find-pcn.md)
###### [Búsqueda del contacto principal](find-primary-contact.md)
#### [Para MPSA](mpsa.md)
...
### [Comparación de las opciones de suscripción](https://visualstudio.microsoft.com/vs/pricing)
### Compra de suscripciones de nube
#### [Información general](vscloud-overview.md)
#### [Preguntas más frecuentes sobre facturación](vscloud-billing-faq.md)
...
## Recursos
### [Notas sobre licencias de Visual Studio](https://aka.ms/vslicensing)
### [Comparación de las opciones de suscripción y precios](https://visualstudio.microsoft.com/vs/pricing)
...
### [Términos de las licencias por volumen](https://www.microsoft.com/en-us/licensing/product-licensing/products.aspx)
