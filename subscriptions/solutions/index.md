---
title: Soluciones compatibles con las suscripciones
description: Lista de archivos INCLUDES para el contenido de widget compatible con las suscripciones de Visual Studio
ms.topic: conceptual
...
ms.locfileid: "111530449"
---
# <a name="visual-studio-subscriptions-support-widget-content-includes-files"></a>Archivos INCLUDES para el contenido de widget compatible con las suscripciones de Visual Studio

## <a name="admin-solutions"></a>Soluciones de administrador
...
## <a name="benefit-activations"></a>Activaciones de ventajas
...
## <a name="download-activate-or-use-software"></a>Descarga, activación o uso de software

### <a name="downloads-and-activations"></a>Descargas y activaciones
...
### <a name="find-and-use-product-keys"></a>Búsqueda y uso de claves de producto
...
### <a name="use-product-features"></a>Uso de características de producto
...
## <a name="other-solutions-or-no-solution"></a>Otras soluciones o ninguna solución

[!INCLUDE [No solution](other-or-no-solution/includes/no-solution.md)]

## <a name="portal-issues"></a>Problemas del portal
...
## <a name="purchase-renew-or-cancel-subscriptions"></a>Compra, renovación o cancelación de suscripciones

### <a name="help-with-purchases"></a>Ayuda con las compras
...
### <a name="help-with-renewals"></a>Ayuda con las renovaciones
...
### <a name="help-with-canceling"></a>Ayuda con las cancelaciones
...
### <a name="order-or-purchase-status"></a>Estado del pedido o la compra
...
## <a name="issues-with-signing-in"></a>Incidencias de inicio de sesión 
