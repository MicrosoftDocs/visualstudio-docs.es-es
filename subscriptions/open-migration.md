...
1. Ha recibido una notificación que indica que no es un usuario reconocido.
1. Seleccione la opción de registro **OLP Partners** (Socios de OLP) y escriba el número de autorización, el número de licencia y la dirección de correo electrónico de cliente usada en el pedido, active la casilla y hacer clic en **Enviar**.
...
1. Inicie sesión en Microsoft Business Center y vaya a "Resumen de relación".
1. Seleccione la opción de Open License deseada.
1. Después, en "Detalles de licencia", en "Suscripciones de Visual Studio", seleccione la opción para administrar suscripciones mediante el vínculo **haga clic aquí**.
1. Inicie sesión en el portal de administración con la misma dirección de correo electrónico que se muestra como contacto principal.
1. El socio podrá administrar suscripciones para esa licencia Open.
...
1. Junto al menú desplegable de contrato, seleccione + Add agreement (+ Agregar contrato) y desplácese hasta el final, donde hay una opción para **New open license** (Nueva Open License).
1. En el panel emergente, escriba el número de autorización, el número de licencia, la dirección de correo electrónico del cliente indicada en el contrato, active la casilla y haga clic en **Enviar**.
