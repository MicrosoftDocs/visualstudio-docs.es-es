---
title: Suscripciones a Visual Studio de Microsoft Partner Network (MPN) | Microsoft Docs
Author: evanwindom
Ms.author: jaunger
Manager: evelynp
Ms.date: 12/11/2017
...
---
# <a name="managing-visual-studio-subscriptions-included-with-microsoft-partner-network-mpn-memberships"></a>Administración de las suscripciones a Visual Studio incluidas con los programas de Microsoft Partner Network (MPN)

## <a name="overview"></a>Información general

El número y el nivel de las suscripciones de Visual Studio varían según el nivel de pertenencia a Microsoft Partner Networks (MPN), como se destaca en la página de [beneficios principales](https://partner.microsoft.com/membership/core-benefits) de MPN.  Para usar una suscripción, trabaje con el administrador de programas para asegurarse de que le ha asignado una suscripción de Visual Studio.  

## <a name="resources--references"></a>Recursos y referencias
...
- [Program Administrator Guide to Software and Online Services Benefits]((https://assets.microsoft.com/Program-Administrator-Guide-to-Software-and-Online-Services-Benefits_1.pdf) ) (Guía del administrador de programas para los beneficios de software y servicios en línea) de Microsoft Partner Network
    - Pág 6: Assigning Contact Roles and Visual Studio subscriptions for Action Pack (Asignar roles de contacto y suscripciones de Visual Studio para Action Pack)
      ...
      **Nota:** Se requiere el rol Contacto técnico para las suscripciones de Visual Studio
...
## <a name="high-level-assignment--access-flow"></a>Flujo de acceso y asignación de alto nivel
...
11. El usuario accederá a [https://my.visualstudio.com](https://my.visualstudio.com?wt.mc_id=o~msft~docs) para iniciar sesión
...
3. Seleccionar **Suscripciones de MSDN** (Nota: Actualización de la suscripción de Visual Studio pendiente)
4. Buscar el **Individuo** deseado
5. Hacer clic en **Enviar**
6. El usuario recibirá un correo electrónico
7. El usuario accederá a [https://my.visualstudio.com](https://my.visualstudio.com?wt.mc_id=o~msft~docs) para iniciar sesión
