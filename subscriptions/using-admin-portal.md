---
title: Introducción al Portal de administradores de suscripciones de Visual Studio | Visual Studio Marketplace
author: evanwindom
ms.author: v-evwin
manager: cabuschl
...
ms.date: 10/28/2020
ms.topic: overview
description: Aprenda cómo empezar a administrar las suscripciones de Visual Studio de su organización con el Portal de administradores de suscripciones.
ms.openlocfilehash: 3ac02dcd49af1c3277be0c3a15a2e3bf9c735f04
ms.sourcegitcommit: 3fc099cdc484344c781f597581f299729c6bfb10
ms.translationtype: HT
ms.contentlocale: es-ES
ms.lasthandoff: 03/19/2021
ms.locfileid: "104673078"
---
...
En el portal de administraciones de Suscripciones de Visual Studio encontrará las herramientas necesarias para administrar las suscripciones de su organización desde un mismo sitio. 
...
Tenga en cuenta estas consideraciones al usar el portal de administradores de Suscripciones de Visual Studio:
...
- Preferencia de idioma para el correo electrónico de comunicación de asignación desde el portal de administradores.
...
> ![Página Suscriptores del Portal de administradores de suscripciones de Visual Studio](_img/using-admin-portal/subscribers-page.png "La página de suscriptores muestra los recuentos de suscripciones por tipo.")
...
> [!div class="mx-imgBorder"]
> ![Página Detalles del Portal de administradores de suscripciones de Visual Studio](_img/using-admin-portal/details-page.png "La página de detalles muestra información sobre el contrato, incluidos los nombres de los superadministradores.")
