...
La obligación de compra completa viene determinada por el número máximo de suscripciones que se asignan a los usuarios. Este nivel de asignación de suscripciones es el punto álgido de asignaciones de usuarios por día o de usuarios que utilizan el software de Visual Studio, lo que sea mayor.

- La asignación de suscripciones de Visual Studio a más usuarios aumenta el nivel de uso máximo.  
...
Puede asignar suscripciones a través de programas como Open License y Open Value, o mediante Visual Studio Marketplace mensualmente. Si usa estos programas, debe procesar su pedido para mas usuarios durante el mes en el que los usuarios (empleados o contratistas externos) empiezan a interactuar con el software con licencia de Visual Studio.
