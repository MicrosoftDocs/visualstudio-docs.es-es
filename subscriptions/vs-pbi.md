---
title: Ventaja de Power BI Pro
Author: evanwindom
Ms.author: jaunger
Manager: evelynp
Ms.date: 10/3/2017
Ms.topic: Get-Started-Article
Description: "Obtenga información sobre cómo activar la suscripción de Power BI Pro incluida en la suscripción de Visual Studio."
...
---
# <a name="activating-the-power-bi-pro-benefit-in-visual-studio-subscriptions"></a>Activación de la ventaja de Power BI Pro en suscripciones de Visual Studio

Desarrolle, pruebe e implemente complementos para Office y SharePoint.  Incluye un sitio para desarrolladores de SharePoint Online de un inquilino. 

Para usar Power BI Pro, debe configurar una cuenta o iniciar sesión con una cuenta existente. 
1.  Haga clic en el vínculo **Obtener código** situado en la parte inferior del icono de la ventaja.   Recibirá una notificación que indica que el código se ha recuperado correctamente.  Haga clic en **Activar**. 
...
![Pago de la ventaja de Power BI Pro](_img\vs-pbi\vs-pbi-payment-blurred-cropped.png)
