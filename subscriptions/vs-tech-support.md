...
4. Una vez completado el proceso, recibe un correo electrónico con el **identificador de contrato** y el **identificador de acceso** que va a usar al crear un incidente de soporte técnico.
