...
Visual Studio para Mac [presenta una nueva interfaz de usuario de edición de texto de Cocoa nativa](/visualstudio/releasenotes/vs2019-mac-relnotes) basada en las mismas capas del editor de Visual Studio en Windows.
