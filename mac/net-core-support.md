...
Versión del SDK de .NET Core  |Visual Studio para Mac 8.0 (estable)  |Visual Studio para Mac 8.1 (versión preliminar)  |
|---------|---------|---------|
|v2.1.0 - v2.1.5xx    |✔|✗|
|v2.1.600 +     |✗|✔︎|
|v2.2.1 - v2.2.1xx|✔︎|✗|
|v2.2.200 + |✗| ✔︎ |
|v3.0 < versión preliminar 4 |✗|✗|
|v3.0 versión preliminar 4 + |✗|✔︎ |

* .NET Core v2.1.505 se instala de manera predeterminada con el programa de instalación.
