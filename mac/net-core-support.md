...
Versión del SDK de .NET Core  |Visual Studio para Mac 8.1 (estable)  |Visual Studio para Mac 8.2 (versión preliminar)  |
|---------|---------|---------|
|v2.1.0 - v2.1.5xx    |✗|✗|
|v2.1.600 +     |✔︎|✔︎|
|v2.2.1 - v2.2.1xx|✗|✗|
...
|v3.0 (versión preliminar 3, 4 y 5) |✔︎|✔︎ |
|v3.0 (versión preliminar 6) |✗|✔︎ |
...
* .NET Core v2.1.700 se instala de manera predeterminada con el instalador.
