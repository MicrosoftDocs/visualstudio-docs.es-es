...
description: En este artículo se explica cómo administrar las propiedades de los proyectos y las soluciones de Visual Studio para Mac
...
* **Compilar**: se usa para establecer o cambiar perfiles de PCL de bibliotecas de clases portables. También se pueden establecer comandos personalizados, configuraciones y opciones del compilador. Aquí también se pueden establecer la ruta de acceso de la salida y el nombre del ensamblado.
* **Ejecutar**: se usa para crear configuraciones de ejecución personalizadas proyecto a proyecto.
* **Código fuente**: controla el formato de muchos tipos de archivo diferentes y convenciones de nomenclatura. También se pueden establecer las directivas de nomenclatura y los estilos de encabezado predeterminados.
* **Control de versiones**: opciones para establecer el estilo de los mensajes de confirmación al usar Control de versiones con el proyecto.
