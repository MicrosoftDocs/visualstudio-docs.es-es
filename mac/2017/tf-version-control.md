...
- [Develop and share your code in TFVC using Visual Studio (on Windows) (Desarrollo y uso compartido del código en TFVC con Visual Studio [en Windows])](/azure/devops/repos/tfvc/share-your-code-in-tfvc-vs)