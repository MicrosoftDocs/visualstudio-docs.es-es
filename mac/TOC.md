...
## [Visual Studio para Mac dirigido a usuarios de Windows](vsmac-for-windows-users.md)
...
## [Compatibilidad con múltiples versiones (multi-targeting)](project-multitargeting.md)
...
## [Visualización de elementos de importación](show-imports.md)
## [Edición de varios símbolos de inserción](multi-caret-editing.md)
...
## [Depuración de paquetes NuGet con vínculo de origen](source-link.md)
...
# Accesibilidad
## [Información general](accessibility.md)
## [Establecimiento de opciones de accesibilidad de IDE](accessibility-ide-options.md)
## Herramientas y características de accesibilidad de macOS
...
# Tutoriales en vídeo
## [Introducción a ASP.NET Core en Visual Studio para Mac](tutorial-aspnet-core-vsmac-getting-started.md)
## [Extensión de una aplicación web de ASP.NET Core existente](tutorial-aspnet-core-vsmac-extending.md)
...
# [Notas de la versión](/visualstudio/releasenotes/vs2019-mac-relnotes)
# [Notas de la versión preliminar](/visualstudio/releasenotes/vs2019-mac-preview-relnotes)
# Muestras
## [Ejemplos destacados](samples/index.yml)
## [Todos los ejemplos de ASP.NET Core](/samples/browse/?products=aspnet-core)
## [Todos los ejemplos de .NET Core](/samples/browse/?products=dotnet-core)
## [Todos los ejemplos de Xamarin.Forms](/xamarin/xamarin-forms/samples/)
## [Todos los ejemplos de Xamarin.iOS](/xamarin/ios/samples/)
## [Todos los ejemplos de Xamarin.Android](/xamarin/android/samples/)
## [Todos los ejemplos de Xamarin.Mac](/xamarin/mac/samples/)
