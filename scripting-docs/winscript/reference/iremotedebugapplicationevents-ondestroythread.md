...
#### <a name="parameters"></a>Parámetros  
 `prdat`  
 de Subproceso que se ha destruido.  
...
## <a name="remarks"></a>Comentarios  
 Este método controla el evento destruido por subproceso.  
