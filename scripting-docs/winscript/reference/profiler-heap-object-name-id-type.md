...
ms.locfileid: "58156065"
---
# <a name="profilerheapobjectnameid-type"></a>PROFILER_HEAP_OBJECT_NAME_ID (Tipo)
Identificador del nombre del objeto de montón. Utilizado en [PROFILER_HEAP_OBJECT (estructura)](../../winscript/reference/profiler-heap-object-structure.md).  
