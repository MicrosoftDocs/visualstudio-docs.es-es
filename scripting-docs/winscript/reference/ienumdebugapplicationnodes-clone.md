---
title: IEnumDebugApplicationNodes::Clone | Documentos de Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
#### <a name="parameters"></a>Parámetros  
 `pperddp`  
 [out] Devuelve el `IEnumDebugApplicationNodes` interfaz del clon del enumerador.  
