---
title: IDebugCodeContext (interfaz) | Documentos de Microsoft
ms.custom: 
ms.date: 01/18/2017
...
Una abstracción que representa una posición en el código ejecutable.  
 ...
 Además de los métodos heredados de `IUnknown`, el `IDebugCodeContext` interfaz expone los métodos siguientes.  
