---
title: IDebugAsyncOperation::GetSyncDebugOperation | Documentos de Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
#### <a name="parameters"></a>Parámetros  
 `ppsdo`  
 [out] La operación sincrónica de depuración asociada a este objeto.  
