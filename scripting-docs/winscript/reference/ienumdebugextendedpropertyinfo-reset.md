---
title: IEnumDebugExtendedPropertyInfo::Reset | Documentos de Microsoft
ms.custom: 
ms.date: 01/18/2017
...
ms.tgt_pltfrm: 
ms.topic: reference
apiname: IEnumDebugExtendedPropertyInfo.Reset
apilocation: scrobj.dll
helpviewer_keywords: IEnumDebugExtendedPropertyInfo::Reset
