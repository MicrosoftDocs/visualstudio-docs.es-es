---
title: IRemoteDebugApplicationEvents::OnSetName | Documentos de Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
## <a name="remarks"></a>Comentarios  
 Este método controla un evento de nombre de conjunto.  
