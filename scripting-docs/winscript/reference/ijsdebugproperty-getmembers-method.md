---
title: 'Ijsdebugproperty:: GetMembers (método) | Documentos de Microsoft'
ms.custom: ''
ms.date: 01/18/2017
...
#### <a name="parameters"></a>Parámetros  
 `members`  
 [in] Marcas para especificar qué se incluye en la información de miembros.  
