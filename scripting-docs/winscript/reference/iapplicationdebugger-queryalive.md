...
## <a name="remarks"></a>Comentarios  
 Este método indica si el depurador responde. Las implementaciones de este método siempre deben devolver `S_OK`.  
  
 Si el proceso del depurador finaliza de forma inesperada, COM devuelve un error del proxy de serialización para las llamadas a este método.  
