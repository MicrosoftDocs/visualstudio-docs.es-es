...
---
# IJsDebugFrame::GetReturnAddress (M&#233;todo)
Consigue que la dirección de devolución se haya insertado al 'inicio' \(vea GetStackRange\) del marco.  
