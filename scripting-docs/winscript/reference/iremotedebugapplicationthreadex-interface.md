---
title: IRemoteDebugApplicationThreadEx (interfaz) | Documentos de Microsoft
ms.custom: 
ms.date: 01/18/2017
...
ms.tgt_pltfrm: 
ms.topic: reference
helpviewer_keywords: IRemoteDebugApplicationThreadEx Interface
...
Representa un subproceso de ejecución dentro de una aplicación determinada.  
 ...
 Además de los métodos heredados de `IUnknown`, el `IRemoteDebugApplicationThreadEx` interfaz expone los métodos siguientes.  
