---
title: 'IJsDebugProperty:: GetPropertyInfo (método) | Microsoft Docs'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
#### <a name="parameters"></a>Parámetros  
 ...
 `pPropertyInfo`  
 enuncia Información sobre el objeto.  
