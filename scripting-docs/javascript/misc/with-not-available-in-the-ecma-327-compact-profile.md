...
' with ' no está disponible en el perfil de diseño de ECMA 327 (ErrWithNotInCP  
 ...
 Para obtener más información acerca de la palabra clave with, vea [with (instrucción](../../javascript/reference/with-statement-javascript.md)).