---
title: "'with' no está disponible en ECMA 327 Compact Profile | Microsoft Docs"
ms.custom: ''
ms.date: 01/18/2017
...
'with' no está disponible en ECMA 327 Compact Profile (ErrWithNotInCP  
 ...
 No tiene permiso para usar la palabra clave en el perfil de Compact.  
  
 Para obtener más información acerca de la palabra clave, consulte [con la instrucción](../../javascript/reference/with-statement-javascript.md).