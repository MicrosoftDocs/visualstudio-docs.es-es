---
title: Math.Cosh (función) (JavaScript) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.author: mikejo
manager: ghogen
ms.openlocfilehash: 5acf370d524a34e516e642fad5072aa92d4d47cb
ms.sourcegitcommit: aadb9588877418b8b55a5612c1d3842d4520ca4c
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 10/27/2017
ms.locfileid: "24638965"
---
# <a name="mathcosh-function-javascript"></a>Math.cosh (función de JavaScript)
...
## <a name="remarks"></a>Comentarios  
 El valor devuelto es el mismo que `(exp(x) + exp(-x))/2`. Si `x` es `NaN`, el resultado es `NaN`.  
