---
title: constructor (propiedad, Intl.DateTimeFormat) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636055"
---
# <a name="constructor-property-intldatetimeformat"></a>constructor (Propiedad, Intl.DateTimeFormat)
Especifica la función que crea a un formateador.  
...
## <a name="remarks"></a>Comentarios  
 Requerido `dateTimeFormatter` es el nombre del formateador.  
