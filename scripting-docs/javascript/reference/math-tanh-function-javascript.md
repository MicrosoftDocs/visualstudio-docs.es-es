---
title: Math.TANH (función) (JavaScript) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638665"
---
# <a name="mathtanh-function-javascript"></a>Math.tanh (función de JavaScript)
...
## <a name="remarks"></a>Comentarios  
 El valor devuelto es el mismo que `(exp(x) - exp(-x))/(exp(x) + exp(-x))`. Si `x` es `NaN`, el resultado es `NaN`.  
