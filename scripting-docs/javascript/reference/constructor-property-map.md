---
title: constructor (propiedad, Map) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636035"
---
# <a name="constructor-property-map"></a>constructor (Propiedad, Map)
Especifica la función que crea un mapa.  
...
## <a name="remarks"></a>Comentarios  
 Requerido `map` es el nombre de la asignación.  
