---
title: "set (M&#233;todo, Int8Array) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
## Parámetros  
 `index`  
 Índice de la ubicación que se establecerá.  
  
 `value`  
 Valor que se establece.  
  
 `array`  
 Matriz con o sin tipo de valores que se establecerá.  
